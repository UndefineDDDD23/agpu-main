...
require_capability('agpu/cohort:assign', $context);
...
if ($returnurl) {
    ...
    $returnurl = new agpu_url('/cohort/index.php', array('contextid' => $cohort->contextid));
}
...
if ($context->contextlevel == CONTEXT_COURSECAT) {
    ...
    navigation_node::override_active_url(new agpu_url('/cohort/index.php', array('contextid'=>$cohort->contextid)));
} else {
