...
$canassign = has_capability('agpu/cohort:assign', $context);
if (!$manager) {
...
if ($category) {
    ...
    navigation_node::override_active_url(new agpu_url('/cohort/index.php'));
    if ($showall) {
...
$baseurl = new agpu_url('/cohort/index.php', $params);
