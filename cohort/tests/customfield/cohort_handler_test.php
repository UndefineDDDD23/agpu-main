...
class cohort_handler_test extends advanced_testcase {
    ...
    public function test_get_configuration_url(): void {
        $this->assertInstanceOf(agpu_url::class, $this->handler->get_configuration_url());
    ...
    public function test_can_configure(): void {
        ...
        assign_capability('agpu/cohort:configurecustomfields', CAP_ALLOW, $roleid, context_system::instance()->id, true);
    ...
    public function test_can_edit(): void {
        ...
        $roleid = self::getDataGenerator()->create_role();
        assign_capability('agpu/cohort:manage', CAP_ALLOW, $roleid, context_system::instance()->id, true);
    ...
    public function test_can_view(): void {
        ...
        assign_capability('agpu/cohort:manage', CAP_ALLOW, $manageroleid, context_system::instance()->id, true);

        $viewroleid = self::getDataGenerator()->create_role();
        assign_capability('agpu/cohort:view', CAP_ALLOW, $viewroleid, context_system::instance()->id, true);

        $viewandmanageroleid = self::getDataGenerator()->create_role();
        assign_capability('agpu/cohort:manage', CAP_ALLOW, $viewandmanageroleid, context_system::instance()->id, true);
        assign_capability('agpu/cohort:view', CAP_ALLOW, $viewandmanageroleid, context_system::instance()->id, true);
