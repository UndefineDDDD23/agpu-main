...
class externallib_test extends externallib_advanced_testcase {
    ...
    public function test_create_cohorts(): void {
        ...
        $roleid = $this->assignUserCapability('agpu/cohort:manage', $contextid);
        ...
        $this->unassignUserCapability('agpu/cohort:manage', $contextid, $roleid);
    ...
    public function test_get_cohorts(): void {
        ...
        $roleid = $this->assignUserCapability('agpu/cohort:view', $context->id);
        ...
        $this->unassignUserCapability('agpu/cohort:view', $context->id, $roleid);
        $roleid = $this->assignUserCapability('agpu/cohort:manage', $context->id, $roleid);
        // Call the external function.
        $returnedcohorts = core_cohort_external::get_cohorts(array(
            $cohort1->id, $cohort2->id));
        $returnedcohorts = external_api::clean_returnvalue(core_cohort_external::get_cohorts_returns(), $returnedcohorts);
    ...
    public function test_update_cohorts(): void {
        ...
        $context = \context_system::instance();
        $roleid = $this->assignUserCapability('agpu/cohort:manage', $context->id);
        ...
        // Call without required capability.
        $this->unassignUserCapability('agpu/cohort:manage', $context->id, $roleid);
        $this->expectException(\required_capability_exception::class);
        core_cohort_external::update_cohorts(array($cohort1));
    }
    ...
    public function test_update_cohorts_missing_dest(): void {
        ...
        $roleid = $this->assignUserCapability('agpu/cohort:manage', $context1->id);
    ...
    public function test_update_cohorts_missing_src(): void {
        ...
        $roleid = $this->assignUserCapability('agpu/cohort:manage', $context2->id);
    ...
    public function test_add_cohort_members(): void {
        ...
        $roleid = $this->assignUserCapability('agpu/cohort:assign', $contextid);
        ...
        $this->unassignUserCapability('agpu/cohort:assign', $contextid, $roleid);
        $this->expectException(\required_capability_exception::class);
    ...
    public function test_delete_cohort_members(): void {
        ...
        $context = \context_system::instance();
        $roleid = $this->assignUserCapability('agpu/cohort:assign', $context->id);
        ...
        // Call without required capability.
        $this->unassignUserCapability('agpu/cohort:assign', $context->id, $roleid);
        $this->expectException(\required_capability_exception::class);
        core_cohort_external::delete_cohort_members(array($cohortdel1, $cohortdel2));
    }
    ...
    public function test_search_cohorts(): void {
        ...
        assign_capability('agpu/cohort:manage', CAP_ALLOW, $creatorrole, $syscontext->id);
        assign_capability('agpu/cohort:view', CAP_ALLOW, $courserole, $syscontext->id);
