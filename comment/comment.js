    ...
    init: function(Y, options) {
        ...
        Y.extend(CommentHelper, Y.Base, {
            ...
            post: function() {
                ...
                if (value && value != M.util.get_string('addcomment', 'agpu')) {
            ...
            renderDeleteIcon: async function(list) {
                return new Promise(function(resolve) {
                    require(['core/templates', 'core/str'], (Templates, Str) => {
                        return Str.get_string('deletecommentbyon', 'agpu', {
                            user: list.fullname,
                            time: list.time
                ...
                this.request({
                    ...
                    callback: async function(id, ret, args) {
                        ...
                        if (ret.error == 'require_login') {
                            var result = {};
                            result.html = M.util.get_string('commentsrequirelogin', 'agpu');
                        } else {
            ...
            toggle_textarea: function(focus) {
                ...
                if (focus) {
                    if (t.get('value') == M.util.get_string('addcomment', 'agpu')) {
                        t.set('value', '');
                        t.setStyle('color', 'black');
                    }
                }else{
                    if (t.get('value') == '') {
                        t.set('value', M.util.get_string('addcomment', 'agpu'));
