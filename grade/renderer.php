...
class core_grades_renderer extends plugin_renderer_base {
     ...
     * @todo Final deprecation in agpu 6.0. See MDL-82116.
     */
    ...
    public function group_selector(object $course, ?string $groupactionbaseurl = null): ?string {
        ...
        if ($groupmode == VISIBLEGROUPS || has_capability('agpu/site:accessallgroups', $context)) {
     ...
     * @todo Final deprecation in agpu 6.0. See MDL-82421.
     */
    #[\core\attribute\deprecated(
        replacement: null,
        since: '4.5',
    ...
    public function initials_selector(
        ...
        $url = new agpu_url($slug, ['id' => $course->id]);
    ...
    public function user_heading(stdClass $user, int $courseid, bool $showbuttons = true): string {
        ...
        $headingdata = [
            'userprofileurl' => (new agpu_url('/user/view.php', ['id' => $user->id, 'course' => $courseid]))->out(false),
            'name' => fullname($user),
        ...
        if ($showbuttons) {
            ...
            $headingdata['buttons'][] = [
                ...
                'url' => (new agpu_url('/message/index.php', ['id' => $user->id]))->out(false),
            ...
            if ($USER->id != $user->id) {
                ...
                $headingdata['buttons'][] = [
                    ...
                    'url' => (new agpu_url('/message/index.php', ['user1' => $USER->id, 'user2' => $user->id,
