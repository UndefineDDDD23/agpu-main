...
class manage_outcomes_action_bar extends action_bar {
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        if ($this->context->contextlevel === CONTEXT_COURSE) {
            ...
            $backlink = new agpu_url('/grade/edit/outcome/course.php', ['id' => $courseid]);
            ...
            $importoutcomeslink = new agpu_url('/grade/edit/outcome/import.php', ['courseid' => $courseid]);
        ...
        $addoutcomelink = new agpu_url('/grade/edit/outcome/edit.php', ['courseid' => $courseid]);
        ...
        if ($this->hasoutcomes) {
            ...
            $exportoutcomeslink = new agpu_url('/grade/edit/outcome/export.php',
