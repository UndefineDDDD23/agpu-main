...
class general_action_bar extends action_bar {
    ...
    /** @var agpu_url $activeurl The URL that should be set as active in the URL selector element. */
    protected $activeurl;
     ...
     * @param agpu_url $activeurl The URL that should be set as active in the URL selector element.
     ...
     */
    public function __construct(\context $context, agpu_url $activeurl, string $activetype, string $activeplugin) {
            ...
            foreach ($plugins as $key => $plugin) {
                ...
                switch ($plugintype) {
                    ...
                    case 'letter':
                        ...
                        break;
                    case 'import':
                        $link = new agpu_url('/grade/import/index.php', ['id' => $courseid]);
                        ...
                        break;
                    case 'export':
                        $link = new agpu_url('/grade/export/index.php', ['id' => $courseid]);
