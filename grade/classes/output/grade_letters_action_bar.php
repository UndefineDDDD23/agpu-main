...
class grade_letters_action_bar extends action_bar {
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        if ($this->context->contextlevel === CONTEXT_COURSE) {
            ...
            $generalnavselector = new general_action_bar($this->context, new agpu_url('/grade/edit/letter/index.php',
                ['id' => $this->context->id]), 'letter', 'view');
            $data = $generalnavselector->export_for_template($output);
        }
        // Add a button to the action bar with a link to the 'edit grade letters' page.
        $editbuttonlink = new agpu_url('/grade/edit/letter/index.php', ['id' => $this->context->id, 'edit' => 1]);
