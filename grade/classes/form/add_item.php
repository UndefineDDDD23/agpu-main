...
class add_item extends dynamic_form {
    ...
    protected function definition() {
        ...
        if (get_config('agpu', 'grade_report_showmin')) {
        ...
        $url = new agpu_url('/grade/edit/tree/item.php', ['id' => $id, 'courseid' => $courseid]);
    ...
    protected function check_access_for_dynamic_submission(): void {
        $courseid = $this->optional_param('courseid', null, PARAM_INT);
        require_capability('agpu/grade:manage', context_course::instance($courseid));
    }
    ...
    protected function get_page_url_for_dynamic_submission(): agpu_url {
        ...
        return new agpu_url('/grade/edit/tree/index.php', $params);
    }
    ...
    public function validation($data, $files): array {
        ...
        if ($gradeitem) {
            if ($gradeitem->gradetype == GRADE_TYPE_VALUE) {
                if ((((bool) get_config('agpu', 'grade_report_showmin')) &&
