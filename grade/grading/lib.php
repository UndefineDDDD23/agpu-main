...
class grading_manager {
    ...
    public function set_active_method($method) {
        ...
        if (empty($method)) {
            ...
            if ('gradingform_'.$method !== clean_param('gradingform_'.$method, PARAM_COMPONENT)) {
                throw new agpu_exception('invalid_method_name', 'core_grading');
            }
     ...
     * FEATURE_ADVANCED_GRADING and the user has the permission agpu/grade:managegradingforms.
     *
     ...
     *
     * @param agpu_url $returnurl optional URL of the page where the user should be sent back to
     * @return agpu_url
     */
    public function get_management_url(?agpu_url $returnurl = null) {
        ...
        return new agpu_url('/grade/grading/manage.php', $params);
    }
