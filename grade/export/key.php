...
$PAGE->navbar->add($strexportgrades, new agpu_url('/grade/export/index.php', ['id' => $courseid]));
$PAGE->navbar->add($strkeys, new agpu_url('/grade/export/keymanager.php', ['id' => $courseid]));
