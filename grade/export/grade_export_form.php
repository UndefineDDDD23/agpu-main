...
class grade_export_form extends agpuform {
    function definition() {
        ...
        if ($grade_items = $gseq->items) {
            ...
            $canviewhidden = has_capability('agpu/grade:viewhidden', context_course::instance($COURSE->id));
        ...
        if (has_capability('agpu/course:viewsuspendedusers', $coursecontext)) {
