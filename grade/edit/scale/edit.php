...
navigation_node::override_active_url(new agpu_url('/grade/edit/scale/index.php',
    array('id' => $courseid)));
...
if ($id) {
    ...
    if (!$scale_rec = $DB->get_record('scale', array('id' => $id))) {
        throw new \agpu_exception('invalidscaleid');
    }
    if ($scale_rec->courseid) {
        ...
        require_capability('agpu/course:managescales', $systemcontext);
    }
