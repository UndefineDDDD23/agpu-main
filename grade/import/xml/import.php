...
$url = new agpu_url('/grade/import/xml/import.php', array('id' => $id,'url' => $gradesurl));
if ($feedback !== 0) {
...
if ($text === false) {
    throw new \agpu_exception('cannotreadfile', 'error',
...
if ($importcode !== false) {
    ...
    if (defined('USER_KEY_LOGIN')) {
        if (grade_import_commit($id, $importcode, $feedback, false)) {
            ...
            throw new \agpu_exception('cannotimportgrade'); // TODO: localize.
        }
    ...
    throw new \agpu_exception('errorduringimport', 'gradeimport_xml',
