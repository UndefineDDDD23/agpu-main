...
class action_bar extends \core_grades\output\action_bar {
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        $generalnavselector = new general_action_bar($this->context,
            new agpu_url('/grade/report/user/index.php', ['id' => $courseid]), 'gradereport', 'user');
        ...
        if (has_capability('agpu/grade:viewall', $this->context)) {
            ...
            $resetlink = new agpu_url('/grade/report/user/index.php', ['id' => $courseid, 'group' => 0]);
            ...
            if (!is_null($this->userid) && $USER->id != $this->userid) {
                $viewasotheruser = new agpu_url('/grade/report/user/index.php',
                    ['id' => $courseid, 'userid' => $this->userid, 'userview' => GRADE_REPORT_USER_VIEW_USER]);
                $viewasmyself = new agpu_url('/grade/report/user/index.php',
