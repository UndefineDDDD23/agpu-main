...
$PAGE->set_url(new agpu_url('/grade/report/overview/index.php', array('id' => $courseid, 'userid' => $userid)));
...
$actionbar = new \core_grades\output\general_action_bar($context,
    new agpu_url('/grade/report/overview/index.php', ['id' => $courseid]), 'report', 'overview');

if (has_capability('agpu/grade:viewall', $context) && $courseid != SITEID) {
    ...
    $isseparategroups = ($course->groupmode == SEPARATEGROUPS and !has_capability('agpu/site:accessallgroups', $context));
