...
/**
 * First implementation of the preferences in the form of a agpuform.
 * TODO add "reset to site defaults" button
 */
class grader_report_preferences_form extends agpuform {
    ...
    function definition() {
        ...
        $canviewhidden = has_capability('agpu/grade:viewhidden', $context);
...
//--------------------------------------------------------------------------------
        ...
        if (has_capability('gradereport/grader:view', $context)) {
            if (has_capability('agpu/course:viewsuspendedusers', $context)) {
