...
class action_bar extends \core_grades\output\action_bar {
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        $generalnavselector = new general_action_bar($this->context,
            new agpu_url('/grade/report/grader/index.php', ['id' => $courseid]), 'gradereport', 'grader');
        ...
        if (has_capability('agpu/grade:viewall', $this->context)) {
            ...
            $resetlink = new agpu_url('/grade/report/grader/index.php', ['id' => $courseid]);
            ...
            if ($course->groupmode == VISIBLEGROUPS || has_capability('agpu/site:accessallgroups', $this->context)) {
            ...
            if (
                ...
                $reset = new agpu_url('/grade/report/grader/index.php', [
                    'id' => $courseid,
                    'group' => 0,
                    'sifirst' => '',
                    'silast' => ''
