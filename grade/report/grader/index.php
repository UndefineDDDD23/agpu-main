...
$baseurl = new agpu_url('/grade/report/grader/index.php', ['id' => $courseid]);

$PAGE->set_url(new agpu_url('/grade/report/grader/index.php', array('id'=>$courseid)));
...
if ($PAGE->user_allowed_editing() && !$PAGE->theme->haseditswitch) {
    ...
    $buttons = $OUTPUT->edit_button(new agpu_url($PAGE->url, $options), 'get');
}
...
$warnings = [];
$isediting = has_capability('agpu/grade:edit', $context) && isset($USER->editing) && $USER->editing;
...
$perpagedata = [
    'baseurl' => new agpu_url('/grade/report/grader/index.php', ['id' => s($courseid), 'report' => 'grader']),
    'options' => []
];
