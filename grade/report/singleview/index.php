...
$PAGE->set_other_editing_capability('agpu/grade:edit');
...
$PAGE->set_url(new agpu_url('/grade/report/singleview/index.php', $pageparams));
...
if ($PAGE->user_allowed_editing() && !$PAGE->theme->haseditswitch) {
    ...
    $button = $OUTPUT->edit_button(new agpu_url($PAGE->url, $options), 'get');
}

$reportname = $report->screen->heading();

$baseurl = new agpu_url('/grade/report/singleview/index.php', ['id' => $courseid, 'item' => $itemtype]);
if ($itemtype == 'user' || $itemtype == 'user_select') {
    ...
    $actionbar = new \core_grades\output\general_action_bar($context, new agpu_url('/grade/report/singleview/index.php',
