...
class grade extends tablelike implements selectable_items, filterable_items {
    ...
    public static function allowcategories(): bool {
        return get_config('agpu', 'grade_overridecat');
    }
    ...
    public function format_line($item): array {
        ...
        if (has_capability('agpu/site:viewfullnames', \context_course::instance($this->courseid))) {
        ...
        $url = new agpu_url("/user/view.php", ['id' => $item->id, 'course' => $this->courseid]);
    ...
    public function pager(): string {
        ...
        return $OUTPUT->paging_bar(
            ...
            new agpu_url('/grade/report/singleview/index.php', [
    ...
    private function get_user_action_menu(\stdClass $user) {
        ...
        $menuitems = [];
        $url = new agpu_url($this->format_link('user', $user->id));
