...
class select extends screen {
    ...
    public function html(): string {
        ...
        if ($this->itemid === null) {
            $userlink = new \agpu_url('/grade/report/singleview/index.php', ['id' => $COURSE->id, 'item' => 'user_select']);
            $gradelink = new \agpu_url('/grade/report/singleview/index.php', ['id' => $COURSE->id, 'item' => 'grade_select']);
            $context = [
                'courseid' => $COURSE->id,
        ...
        foreach ($types as $type) {
            ...
            $url = new agpu_url('/grade/report/singleview/index.php', $params);
