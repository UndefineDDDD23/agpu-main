...
class finalgrade extends grade_attribute_format implements unique_value, be_disabled, be_readonly {
    ...
    public function set($value) {
        ...
        if ($errorstr) {
            ...
            if (has_capability('agpu/site:viewfullnames', \context_course::instance($gradeitem->courseid))) {
        ...
        $gradeitem->update_final_grade($userid, $finalgrade, 'singleview', $feedback, FORMAT_agpu,
            null, null, true);
        return '';
    }
}
