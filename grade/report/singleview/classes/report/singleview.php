...
class singleview extends grade_report {
    ...
    public function process_data($data) {
        if (has_capability('agpu/grade:edit', $this->context)) {
    ...
    public function __construct(
        ...
        $this->baseurl = new agpu_url($base, $idparams);

        $this->pbarurl = new agpu_url($base, $idparams + [
                'item' => $itemtype,
                'itemid' => $itemid
            ]);
    ...
    public function bulk_actions_menu(renderer_base $output): string {
        ...
        foreach ($options as $type => $option) {
            $action = new \action_menu_link_secondary(new \agpu_url('#'), null, $option,
