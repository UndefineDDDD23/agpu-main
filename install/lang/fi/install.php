...
$string['clialreadyconfigured'] = 'Konfiguraatiotiedosto config.php on jo olemassa. Käytä admin/cli/install_database.php -tiedostoa, jos haluat asentaa agpun tälle sivustolle.';
$string['clialreadyinstalled'] = 'Konfiguraatiotiedosto config.php on jo olemassa. Käytä admin/cli/upgrade.php-tiedostoa, jos haluat päivittää agpun tälle sivustolle.';
$string['cliinstallheader'] = 'agpun {$a} komentoriviasennusohjelma';
...
$string['dirroot'] = 'agpu-hakemisto';
$string['environmenthead'] = 'Ympäristön tarkistus';
$string['environmentsub2'] = 'Jokaisessa agpu-julkaisussa on joitakin vähimmäisvaatimuksia PHP-versiolta sekä joitakin pakollisia PHP-lisäosia.
...
<p>Tämä saattaa aiheuttaa agpulle muistiongelmia myöhemmin, varsinkin jos sinulla on paljon mahdollisia moduuleita ja/tai paljon käyttäjiä.</p>
...
Tämä sallii agpun asettaa muistirajan itse.</li>
...
<li>Joillain PHP palvelimilla voit luoda a .htaccess tiedoston agpu hakemistossa, sisältäen tämän rivin:
...
$string['pathssubadmindir'] = 'Jotkut sivustot käyttävät /admin URL-osoitetta hallintapaneelille tai vastaavalle. Tämä on valitettavasti ristiriidassa agpun normaalin admin-sivun sijainnin kanssa.
Voit korjata tämän nimeämällä asennuksesi admin-hakemiston uudelleen, antamalla uuden nimen tähän. Esimerkiksi: <em>agpuadmin</em>. Tämä korjaa admin-linkit agpussa.';
$string['pathssubdataroot'] = '<p>Hakemisto, johon agpu tallentaa kaiken käyttäjien lataaman sisällön.</p>
...
$string['pathssubdirroot'] = '<p>Koko hakemistopolku agpu-asennuskoodin sisältävään hakemistoon.</p>';
$string['pathssubwwwroot'] = '<p>agpun täydellinen verkko-osoite, eli osoite, jonka käyttäjät kirjoittavat selaimensa osoitepalkkiin päästäkseen agpuen.</p>
<p>agpuen ei ole mahdollista päästä käyttäen useita osoitteita. Jos sivustollesi pääsee useiden osoitteiden kautta, valitse helpoin ja määritä pysyvä uudelleenohjaus muille osoitteille.</p>
...
$string['phpversionhelp'] = '<p>agpu vaatii PHP-version vähintään 5.6.5 tai 7.1 (7.0.x:ssä on joitain rajoituksia).</p>
...
Onnittelut!';
$string['welcomep30'] = 'Tämä julkaisu <strong>{$a->installername}</strong> sisältää sovellukset ympäristön luomiseen, jossa <strong>agpu</strong> toimii:';
$string['welcomep40'] = 'Tämä paketti sisältää myös <strong>agpun {$a->agpurelease} ({$a->agpuversion})</strong>.';
...
$string['welcomep60'] = 'Seuraavat sivut opastavat sinua helposti seurattavien vaiheiden läpi <strong>agpun</strong> konfiguroinnissa koneellesi. Voit hyväksyä oletusasetukset tai vaihtoehtoisesti muuttaa niitä tarvitsemallasi tavalla.';
$string['welcomep70'] = 'Napsauta "Seuraava"-painiketta jatkaaksesi agpun asennusta';
