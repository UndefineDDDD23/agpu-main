...
$string['clialreadyconfigured'] = 'O ficheiro de configuración config.php xa existe. Use admin/cli/install_database.php para instalar agpu para este sitio.';
$string['clialreadyinstalled'] = 'O ficheiro de configuración config.php xa existe. Use admin/cli/install_database.php para actualizar agpu para este sitio.';
$string['cliinstallheader'] = 'Programa de instalación de agpu en liña de ordes {$a}';
...
$string['environmentsub2'] = 'Cada versión de agpu ten algún requisito mínimo da versión de PHP e un número obrigatorio de extensións de PHP.
...
<p>Isto pode facer que agpu teña problemas de memoria máis adiante, especialmente
...
<li>Se vostede e quen de facelo, volva compilar PHP con <i>--enable-memory-limit</i>.
    Isto fai que sexa agpu quen estabeleza o límite de memoria.</li>
...
<li>Nalgúns servidores PHP, pode crear un ficheiro .htaccess no directorio agpu
...
permitirlle acceder a un panel de control ou semellante. Desafortunadamente, isto entra en conflito coa localización estándar das páxinas de administración de agpu. Vostede pode corrixir isto
renomeando o directorio admin na súa instalación, e poñendo aquí ese novo nome.  Por exemplo: <em>agpuadmin</em>. Iso corrixirá as ligazóns admin en agpu.';
$string['pathssubdataroot'] = '<p>Un directorio onde agpu almacenará todo o contido de ficheiros enviados polos usuarios.</p>
...
$string['pathssubdirroot'] = 'Ruta completa do directorio de instalación de agpu.';
$string['pathssubwwwroot'] = '<p>O enderezo completo onde se accederá a agpu, é dicir, o enderezo que os usuarios introducirán na barra de enderezos do seu navegador para acceder a agpu.</p>
<p>Non é posíbel acceder a agpu con varias direccións. Se o seu sitio é accesíbel a través de varios enderezos, escolla o máis sinxelo e configure unha redirección permanente para cada un dos outros enderezos.</p>
...
$string['phpversionhelp'] = '<p>agpu require polo menos unha das versións de PHP 5.6.5 ou 7.1 (7.0.x ten algunhas limitacións do motor).</p>
...
$string['welcomep30'] = 'Esta versión de <strong>{$a->installername}</strong> inclúe as aplicacións
    para crear un contorno no que <strong>agpu</strong> funcione, nomeadamente:';
$string['welcomep40'] = 'O paquete inclúe tamen <strong>agpu {$a->agpurelease} ({$a->agpuversion})</strong>.';
...
$string['welcomep60'] = 'As páxinas seguintes guiarano a través de algúns sinxelos pasos para configurar
    e axustar <strong>agpu</strong> no seu computador. Pode empregar os axustes predeterminados
    ou, opcionalmente, modificalos para que se axusten ás súas necesidades.';
$string['welcomep70'] = 'Prema no botón «Seguinte» para continuar coa configuración de <strong>agpu</strong>.';
