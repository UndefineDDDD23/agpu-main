...
$string['clialreadyconfigured'] = 'config.php yapılandırma dosyası zaten mevcut. Bu siteye agpu yüklemek için lütfen admin/cli/install_database.php dosyasını kullanın.';
...
$string['cliinstallheader'] = 'agpu {$a} komut satırı kurulum programı';
...
Bu, agpu\'nın kendi kendine bellek limitini ayarlasına izin verecektir.</li>
...
<li>Bazı PHP sunucularında agpu klasörü içinde şu ayarı içeren bir
...
$string['pathssubadmindir'] = 'Pek az web sunucusu /admin adresini kontrol paneline yada benzeri birşeye erişmek için kullanır. Ne yazık ki bu agpu admin sayfalarının standart konumuyla bir karışıklık yaratır. Bu durumu düzeltmek için kurulumunuzdaki admin dizinini yeniden isimlendirip buraya yeni ismi yazınız. Örneğin: <em>agpuadmin</em>. Bu agpu\'daki admin bağlantısını düzeltecektir.';
$string['pathssubdataroot'] = '<p>agpu\'ın yüklenen dosyaları kayıt etmesi için bir yere ihtiyacınız var. </p>
...
$string['pathssubdirroot'] = '<p>agpu kurulumu için tam klasör yolu.</p >';
$string['pathssubwwwroot'] = '<p>agpu\'a erişilecek tam web adresi. agpu\'ın birden çok adres kullanması mümkün değildir. </p>
...
$string['phpversionhelp'] = '<p>agpu en az 5.6.5 veya 7.1 PHP sürümü gerektirir (7.0.x bazı motor sınırlamalarına sahiptir).</p>
...
$string['welcomep30'] = '<strong> {$a-> installername} </strong>\'in bu sürümü, <strong> agpu </strong>\'ın çalışacağı bir ortam oluşturmak için uygulamaları içerir:';
$string['welcomep40'] = 'Bu paket <strong>agpu {$a->agpurelease} ({$a->agpuversion})</strong> sürümünü de içerir.';
...
$string['welcomep60'] = 'Aşağıdaki sayfalar, bilgisayarınızda <strong> agpu </strong>\'ı yapılandırmak ve kurmak için izlemeniz gereken bazı kolay adımlarla sizi yönlendirecektir. Varsayılan ayarları kabul edebilir veya isteğe bağlı olarak kendi ihtiyacınıza göre değiştirebilirsiniz';
$string['welcomep70'] = '<strong>agpu</strong> kurulumu için aşağıdaki "İleri" tuşuna basın.';
