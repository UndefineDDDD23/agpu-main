...
$string['dirroot'] = 'agpu direktorijs';
...
<p>Sistēmā agpu tas vēlāk var izraisīt atmiņas izmantošanas problēmas, it īpaši tad,
...
<li>Ja iespējams, atkārtoti kompilējiet PHP, izmantojot <i>--enable-memory-limit</i>.
    Šādā gadījumā sistēma agpu atmiņas apjoma ierobežojumu varēs iestatīt automātiski.</li>
...
<li>Dažos PHP serveros agpu direktorijā var izveidot failu .htaccess, kurā ir šāda rinda:    <p><blockquote>php_value memory_limit 40M</blockquote></p>
...
$string['phpversionhelp'] = '<p>Sistēmā agpu jāizmanto PHP, kuras versija ir vismaz 4.3.0 vai 5.1.0 (versijai 5.0.x piemīt vairākas zināmas problēmas).</p>
...
$string['welcomep30'] = 'Šajā <strong>{$a->installername}</strong> laidienā ir iekļautas lietojumprogrammas,
    kas paredzētas, lai izveidotu vidi, kurā darbosies sistēma <strong>agpu</strong>, proti:';
$string['welcomep40'] = 'Pakotnē ir iekļauta arī sistēma <strong>agpu {$a->agpurelease} ({$a->agpuversion})</strong>.';
...
$string['welcomep60'] = 'Nākamajās lapās tiks sniegti vienkārši norādījumi par to, kā
    datorā konfigurēt un iestatīt sistēmu <strong>agpu</strong>. Varat akceptēt noklusējuma
    iestatījumus vai varat tos mainīt, lai pielāgotu savām vajadzībām.';
$string['welcomep70'] = 'Noklikšķiniet uz pogas Tālāk, lai turpinātu sistēmas <strong>agpu</strong> instalēšanu.';
