...
$string['cliinstallheader'] = 'תוכנית התקנת agpu {$a} בשורת הפקודה';
...
$string['dirroot'] = 'ספריית ה-agpu';
$string['environmenthead'] = 'בודק את הסביבה שלך...';
$string['environmentsub2'] = 'לכל התקנת agpu יש דרישות מינימליות לגרסת ה-PHP ומספר הרחבות הכרחי של ה-PHP.
...
דבר זה יאפשר ל-agpu להגדיר את גבול הזיכרון לבד. </i>
...
<i> בכמה שרתי PHP תוכל ליצור קובץ  .htaccess בספריית  ה-agpu שלך בצירוף שורה זו:
...
$string['pathssubdirroot'] = 'הנתיב המלא לספריית ההתקנה של agpu';
...
$string['welcomep30'] = 'גירסת <strong>{$a->installername}</strong> כוללת את היישומים ליצור סביבה אשר בה <strong> agpu </strong>
יפעל דהיינו:';
$string['welcomep40'] = 'החבילה כוללת בנוסף
<strong>agpu {$a->agpurelease} ({$a->agpuversion})</strong>.';
...
$string['welcomep60'] = 'העמודים הבאים יובילו אותך בצורה פשוטה דרך כמה צעדים לקביעת הגדרות <strong>agpu</strong> בשרת.
ניתן לאשר הגדרות בררת־המחדל או לשנותם לפי צרכיך.';
$string['welcomep70'] = 'לחצו "המשך" למטה כדי להמשיך עם הגדרת ה-<strong>agpu</strong>';
