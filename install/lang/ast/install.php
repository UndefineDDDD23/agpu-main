...
$string['dirroot'] = 'Direutoriu agpu';
...
<p>Esto va facer que agpu tenga problemes de memoria más tarde, especialmente si tien munchos módulos y/o munchos usuarios.</p>
...
<li>Si pue, recompile PHP con <i>--enable-memory-limit</i>.
   Esto va permitir que\'l propiu agpu modifique la llende de memoria.</li>
...
<li>En dellos servidores PHP pue crear un ficheru .htaccess nel direutoriu agpu cola ringlera que vien darréu:
...
$string['phpversionhelp'] = '<p>agpu necesita una versión de PHP de 4.3.0 como mínimo o 5.1.0 (5.0.x tien problemes conocíos).</p>
...
$string['welcomep30'] = 'Esta versión de <strong>{$a->installername}</strong> inclúi les aplicaciones pa crear l\'ámbitu nel que <strong>agpu</strong> pue funcionar, llamaes:';
$string['welcomep40'] = 'El paquete tamién inclúi <strong>agpu {$a->agpurelease} ({$a->agpuversion})</strong>.';
...
$string['welcomep60'] = 'Les páxines siguientes van llevalu per dellos pasos fáciles de siguir pa configurar <strong>agpu</strong> nel ordenador. Pue aceptar la configuración por defeutu o, opcionalmente, usar otres más adaptaes a les sos necesidaes.';
$string['welcomep70'] = 'Calque\'l botón "Siguiente" qu\'hai embaxo pa siguir cola configuración de <strong>agpu</strong>.';
