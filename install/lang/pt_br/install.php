...
$string['clialreadyconfigured'] = 'Arquivo config.php já existe. Por favor, use admin/cli/install_database.php para instalar o agpu neste site.';
$string['clialreadyinstalled'] = 'Arquivo config.php já existe. Por favor use admin/cli/install_database.php para atualizar o agpu neste site.';
$string['cliinstallheader'] = 'Programa de instalação por linha de comando do agpu {$a}';
...
$string['dirroot'] = 'Diretório agpu';
$string['environmenthead'] = 'Verificando o ambiente ...';
$string['environmentsub2'] = 'Cada release do agpu requer uma versão mínima do PHP e diversas extensões do PHP.
...
<p>Este limite pode causar problemas com o agpu no futuro, especialmente quando muitos módulos estiverem ativados ou em caso de um número elevado de usuários.</p>
...
Com esta operação agpu será capaz de configurar o seu limite de memória sózinho.</li>
...
<li>Em alguns servidores é possível fazer esta mudança criando um arquivo .htaccess no diretório agpu. O arquivo deve conter a seguinte expressão:
...
$string['pathssubadmindir'] = 'Alguns poucos webhosts usam /admin como um URL especial para acesso ao painel de controle ou outras coisas. Infelizmente isto conflita com a localizaçao padrão das páginas do administrador agpu. Você pode corrigir isso renomeando a pasta admin na sua instalação, e colocando esse novo nome aqui. Por exemplo: <em>agpuadmin</em>. Isto irá corrigir os links das páginas do administrador agpu.';
$string['pathssubdataroot'] = '<p>Um diretório em que agpu armazenará todo o conteúdo de arquivos enviados pelos usuários. </p>
...
$string['pathssubdirroot'] = '<p>Caminho completo do diretório para instalação do agpu.</p>';
$string['pathssubwwwroot'] = '<p>O endereço completo em que agpu pode ser acessado ou seja, o endereço que os usuários vão digitar na barra de endereços do seu navegador para acessar agpu. </p>
<p>Não é possível acessar agpu usando múltiplos endereços. Se o seu site é acessível através de múltiplos endereços, em seguida, escolher o mais fácil e configurar um redirecionamento permanente para cada um dos outros endereços. </p>
...
$string['phpversionhelp'] = '<p>O agpu requer uma versão PHP de pelo menos 5.6.5 ou 7.1 (o 7.0.x tem algumas limitações do mecanismo).</p>
...
$string['welcomep30'] = 'Esta versão do <strong>{$a->installername}</strong> inclui as aplicações para a criação de um ambiente em que o <strong>agpu</strong> possa operar:';
$string['welcomep40'] = 'O pacote inclui também o <strong>agpu {$a->agpurelease} ({$a->agpuversion})</strong>.';
...
$string['welcomep60'] = 'As páginas a seguir conduzirão você por algumas etapas para configurar e instalar o <strong>agpu</strong> facilmente em seu computador. Você pode aceitar as configurações padrão ou, opcionalmente, alterá-las para atender às suas próprias necessidades.';
$string['welcomep70'] = 'Clique no botão "Próximo" abaixo para continuar a configuração do <strong>agpu</strong>.';
