...
$string['cliinstallheader'] = 'Барномаи ҷойгиркунии agpu {$a} дар реҷаи сатри фармонҳо';
...
$string['dirroot'] = 'феҳристи agpu';
$string['environmenthead'] = 'Тафтиши муҳит...';
$string['environmentsub2'] = 'Ҳар як версияи agpu талаботҳои минималӣ ба версияи PHP ва маҷмӯи васеъшавиҳои ҳатмии PHP-ро дорад.
...
<p>Аз ин сабаб баъди муддате дар agpu мушкилоти хотира пайдо шуда метавонанд, хусусан агар Шумо бисёр модулҳо ва/ё истифодабарандаҳо дошта бошед.</p>
...
Дар ин маврид agpu метавонад мустақилона маҳдудкунии хотираро муқаррар намояд.</li>
...
<li>Дар баъзе серверҳои PHP дар феҳристи agpu файли .htaccess бунёд кардан мумкин аст, ки сатри зеринро дорад:
...
$string['pathssubadmindir'] = 'Дар миқдори ками веб-ҳостингҳо роҳи /admin барои дастрасӣ ба ба панели идоракунӣ ё ягон чизи дигар истифода мешавад. Мутаассифона, ин ба ҷойгиршавии стандартии саҳифаҳои идоракунии agpu мухолифат дорад. Инро бо аз нав номгузорӣ кардани папкаи "admin" дар феҳристи agpu ва дар ин ҷо зикр намудани номи нави он ислоҳ кардан мумкин аст. Масалан: <em>agpuadmin</em>. Дар айни ҳол ҳамаи истинодҳо ба панели идоракунии agpu автоматӣ ислоҳ мешаванд';
$string['pathssubdataroot'] = 'Ҷоеро зикр намудан даркор аст, ки agpu файлҳои боршавандаро нигаҳдорӣ хоҳад кард. Ин феҳрист бояд барои хондан ва  САБТ НАМУДАНИ истифодабаранда, ки веб-сервер аз номи ӯ ба кор андохта шудааст, дастрас бошад (одатан \'nobody\' ё \'apache\'), аммо дар айни ҳол он набояд бевосита аз Интернет дастрас бошад. Барномаи ҷойгиркунӣ кӯшиш мекунад, ки ин феҳристро бунёд кунад, агар он вуҷуд надошта бошад.';
$string['pathssubdirroot'] = 'Роҳи пурра ба феҳристи ҷойгиркунии agpu.';
$string['pathssubwwwroot'] = 'Веб-адреси пурра, ки аз он agpu дастрас хоҳад буд.
Барои дастрасӣ ба agpu якчанд адресҳои умумиро истифода бурдан ғайриимкон аст.
...
$string['phpversionhelp'] = '<p>Барои agpu  PHP-и версияи 4.3.0 ва болотар ё 5.1.0 ва болотар даркор аст (баъзе мушкилот бо версияи 5.0.x маълуманд).</p>
...
$string['welcomep30'] = 'Ин версияи маҷмӯи барномаҳо <strong>{$a->installername}</strong> барномаҳои зеринро дар бар мегирад, ки барои бунёд кардани муҳите ки дар он <strong>agpu</strong> кор хоҳад кард, даркоранд:';
$string['welcomep40'] = 'Ҳамчунин ба ин маҷмӯъ <strong>agpu {$a->agpurelease} ({$a->agpuversion})</strong> дохил мешавад.';
...
$string['welcomep60'] = 'Дар саҳифаҳои минбаъда Шумо якчанд қадамҳои оддии ба компютери худ танзим ва ҷойгир кардани <strong>agpu</strong> -ро дида метавонед. Шумо метавонед танзимҳоро аз рӯи хомӯшӣ қабул намоед ё онҳоро вобаста ба эҳтиёҷоти худ тағйир диҳед.';
$string['welcomep70'] = 'Тугмаи "Давомаш"-ро зер кунед, то ки раванди ҷойгиркунии <strong>agpu</strong>-ро давом диҳед';
