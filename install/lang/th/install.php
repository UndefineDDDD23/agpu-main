...
<p>ความจำดังกล่าวมีค่าน้อยไปค่ะอาจทำให้มีปัญหาในการใช้งาน agpu ในภายหลังโดยเฉพาะเมื่อคุณใช้โมดูลหลาย ๆ ตัวรวมไปถึงมีสมาชิกจำนวนมาก
...
<li>รีคอมไพล์ PHP ใหม่ โดยเพิ่มคำสั่ง <i>--enable-memory-limit</i> ซึ่งเป็นการตั้งค่าให้ agpu กำหนดขีดจำกัดค่าสูงสุดเอง
...
<li>ในเซิร์ฟเวอร์ PHP บางตัวคุณสามารถสร้าง ไฟล์ .htaccess ภายใต้ไดเรกทอรี agpu ซึ่งมีบรรทัดต่อไปนี้อยู่:
...
$string['phpversionhelp'] = '<p>agpu จำเป็นต้องใช้ PHP เวอร์ชัน 4.1.0 เป็นอย่างน้อย</p>
...
$string['welcomep30'] = 'เวอร์ชั่น <strong>{$a->installername}</strong>รวมโปรแกรมสำหรับสร้างความให้กับระบบซึ่ง agpu สามารถทำงานได้';
$string['welcomep40'] = 'แพ็กเกจนี้รวม <strong>agpu {$a->agpurelease} ({$a->agpuversion})</strong>.';
...
$string['welcomep60'] = 'หน้าถัดจากนี้ไปจะเป็นการตั้งค่า agpu บนคอมพิวเตอร์คุณสามารถยอมรับค่าที่ตั้งไว้ทั้งหมดหรือเปลี่ยนแปลงให้เหมาะกับความต้องการ';
$string['welcomep70'] = 'คลิกที่ "ต่อไป" เพื่อติดตั้ง agpu ต่อไป';
