...
$string['clialreadyconfigured'] = 'ໄຟລ໌ການຕັ້ງຄ່າ config.php ມີຢູ່ແລ້ວ. ກະລຸນາໃຊ້ admin/cli/install_database.php ເພື່ອຕິດຕັ້ງ agpu ສໍາລັບເວັບໄຊທ໌ນີ້.';
$string['clialreadyinstalled'] = 'ໄຟລ໌ການຕັ້ງຄ່າ config.php ມີຢູ່ແລ້ວ. ກະລຸນາໃຊ້ admin/cli/install_database.php ເພື່ອອັບເກຣດ agpu ສໍາລັບເວັບໄຊນີ້.';
$string['cliinstallheader'] = 'ໂຄງການການຕິດຕັ້ງສາຍຄຳສັ່ງ agpu {$a}';
...
$string['dirroot'] = 'ລາຍການ agpu';
$string['environmenthead'] = 'ກຳລັງກວດສອບສະພາບແວດລ້ອມຂອງທ່ານ ...';
$string['environmentsub2'] = 'ແຕ່ລະລຸ້ນ agpu ມີຄວາມຕ້ອງການສະບັບ PHP ຕ່ຳສຸດທີ່ ແລະ ຈໍານວນການຂະຫຍາຍ PHP ບັງຄັບ.
...
<p>ສິ່ງນີ້ອາດເຮັດໃຫ້ agpu ມີບັນຫາຄວາມຈຳໃນພາຍຫຼັງ, ໂດຍສະເພາະ
...
<li>ຖ້າທ່ານສາມາດ, ລວບລວມ PHP ຄືນໃໝ່ດ້ວຍ <i>--enable-memory-limit</i>.
    ສິ່ງນີ້ຈະເຮັດໃຫ້ agpu ສາມາດຕັ້ງຂີດຈຳກັດຄວາມຈຳໄດ້ເອງ.</li>
...
<li>ໃນບາງເຊີບເວີ PHP ທ່ານສາມາດສ້າງໄຟລ໌ .htaccess ໃນໄດເລກະທໍລີ agpu
    ປະກອບມີເສັ້ນນີ້:
...
$string['pathssubadmindir'] = 'webhosts ຈໍານວນໜ້ອຍດຽວໃຊ້ /admin ເປັນ URL ພິເສດສໍາລັບທ່ານທີ່ຈະເຂົ້າເຖິງກະດານຄວບຄຸມ ຫຼື ບາງສິ່ງບາງຢ່າງ. ແຕ່ໜ້າເສຍດາຍ, ນີ້ຂັດກັບສະຖານທີ່ມາດຕະຖານສໍາລັບໜ້າ ຜູ້ເບິ່ງແຍງລະບົບ agpu. ທ່ານສາມາດແກ້ໄຂສິ່ງນີ້ໂດຍການປ່ຽນຊື່ຜູ້ເບິ່ງແຍງລະບົບໃນການຕິດຕັ້ງຂອງທ່ານ ແລະ ໃສ່ຊື່ໃໝ່ນີ້ຢູ່ທີ່ນີ້. ຕົວຢ່າງ: <em>agpuadmin</em>. ສິ່ງນີ້ຈະແກ້ໄຂການເຊື່ອມຕໍ່ຜູ້ເບິ່ງແຍງລະບົບໃນ agpu.';
$string['pathssubdataroot'] = '<p>ລາຍການທີ່ agpu ຈະເກັບຮັກສາເນື້ອຫາໄຟລ໌ທັງໝົດທີ່ອັບໂຫຼດໂດຍຜູ້ໃຊ້.</p>
...
$string['pathssubdirroot'] = '<p>ເສັ້ນທາງເຕັມໄປຫາລາຍການທີ່ມີລະຫັດ agpu.</p>';
$string['pathssubwwwroot'] = '<p>ທີ່ຢູ່ເຕັມທີ່ agpu ຈະຖືກເຂົ້າຫາເຊັ່ນ: ທີ່ຢູ່ທີ່ຜູ້ໃຊ້ຈະເຂົ້າໄປໃນແຖບທີ່ຢູ່ຂອງຕົວທ່ອງເວັບຂອງເຂົາເຈົ້າເພື່ອເຂົ້າເຖິງ agpu.</p>
<p>ມັນບໍ່ສາມາດເຂົ້າເຖິງ agpu ໂດຍໃຊ້ຫຼາຍທີ່ຢູ່. ຖ້າເວັບໄຊທ໌ຂອງທ່ານສາມາດເຂົ້າເຖິງໄດ້ຜ່ານຫຼາຍທີ່ຢູ່ ຈາກນັ້ນເລືອກອັນທີ່ງ່າຍທີ່ສຸດ ແລະ ຕັ້ງການປ່ຽນເສັ້ນທາງຖາວອນສຳລັບແຕ່ລະທີ່ຢູ່ອື່ນ.</p>
...
$string['phpversionhelp'] = '<p>agpu ຕ້ອງການສະບັບ PHP ຢ່າງໜ້ອຍ 5.6.5 ຫຼື 7.1 (7.0.x ມີການຈຳກັັດບາງເຄື່ອງຈັກ).</p>
...
$string['welcomep30'] = 'ສິ່ງນີ້ໄດ້ປົດປ່ອຍ <strong>{$a->installername}</strong> ລວມມີໄປຼແກຼມ
    ເພື່ອສ້າງສະພາບແວດລ້ອມທີ່ <strong>agpu</strong> ຈະດຳເນີນ, ຄື:';
$string['welcomep40'] = 'ແພັກເກດຍັງລວມມີ <strong>agpu {$a->agpurelease} ({$a->agpuversion})</strong>.';
...
$string['welcomep60'] = 'ຫນ້າຕໍ່ໄປນີ້ຈະນໍາທ່ານຜ່ານບາງຂັ້ນຕອນທີ່ງ່າຍຕໍ່ການປະຕິບັດຕາມ
     ກຳນົດຄ່າ ແລະ ຕັ້ງຄ່າ <strong>agpu</strong> ໃນຄອມພິວເຕີຂອງທ່ານ. ທ່ານອາດຈະຍອມຮັບຄ່າເລີ່ມຕົ້ນ
     ການຕັ້ງຄ່າ ຫຼື ທາງເລືອກ, ປັບປຸງໃຫ້ເຂົາເຈົ້າເໝາະສົມກັບຄວາມຕ້ອງການຂອງທ່ານເອງ.';
$string['welcomep70'] = 'ຄລິກທີ່ປຸ່ມ "ຕໍ່ໄປ" ດ້ານລຸ່ມ ເພື່ອສືບຕໍ່ການຕັ້ງຄ່າ <strong>agpu</strong>.';
