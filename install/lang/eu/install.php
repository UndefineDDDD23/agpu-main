...
$string['clialreadyconfigured'] = 'Dagoeneko badago config.php konfigurazio-fitxategia. Mesedez erabili admin/cli/install_database.php agpu gune honetan instalatu nahi baduzu.';
$string['clialreadyinstalled'] = 'Dagoeneko badago config.php konfigurazio-fitxategia. Mesedez erabili admin/cli/upgrade.php zure agpu gunea eguneratu nahi baduzu.';
$string['cliinstallheader'] = 'agpu {$a} komando-lerro bidezko instalaziorako programa';
...
<p>Aurrerago honek agpuri arazoak sor diezaizkioke,
...
Horrek agpu-k berak memoria-muga ezartzea ahalbidetzen du.</li>
...
<li>PHP zerbitzari batzuetan agpu-ren direktorioan beheko lerro hau daukan .htaccess fitxategia sor dezakezu:
...
$string['pathssubadmindir'] = 'Web ostalari gutxi batzuk /admin URL berezi gisa erabiltzen dute kontrol-panel edo antzekora sarbidea emateko. Zoritxarrez, honek agpuren kudeatze-orrien lehenetsitako kokapenarekin gatazka sortzen du. Hau konpondu dezakezu zure instalazioko admin direktorioa berrizendatuz, eta izen berria hemen sartuta. Adibidez <em>agpuadmin</em>. Honek agpuko admin estekak konponduko du.';
$string['pathssubdataroot'] = '<p>agpuk erabiltzaileek igotako fitxategien edukiak bilduko dituen direktorio bat.</p>
...
$string['pathssubdirroot'] = '<p>agpuko kodea daukan direktorioaren bide osoa.</p>';
$string['pathssubwwwroot'] = '<p>agpu eskuragarri egongo den helbide osoa, hau da, erabiltzaileek agpun sartzeko nabigatzailearen helbide barran idatziko duten helbidea</p>
<p>agpu ezin da hainbat helbidetatik eskuragarri egon. Zure gunea hainbat helbidetatik eskuragarri badago errazena aukeratu eta bertara beste helbideetatik behin-betiko berbideraketak konfiguratu itzazu.</p>
...
$string['phpversionhelp'] = '<p>agpuk PHP 5.6.5 edo 7.1 bertsioetako bat behar du (7.0.x bertsioek muga batzuk dituzte). </p>
...
$string['welcomep30'] = '<strong>{$a->installername}</strong>ren bertsio honek <strong>agpu</strong>-k
zure ordenagailuan funtzionatzeko behar diren aplikazioak dauzka, zehazki hurrengoak:';
$string['welcomep40'] = 'Paketeak ere zera dauka: <strong>agpu {$a->agpurelease} ({$a->agpuversion})</strong>.';
...
$string['welcomep60'] = 'Datozen orriek urrats erraz batzuen bidez gidatuko zaituzte <strong>agpu</strong> zure ordenagailuan instalatu eta konfiguratzeko. Aholkatzen diren lehenetsitako balioak mantendu edo, nahi izanez gero, alda ditzakezu zure beharrei erantzun diezaieten.';
$string['welcomep70'] = 'Egin klik "Hurrengoa" botoian <strong>agpu</strong>ren konfigurazioarekin jarraitzeko.';
