...
$string['clialreadyconfigured'] = 'config.php тохиргооны файл байна. Энэ сайтад agpu системийг суулгахын тулд admin/cli/install_database.php ашиглана уу.';
$string['clialreadyinstalled'] = 'config.php тохиргооны файл байна. Энэ сайтад agpu системийг шинэчлэхийн тулд admin/cli/install_database.php ашиглана уу.';
$string['cliinstallheader'] = 'agpu {$a} командын мөр суулгах програм';
...
$string['dirroot'] = 'agpu лавлах';
$string['environmenthead'] = 'Таны орчныг шалгаж байна ...';
$string['environmentsub2'] = 'agpu системийн хувилбар бүр нь PHP хувилбарын хамгийн наад захын шаардлагыг хангаж, PHP гол гол өргөтгөлтэй байдаг.
...
<p>Энэ нь agpu системд хожим санах ойн асуудал, ялангуяа олон модулийг идэвхжүүлсэн ба/буюу олон хэрэглэгчтэй үед үүсгэж болзошгүй.</p>
...
<li>Хэрэв боломжтой бол PHP-г <i>--enable-memory-limit</i> ашиглан дахин хөрвүүлээрэй.
     Энэ нь agpu системд санах ойн хязгаарыг өөрөө тохируулах боломжийг олгоно.</li>
...
<li>Зарим PHP серверт дараах мөрийг агуулсан agpu санд .htaccess файлыг үүсгэж болно: <blockquote><div>php_value memory_limit 40M</div></blockquote>
...
$string['pathssubadmindir'] = 'Маш цөөн веб хост /админыг хянах самбар эсвэл өөр зүйлд нэвтрэхийн тулд тусгай URL болгон ашигладаг. Харамсалтай нь энэ нь agpu админ хуудасны стандарт байршилтай зөрчилддөг. Та үүнийг засах боломжтой
Суурилуулалтад админ лавлахын нэрийг өөрчилж, энд шинэ нэрийг оруулах замаар засаж болно. Жишээ нь: <em>agpuadmin</em>. Энэ нь agpu дээрх админ холбоосыг засах болно.';
$string['pathssubdataroot'] = '<p>agpu нь хэрэглэгчийн байршуулсан бүх файлын агуулгыг хадгалах лавлах.</p>
...
$string['pathssubdirroot'] = '<p>agpu код агуулсан лавлахад хандах бүрэн зам.</p>';
$string['pathssubwwwroot'] = '<p>agpu системд хандах бүрэн хаяг, өөрөөр хэлбэл хэрэглэгч agpu системд хандахын тулд хөтчийн хаягийн мөрөнд оруулах хаяг.</p>
<p>Олон хаяг ашиглан agpu системд хандах боломжгүй. Таны сайтад олон хаягаар хандах боломжтой бол хамгийн хялбарыг сонгож, бусад хаяг руугаа байнгын дахин чиглүүлэлт хийхээр тохируулна уу.</p>
...
$string['phpversionhelp'] = '<p>agpu системд хамгийн багадаа 5.6.5 эсвэл 7.1 PHP хувилбар шаардлагатай (7.0.x нь системийн зарим хязгаарлалттай).</p>
...
$string['welcomep30'] = '<strong>{$a->installername}</strong> энэхүү хувилбарт <strong>agpu</strong> ажиллах орчныг бүрдүүлэх аппликейшнүүд багтсан болно, тухайлбал:';
$string['welcomep40'] = 'Түүнчлэн энэ багц нь <strong>agpu {$a->agpurelease} ({$a->agpuversion})</strong>-г агуулдаг.';
...
$string['welcomep60'] = 'Дараах хуудсууд нь таны компьютерт <strong>agpu</strong> системийг тохируулах, тохируулахад хялбар алхмыг хийх болно. Та өгөгдмөл тохиргоог хүлээн зөвшөөрөх эсвэл өөрийн хэрэгцээнд тохируулан өөрчилж болно.';
$string['welcomep70'] = 'Доорх "Дараах" товчийг дарж <strong>agpu</strong> системийн тохиргоог үргэлжлүүлнэ үү.';
