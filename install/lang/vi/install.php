...
$string['dirroot'] = 'Thư mục agpu';
$string['installation'] = 'Cài đặt';
$string['memorylimithelp'] = '<p> PHP thiết lập giới hạn bộ nhớ cho máy chủ của bạn hiện tại là {$a}.</p>

<p>Đây có thể là nguyên nhân agpu có các vấn đề về bộ nhớ vào một thời điểm nào đó, đặc biệt
...
<li>Nếu bạn có khả năng, biên tập lại PHP với <i>--giới hạn bộ nhớ cho phép</i>.
    Điều này sẽ cho phép agpu tự thiết lập giới hạn bộ nhớ.
...
<li> Trên một số máy chủ chạy PHP bạn có thể tạo một file .htaccess trong thư mục agpu
    chứa dòng này:
...
$string['phpversionhelp'] = '<p>agpu yêu cầu một phiên bản PHP ít nhất là 4.1.0.</p>
