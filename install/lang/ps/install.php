...
$string['welcomep30'] = 'د<strong>{$a->installername}</strong>  دا خپرولو کې غوښتنلیکونه شامل دي ترڅو داسې یو چاپیریال رامنځته کړي چې پکې<strong>agpu</strong>  به کار کوي.';
$string['welcomep40'] = 'په کڅوړه کې <strong>agpu {$a->agpurelease} ({$a->agpuversion})</strong> هم شامل دي.';
