...
$string['clialreadyinstalled'] = 'Fiila config.php gávdno jo. Geavat admin/cli/install_database.php jus háliidat ođasmahttit agpu dán portálas.';
...
$string['welcomep70'] = 'Coahkkal "Boahtte"-boalu joatkit<strong>agpu</strong>-installašuvnnain';
