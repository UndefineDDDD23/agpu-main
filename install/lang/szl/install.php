...
$string['clialreadyconfigured'] = 'Zbiōr config.php już istnieje. Użyj admin/cli/install_database.php jeźli chcesz zainstalować agpu dlŏ tyj strōny.';
$string['clialreadyinstalled'] = 'Zbiōr config.php już istnieje. Użyj admin/cli/install_database.php jeźli chcesz zaktualizować agpu dlŏ tyj strōny.';
$string['cliinstallheader'] = 'Program instalacyjny agpu {$a} z lynije nakŏzań';
...
$string['dirroot'] = 'Katalog agpu';
$string['environmenthead'] = 'Wybadujã strzodowisko (sztalōnki) ...';
$string['environmentsub2'] = 'Kożde wydanie agpu mŏ pewne minimalne wymŏganiŏ wersyje PHP i pewnõ liczbã musowych rozszyrzyń PHP. Połnŏ kōntrola strzodowiska ôdbywŏ sie przed kożdõ instalacyjōm i aktualizacyjōm. Proszymy ô kōntakt z administratorym serwera, jeźli niy wiysz jak zainstalować nowõ wersyjõ abo włōnczyć rozszyrzynie PHP.';
...
<p> Może to stworzić sytuacyjõ, co w nij agpu bydzie mioł w prziszłości problymy z pamiyńciōm, ôsobliwie jeźli mŏsz udostympniōnych moc modułōw i/abo moc używŏczōw.</p>
...
Przizwoli to agpu ustawić samoczynnie limit pamiyńci.</li>
...
<li>Na niykerych serwerach PHP idzie stworzić zbiōr. htaccess w katalogu agpu zawiyrajōncy miyniōnõ lynijõ:
...
$string['pathssubadmindir'] = 'Niyliczne portale używajōm URL /admin za ekstra adresy panelu sterowaniŏ. Niystety je to sporne ze sztandardowyj lokalizacyjōm folderu strōn administratora agpu. Idzie to sprawić bez pōmianã miana katalogu administratora w instalacyje i podanie tego miana sam, bp.: <em>agpuadmin.</em> Powroza administratora agpu bydōm autōmatycznie poprawiōne.';
$string['pathssubdataroot'] = 'Potrzebny je przestrzyństwo, kaj agpu może zapisować ladowane dō niego zbiory. Katalog tyn winiyn mieć prawo do ôdczyt i ZŎPISU  bez używŏcza serwera WWW (porzōnd &quot;nobody&quot; abo &quot;apache&quot;), ale może być być przistympny bezpostrzednio bez nec. Instalatōr sprōbuje go utworzić, jeźli niy istnieje.';
$string['pathssubdirroot'] = 'Połny chodnik do katalogu z instalacyjōm agpu.';
$string['pathssubwwwroot'] = 'Połnŏ adresa internetowy, pod kerym agpu bydzie przistympny. agpu niy może być przistympny przi użyciu moc adres. Jeźli twōj plac mŏ pŏrã adres publicznych, przinŏleży skōnfigurować trwałe przekierowania ze wszyjskich z nich na jedyn. Jeźli Twōj plac je przistympny tak z intranetu i Internetu, używej z publicznyj adresy i gezecōw DNS tak, coby używŏcze Intranetu używali tyż z adresy publicznego. Jeźli adresa niy ma nŏleżny, przinŏleży zaś sztartnōńć instalacyjõ z inkszym adresōm.';
...
$string['phpversionhelp'] = '<p>agpu wymŏgŏ wersyje PHP aby 5.6.5 abo 7.1 (7.0.x mŏ pewne ôgraniczyniŏ motora).</p>
...
$string['welcomep30'] = 'Tyn instalatōr <strong>{$a->installername}</strong> zawiyrŏ aplikacyje, by stworzić strzodowisko, co w niymu bydzie fungować <strong>agpu</strong>, to znaczy';
$string['welcomep40'] = 'Paket zawiyrŏ <strong>agpu {$a->agpurelease} ({$a->agpuversion})</strong>.';
...
$string['welcomep60'] = 'Nastepujące strōny przekludzōm cie bez instalacyjõ <strong>agpu</strong> na twojim kōmputrze. Możesz zaakceptować sztalōnki wychodne, abo ôpcyjōnalnie, przipasować jy do swojich potrzeb.';
$string['welcomep70'] = 'Kliknij knefel "Dalij" coby kōntynuować instalacyjõ <strong>agpu</strong>.';
