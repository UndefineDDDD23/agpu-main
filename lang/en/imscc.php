...
/**
 * Strings for component 'imscc', language 'en', branch 'agpu_20_STABLE'
 *
 * @package    core
 * @subpackage imscc
...
$string['cc2agpu_checking_schema'] = 'CC format! Checking schema...';
$string['cc2agpu_invalid_schema'] = 'The schema is not valid.';
$string['cc2agpu_manifest_dont_load'] = 'Cannot load the XML manifest.';
$string['cc2agpu_req_auth'] = 'ERROR: The Common Cartridge package requires authorization.';
$string['cc2agpu_valid_schema'] = 'Schema valid!';
