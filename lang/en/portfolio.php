...
/**
 * Strings for component 'portfolio', language 'en', branch 'agpu_20_STABLE'
 *
...
$string['format_mbkp'] = 'agpu backup format';
...
$string['leap2a_feedtitle'] = 'Leap2A export from agpu for {$a}';
