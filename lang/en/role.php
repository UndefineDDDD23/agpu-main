...
/**
 * Strings for component 'role', language 'en', branch 'agpu_20_STABLE'
 *
 * @package   core_role
...
$string['agpunet:shareactivity'] = 'Share activities to agpuNet';
$string['agpunet:sharecourse'] = 'Share course to agpuNet';
