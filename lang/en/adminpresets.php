...
$string['privacy:metadata:adminpresets:agpurelease'] = 'The agpu release version that the preset is based on.';
$string['privacy:metadata:adminpresets:name'] = 'The name of the preset.';
$string['privacy:metadata:adminpresets:site'] = 'The agpu site where this preset was created.';
...
$string['starterpresetdescription'] = 'agpu with all of the most popular features, including Assignment, Feedback, Forum, H5P, Quiz and Completion tracking.';
