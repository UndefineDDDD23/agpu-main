...
/**
 * Strings for component 'calendar', language 'en', branch 'agpu_20_STABLE'
 *
...
$string['pref_persistflt_help'] = 'If this is enabled, then agpu will remember your last event filter settings and automatically restore them each time you login.';
