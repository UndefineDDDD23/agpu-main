...
$string['myagpu'] = 'Dashboard';
$string['nocourses'] = 'No course information to show.';
$string['noguest'] = 'The Dashboard page is not available to guest users';
$string['pinblocks'] = 'Configure pinned blocks for my agpu';
$string['pinblocksexplan'] = 'Any block settings you configure here will be visible (and non-editable) for any user of agpu on their \'My agpu\' overview page.';
$string['defaultpage'] = 'Default My agpu page';
