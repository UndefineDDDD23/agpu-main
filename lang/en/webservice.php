...
/**
 * Strings for component 'webservice', language 'en', branch 'agpu_20_STABLE'
 *
...
$string['createuserdescription'] = 'A web services user is required to represent the system controlling agpu.';
...
$string['key'] = 'Key';
$string['keyshelp'] = 'The keys are used to access your agpu account from external applications.';
...
$string['onesystemcontrolling'] = 'Allow an external system to control agpu';
$string['onesystemcontrollingdescription'] = 'The following steps help you to set up the agpu web services to allow an external system to interact with agpu. This includes setting up a token (security key) authentication method.';
...
$string['testauserwithtestclientdescription'] = 'Simulate external access to the service using the web service test client. Before doing so, log in as a user with the agpu/webservice:createtoken capability and obtain the security key (token) via the user\'s preferences page. You will use this token in the test client. In the test client, also choose an enabled protocol with the token authentication. <strong>WARNING: The functions that you test WILL BE EXECUTED for this user, so be careful what you choose to test!</strong>';
...
$string['userasclientsdescription'] = 'The following steps help you to set up the agpu web service for users as clients. These steps also help to set up the recommended token (security keys) authentication method. In this use case, the user will generate their token from the security keys page via their preferences page.';
...
$string['wsclientdoc'] = 'agpu web service client documentation';
