...
/**
 * Strings for component 'core_enrol', language 'en', branch 'agpu_20_STABLE'
 *
 * @package    core_enrol
 * @subpackage enrol
...
$string['customwelcomemessage_help'] = 'Accepted formats: Plain text or agpu-auto format. HTML tags and multi-lang tags are also accepted, as well as the following placeholders:
<ul>
