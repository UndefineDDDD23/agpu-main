...
/**
 * Strings for component 'rating', language 'en', branch 'agpu_20_STABLE'
 *
 * @package   core_rating
...
$string['rolewarning_help'] = 'Roles with permission to rate are roles with the capability agpu/rating:rate plus any activity-specific rating capabilities. You can give more roles permission to rate via the page Permissions.';
