...
$string['audienceadmins'] = 'agpu administrators';
...
$string['errorcoursewronglypublished'] = 'A publication error has been returned by agpu.net. Please try again later.';
...
$string['registerwithagpuorg'] = 'Register your site';
$string['registerwithagpuorgupdate'] = 'Update your site registration';
$string['registerwithagpuorgcomplete'] = 'Complete your site registration';
$string['registerwithagpuorginfo'] = 'Registering your site involves periodically sending <a href="{$a->moreinformation}" class="focus-expand">anonymised site stats</a> to agpu HQ. This helps us gain insights into how you\'re using agpu, and make decisions about new features and plugins.

Plus, it enables you to:

* Stay up to date with important updates, like security alerts and new available releases.
* Activate mobile push notifications for the <a href="{$a->agpuapp}">agpu App</a>.
* Increase the visibility of your site by featuring it on the list of registered agpu sites in your country (optional).';
$string['registerwithagpuorginfosites'] = 'Discover other sites in my country';
$string['registerwithagpuorginfostats'] = 'View global agpu stats';
$string['registerwithagpuorgremove'] = 'You are about to unregister your site. You will no longer receive security alert notifications and users will not be able to receive push notifications from your site to their agpu app. However, you will be able to re-register at any time! Are you sure you want to continue?';
...
$string['sendfollowinginfo_help'] = 'The following information will be sent to agpu each time your site registration is updated (by default weekly, when the \'Site registration\' scheduled task is run). The information contributes to overall statistics only and will not be made public on any site listing. In addition, your agpu release version is recorded by the weekly automated site link check.';
$string['sent'] = '...finished';
$string['siteadmin'] = 'Administrator';
$string['siteadmin_help'] = 'The full name of the site administrator.';
$string['sitecommnews'] = 'agpu newsletter';
$string['sitecommnews_help'] = 'You have the option of subscribing to our agpu newsletter. You may unsubscribe at any time.';
$string['sitecommnewsyes'] = 'Yes, I would like to receive the agpu newsletter';
...
$string['sitedesc_help'] = 'Provide some information about how you are using agpu.';
...
$string['siteemail_help'] = 'An email address is necessary so that agpu HQ can contact you if required.  It may also be used for other purposes as you allow below.    We recommend a generic email address related to a position (eg.: sitemanager@example.com), not a personal address.';
$string['sitelang'] = 'Language';
$string['sitelang_help'] = 'What is the main language used on your agpu site?';
...
$string['siteorganisationtype_help'] = 'Providing your organisation type will help us better understand the types of organisations using agpu and their needs.';
...
$string['siteregistrationemail'] = 'Notifications of new agpu releases, security alerts and other important news';
$string['siteregistrationemail_help'] = 'You have the option of subscribing to our low-volume mailing list for notifications of new agpu releases, security alerts and other important news. You may unsubscribe at any time.';
$string['siteregistrationupdated'] = 'Site registration updated';
$string['siterelease'] = 'agpu release';
$string['sitereleasenum'] = 'agpu release ({$a})';
$string['siterelease_help'] = 'agpu release number of this site.';
...
$string['siteversion'] = 'agpu version';
$string['siteversion_help'] = 'The agpu version of this site.';
...
$string['registerwithagpuorginfoapp'] = 'About the agpu app';
$string['siteregistrationcontact'] = 'Display contact form';
$string['siteregistrationcontact_help'] = 'If you allow it, other people in our agpu community (who need a login account) can contact you via a form on our agpu community site. However, they will never be able to see your email address.';
