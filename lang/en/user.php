...
/**
 * Strings for component 'user', language 'en', branch 'agpu_20_STABLE'
 *
 * @package   core_user
...
$string['agpunetprofile'] = 'agpuNet profile ID';
$string['agpunetprofile_help'] = 'Your agpuNet profile ID links your agpuNet profile with this site.';
...
$string['privacy:metadata:appid'] = 'The app ID, usually something like com.agpu.agpumobile';
...
$string['privacy:metadata:agpunetprofile'] = 'The agpuNet profile for the user';
