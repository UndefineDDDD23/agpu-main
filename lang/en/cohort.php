...
/**
 * Strings for component 'cohort', language 'en', branch 'agpu_20_STABLE'
 *
 * @package    core_cohort
 * @subpackage cohort
...
$string['visible_help'] = "Any cohort can be viewed by users who have 'agpu/cohort:view' capability in the cohort context.<br/>
