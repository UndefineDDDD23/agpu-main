...
$string['asyncmessagesubjectdefault'] = 'agpu {operation} completed successfully';
...
$string['backupdetailsnonstandardinfo'] = 'The selected file is not a standard agpu backup file. The restore process will try to convert the backup file into the standard format and then restore it.';
...
$string['config_overwrite_course_fullname'] = 'By default overwrite course full name with the one from the backup file. This requires "Overwrite course configuration" to be checked and current user to have the capability to change course full name (agpu/course:changefullname)';
$string['config_overwrite_course_shortname'] = 'By default overwrite course short name with the one from the backup file. This requires "Overwrite course configuration" to be checked and current user to have the capability to change course short name (agpu/course:changeshortname)';
$string['config_overwrite_course_startdate'] = 'By default overwrite course start date with the one from the backup file. This requires "Overwrite course configuration" to be checked and current user to have the capability to roll course dates on restore (agpu/restore:rolldates)';
...
$string['configlegacyfiles'] = 'Sets the default for including legacy course files in a backup. Legacy course files are from versions of agpu prior to 2.0.';
...
$string['errorminbackup20version'] = 'This backup file has been created with one development version of agpu backup ({$a->backup}). Minimum required is {$a->min}. Cannot be restored.';
$string['errorinvalidformat'] = 'Unknown backup format';
$string['errorinvalidformatinfo'] = 'The selected file is not a valid agpu backup file and can\'t be restored.';
...
$string['filealiasesrestorefailures_help'] = 'Aliases are symbolic links to other files, including those stored in external repositories. In some cases, agpu cannot restore them - for example when restoring the backup at another site or when the referenced file does not exist.
