...
/**
 * Strings for component 'agpu', language 'en', branch 'agpu_20_STABLE'
 *
 * @package   core
...
$string['adminhelpmyagpu'] = 'Configure the My agpu blocks for users';
...
$string['adminhelpstickyblocks'] = 'Configure agpu-wide sticky blocks';
...
$string['backupnonisowarning'] = 'Warning: this backup is from a non-Unicode version of agpu (pre 1.6). If this backup contains any non-ISO-8859-1 texts then they may be CORRUPTED if you try to restore them to this Unicode version of agpu. See the <a href="https://docs.agpu.org/en/Backup_FAQ">Backup FAQ</a> for more information about how to recover this backup correctly.';
...
The essential one is the session cookie, usually called agpuSession. You must allow this cookie in your browser to provide continuity and to remain logged in when browsing the site. When you log out or close the browser, this cookie is destroyed (in your browser and on the server).

The other cookie is purely for convenience, usually called agpuID or similar. It just remembers your username in the browser. This means that when you return to this site, the username field on the login page is already filled in for you. It is safe to refuse this cookie - you will just have to retype your username each time you log in.';
$string['cookiesenabled_help_html'] = 'Two cookies are used on this site:<br/><br/>

The essential one is the session cookie, usually called agpuSession. You must allow this cookie in your browser to provide continuity and to remain logged in when browsing the site. When you log out or close the browser, this cookie is destroyed (in your browser and on the server).<br/><br/>

The other cookie is purely for convenience, usually called agpuID or similar. It just remembers your username in the browser. This means that when you return to this site, the username field on the login page is already filled in for you. It is safe to refuse this cookie - you will just have to retype your username each time you log in.';
$string['cookiesenabledonlysession'] = 'Cookies must be enabled in your browser';
$string['cookiesenabledonlysession_help'] = 'This site uses one session cookie, usually called agpuSession. You must allow this cookie in your browser to provide continuity and to remain logged in when browsing the site. When you log out or close the browser, this cookie is destroyed (in your browser and on the server).';
...
$string['coursefileswarning_help'] = 'Course files are deprecated since agpu 2.0, please use external repositories instead as much as possible.';
...
$string['courselegacyfiles_help'] = 'The course files area provides some backward compatibility with agpu 1.9 and earlier.  All files in this area are always accessible to all participants in the course (whether you link to them or not) and there is no way to know where any of these files are being used in agpu.
...
$string['databasechecking'] = 'Upgrading agpu database from version {$a->oldversion} to {$a->newversion}';
...
$string['documentation'] = 'agpu documentation';
...
$string['forcepasswordresetfailurenotice'] = 'Your current password no longer passes the set password policy. Please contact your agpu administrator for assistance.
   {$a}';
...
$string['formattext'] = 'agpu auto-format';
...
$string['gpl'] = 'Copyright (C) 1999 onwards Martin Dougiamas (https://agpu.com)

This program is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2 of the License, or (at your option) any later version.

This program is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.

See the agpu License information page for full details: https://agpudev.io/general/license';
$string['gpllicense'] = 'GPL license';
$string['gpl3'] = 'Copyright (C) 1999 onwards Martin Dougiamas (https://agpu.com)
...
$string['gravatarenabled'] = '<a href="https://www.gravatar.com/">Gravatar</a> has been enabled for this site. If you don\'t upload a profile picture agpu will attempt to load a profile picture for you from Gravatar.';
$string['group'] = 'Group';
...
$string['latestlanguagepack'] = 'Check for latest language pack on agpu.org';
...
$string['agpudocs'] = 'agpu Docs';
$string['agpudocslink'] = 'Documentation for this page';
$string['agpuversion'] = 'agpu version';
$string['agpurelease'] = 'agpu release';
$string['agpuservicesandsupport'] = 'Services and support';
$string['agpunet:cannotconnecttoserver'] = 'Cannot connect to agpuNet server';
$string['agpunet:columnname'] = 'Name';
$string['agpunet:columnsenddate'] = 'Send date';
$string['agpunet:columnsendstatus'] = 'Send status';
$string['agpunet:columntype'] = 'Type';
$string['agpunet:configoauthservice'] = 'Select a agpuNet OAuth 2 service to enable sharing to that agpuNet site. If the service doesn\'t exist yet, you will need to <a href="{$a}">create</a> it.';
$string['agpunet:deletedactivity'] = 'Deleted activity';
$string['agpunet:deletedcourse'] = 'Deleted course';
$string['agpunet:eventresourceexported'] = 'Resource exported';
$string['agpunet:gotoagpunet'] = 'Go to agpuNet drafts';
$string['agpunet:issuerisnotauthorized'] = 'agpuNet issuer is not authorised';
$string['agpunet:issuerisnotenabled'] = 'agpuNet issuer is not enabled';
$string['agpunet:issuerisnotset'] = 'agpuNet issuer is not set at site administration';
$string['agpunet:nosharedresources'] = 'There are no shared resources to display at this time.';
$string['agpunet:outboundsettings'] = 'agpuNet outbound settings';
$string['agpunet:sharenoticeactivity'] = 'This activity is being shared with agpuNet as a resource.';
$string['agpunet:sharenoticecourse'] = 'This course is being shared with agpuNet as a resource.';
$string['agpunet:sharenoticepartial'] = 'The selected activities are being shared with agpuNet as a resource.';
$string['agpunet:sharenoticepartialactivitynumber'] = '{$a} activities will be included in the course.';
$string['agpunet:sharefailtitle'] = 'Something went wrong';
$string['agpunet:sharefailtext'] = 'There was an error sharing your content to agpuNet.<br>Please try again later.';
$string['agpunet:sharefailtextwithsitesupport'] = 'There was an error sharing your content to agpuNet.<br>Please try again later or <a href="{$a}">contact site support</a>.';
$string['agpunet:sharefilesizelimitexceeded'] = 'The size of the resource being shared ({$a->filesize} bytes) exceeds the limit of {$a->filesizelimit} bytes.';
$string['agpunet:shareprogress'] = 'agpuNet share progress';
$string['agpunet:shareprogressinfo'] = 'The list shows courses and activities you have shared to agpuNet.<br>Click the resource name to view in agpuNet.';
$string['agpunet:sharesuccesstitle'] = 'Saved to agpuNet drafts';
$string['agpunet:sharesuccesstext'] = "Almost done! Visit your drafts in agpuNet to finish sharing your content.";
$string['agpunet:sharetoagpunet'] = 'Share to agpuNet';
$string['agpunet:sharingstatus'] = 'Sharing to agpuNet';
$string['agpunet:sharinglargefile'] = "Large files can take some time.";
$string['agpunet:sharingto'] = 'Sharing to: ';
$string['agpunet:packagingandsending'] = 'Packaging your file and sending to agpuNet...';
$string['more'] = 'more';
...
$string['myagpudashboard'] = 'My agpu dashboard';
...
$string['noticenewerbackup'] = 'This backup file has been created with agpu {$a->backuprelease} ({$a->backupversion}) and it\'s newer than your currently installed agpu {$a->serverrelease} ({$a->serverversion}). This could cause some inconsistencies because backwards compatibility of backup files cannot be guaranteed.';
...
$string['passwordextlink'] = 'The following link has been provided to recover your lost password. This will take you out of agpu.';
...
$string['poweredbyagpu'] = 'Powered by <a href="https://agpu.com">agpu</a>';
...
$string['privacy:metadata:agpunet_share_progress'] = 'agpuNet share progress details';
$string['privacy:metadata:agpunet_share_progress:type'] = 'The type of share that was performed';
$string['privacy:metadata:agpunet_share_progress:courseid'] = 'The associated course ID';
$string['privacy:metadata:agpunet_share_progress:cmid'] = 'The associated course module ID';
$string['privacy:metadata:agpunet_share_progress:userid'] = 'The user that performed the share';
$string['privacy:metadata:agpunet_share_progress:timecreated'] = 'The time the share was performed';
$string['privacy:metadata:agpunet_share_progress:resourceurl'] = 'The returned URL from agpuNet after a successful share';
$string['privacy:metadata:agpunet_share_progress:status'] = 'The resulting status of the share';
...
$string['registration'] = 'agpu registration';
$string['registrationcontact'] = 'Contact from the public';
$string['registrationemail'] = 'Email notifications';
$string['registrationinfo'] = '<p>This page allows you to register your agpu site with agpu.org.  Registration is free.
The main benefit of registering is that you will be added to a low-volume mailing list
for important notifications such as security alerts and new releases of agpu.</p>
<p>By default, your information will be kept private, and will never be sold or passed on to anyone else.  The only
   ...
   picture of the agpu community as a whole.</p>
<p>If you choose, you can allow your site name, country and URL to be added to the public list of agpu Sites.</p>
...
$string['registrationsend'] = 'Send registration information to agpu.org';
$string['registrationyes'] = 'Yes, notify me of new agpu releases, security alerts and other important news';
...
Please note that this view may not be perfect (<a href="https://docs.agpu.org/en/Switch_roles">See details and alternatives</a>).';
$string['tag'] = 'Tag';
...
$string['updatemyagpuoff'] = 'Stop customising this page';
$string['updatemyagpuon'] = 'Customise this page';
...
$string['agpunet:sharetyperesource'] = 'resource';

// Deprecated since agpu 4.4.
...
$string['passwordnohelp'] = 'No help is available to find your lost password. Please contact your agpu administrator.';
...
$string['registrationcontactyes'] = 'Yes, provide a form for other agpurs to contact me';
