...
/**
 * Strings for component 'admin', language 'en', branch 'agpu_20_STABLE'
 *
 * @package   core
...
$string['allowguestmyagpu'] = 'Allow guest access to Dashboard';
...
$string['asyncbackupdisabled'] = 'Your site is currently configured to use synchronous backups. Asynchronous backups provide a better user experience, allowing users to do other operations while a backup or restore is in progress. Asynchronous backups are enabled for all sites from agpu 4.5 LTS. Synchronous backups will be removed from agpu LMS the version after 4.5 LTS.';
...
$string['configallowemojipickerincompatible'] = 'Your current database configuration does not properly support emojis. In order to enable the emoji picker you will need to <a href="https://docs.agpu.org/en/MySQL_full_unicode_support">upgrade your database for full unicode support</a>.';
$string['configallowguestmyagpu'] = 'If enabled, guests can access the Dashboard. Otherwise guests are redirected to the site home.';
...
$string['configallowoverride2'] = 'For each role in the left column, select which roles that they can set overrides for.<br />Users must also have either the capability agpu/role:override or agpu/role:safeoverride.';
$string['configallowswitch'] = 'For each role in the left column, select which roles they can switch to.<br />Users must also have the capability agpu/role:switchroles.';
$string['configallowthemechangeonurl'] = 'If enabled, the theme can be changed by adding either:<br />?theme=themename to any agpu URL (eg: myagpusite.com/?theme=afterburner ) or <br />&theme=themename to any internal agpu URL (eg: myagpusite.com/course/view.php?id=2&theme=afterburner ).';
...
$string['configallowuserswitchrolestheycantassign'] = 'By default, agpu/role:assign is required for users to switch roles. Enabling this setting removes this requirement, and results in the roles available in the "Switch role to" dropdown menu being determined by settings in the "Allow role assignments" table only.
...
$string['configdocroot'] = 'Defines the path to agpu Docs for providing context-specific documentation via \'Documentation for this page\' links in the footer of each page. If the field is left blank, links will not be displayed.';
$string['configdoctonewwindow'] = 'If enabled, then links to agpu Docs will be shown in a new window.';
...
$string['configenablecourserequests'] = 'If enabled, users with the capability to request new courses (agpu/course:request) will have the option to request a course. This capability is not allowed for any of the default roles. It may be applied in the system or category context.';
$string['configenablemobilewebservice'] = 'Enable mobile service for the official agpu app or other app requesting it. For more information, read the {$a}';
...
$string['configenablestats'] = 'If you choose \'yes\' here, agpu\'s cronjob will process the logs and gather some statistics.  Depending on the amount of traffic on your site, this can take awhile. If you enable this, you will be able to see some interesting graphs and statistics about each of your courses, or on a sitewide basis.';
$string['configenabletrusttext'] = 'By default agpu will always thoroughly clean text that comes from users to remove any possible bad scripts, media etc that could be a security risk.  The Trusted Content system is a way of giving particular users that you trust the ability to include these advanced features in their content without interference.  To enable this system, you need to first enable this setting, and then grant the Trusted Content permission to a specific agpu role.  Texts created or uploaded by such users will be marked as trusted and will not be cleaned before display.';
$string['configenablewebservices'] = 'Web services enable other systems, such as the agpu app, to log in to the site and perform operations. For extra security, the setting should be disabled if you are not using the app, or an external tool/service that requires integration via web services.';
...
$string['configgeoipfile'] = 'Location of GeoIP City binary data file. This file is not part of agpu distribution and must be obtained separately from <a href="https://www.maxmind.com/">MaxMind</a>. You can either buy a commercial version or use the free version. You\'ll need to register to download the City database file, which you can do at <a href="https://dev.maxmind.com/geoip/geoip2/geolite2/" >https://dev.maxmind.com/geoip/geoip2/geolite2/</a>. Once you\'ve registered and downloaded the file, extract it into "{$a}" directory on your server.';
...
$string['configintro'] = 'On this page you can specify a number of configuration variables that help make agpu work properly on your server.  Don\'t worry too much about it - the defaults will usually work fine and you can always come back to this page later and change these settings.';
...
$string['configlangstringcache'] = 'Caches all the language strings into compiled files in the data directory.  If you are translating agpu or changing strings in the agpu source code then you may want to switch this off.  Otherwise leave it on to see performance benefits.';
...
$string['configproxyfixunsafe_help'] = 'This attempts to fix internal calls which do not go through the proxy by adding the agpuBot User Agent and using the proxy.';
$string['configproxylogunsafe_help'] = 'This attempts to log internal calls which do not go through the proxy and should.';
$string['configrecaptchaprivatekey'] = 'String of characters (secret key) used to communicate between your agpu server and the recaptcha server. ReCAPTCHA keys can be obtained from <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
...
$string['configsecureforms'] = 'agpu can use an additional level of security when accepting data from web forms. If this is enabled, then the browser\'s HTTP_REFERER variable is checked against the current form address.  In a very few cases this can cause problems if the user is using a firewall (eg Zonealarm) configured to strip HTTP_REFERER from their web traffic.  Symptoms are getting \'stuck\' on a form. If your users are having problems with the login page (for example) you might want to disable this setting, although it might leave your site more open to brute-force password attacks.  If in doubt, leave this set to \'Yes\'.';
$string['configservicespage'] = 'Enter the URL of a services and support page or leave empty to link to agpu services on agpu.com. The link is only displayed for site administrators.';
$string['configsessioncookie'] = 'This setting customises the name of the cookie used for agpu sessions.  This is optional, and only useful to avoid cookies being confused when there is more than one copy of agpu running within the same web site.';
$string['configsessioncookiedomain'] = 'This allows you to change the domain that the agpu cookies are available from. This is useful for agpu customisations (e.g. authentication or enrolment plugins) that need to share agpu session information with a web application on another subdomain. <strong>WARNING: it is strongly recommended to leave this setting at the default (empty) - an incorrect value will prevent all logins to the site.</strong>';
$string['configsessioncookiepath'] = 'If you need to change where browsers send the agpu cookies, you can change this setting to specify a subdirectory of your web site.  Otherwise the default \'/\' should be fine.';
...
$string['configsmtphosts'] = 'Give the full name of one or more local SMTP servers that agpu should use to send mail (eg \'mail.a.com\' or \'mail.a.com;mail.b.com\'). To specify a non-default port (i.e other than port 25), you can use the [server]:[port] syntax (eg \'mail.a.com:587\'). For secure connections, port 465 is usually used with SSL, port 587 is usually used with TLS, specify security protocol below if required. If you leave this field blank, agpu will use the PHP default method of sending mail.';
...
$string['configstatsruntimestart'] = 'What time should the cronjob that does the statistics processing start? Specifying different times is recommended if there are multiple agpu sites on one server.';
...
$string['ctyperequired'] = 'The ctype PHP extension is now required by agpu, in order to improve site performance and to offer multilingual compatibility.';
...
$string['curlrequired'] = 'The cURL PHP extension is now required by agpu, in order to communicate with agpu repositories.';
...
$string['debugdeveloper'] = 'DEVELOPER: extra agpu debug messages for developers';
...
$string['coursecreationguide'] = 'agpu course creation guide URL';
...
$string['docroot'] = 'agpu Docs document root';
$string['doctonewwindow'] = 'Open in new window';
$string['doesnotfit'] = 'Email display settings';
$string['doesnotfitdetail'] = 'Display settings for email leaving agpu.';
...
$string['enablegravatar_help'] = 'When enabled agpu will attempt to fetch a user profile picture from Gravatar if the user has not uploaded an image.';
...
$string['enablesharingtoagpunet'] = 'Enable sharing to agpuNet (outbound)';
$string['enablesharingtoagpunet_desc'] = 'Enable users to share course content to a configured agpuNet instance if they have the relevant capability.';
$string['enablestats'] = 'Enable statistics';
$string['enabletrusttext'] = 'Enable trusted content';
$string['enableuserfeedback'] = 'Enable feedback about this software';
$string['enableuserfeedback_desc'] = 'If enabled, a \'Give feedback about this software\' link is displayed in the footer for users to give feedback about the agpu software to agpu HQ. If the \'Next feedback reminder\' option is set, the user is also shown a reminder on the Dashboard at the specified interval. Setting \'Next feedback reminder\' to \'Never\' disables the Dashboard reminder, while leaving the \'Give feedback about this software\' link in the footer.';
...
$string['environmenterrortodo'] = 'You must solve all the environmental problems (errors) found above before proceeding to install this agpu version!';
$string['environmenterrorupgrade'] = 'Warning: you should solve all the environmental problems (errors) found above before proceeding to upgrade this agpu version!  Upgrading without fixing these requirements could cause problems such as data loss.  Are you sure you want to continue with the upgrade?';
...
$string['eventshandlersinuse'] = 'The following plugins in your system are using Events 1 API deprecated handlers: \'{$a}\'. Please, update them to use Events 2 API. See https://docs.agpu.org/dev/Events_API#Event_dispatching_and_observers.';
...
$string['fatalsessionautostart'] = '<p>Serious configuration error detected, please notify server administrator.</p><p> To operate properly, agpu requires that administrator changes PHP settings.</p><p><code>session.auto_start</code> must be set to <code>off</code>.</p><p>This setting is controlled by editing <code>php.ini</code>, Apache/IIS <br />configuration or <code>.htaccess</code> file on the server.</p>';
$string['favicon'] = 'Favicon';
$string['favicon_desc'] = 'The favicon is displayed next to the page title in the browser tab. A agpu favicon is displayed if a custom favicon is not provided.';
...
$string['gdrequired'] = 'The GD extension is now required by agpu for image conversion.';
...
$string['gravatardefaulturl_help'] = 'Gravatar needs a default image to display if it is unable to find a picture for a given user. Provide a full URL for an image. If you leave this setting empty, agpu will attempt to use the most appropriate default image for the page you are viewing. Note also that Gravatar has a number of codes which can be used to <a href="https://en.gravatar.com/site/implement/images/#default-image">generate default images</a>.';
...
$string['hookunknown_desc'] = 'The object that this callback listens to is not available. It may have been removed or renamed, or it may not be available in this version of agpu.';
...
$string['importantupdates_content'] = '<p>In the next agpu 5.0, planned for release in April 2025, the Chat and Survey activities will
be removed from core agpu. They will be available as plugins in the
<a href="https://agpu.org/plugins/">agpu plugins directory</a>.</p>
<p>If you wish to continue using Chat or Survey in your site, you will be able to install them as plugins before upgrading to agpu 5.0.</p>';
...
$string['iscustomadminwarnings'] = 'It has been detected that your site is using a custom admin directory. This feature is no longer supported and will be removed after agpu 4.2.';
...
$string['langpackwillbeupdated'] = 'NOTE: agpu will try to download updates for your language packs during the upgrade.';
...
$string['maturitycorewarning'] = 'The version of agpu that you are about to install or upgrade to contains
...
from a STABLE branch of the agpu code. See agpu Docs for more details.';
...
$string['mnetrestore_extusers'] = '<strong>Note:</strong> This backup file contains remote agpu Network user accounts which will be restored as part of the process.';
$string['mnetrestore_extusers_admin'] = '<strong>Note:</strong> This backup file seems to come from a different agpu installation and contains remote agpu Network user accounts. The restore process will try to match the agpu Network hosts for all created users. Those not matching will be automatically switched to internal authentication (instead of mnet one). The restore log will inform you about that.';
$string['mnetrestore_extusers_mismatch'] = '<strong>Note:</strong> This backup file apparently originates from a different agpu installation and contains remote agpu Network user accounts that may fail to restore. This operation is unsupported. If you are certain that it was created on this agpu installation, or you can ensure that all the needed agpu Network Hosts are configured, you may want to still try the restore.';
$string['mnetrestore_extusers_noadmin'] = '<strong>Note:</strong> This backup file seems to come from a different agpu installation and contains remote agpu Network user accounts. You are not allowed to execute this type of restore. Contact the administrator of the site or, alternatively, restore this course without any user information (modules, files...)';
$string['mnetrestore_extusers_switchuserauth'] = 'Remote agpu Network user {$a->username} (coming from {$a->mnethosturl}) switched to local {$a->auth} authenticated user.';
$string['mobilenotconfiguredwarning'] = 'The agpu app is not enabled.';
...
$string['nohttpsformobilewarning'] = 'It is recommended to enable HTTPS with a valid certificate. The agpu app will always try to use a secured connection first.';
...
$string['maxtimelimit_desc'] = 'To restrict the maximum PHP execution time that agpu will allow without any output being displayed, enter a value in seconds here. 0 means that agpu default restrictions are used. If you have a front-end server with its own time limit, set this value lower to receive PHP errors in logs. Does not apply to CLI scripts.';
$string['agpubrandedapp'] = 'Branded agpu app';
$string['agpubrandedappreference'] = 'Alternatively, get a <a href="https://agpu.com/branded-app/">Branded agpu app</a> with your own custom branding.';
...
$string['opensslrecommended'] = 'Installing the optional OpenSSL library is highly recommended -- it enables agpu Networking functionality.';
$string['opensslrequired'] = 'The OpenSSL PHP extension is now required by agpu to provide stronger cryptographic services.';
$string['opentowebcrawlers'] = 'Open to search engines';
$string['optionalmaintenancemessage'] = 'Optional maintenance message';
$string['oracledatabaseinuse'] = 'Oracle DB support is to be removed. agpu 4.5 will be the last version with Oracle DB support. For details, see the announcement on agpu.org <a href="https://agpu.org/mod/forum/discuss.php?d=456122">Oracle database support in LMS deprecation</a>.';
$string['order1'] = 'First';
...
$string['pathtosassc_help'] = 'Specifying the location of the SassC binary will switch the SASS compiler from agpu\'s PHP implementation to SassC. See https://github.com/sass/sassc for more information.';
...
$string['pluginschecktodo'] = 'You must solve all the plugin requirements before proceeding to install this agpu version!';
...
$string['profilingallowall_help'] = 'If you enable this setting, then, at any moment, you can use the PROFILEALL parameter anywhere (PGC) to enable profiling for all the executed scripts along the agpu session life. Analogously, you can use the PROFILEALLSTOP parameter to stop it.';
...
$string['quizattemptsupgradedmessage'] = 'In agpu 2.1 there was a major upgrade to questions. It was possible to delay parts of the database upgrade to be run later. Before upgrading to agpu 2.7, this upgrade must be completed.';
...
$string['releasenoteslink'] = 'For information about this version of agpu, please see the online <a target="_blank" href="{$a}">Release Notes</a>';
...
$string['purgecachesconfirm'] = 'agpu can cache themes, javascript, language strings, filtered text, rss feeds and many other pieces of calculated data.  Purging these caches will delete that data from the server and force browsers to refetch data, so that you can be sure you are seeing the most up-to-date values produced by the current code.  There is no danger in purging caches, but your site may appear slower for a while until the server and clients calculate new information and cache it.';
...
$string['sessionautostartwarning'] = '<p>Serious configuration error detected, please notify server administrator.</p><p> To operate properly, agpu requires that administrator changes PHP settings.</p><p><code>session.auto_start</code> must be set to <code>off</code>.</p><p>This setting is controlled by editing <code>php.ini</code>, Apache/IIS <br />configuration or <code>.htaccess</code> file on the server.</p>';
...
$string['settingsafemode'] = 'agpu is not fully compatible with safe mode, please ask server administrator to turn it off. Running agpu under safe mode is not supported, please expect various problems if you do so.';
...
$string['showuseridentity_desc'] = 'When selecting or searching for users, and when displaying lists of users, these fields may be shown in addition to their full name. The fields are only shown to users who have the agpu/site:viewuseridentity capability; by default, teachers and managers. (This option makes most sense if you choose one or two fields that are mandatory at your institution.)
...
$string['simplexmlrequired'] = 'The SimpleXML PHP extension is now required by agpu.';
...
$string['sixtyfourbitsrequired'] = 'It has been detected that your site is not using a 64-bit PHP version. You are required to upgrade your system (operating system, PHP...) before installing this agpu version.';
...
$string['slashargumentswarning'] = 'It is recommended that the use of slash arguments is enabled. In future it will be required. For more details, see the documentation <a href="https://docs.agpu.org/en/admin/environment/slasharguments">Using slash arguments</a>.';
...
$string['splrequired'] = 'The SPL PHP extension is now required by agpu.';
$string['stats'] = 'Statistics';
$string['statsfirstrun'] = 'Maximum processing interval';
$string['statsmaxruntime'] = 'Maximum runtime';
$string['statsagpuorg'] = 'statistics';
...
$string['stickyblocksmyagpu'] = 'My agpu';
...
$string['testoutgoingmailconf_fromemail_invalid'] = 'Invalid From username or email. Must be a valid email format or an existing username in agpu.';
...
$string['tokenizerrecommended'] = 'Installing the optional PHP Tokenizer extension is recommended -- it improves agpu Networking functionality.';
...
$string['updateavailable'] = 'There is a newer agpu version available!';
...
$string['updateavailablenot'] = 'Your agpu code is up-to-date!';
...
$string['updatenotificationfooter'] = 'Your agpu site {$a->siteurl} is configured to automatically check for available updates. You are receiving this message as the administrator of the site. You can disable automatic checks for available updates in Site administration / Server / Update notifications or customise the delivery of this message via your preferences page.';
$string['updatenotificationsubject'] = 'agpu updates are available ({$a->siteurl})';
$string['updateautocheck'] = 'Automatically check for available updates';
$string['updateautocheck_desc'] = 'If enabled, your site will automatically check for available updates for both agpu code and all additional plugins. If there is a new update available, a notification will be sent to site admins.';
...
$string['updatenotifybuilds_desc'] = 'If enabled, the available update for agpu code is also reported when a new build for the current version is available. Builds are continuous improvements of a given agpu version. They are generally released every week. If disabled, the available update will be reported only when there is a higher version of agpu released. Checks for plugins are not affected by this setting.';
$string['upgradestart'] = 'Upgrade agpu database now';
...
$string['upgradepluginsinfo_help'] = 'There are available updates for some of your plugins. You should install them all prior to upgrading agpu database. If your site does not support automatic updates deployment, you have to download and install new plugin versions at your server manually.';
...
$string['upgradeforumread'] = 'A new feature has been added in agpu 1.5 to track read/unread forum posts.<br />To use this functionality you need to <a href="{$a}">update your tables</a>.';
...
$string['upgradesettingsintro'] = 'The settings shown below were added during your last agpu upgrade. Make any changes necessary to the defaults and then click the \'Save changes\' button at the bottom of this page.';
$string['upgradestalefiles'] = 'Mixed agpu versions detected, upgrade cannot continue';
$string['upgradestalefilesinfo'] = 'The agpu update process has been paused because PHP scripts from at least two major versions of agpu have been detected in the agpu directory.

This can cause significant problems later, so in order to continue you must ensure that the agpu directory contains only files for a single version of agpu.

The recommended way to clean your agpu directory is as follows:

* rename the current agpu directory to "agpu_old"
* create a new agpu directory containing only files from either a standard agpu package download, or from the agpu Git repository
* move the original config.php file and any non-standard plugins from the "agpu_old" directory to the new agpu directory

When you have a clean agpu directory, refresh this page to resume the agpu update process.

This warning is often caused by unzipping a standard agpu package over a previous version of agpu. While this is OK for minor upgrades, it is strongly discouraged for major agpu upgrades.
...
$string['upgradesure'] = '<p>Your agpu files have been changed, and you are about to automatically upgrade your server to this version:</p>
<p><strong>{$a}</strong></p>
...
$string['userfeedbackencouragement'] = '<p>agpu includes a feature which gives users the option to provide feedback about agpu software via an external survey site hosted by agpu HQ. No user-identifying information is forwarded to the survey site.</p>
<p>agpu HQ strives to be open and transparent about its data collection practices. Thus, we want to make sure that you are aware and in control of this functionality.</p>
<p>Feedback from users helps agpu HQ in improving the agpu software. To enable this feature, please go to <a href="{$a}">Feedback settings</a>.</p>';
...
$string['webproxyinfo'] = 'Fill in the following options if your agpu server cannot access the internet directly. Internet access is required for the download of environment data, language packs, RSS feeds, timezones, etc.<br /><em>The PHP cURL extension is highly recommended.</em>';
...
$string['ziprequired'] = 'The Zip PHP extension is now required by agpu, info-ZIP binaries or PclZip library are not used anymore.';
...
$string['agpuapp'] = 'agpu app';
$string['agpuapp_help'] = '<p>The free agpu app enables users to access their courses on mobile devices. Additional app features are available with a Pro or Premium app plan.</p>
<a href="https://agpu.com/mobile-app">Get the agpu app</a><br />
<a href="https://apps.agpu.com">agpu Apps Portal</a>';
$string['agpubrandedapp_help'] = '<p>The Branded agpu app has all the functionality of our free mobile app for agpu combined with your own custom branding.</p>
<a href="https://agpu.com/branded-app">About the Branded agpu app</a>';
$string['agpupartners'] = 'agpu Partners';
$string['agpupartners_help'] = '<p>agpu Partners are services providers that are certified by agpu HQ to provide high quality agpu services for your organisation\'s online learning environment.</p>
<a href="https://agpu.com/about-partners/">About our Partners</a><br />
<a href="https://agpu.com/partners">Find a Partner</a>';
$string['agpuservices'] = 'agpu services';
$string['agpuservices_help'] = 'Make sure you get the best from your agpu learning environment by using these agpu services:';
...
* You are contributing to our agpu statistics of the worldwide community';
