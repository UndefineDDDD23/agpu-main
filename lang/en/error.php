...
/**
 * Strings for component 'error', language 'en', branch 'agpu_20_STABLE'
 *
 * @package   core
...
$string['backupcontainexternal'] = 'This backup file contains external agpu Network Hosts that are not configured locally';
...
$string['cannotdownloadlanguageupdatelist'] = 'Cannot download list of language updates from download.agpu.org';
...
$string['mimetexisnotexist'] = 'Your system is not configured to run mimeTeX. You need to obtain the C source from <a href="https://www.forkosh.com/mimetex.zip">https://www.forkosh.com/mimetex.zip</a>, compile it and put the executable into your agpu/filter/tex/ directory.';
...
$string['missing_agpu_backup_xml_file'] = 'Backup is missing XML file: {$a}';
...
$string['agpunet:invalidshareformat'] = 'Incorrect agpuNet share format';
$string['agpunet:invalidsharestatus'] = 'Incorrect agpuNet share status';
$string['agpunet:invalidsharetype'] = 'Invalid agpuNet share type';
$string['agpunet:usernotconfigured'] = 'You do not have permission to share content to agpuNet, or your account is incorrectly configured.';
...
$string['pluginrequirementsnotmet'] = 'Plugin "{$a->pluginname}" ({$a->pluginversion}) could not be installed.  It requires a newer version of agpu (currently you are using {$a->currentagpu}, you need {$a->requireagpu}).';
$string['pluginunsupported'] = 'Plugin "{$a->pluginname}" {$a->pluginversion} does not support this version of agpu {$a->agpuversion}. Seek plugin information to find supported versions.';
...
$string['unicodeupgradeerror'] = 'Sorry, but your database is not already in Unicode, and this version of agpu is not able to migrate your database to Unicode.  Please upgrade to agpu 1.7.x first and perform the Unicode migration from the Admin page.  After that is done you should be able to migrate to agpu {$a}';
...
$string['upgraderequires19'] = 'Error: New agpu version was installed on server, unfortunately upgrade from the previous version is not supported.<br />Please upgrade first to latest 1.9.x release. You can also return to previous version by reinstalling original files.';
