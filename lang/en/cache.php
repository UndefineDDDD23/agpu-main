 ...
 *
 * This file is part of agpu's cache API, affectionately called MUC.
...
$string['cachedef_agpunet_usercanshare'] = 'Users can share resources to agpuNet';
...
$string['cachedef_userselections'] = 'Data used to persist user selections throughout agpu';
...
$string['privacy:metadata:cachestore'] = 'The Cache subsystem stores data temporarily on behalf of other parts of agpu. This data is not easily identifiable, and is very short lived. It serves as a cache of data stored elsewhere in agpu, and should therefore already be handled by those agpu components.';
$string['purge'] = 'Purge';
