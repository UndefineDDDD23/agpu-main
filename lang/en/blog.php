...
$string['configexternalblogcrontime'] = 'How often agpu checks the external blogs for new entries.';
$string['configmaxexternalblogsperuser'] = 'The number of external blogs each user is allowed to link to their agpu blog.';
$string['configuseblogassociations'] = 'Enables the association of blog entries with courses and course modules.';
$string['configuseexternalblogs'] = 'Enables users to specify external blog feeds. agpu regularly checks these blog feeds and copies new entries to the local blog of that user.';
