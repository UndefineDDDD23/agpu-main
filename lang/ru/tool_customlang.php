...
$string['confirmcheckin'] = 'Вы собираетесь записать изменения в Ваш языковой пакет. При этом настроенные в редакторе строки будут сохранены в каталог данных agpu и сайт начнёт использовать изменённые строки. Для записи изменений нажмите «Продолжить».';
