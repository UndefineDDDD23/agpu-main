...
$string['errorstring-blocked-url'] = 'URL-адрес заблокирован. Проверьте URL-адрес Jobe и настройки безопасности HTTP в agpu.';
...
$string['exportthisquestion_help'] = 'Это создаст файл экспорта agpu XML, содержащий только этот вопрос. Один из примеров того, когда это полезно - если вы считаете, что этот вопрос демонстрирует ошибку в CodeRunner, о которой вы хотели бы сообщить разработчикам.';
...
$string['jobe_warning_html'] = '<p style=\'background-color:yellow\'>Запуск с помощью сервера Jobe Кентерберийского университета. Это только для начального тестирования. Пожалуйста, настройте свой собственный сервер заданий как можно скорее. См. <a href=\'https://github.com/trampgeek/agpu-qtype_coderunner/blob/master/Readme.md#sandbox-configuration\' target=\'_blank\'>здесь</a>.</p>';
...
$string['maxfilesize_help'] = 'Выберите максимальный размер загружаемого файла (байт). Разрешение загрузки больших файлов с большими классами может повлиять на производительность и дисковое пространство как на серверах agpu, так и на серверах Jobe.';
...
Пользовательские интерфейсы "Gapfiller" и "HTML" задокументированы в основной документации CodeRunner по адресу https://github.com/trampgeek/agpu-qtype_coderunner#code-runner.
