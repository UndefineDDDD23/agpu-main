...
Избегайте использования слова «ссылка». Это поможет пользователям программ чтения с экрана, так как программы чтения с экрана объявляют ссылки (например, «agpu.org, ссылка»), поэтому нет необходимости включать слово «ссылка» в поле названия.';
