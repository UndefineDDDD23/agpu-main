...
/**
 * Strings for component 'tinymce_mathslate', language 'ru', version '4.5'.
 *
...
$string['mathjaxurl_desc'] = 'URL на файл MathJax.js, который Mathslate должен загрузить, если MathJax не доступен и настроен (возможно при использовании фильтра agpu TeX). По умолчанию загружается из интернета через http. Если на сайте применяется https, то используйте "https://c328740.ssl.cf1.rackcdn.com/mathjax/latest/MathJax.js" или лучше установите локальную копию.';
