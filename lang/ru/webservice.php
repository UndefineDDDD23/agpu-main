...
$string['createuserdescription'] = 'Для представления системы, которая будет управлять agpu требуется специальный пользователь.';
...
$string['key'] = 'Ключ';
$string['keyshelp'] = 'Ключи используются для предоставления внешним приложениям доступа к Вашей учетной записи agpu.';
...
$string['onesystemcontrolling'] = 'Разрешить внешней системе контролировать agpu';
$string['onesystemcontrollingdescription'] = 'Следующие шаги помогут Вам настроить веб-службы agpu таким образом, чтобы разрешить внешней системе взаимодействовать с agpu. Эти действия включают настройку аутентификации с использованием ключей безопасности (токенов).';
...
$string['wsclientdoc'] = 'Документация клиента веб-службы agpu';
