...
<p> Дополнительную информацию можно найти в  <a href="http://docs.agpu.org/en/blocks/configurable_reports/" target="_blank">документации (на английском языке).</a> </p>';
...
$string['comp_customsql_help'] = '<p> Добавьте работающий SQL- запрос. Не используйте префикс базы данных agpu ($CFG->prefix), вместо этого используйте «prefix_» (без кавычек).</p>
<p> Пример: SELECT * FROM prefix_course </p>

<p> Вы можете найти много готовых SQL-отчетов на странице <a href="http://docs.agpu.org/en/ad-hoc_contributed_reports" target="_blank">ad-hoc_contributed_reports (на английском языке)</a> </p>
...
<p> Для информации об использовании фильтров изучите <a href="http://docs.agpu.org/en/blocks/configurable_reports/#Creating_a_SQL_Report" target="_blank">руководство по созданию SQL-отчетов (на английском языке).</a> </p>';
...
<p>Дополнительная инфоормация: <a href="http://docs.agpu.org/en/blocks/configurable_reports/" target="_blank">Документация (на английском языке)</a></p>';
...
$string['executeatinfo'] = 'Планировщик заданий agpu будет выполнять запланированные SQL-запросы в указанное время один раз в сутки.';
...
$string['listofsqlreports'] = 'Для переключения в полный экран редактирования нажмите клавишу F11 при нахождении курсора в редакторе. Для выхода из полного экрана редактирования используйте клавишу  Esc. <br/><br/> <a href="http://docs.agpu.org/en/ad-hoc_contributed_reports" target="_blank">Список доступных SQL-отчетов</a>';
...
$string['reportscapabilities_summary'] = 'Пользователи, имеющие право agpu/site:viewreports';
...
Если подключение к хранилищу не работает, Вы можете вручную скачать отчеты <a href="https://github.com/jleyva/agpu-configurable_reports_repository" target="_blank">здесь</a>, а затем импортировать их при помощи функции «Импорт отчета».';
$string['role'] = 'Роль';
