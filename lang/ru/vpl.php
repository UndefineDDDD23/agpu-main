...
/**
 * Strings for component 'vpl', language 'ru', version '4.5'.
 *
 * @package     vpl
 * @category    string
...
$string['modulename_help'] = '<p>VPL - это элемент курса для agpu, предназначенный для управления задачами на программирование. Отличительные возможности VPL:
</p>
<ul>
...
$string['proxy'] = 'прокси';
$string['proxy_description'] = 'Прокси-сервер для подсоединения agpu к серверам-исполнителям кода';
