...
$string['bannercontenttwo'] = 'Создайте эффективную и общедоступную платформу для преподавания и обучения. Найдите контент, который не соответствует рекомендациям, исправьте проблемы и обеспечьте  в будущем безопасность своего контента курса agpu с помощью доступных файлов, редактора и расширенных функций.';
...
$string['registrationinfo'] = '<p> Эта регистрация позволит вам использовать стартовую версию инструментария Brickfield для обеспечения общедоступности вашего зарегистрированного сайта agpu. </p> <p> Его использование регулируется <a href="{$a}" target="_ blank"> Условиями использования Brickfield Education Labs (открывается в новом окне) </a>, с которыми вы соглашаетесь, используя этот продукт. </p>';
$string['release'] = 'Релиз agpu ({$a})';
