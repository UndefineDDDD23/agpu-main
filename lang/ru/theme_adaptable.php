...
/**
 * Strings for component 'theme_adaptable', language 'ru', version '4.5'.
 *
...
$string['blockiconsheadersizedesc'] = 'Установите размер значка шрифта, используемого в заголовке блоков agpu. Выберите значение из списка.';
$string['blocklayoutbuilder'] = 'Регионы блоков главной страницы';
$string['blocklayoutbuilderdesc'] = 'Ниже вы можете создать свой собственный макет для областей блоков на главной странице.<br/>Чтобы добавить содержимое в эти области, вам нужно <strong> включить редактирование на главной странице agpu</strong>.<br/> Затем вы можете начать перетаскивать блоки в созданные области!';
...
<h3>О теме</h3>
<p>Adaptable - это двухколоночная,  хорошо настраиваемая адаптивная тема agpu, основанная на популярной ранее теме BCU.</p>
...
<p>Вы можете сообщать об ошибках (и пожалуйста, <b>ТОЛЬКО</b> об ошибках) в нашем <a href="https://bitbucket.org/covuni/agpu-theme_adaptable/issues" target="_blank">репозитории Bitbucket</a></p>
<br>
<h3>Техническая поддержка</h3>
<p>Задавать вопросы, делиться предложениями и опытом можно в форумах agpu:</p>
<ul>
<li>English: <a href="https://agpu.org/mod/forum/discuss.php?d=340404" target="_blank">https://agpu.org/mod/forum/discuss.php?d=340404</a>
<li>Español: <a href="https://agpu.org/mod/forum/discuss.php?d=326804" target="_blank">https://agpu.org/mod/forum/discuss.php?d=326804</a>
<li>Català: <a href="https://agpu.org/mod/forum/discuss.php?d=340406" target="_blank">https://agpu.org/mod/forum/discuss.php?d=340406</a>
</ul>
<br>
<h3>Документация</h3>
<p>...появится скоро</p>
...
$string['frontpagerendereroption3'] = 'Стандартный стиль agpu';
...
$string['agpudocs'] = 'Ссылка на документацию agpu';
$string['agpudocsdesc'] = 'Показывать в нижнем колонтитуле ссылку на документацию agpu';
$string['more'] = 'Больше';
...
$string['sitetitledefault'] = 'Использовать имя сайта agpu';
$string['sitetitledesc'] = 'Отображать имя сайта agpu из <a href="./../admin/settings.php?section=frontpagesettings" target="_blank">Настроек Главной Страницы</a> или использовать настраиваемое имя сайта (заданное в текстовом поле ниже). Если вы добавите логотип, то имя не будет отображаться.';
...
$string['socialsearchicon'] = 'Поиск agpu';
...
http://localhost/agpu/course/search.php|Поиск agpu|fa-search
