...
$string['enableautodiscovery_help'] = 'При включенном параметре ленты на веб-страницах будут найдены автоматически. Например, если вводится http://docs.agpu.org, то будет найдено http://docs.agpu.org/en/index.php?title=Special:RecentChanges&feed=rss';
