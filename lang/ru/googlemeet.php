...
$string['from'] = 'с';
$string['googlemeet:addinstance'] = 'Добавлять новый Google Meet™ для agpu';
...
$string['googlemeet:view'] = 'Просматривать содержимое Google Meet™ для agpu';
$string['hide'] = 'Скрыть';
...
$string['invalidissuerid'] = 'Служба OAuth, выбранная в настройках Google Meet™ for agpu не поддерживается Google';
...
$string['issuerid_desc'] = '<a href="https://github.com/ronefel/agpu-mod_googlemeet/wiki/How-to-create-Client-ID-and-Client-Secret" target="_blank">Как настроить службу OAuth</a>';
...
$string['modulename'] = 'Google Meet™ для agpu';
$string['modulename_help'] = 'Модуль «Google Meet™ для agpu» позволяет учителю создавать комнату Google Meet как ресурс в курсе и после мероприятий делать доступными для студентов записи, сохранённые на Google Диске. <p>©2018 Google LLC All rights reserved.<br/> Google Meet и  логотип Google Meet logo — зарегистрированные торговые марки Google LLC.</p>';
$string['modulenameplural'] = 'Экземпляры Google Meet™ для agpu';
...
$string['notifytask'] = 'Задача уведомления Google Meet™ для agpu';
$string['or'] = 'или';
$string['play'] = 'Воспроизвести';
$string['pluginadministration'] = 'Управление Google Meet™ для agpu';
$string['pluginname'] = 'Google Meet™ для agpu';
...
$string['sync_notloggedin'] = 'Войдите в Вашу учётную запись Google, чтобы синхронизировать записи Google Meet с agpu';
