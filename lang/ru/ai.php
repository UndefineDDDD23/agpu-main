...
$string['action_generate_text_instruction'] = 'Вы получите исходный текст от пользователя. Ваша задача — сгенерировать текст на основе его заявки. Следуйте этим важным инструкциям:
...
$string['noproviders'] = 'Это действие недоступно. Для этого действия не определены <a href="{$a}">поставщики</a>';
...
$string['placementsettings_desc'] = 'Эти настройки контролируют различные аспекты этого размещения ИИ.<br/> Они управляют тем, как размещение подключается к службе ИИ и связанными с этим операциями.';
...
$string['userpolicy'] = '<b>Добро пожаловать в новую функцию ИИ!</b>
<br>
Эта функция искусственного интеллекта (ИИ) основана исключительно на внешних больших языковых моделях (LLM - Large Language Models) для улучшения вашего опыта обучения и преподавания. Перед началом применения служб ИИ, пожалуйста, ознакомьтесь с политикой их использования.
<br>
<b>Точность контента, созданного ИИ</b>
<br>
ИИ может предоставлять полезные предложения и информацию, но его точность может меняться. Вам всегда следует дважды проверять предоставленную информацию, чтобы убедиться, что она точна, полна и подходит для вашей конкретной ситуации.
<br>
<b>Как обрабатываются ваши данные</b>
<br>
Эта функция ИИ предоставляется внешними сторонними LLM. Если вы решите использовать эту функцию, любые вводимые вами данные или персональные данные будут обрабатываться в соответствии с политикой конфиденциальности сторонней службы. Мы рекомендуем вам ознакомиться с политикой конфиденциальности LLM, чтобы понять, как будут обрабатываться ваши персональные данные.
Кроме того, на этом сайте может храниться запись вашего взаимодействия с функциями ИИ. Если у вас возникнут вопросы по этому поводу, обратитесь к своим учителям или управляющим учебным процессом.';
