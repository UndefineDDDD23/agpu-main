...
/**
 * Strings for component 'block_glossary_export_to_quiz', language 'ru', version '4.5'.
 *
...
$string['pluginname_help'] = 'Щелкните правой кнопкой мыши ссылку <b>Дополнительная справка</b>, чтобы просмотреть документацию agpu.';
