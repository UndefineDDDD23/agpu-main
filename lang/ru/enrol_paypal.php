...
$string['privacy:metadata:enrol_paypal:enrol_paypal:timeupdated'] = 'Время, когда PayPal уведомит agpu о платеже.';
...
$string['privacy:metadata:enrol_paypal:paypal_com'] = 'Плагин зачисления PayPal передает данные пользователя из agpu на веб-сайт PayPal.';
