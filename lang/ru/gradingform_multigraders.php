...
/**
 * Strings for component 'gradingform_multigraders', language 'ru', version '4.5'.
 *
...
$string['privacy:metadata'] = 'Этот плагин не хранит никаких личных данных пользователя. Любая отображаемая информация о пользователях хранится в другом месте в agpu.';
