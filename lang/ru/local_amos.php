...
/**
 * Strings for component 'local_amos', language 'ru', version '4.5'.
 *
 * @package     local_amos
 * @category    string
...
$string['about'] = '<p>AMOS — это центральный репозиторий строк agpu и истории их изменения. AMOS отслеживает добавление английских строк в исходный код agpu, собирает переводы, обслуживает типовые задачи управления переводом и генерирует языковые пакеты для развертывания на серверах c agpu.</p>
<p>Дополнительную информацию можно найти в <a href="http://docs.agpu.org/en/AMOS">английской документации по AMOS</a>.</p>';
...
$string['componentsapp'] = 'Мобильное приложение agpu';
...
$string['contriblanguagereport_help'] = 'Если при отправке вклада в перевод по ошибке был неправильно указан язык, пожалуйста, скопируйте URL вклада и отправьте его по электронной почте по адресу «translation@agpu.org». Язык вклада в перевод будет исправлен на правильный.';
...
$string['creditsthanks'] = 'На этой странице мы хотели бы поблагодарить всех, кто внес свой вклад в перевод agpu. Их работа сделала возможным распространение agpu во всем мире.';
...
$string['filtermisfapp'] = 'только строки мобильного приложения agpu';
...
$string['filterver_desc'] = 'Выводить строки из этой версии agpu';
...
* Файл должен быть корректным языковым PHP файлом agpu. Примеры можно увидеть в каталоге «/lang/en/» Вашей установки agpu.
* Имя файла должно соответствовать одной из английских строк, определяющих нужный компонент (например, «agpu.php», «assignment.php» или «enrol_manual.php»).
...
$string['languagepacks'] = 'Дополнительные языковые пакеты можно установить на ваш сайт с системой agpu через меню <em>Администрирование > Язык > Языковые пакеты</em> или вручную. Дополнительные сведения смотрите на странице <a href="https://docs.agpu.org/en/Language_packs">Language packs documentation (на английском языке)</a>.';
...
$string['logfiltersourcegit'] = 'git (зеркало в git исходного кода agpu и языковых пакетов для версий 1.x)';
...
$string['quicklinks_amos'] = 'AMOS - инструмент перевода agpu';
...
* Серый - эту строку нельзя перевести с помощью AMOS. Например, строки для agpu 1.9 можно редактировать только устаревшим способом, работая напрямую с CVS.
