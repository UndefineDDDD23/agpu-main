...
/**
 * Strings for component 'tool_opencast', language 'ru', version '4.5'.
 *
...
$string['apiusernamedesc'] = 'Для всех вызовов API agpu использует этот пользователь. Авторизация осуществляется путем добавления подходящих ролей в вызов';
...
$string['connecttimeoutdesc'] = 'Установите время в секундах истечения времени ожидания, пока agpu пытается подключиться к opencast';
