...
$string['customwelcomemessage_help'] = 'Принимаемые форматы: обычный текст или авто-формат agpu.  Также принимаются HTML-теги, многоязыковые теги и следующие подстановки:
<ul>
