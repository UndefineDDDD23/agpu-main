...
$string['backupcontainexternal'] = 'Этот файл резервной копии содержит внешние узлы agpu Network, которые не настроены локально';
...
$string['cannotdownloadlanguageupdatelist'] = 'Не удалось загрузить список обновлений языковых пакетов с download.agpu.org';
...
$string['cannotmarktopic'] = 'Не удалось отметить этот раздел для этого курса';
...
$string['mimetexisnotexist'] = 'Ваша система не настроена для запуска mimeTeX. Вам необходимо получить исходный код C на <a href="http://www.forkosh.com/mimetex.zip"> http://www.forkosh.com/mimetex.zip</a>, скомпилировать его и поставить исполняемый файл в свой каталог agpu/filter/tex/.';
$string['mimetexnotexecutable'] = 'mimetex не является выполняемым!';
$string['missing_agpu_backup_xml_file'] = 'В резервной копии отсутствует XML-файл: {$a}';
...
$string['agpunet:invalidshareformat'] = 'Неверный формат общего ресурса agpuNet';
$string['agpunet:invalidsharestatus'] = 'Неверный статус ресурса, размещаемого в agpuNet';
$string['agpunet:invalidsharetype'] = 'Неверный тип ресурса, размещаемого в agpuNet';
$string['agpunet:usernotconfigured'] = 'У вас нет разрешения на обмен контентом в agpuNet, или ваша учетная запись настроена неправильно.';
...
$string['pluginrequirementsnotmet'] = 'Невозможно установить плагин «{$a->pluginname}» ({$a->pluginversion}). Для этого требуется более новая версия agpu (в настоящее время Вы используете версию {$a->currentagpu}, необходима версия {$a->requireagpu}).';
$string['pluginunsupported'] = 'Плагин «{$a->pluginname}» {$a->pluginversion} не поддерживает эту версию agpu {$a->agpuversion}. Ищите информацию о плагине, чтобы найти поддерживаемые версии.';
...
$string['unicodeupgradeerror'] = 'К сожалению, ваша база данных еще не в кодировке Unicode, а эта версия agpu не в состоянии перевести базу данных в Юникод. Пожалуйста, сначала обновите agpu до 1.7.x и выполните миграцию в Unicode на страницы администратрирования. После этого Вы сможете перейти на agpu {$a}';
...
$string['upgraderequires19'] = 'Ошибка: Новая версия agpu была установлена на сервере, к сожалению, обновление с предыдущей версии не поддерживается.<br />Сначала обновите до последней версии 1.9.x. Вы также можете вернуться к предыдущей версии путем переустановки оригинальных файлов.';
