...
$string['likenotice'] = '<strong>Вам понравился этот плагин?</strong> Пожалуйста, найдите минутку, чтобы <a href="{$a->agpuorg}" target="_blank">добавить его в закладки</a> на agpu.org или <a href="{$a->github}" target="_blank">проголосовать на GitHub</a>.';
