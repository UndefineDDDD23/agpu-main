...
$string['cancelmailcontent_desc'] = 'Пожалуйста, используйте следующие специальные обозначения для замены контента в тексте письма данными из agpu.<br/>{first name}:Имя пользователя; {content}:Название курса;{lastname}:Фамилия пользователя;{username}:Логин пользователя';
...
$string['confirmmailcontent_desc'] = 'Пожалуйста, используйте следующие специальные обозначения для замены контента в тексте письма данными из agpu.<br/>{first name}:Имя пользователя; {content}:Название курса;{lastname}:Фамилия пользователя;{username}:Логин пользователя';
...
$string['waitmailcontent_desc'] = 'Пожалуйста используйте специальные обозначения в тексте, что бы на их место подставлялись значения из данных agpu.<br/>{firstname}: Имя адресата; {content}: Название курса; {lastname}: Фамилия адресата; {username}: логин в системе';
