...
Функция работает, только если сервер agpu доступен для BigBlueButton.';
...
$string['view_warning_default_server'] = 'Этот сайт использует <a href="https://bigbluebutton.org/free-bigbluebutton-service-for-agpu/" target="_blank">бесплатный сервис BigBlueButton для agpu (открывается в новом окне)</a>, предоставляемый Blindside Networks со следующими ограничениями:
<ol>
