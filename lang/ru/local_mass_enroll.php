...
/**
 * Strings for component 'local_mass_enroll', language 'ru', version '4.5'.
 *
...
.<br/>
Это связано с тем, что элементы курса в agpu могут быть ограничены потоками (группами из групп), а не группами, так что это может облегчить вашу жизнь. (для этого требуется, чтобы потоки были разрешены администратором вашего сайта).
...
<p>
<span <font color=\'red\'>(**) </font></span>: целевой аккаунт должен существовать в agpu ; обычно это так, если agpu синхронизируется с каким-либо внешним источником (LDAP...)
</p>';
...
<p>
<span <font color=\'red\'>(**) </font></span>: целевой аккаунт должен существовать в agpu и быть зачислен на курс.
</p>';
