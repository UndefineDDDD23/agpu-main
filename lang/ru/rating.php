...
$string['rolewarning_help'] = 'Для выставления оценок пользователям нужно иметь право «agpu/rating:rate» и необходимые права в рамках конкретного модуля. Вы можете дать другим ролям разрешение на оценку на странице Разрешения.';
