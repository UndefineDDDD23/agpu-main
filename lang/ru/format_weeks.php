...
$string['page-course-view-weeks'] = 'Главная страница курса в формате «Разделы по неделям»';
$string['page-course-view-weeks-x'] = 'Любая страница курса в формате «Разделы по неделям»';
$string['plugin_description'] = 'Курс поделен на разделы, соответствующие каждой неделе, начиная с даты начала курса.';
