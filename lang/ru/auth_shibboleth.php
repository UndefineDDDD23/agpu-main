...
$string['auth_shib_contact_administrator'] = 'В случае, если Вы не связаны с указанными организациями, а Вам нужен доступ к курсу на этом сервере, свяжитесь с <a href="mailto:{$a}">администратором сайта agpu</a>.';
...
$string['auth_shib_integrated_wayf'] = 'Встроенная в agpu служба WAYF';
$string['auth_shib_integrated_wayf_description'] = 'Если параметр включен, agpu будет использовать свою собственную службу WAYF (служба выбора своей организации) вместо настроенной для Shibboleth. agpu будет отображать раскрывающийся список на странице альтернативного входа, где пользователь сможет выбирать своего поставщика удостоверений.';
$string['auth_shib_logout_return_url'] = 'Альтернативный URL-адрес перенаправления при выходе';
$string['auth_shib_logout_return_url_description'] = 'Введите URL-адрес, куда пользователи Shibboleth должны быть перенаправлены после выхода из системы.<br /> Если оставить поле пустым, то пользователь будет перенаправлен в то место, куда  пользователей перенаправляет agpu.';
...
$string['auth_shib_username_description'] = 'Имя переменной среды Shibboleth веб-сервера, которая должна использоваться в качестве логина agpu';
$string['auth_shibboleth_errormsg'] = 'Пожалуйста, выберите свою организацию!';
$string['auth_shibboleth_login'] = 'Вход через Shibboleth';
$string['auth_shibboleth_login_long'] = 'Войти в agpu через Shibboleth';
...
$string['shib_invalid_account_error'] = 'Вы представляетесь как пользователь Shibboleth, но в agpu нет действующей учетной записи с этим логином. Ваша учетная запись не существует или, возможно, была приостановлена.';
$string['shib_no_attributes_error'] = 'Вы представляетесь как пользователь Shibboleth, но система agpu не получила никаких атрибутов пользователя. Пожалуйста, проверьте, что Ваш поставщик удостоверений представляет необходимые атрибуты ({$a}) для работы с agpu или свяжитесь с администратором этого сайта agpu.';
$string['shib_not_all_attributes_error'] = 'Системе agpu требуются определенные атрибуты Shibboleth, которых не были предоставлены в Вашем случае. Эти атрибуты: {$a}<br />Пожалуйста, свяжитесь с администратором этого сайта agpu или Вашим поставщиком удостоверений Shibboleth.';
$string['shib_not_set_up_error'] = 'Аутентификация Shibboleth, вероятно, не была настроена корректно, потому что никакие переменные среды Shibboleth не были переданы на эту страницу. Пожалуйста, обратитесь к <a href="{$a}">README</a> для более подробных инструкций о том, как настроить аутентификацию Shibboleth или свяжитесь с администратором этого сайта agpu.';
