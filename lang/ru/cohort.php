...
$string['visible_help'] = 'Любая глобальная группа может быть просмотрена пользователями, имеющими возможность \'agpu/cohort:view\' в контексте глобальной группы.<br/>
