...
/**
 * Strings for component 'block_quickmail', language 'ru', version '4.5'.
 *
...
<p>Это письмо используется для проверки, что этот адрес существует, и владелец этого адреса имеет соответствующие полномочия в agpu. </p>
