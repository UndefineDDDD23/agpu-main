...
/**
 * Strings for component 'local_agpumobileapp', language 'ru', version '4.5'.
 *
 * @package     local_agpumobileapp
 * @category    string
...
$string['appstoredescription'] = 'ПРИМЕЧАНИЕ: Это официальное приложение agpu Mobile будет работать ТОЛЬКО с сайтами agpu, в которых настроено соответствующее разрешение. Если у вас есть проблемы с подключением, обратитесь, пожалуйста, к вашему администратору agpu.

Если ваш сайт agpu правильно настроен, то вы можете использовать это приложение для того, чтобы:
...
Чтобы получить самую свежую информацию, пожалуйста посетите http://docs.agpu.org/en/Mobile_app.
...
Запись аудио - Для записи аудио для загрузки на agpu
Чтение и изменение содержимого вашей SD карты - Содержимое загружается на SD карту для просмотра в автономном режиме
Доступ к сети - Чтобы иметь возможность подключиться к вашему сайту agpu  и проверить, подключены ли вы и переключиться в автономный режим в противном случае
...
$string['core.login.connecttoagpu'] = 'Подключение к agpu';
...
$string['core.login.erroraccesscontrolalloworigin'] = 'Запрос «Cross-Origin», который вы пытаетесь выполнить, отклонён. Пожалуйста, проверьте https://docs.agpu.org/dev/agpu_Mobile_development_using_Chrome_or_Chromium';
...
$string['core.login.invalidagpuversion'] = 'Устаревшая версия agpu. Минимальная требуемая версия - {{$a}} или новее.';
...
$string['core.login.siteurlrequired'] = 'Требуется URL-адрес сайта, напр. <i>http://www.youragpusite.org</i>';
...
$string['pluginname'] = 'Строки языка «agpu Mobile»';
