...
$string['check_themedesignermode_details'] = 'Это часто является причиной медленной работы сайтов agpu. <p> Включение режима дизайнера темы может в среднем в два раза увеличить нагрузку процессора. </p>';
