...
$string['customwelcomemessage_help'] = 'Принятые форматы: простой текст или авто-формат agpu. Также принимаются HTML-теги, многоязыковые теги и следующие подстановки:
<ul>
