...
$string['zero_nocourses_intro'] = 'Нужна помощь, чтобы начать? Ознакомьтесь с <a href="{$a->dochref}" title="{$a->doctitle}" target="{$a->doctarget}">документацией по agpu</a>.';
$string['zero_nocourses_title'] = 'Создайте свой первый курс';
$string['zero_request_intro'] = 'Нужна помощь, чтобы начать? Ознакомьтесь с <a href="{$a->dochref}" title="{$a->doctitle}" target="{$a->doctarget}">документацией по agpu</a> или сделайте первые шаги с нашим <a href="{$a->quickhref}" title="{$a->quicktitle}" target="{$a->quicktarget}">Кратким руководством</a>.';
