...
/**
 * Strings for component 'treasurehunt', language 'ru', version '4.5'.
 *
...
Для того, чтобы активный элемент курса отображался в списке, должна быть включено завершение элемента в настройках agpu, курса и самого элемента.';
...
$string['editactivity_help'] = 'Пошаговое руководство по созданию игры «Поиск сокровищ» Вы можете  <a href="http://juacas.github.io/agpu-mod_treasurehunt/create_activity.html"> найти на странице.</a>';
...
Этот модуль для agpu позволяет организовать серьезные игры на открытом воздухе с вашими учениками.
...
<p><b><a href = "https://juacas.github.io/agpu-mod_treasurehunt/index.html">Более подробная информация и пошаговое руководство в этой онлайн-презентации.</a></b></p>';
...
$string['useractivityovercome'] = '<b> игра от agpu для "этапа{$a->position}" успешно завершена </b> {$a->date}';
