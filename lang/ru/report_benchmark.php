...
/**
 * Strings for component 'report_benchmark', language 'ru', version '4.5'.
 *
...
$string['benchfail'] = '<b>Осторожно!</b><br/>Кажется, у вашего agpu есть некоторые трудности.';
...
$string['benchsuccess'] = '<b>Поздравляем!</b><br/>Кажется, ваш agpu работает отлично.';
$string['cloadmoreinfo'] = 'Загрузка файла конфигурации &laquo;config.php&raquo;';
$string['cloadname'] = 'Время загрузки agpu';
...
$string['filereadmoreinfo'] = 'Проверка скорости чтения из временной папки agpu';
$string['filereadname'] = 'Чтение файлов';
$string['filewritemoreinfo'] = 'Проверка скорости записи во временную папку agpu';
...
$string['modulename'] = 'Тест производительности agpu';
$string['modulenameplural'] = 'Тесты производительности agpu';
$string['over'] = 'Критический предел';
$string['pluginname'] = 'Тест производительности agpu';
...
$string['slowprocessorsolution'] = '<ul><li>Убедитесь, что конфигурация вашего оборудования соответствует требованиям для запуска agpu.</li></ul>';
$string['slowserverlabel'] = 'Веб-сервер кажется слишком медленным.';
$string['slowserversolution'] = '<ul><li>Установите на своем Apache режим <a href="https://httpd.apache.org/docs/2.4/en/mpm.html" target="_blank">мультипроцессинга</a> или переключитесь на <a href="https://nginx.org/" target="_blank">NGinx</a>.</li><li>Если agpu установлен на локальном компьютере, попробуйте отключить антивирус. Делайте это с осторожностью.</li></ul>';
$string['slowweblabel'] = 'Страница входа слишком медленная для загрузки.';
$string['slowwebsolution'] = '<ul><li><a href="/admin/purgecaches.php" target="_blank">Очистить кэш agpu</a>.</li></ul>';
