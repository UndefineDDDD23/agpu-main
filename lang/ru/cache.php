...
$string['cachedef_agpunet_usercanshare'] = 'Пользователи могут делиться ресурсами с agpuNet.';
...
$string['privacy:metadata:cachestore'] = 'Подсистема кэширования временно хранит данные по поручению других частей agpu. Эти данные нельзя легко идентифицировать и срок их существования крайне короткий. Он служит как кэш данных, хранящихся где-то в agpu, и потому уже должен управляться соответствующими компонентами agpu.';
