...
/**
 * Strings for component 'theme_essential', language 'ru', version '4.5'.
 *
...
$string['advert_tagline'] = 'Хотите знать, как настроить темы, но не сильны в сфере разработки, нет опыта работы с php и с темами agpu? Тогда "agpubites Theme Design. 1-й уровень" для Вас! Вы получите введение в разработку темы agpu. Вы получите хорошую базу для дальнейшего развития при желании. Нажмите здесь для получения дополнительной информации';
...
$string['androiddesc'] = 'Введите URL своего мобильного приложения в магазине Google Play. Если у Вас нет своего приложения, то Вы можете ввести в это поле ссылку на официальное мобильное приложение agpu (https://play.google.com/store/apps/details?id=com.agpu.agpumobile).';
...
<p>Essential основана на теме Bootstrap, которая была создана для agpu 2.5 с помощью:<br>
...
<h4>PayPal</h4>
<p>Пожалуйста, свяжитесь со мной через мой <a href="http://agpu.org/user/profile.php?id=442195" target="_blank">профиль в agpu</a> для получения подробностей, так как я — частное лицо и потому по  правилам PayPal не могу размещать кнопки \'buy me now\'.</p>
<h4>Flattr</h4>
...
$string['fontheadingdesc'] = 'Выберите и введите шрифты, которые Вы хотите использовать в своей среде agpu.';
...
$string['frontpageblocksdesc'] = 'Здесь вы можете указать, должны ли стандартные блоки agpu на главной странице выравниваться до или после контента.';
...
$string['iosdesc'] = 'Введите адрес своего мобильного приложения в магазине App Store. Если у Вас нет своего приложения, Вы можете ввести в это поле ссылку на официальное мобильное приложение agpu (https://itunes.apple.com/en/app/agpu-mobile/id633359593).';
...
$string['layoutdesc'] = 'Эта тема создана для размещения обоих колонок блоков с одной стороны. Если Вы предпочитаете стандартную раскладку agpu, то можете включить этот параметр и вернуться к привычному старому виду в три колонки.';
$string['left'] = 'Слева';
...
$string['paypal_click'] = 'профиль в agpu';
...
$string['styleguidedesc'] = 'Оригинальный код документации лицензирован по лицензии «{$a->origcodelicenseurl}».  Holder.js лицензирован по лицензии «{$a->holderlicenseurl}» .  Дополнительный код  лицензирован по лицензии «{$a->thiscodelicenseurl}», которая является «{$a->compatible}» лицензией.  Контент лицензирован по лицензии «{$a->contentlicenseurl}». Документация была отформатирована для показа в agpu с добавлением в нужных местах значков FontAwesome.  Дополнительный CSS можно найти в файле «essential_admin_setting_styleguide.php» после комментария «// Beyond docs.css.». Раздел «{$a->globalsettings}» был удален.';
...
$string['themecolordesc'] = 'Основной цвет темы. Это изменит цвет многих компонентов, для создания желаемого цвета на вашем сайте agpu.';
...
$string['versionalerttext1'] = 'Тема предназначена для другой версии agpu.';
$string['versionalerttext2'] = 'Могут наблюдаться непредвиденные проблемы. Используйте версию темы, подходящую для вашей версии agpu.';
...
$string['windowsdesc'] = 'Введите URL-адрес своего мобильного приложения в Windows Store. Если у Вас нет своего приложения, то Вы можете ввести в это поле ссылку на официальное мобильное приложение agpu (http://apps.microsoft.com/windows/en-us/app/9df51338-015c-41b7-8a85-db2fdfb870bc).';
$string['windowsurl'] = 'URL-адрес Windows (для ПК)';
$string['winphone'] = 'Windows (для мобильных устройств)';
$string['winphonedesc'] = 'Введите URL-адрес своего мобильного приложения в магазине Windows Phone Store. Если у Вас нет своего приложения, то Вы можете ввести в это поле ссылку на официальное мобильное приложение agpu (http://www.windowsphone.com/en-us/store/app/agpumobile/d0732b88-3c6d-4127-8f24-3fca2452a4dc).';
