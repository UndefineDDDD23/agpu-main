...
$string['authconfirm'] = 'Это действие предоставит постоянный доступ API к agpu для аутентифицированной учетной записи. Это предназначено для использования в качестве системной учетной записи для управления файлами, принадлежащими agpu.';
...
$string['userfieldinternalfield_help'] = 'Имя поля пользователя agpu, которое должно отображаться из внешнего поля.';
