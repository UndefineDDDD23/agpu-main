...
/**
 * Strings for component 'enrol_autoenrol', language 'ru', version '4.5'.
 *
...
$string['customwelcomemessage_help'] = 'Настраиваемое приветственное сообщение может быть добавлено как текст или авто-формат agpu и содержать в себе теги HTML и многоязычные теги.
...
$string['warning_message'] = 'Добавление этого плагина в курс позволит любым зарегистрированным пользователям agpu получить доступ к вашему курсу. Добавляйте этот способ записи только если вы хотите открыть доступ к вашему курсу для всех пользователей agpu.';
