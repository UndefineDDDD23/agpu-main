...
$string['mobilesettings_help'] = 'Эти настройки управляют поведением мобильного приложения agpu';
...
<td>Данные о посещаемости</td>
<td>Временный пользователь заменит пользователя agpu</td>
</tr>
<tr>
<td>Нет данных о посещаемости</td>
<td>Данные о посещаемости</td>
<td>Посещаемость временного пользователя будет передана пользователю agpu</td>
</tr>
<tr>
<td>Данные о посещаемости</td>
<td>Нет данных о посещаемости</td>
...
$string['userimportto'] = 'Поле пользователя в agpu';
$string['userimportto_help'] = 'Поле agpu, которое соответствует данным из экспортированного CSV';
