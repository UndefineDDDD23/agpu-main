...
/**
 * Strings for component 'block_people', language 'ru', version '4.5'.
 *
...
$string['privacy:metadata'] = 'Плагин «Люди» предоставляет расширенные функциональные возможности пользователям agpu, но не хранит никаких личных данных.';
