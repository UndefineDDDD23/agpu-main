...
$string['installfromrepo'] = 'Установить плагины из каталога плагинов agpu (agpu Plugins Directory)';
$string['installfromrepo_help'] = 'Вы будете перенаправлены в каталог плагинов agpu (agpu Plugins Directory) для поиска и установки плагина. Обратите внимание, что при этом будут переданы полное имя, URL-адрес и версия системы agpu, установленной на Вашем сайте; это упрощает процесс установки плагинов.';
$string['installfromzip'] = 'Установить плагин из ZIP-файла';
$string['installfromzip_help'] = 'В качестве альтернативы установке плагина непосредственно из каталога плагинов agpu можно загрузить плагин в виде ZIP-пакета. ZIP-пакет должен иметь такую же структуру, как и пакет, скачанный из каталога плагинов agpu.';
$string['installfromzipfile'] = 'ZIP-пакет';
$string['installfromzipfile_help'] = 'ZIP-пакет с плагином должен содержать только один каталог, имя которого должно совпадать с названием плагина. Архив будет извлечен в каталог, предназначенный для плагинов указанного типа. Если архив был загружен из каталога плагинов agpu, он точно имеет необходимую структуру.';
...
$string['remoterequestalreadyinstalled'] = 'Есть запрос на установку на этом сайте плагина «{$a->name}» ({$a->component}) версии {$a->version} из каталога плагинов agpu. Однако, этот плагин <strong>уже установлен</strong> на этом сайте.';
$string['remoterequestconfirm'] = 'Есть запрос на установку на этом сайте плагина «<strong>{$a->name}</strong>» ({$a->component}) версии {$a->version} из каталога плагинов agpu. Если Вы нажмете «Продолжить», ZIP-пакет с плагином будет скачан для проверки. На этом этапе ничего не будет устанавливаться.';
$string['remoterequestinvalid'] = 'Есть запрос на установку на этом сайте плагина из каталога плагинов agpu. К сожалению, этот запрос был некорретным и плагин не может быть установлен.';
$string['remoterequestnoninstallable'] = 'Есть запрос на установку плагина «{$a->name}» ({$a->component}) версии {$a->version} из каталога плагинов agpu на этот сайт. Однако, предварительная проверка установки плагина завершилась с ошибкой (код причины: {$a->reason}).';
$string['remoterequestpermcheck'] = 'Есть запрос на установку на этом сайте плагина «{$a->name}» ({$a->component}) версии {$a->version} из каталога плагинов agpu. Однако, каталог <strong>{$a->typepath}</strong>, предназначенный для плагинов этого типа, не доступен для записи. Вы должны дать доступ на запись в этот каталог пользователю, от имени которого запускается веб-сервер, и нажать кнопку «Продолжить», чтобы повторить проверку.';
