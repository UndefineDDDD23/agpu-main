...
$string['path_help'] = 'Каталог, в который будут сохраняться файлы, используемые этим хранилищем кэша. Здесь можно указать каталог на более производительном диске (например, созданном в памяти). Если оставить поле пустым (по умолчанию), то каталог будет автоматически создан в каталоге agpudata.';
