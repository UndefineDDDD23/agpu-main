...
$string['newcourseenddate'] = 'Новое поле даты окончания курса';
$string['newcourseenddate_desc'] = 'Необязательно. Если не задано, то дата окончания курса будет связана с настроенной по умолчанию продолжительностью курса. Если задано, то значение шаблона будет переопределено.';
...
$string['newcoursestartdate'] = 'Новое поле даты начала курса';
$string['newcoursestartdate_desc'] = 'Необязательно. Если не задано, то дата начала курса будет установлена на текущую дату. Если задано, то значение шаблона будет переопределено.';
