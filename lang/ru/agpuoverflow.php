...
/**
 * Strings for component 'agpuoverflow', language 'ru', version '4.5'.
 *
 * @package     agpuoverflow
 * @category    string
...
$string['configforcedreadtracking'] = 'Разрешить настроить agpuoverflows на принудительное отслеживание информации о чтении. Это приведет к снижению эффективности в работе форума, особенно на курсах с большим количеством форумов и сообщений. Когда этот параметр выключен, во всех форумах, ранее настроенных на принудительное отслеживание чтения, эта настройка  рассматривается как необязательная.';
...
$string['configtrackagpuoverflow'] = 'Установите «Да», если вы хотите отслеживать прочитано/непрочитано для каждого пользователя.';
...
$string['confirmsubscribediscussion'] = 'Вы действительно хотите подписаться на обсуждение «{$a->discussion}» на форуме «{$a->agpuoverflow}» ?';
$string['confirmunsubscribe'] = 'Вы действительно хотите отписаться от форума «{$a}»?';
$string['confirmunsubscribediscussion'] = 'Вы действительно хотите отписаться от обсуждения  «{$a->discussion}»  в форуме «{$а->agpuoverflow}»?';
...
$string['coursewidereputation_help'] = 'Если задано «Да», то репутация пользователей во всех форумах agpuoverflow в рамках данного курса будет суммироваться.';
$string['crontask'] = 'agpuoverflow находится в разработке';
...
$string['discussionnownotsubscribed'] = '{$a->name} не будет получать уведомления о новых сообщениях в обсуждении «{$a->discussion}» из форума «{$a->agpuoverflow}».';
$string['discussionnowsubscribed'] = '{$a->name} будет получать уведомления о новых сообщениях в обсуждении «{$a->discussion}» из форума «{$a->agpuoverflow}».';
...
$string['generalagpuoverflows'] = 'Форумы в этом курсе';
...
$string['hiddenagpuoverflowpost'] = 'Скрытый пост на форуме';
...
$string['invalidagpuoverflowid'] = 'Неверный ID форума';
...
$string['markagpuoverflowreadsuccessful'] = 'Все сообщения были отмечены как прочитанные.';
...
$string['modulename_help'] = 'Модуль agpuoverflow позволяет участникам использовать структуру форума "вопрос-ответ". Отображение форума не является хронологическим, так как порядок зависит от голосов, а не от времени.';
$string['agpuoverflow:addinstance'] = 'Добавлять новый экземпляр agpuoverflow';
$string['agpuoverflow:allowforcesubscribe'] = 'Назначать принудительную подписку';
$string['agpuoverflow:createattachment'] = 'Создавать вложения';
$string['agpuoverflowauthorhidden'] = 'Автор (скрыт)';
$string['agpuoverflowbodyhidden'] = 'Это сообщение не может быть просмотрено. Возможные причины: вы не разместили его в обсуждении; еще не прошло максимальное время редактирования; обсуждение не началось или уже закончилось.';
$string['privacy:metadata:core_files'] = 'agpuoverflow хранит файлы, которые были загружены пользователем, чтобы сформировать часть сообщения на форуме.';
$string['privacy:metadata:agpuoverflow_discuss_subs'] = 'Информация о подписках на отдельные обсуждения на форуме. Включает в себя данные о том, когда пользователь решил подписаться на обсуждение или отписаться от того, на которое он иначе был бы подписан.';
$string['privacy:metadata:agpuoverflow_discuss_subs:discussion'] = 'Код обсуждения, на которое пользователь подписался или отписался.';
$string['privacy:metadata:agpuoverflow_discuss_subs:preference'] = 'Время начала подписки.';
$string['privacy:metadata:agpuoverflow_discuss_subs:userid'] = 'Код пользователя, который изменил настройки подписки.';
$string['privacy:metadata:agpuoverflow_discussions'] = 'Информация об обсуждениях на форуме. Включает в себя обсуждения, которые пользователь начал.';
$string['privacy:metadata:agpuoverflow_discussions:name'] = 'Название обсуждения.';
$string['privacy:metadata:agpuoverflow_discussions:timemodified'] = 'Время, когда обсуждение (например, сообщение) было изменено в последний раз.';
$string['privacy:metadata:agpuoverflow_discussions:userid'] = 'Код пользователя, который создал обсуждение.';
$string['privacy:metadata:agpuoverflow_discussions:usermodified'] = 'Код пользователя, который последним изменил обсуждение';
$string['privacy:metadata:agpuoverflow_posts'] = 'Информация о сообщениях на форуме. Включает в себя сведения о сообщениях, написанных пользователем.';
$string['privacy:metadata:agpuoverflow_posts:created'] = 'Дата создания этого сообщения.';
$string['privacy:metadata:agpuoverflow_posts:discussion'] = 'Код обсуждения, к которому это сообщение относится.';
$string['privacy:metadata:agpuoverflow_posts:message'] = 'Текст данного сообщения.';
$string['privacy:metadata:agpuoverflow_posts:modified'] = 'Последняя дата, когда это сообщение было изменено.';
$string['privacy:metadata:agpuoverflow_posts:parent'] = 'Код обсуждения, к которому относится сообщение с оценкой.';
$string['privacy:metadata:agpuoverflow_posts:userid'] = 'Код пользователя, который отправил это сообщение.';
$string['privacy:metadata:agpuoverflow_ratings'] = 'Информация об оценках сообщений. Включает в себя информацию о том, когда пользователь оценил сообщение и его конкретную оценку.';
$string['privacy:metadata:agpuoverflow_ratings:discussionid'] = 'Код обсуждения, к которому относится сообщение с оценкой.';
$string['privacy:metadata:agpuoverflow_ratings:firstrated'] = 'Дата, когда оценка была представлена.';
$string['privacy:metadata:agpuoverflow_ratings:lastchanged'] = 'Дата, когда оценка была изменена в последний раз.';
$string['privacy:metadata:agpuoverflow_ratings:agpuoverflowid'] = 'Код форума agpuoverflow, который содержит сообщение с оценкой.';
$string['privacy:metadata:agpuoverflow_ratings:postid'] = 'Код сообщения, которое было оценено.';
$string['privacy:metadata:agpuoverflow_ratings:rating'] = 'Представленная оценка. 0 = нейтрально, 1 = отрицательно, 2 = положительно, 3 = полезно, 4 = решение';
$string['privacy:metadata:agpuoverflow_ratings:userid'] = 'Код пользователя, представившего оценку.';
$string['privacy:metadata:agpuoverflow_read'] = 'Информация об отслеживании прочтения сообщений. Включает в себя информацию о том, когда сообщения были прочитаны пользователем.';
$string['privacy:metadata:agpuoverflow_read:discussionid'] = 'Код обсуждения, которому принадлежит прочитанное сообщение,';
$string['privacy:metadata:agpuoverflow_read:firstread'] = 'Дата, когда сообщение было прочитано в первый раз.';
$string['privacy:metadata:agpuoverflow_read:lastread'] = 'Дата, когда сообщение было прочитано пользователем в последний раз.';
$string['privacy:metadata:agpuoverflow_read:postid'] = 'Код сообщения, которое было прочитано.';
$string['privacy:metadata:agpuoverflow_read:userid'] = 'Код пользователя, который прочитал сообщение.';
$string['privacy:metadata:agpuoverflow_subscriptions'] = 'Информация о подписках на форумы. Включает в себя информацию о том, на какие форумы подписался пользователь.';
$string['privacy:metadata:agpuoverflow_subscriptions:agpuoverflow'] = 'Код форума agpuoverflow, на который подписан пользователь.';
$string['privacy:metadata:agpuoverflow_subscriptions:userid'] = 'Код пользователя, подписавшегося на форум.';
$string['privacy:metadata:agpuoverflow_tracking'] = 'Информация об отслеживании форумов. Включает в себя информацию о том, какие форумы пользователь не отслеживает.';
$string['privacy:metadata:agpuoverflow_tracking:agpuoverflowid'] = 'Код форума agpuoverflow, который не отслеживается пользователем.';
$string['privacy:metadata:agpuoverflow_tracking:userid'] = 'Код пользователя, который не отслеживает форум.';
...
$string['smallmessage'] = 'Пользователем {$a->user} размещено сообщение в {$a->agpuoverflowname}';
...
$string['taskcleanreadrecords'] = 'Работа по техническому обслуживанию agpuoverflow для очистки старых прочитанных записей';
$string['tasksendmails'] = 'Работа по техническому обслуживанию agpuoverflow для отправки почты';
$string['taskupdategrades'] = 'Работа по техническому обслуживанию agpuoverflow для обновления оценок';
...
$string['trackagpuoverflow'] = 'Отслеживать непрочитанные сообщения';
