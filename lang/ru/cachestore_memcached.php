...
Версия PHP расширения Memcached, которую Вы сейчас используете, не дает возможности agpu убедиться в том, что кэш изолирован (sandboxed cache). До момента обновления мы рекомендуем не настраивать другие приложения на использование тех же серверов Memcached, которые использует agpu.';
