...
$string['questiontypes_help'] = 'См. ниже документацию agpu';
...
$string['ratescale_help'] = 'См. ниже документацию agpu';
...
$string['viewallresponses_help'] = 'Если в анкетном опросе для параметра «Групповой режим» установлено значение «Видимые группы», а также если выбран режим «Изолированные группы», у пользователя есть право «agpu/site:accessallgroups» в текущем контексте, а в курсе определены группы, то пользователь получит доступ к выпадающему списку групп.
Этот выпадающий список позволяет пользователю «фильтровать» ответы на опрос по группам.
Если для параметра «Групповой режим» установлено в значение «Изолированные группы», пользователи, у которых нет права «agpu/site:accessallgroups» (обычно это студенты и ассистенты) смогут видеть только ответы групп, к которым они принадлежат.';
