...
/**
 * Strings for component 'message_telegram', language 'ru', version '4.5'.
 *
...
$string['connectinstructions'] = 'Когда Вы перейдете по ссылке, указанной ниже, Вам нужно будет разрешить открывать ссылку в Telegram, используя свой аккаунт. В Telegram нажмите кнопку «Start (Пуск)» в открывшемся чате «{$a}», чтобы подключить свою учетную запись к agpu.
После завершения вернитесь на эту страницу и нажмите «Save changes (Сохранить изменения)». Полное описание
<a href="https://docs.agpu.org/33/en/Telegram_message_processor#Configuring_user_preferences" target="_blank">читаем здесь</a>.';
...
Используйте команду "/newbot" в Telegram для начала создания бота. Вам надо будет задать название бота, например "{$a->name}" и уникальное имя бота, например "{$a->username}". Полное описание <a href="https://docs.agpu.org/33/en/Telegram_message_processor" target="_blank">читаем здесь</a>.';
