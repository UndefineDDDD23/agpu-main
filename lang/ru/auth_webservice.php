...
$string['auth_webservicedescription'] = 'Этот способ аутентификации должен использоваться только для тех учетных записей, которые используются клиентами веб-служб agpu';
