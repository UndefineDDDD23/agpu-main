...
/**
 * Strings for component 'local_ldap', language 'ru', version '4.5'.
 *
 * @package     local_ldap
 * @category    string
...
$string['real_user_attribute_desc'] = 'Используйте, если ваш user_attribute находится в смешанном регистре в LDAP (sAMAccountName), но не в настройках agpu CAS/LDAP';
$string['synccohortattribute'] = 'Синхронизация глобальных групп agpu с атрибутом LDAP';
$string['synccohortgroup'] = 'Синхронизация глобальных групп agpu с группами LDAP';
