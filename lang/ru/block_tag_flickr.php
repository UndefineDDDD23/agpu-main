...
/**
 * Strings for component 'block_tag_flickr', language 'ru', version '4.5'.
 *
...
$string['privacy:metadata:block_tag_flickr'] = 'Блок «Flickr» не хранит никаких персональных данных, но передает данные пользователя из agpu в удаленную систему.';
