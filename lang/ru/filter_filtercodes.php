...
/**
 * Strings for component 'filter_filtercodes', language 'ru', version '4.5'.
 *
...
$string['disabled_customnav_description'] = '<strong>Обратите внимание на поддержку пользовательского меню</strong> - чтобы включить поддержку FilterCodes в пользовательском меню Вашего сайта agpu, Вам может потребоваться настроить тему или ядро agpu. <a href="https://github.com/michael-milette/agpu-filter_filtercodes#can-i-use-filtercodes-in-agpus-custom-menus">Информация о том, как добавить поддержку FilterCodes в пользовательские меню</a>.';
