...
$string['configallowexternallinks'] = 'Эта опция позволяет всем пользователям выбирать, копировать или нет внешние медиа-файлы в agpu. Если эта опция выключена, то  медиа-файлы всегда копируются в agpu (это обычно лучше для целостности данных и безопасности). Если опция включена, то пользователи каждый раз могут выбирать вариант при добавлении медиа в текст.';
...
$string['configgetfiletimeout'] = 'Тайм-аут в секундах для закачки внешнего файла в agpu.';
...
$string['confirmdelete'] = 'Вы уверены, что хотите удалить репозиторий «{$a}»? Если Вы выберете «Продолжить и загрузить», то файлы по ссылкам на внешний источник будут загружены в agpu, но этот процесс может занять много времени.';
...
$string['confirmremove'] = 'Вы уверены, что хотите удалить этот плагин репозитория, его настройки и <strong>все его экземпляры</strong> - {$a}? Если Вы выберете «Продолжить и загрузить», то файлы по ссылкам на внешний источник будут загружены в agpu, но этот процесс может занять много времени.';
