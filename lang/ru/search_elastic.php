...
/**
 * Strings for component 'search_elastic', language 'ru', version '4.5'.
 *
...
$string['enrichdesc'] = 'Глобальный поиск может дополнить индексированные данные, которые используются для поиска, извлекая текст и другие данные из файлов. Извлечение данных из файлов в agpu регулируется следующими группами настроек.';
