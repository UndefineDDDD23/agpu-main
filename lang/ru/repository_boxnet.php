...
$string['information'] = 'Получите ключ API для вашего сайта agpu на <a href="https://app.box.com/developers/services">странице разработчиков Box</a>.';
...
$string['privacy:metadata:repository_boxnet'] = 'Плагин хранилища Box не хранит никаких личных данных, но передает данные пользователя из agpu в отдаленную систему.';
