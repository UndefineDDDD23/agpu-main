...
$string['enablequarantine_help'] = 'Если этот параметр включен, то все файлы, опознанные как вирусы, будут помещены в папку карантина ([dataroot]/{$a}) для последующей проверки. Загрузить их в agpu не удастся. Если используется антивирусное сканирование на уровне файловой системы, то папку карантина следует исключить из антивирусной проверки, чтобы избежать обнаружения зараженных файлов в карантине.';
