...
$string['setupinfodetails'] = 'Чтобы получить ключ API и секрет, войдите в Flickr и <a href="{$a->applyurl}">подайте заявку на получение нового ключа</a>. После получения нового ключа и секрета перейдите по ссылке «Edit auth flow for this app». В «App Type» выберите «Web Application». В поле «Callback URL» введите значение: <br /> <code>{$a->callbackurl}</code>. <br /> При желании Вы также можете предоставить описание и логотип своего сайта agpu. Эти значения могут быть установлены и позже на <a href="{$a->keysurl}">странице</a> списка Ваших приложений Flickr.';
