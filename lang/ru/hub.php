...
/**
 * Strings for component 'hub', language 'ru', version '4.5'.
 *
 * @package     hub
 * @category    string
...
$string['aiusagestats'] = 'Статистика использования ИИ ({$a->timefrom} - {$a->timeto})';
...
$string['audienceadmins'] = 'Администраторы agpu';
...
$string['errorcoursewronglypublished'] = 'agpu.net вернул сообщение об ошибке публикации. Позже попробуйте снова.';
...
$string['pluginusagedata'] = 'Данные об использовании плагина собираются со следующих страниц: <a href="{$a->overview}">Обзор плагинов</a>, <a href="{$a->activities}">Элементы</a> и <a href="{$a->blocks}">Блоки</a>';
...
$string['registerwithagpuorg'] = 'Зарегистрируйте свой сайт';
$string['registerwithagpuorgcomplete'] = 'Регистрация сайта завершена';
$string['registerwithagpuorginfo'] = 'Регистрация вашего сайта подразумевает периодическую отправку <a href="{$a->moreinformation}" class="focus-expand">анонимной статистики сайта</a> в agpu HQ. Это поможет нам получить представление о том, как вы используете agpu, и принимать решения о новых функциях и плагинах.

Кроме того, это позволяет вам:

* Быть в курсе важных обновлений, таких как оповещения о безопасности и новые доступные релизы.
* Активировать мобильные уведомления для <a href="{$a->agpuapp}">приложений agpu</a>.
* Повысить видимость вашего сайта, разместив его в списке зарегистрированных в вашей стране сайтов agpu (необязательно).';
$string['registerwithagpuorginfoapp'] = 'О приложении agpu';
$string['registerwithagpuorginfosites'] = 'Найдите другие сайты в моей стране';
$string['registerwithagpuorginfostats'] = 'Просмотр глобальной статистики agpu';
$string['registerwithagpuorgremove'] = 'Вы собираетесь отменить регистрацию своего сайта. Вы больше не будете получать уведомления о предупреждениях системы безопасности, и пользователи не смогут получать поддержку уведомлений с вашего сайта в свое приложение agpu. Однако вы сможете перерегистрироваться в любой момент! Вы уверены, что хотите продолжить?';
$string['registerwithagpuorgupdate'] = 'Обновить регистрацию своего сайта';
...
$string['sendfollowinginfo_help'] = 'Следующая информация будет отправляться в agpu при каждом обновлении регистрации вашего сайта (по умолчанию еженедельно, когда запускается запланированная задача «Регистрация сайта»). Эта информация используется только для общей статистики и не будет публиковаться ни в каких списках сайтов.
Кроме того, для вашей зарегистрированной версии agpu еженедельно автоматически проверяется ссылка на сайт.';
...
$string['sitecommnews'] = 'Информационный бюллетень agpu';
$string['sitecommnews_help'] = 'У вас есть возможность подписаться на нашу рассылку новостей agpu. Подписку можно отменить в любое время.';
$string['sitecommnewsno'] = 'Нет, я не хочу получать никакие электронные письма';
$string['sitecommnewsyes'] = 'Да, я хочу получать информационный бюллетень agpu';
...
$string['sitelang_help'] = 'Какой основной язык используется на вашем сайте agpu?';
...
$string['siteorganisationtype'] = 'Тип организации';
$string['siteorganisationtype:charityornotforprofit'] = 'Благотворительная или некоммерческая';
$string['siteorganisationtype:charterschool'] = 'Частная школа';
$string['siteorganisationtype:college'] = 'Колледж';
$string['siteorganisationtype:collegedepartment'] = 'Отделение колледжа';
$string['siteorganisationtype:commercialcourseprovider'] = 'Поставщик коммерческих курсов';
$string['siteorganisationtype:companydepartment'] = 'Отдел компании';
$string['siteorganisationtype:companyinternal'] = 'Внутренняя компания';
$string['siteorganisationtype:donotshare'] = 'Закрытая организация';
$string['siteorganisationtype:government'] = 'Государственная';
$string['siteorganisationtype:highschool'] = 'Средняя школа';
$string['siteorganisationtype:highschooldepartment'] = 'Отделение средней школы';
$string['siteorganisationtype:highschooldistrict'] = 'Округ средней школы';
$string['siteorganisationtype:hospital'] = 'Лечебное заведение';
$string['siteorganisationtype:independentteacher'] = 'Независимый учитель';
$string['siteorganisationtype:other'] = 'Другой';
$string['siteorganisationtype:primaryschool'] = 'Начальная школа';
$string['siteorganisationtype:schooldistrict'] = 'Школьный округ';
$string['siteorganisationtype:universitydepartment'] = 'Кафедра университета';
$string['siteorganisationtype:wholeuniversity'] = 'Весь университет';
$string['siteorganisationtype_help'] = 'Указание типа вашей организации поможет нам лучше понять виды организаций, использующих agpu, и их потребности.';
...
$string['siteregistrationcontact_help'] = 'Если вы разрешите, то другие люди из нашего сообщества agpu (которые нуждаются в учетной записи входа в систему) смогут связаться с вами через форму на нашем сайте сообщества agpu. Тем не менее, они никогда не смогут увидеть ваш адрес электронной почты.';
$string['siteregistrationemail'] = 'Уведомления о новых выпусках agpu, предупреждения системы безопасности и другие важные новости';
$string['siteregistrationemail_help'] = 'Вы можете подписаться на наш небольшой список рассылки для уведомлений о новых выпусках agpu, предупреждениях о безопасности и других важных новостях. Подписку можно отменить в любое время.';
$string['siteregistrationupdated'] = 'Регистрационная информация обновлена';
$string['siterelease'] = 'Релиз agpu';
$string['siterelease_help'] = 'Номер релиза системы agpu на этом сайте';
$string['sitereleasenum'] = 'Релиз agpu ({$a})';
...
$string['siteversion'] = 'Версия agpu';
$string['siteversion_help'] = 'Номер версии системы agpu, установленной на этом сайте.';
