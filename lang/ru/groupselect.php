...
$string['hidegroupmembers_help'] = 'Если включено, все участники групп будут скрыты от студентов. Если у студентов есть права управлять группами (agpu/course:managegroups) или если у них есть доступ ко всем группам (agpu/site:accessallgroups), участники будут всё равно показаны.';
...
* Полная совместимость со встроенными группами agpu: при необходимости группы могут быть созданы другими средствами, поддерживаются групповые задания и пр.';
