...
Список значков берется из каталога /pix/f вашего сервера agpu. При необходимости можно добавить свои значки в эту папку.';
...
$string['revert'] = 'Вернуть {$a} к настройкам agpu по умолчанию';
$string['revert_confirmation'] = 'Вы уверены, что хотите вернуть <strong>.{$a}</strong> к настройкам agpu по умолчанию, отменив свои изменения?';
