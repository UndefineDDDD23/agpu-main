...
$string['requiresattentionexplanation'] = 'Этот плагин не обеспечивает API конфиденциальности agpu. Если этот плагин хранит какие-либо личные данные, они не могут быть экспортированы или удалены средствами системы конфиденциальности agpu.';
