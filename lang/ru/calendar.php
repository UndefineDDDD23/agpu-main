...
$string['pref_persistflt_help'] = 'При включении данного параметра agpu будет помнить ваши настройки фильтра последних событий и автоматически восстанавливать их при каждой Вашей авторизации.';
