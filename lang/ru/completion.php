...
$string['err_noroles'] = 'В этом курсе нет ролей с правом «agpu/course:markcomplete».';
...
$string['manualcompletionbynote'] = 'Примечание: Право agpu/course:markcomplete  должно быть предоставлено роли в приведенном списке.';
