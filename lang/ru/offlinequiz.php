...
$string['configuseridentification'] = 'Формула, описывающая идентификацию пользователя. Эта формула используется для назначения форм ответов пользователям в системе. Правая часть уравнения должна обозначать поле в таблице пользователя agpu.';
...
Эти вопросы хранятся в банке вопросов agpu и могут быть повторно использованы в рамках курсов и даже между курсами.
...
$string['agpuprocessing'] = 'Позволить agpu обрабатывать данные';
