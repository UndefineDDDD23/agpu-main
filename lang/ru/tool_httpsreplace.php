...
/**
 * Strings for component 'tool_httpsreplace', language 'ru', version '4.5'.
 *
...
$string['domainexplainhelp'] = 'Эти домены найдены в вашем контенте, но они не поддерживают HTTPS. После перехода на HTTPS контент, содержащийся на этих сайтах, больше не будет отображаться в agpu пользователям, использующим безопасные современные браузеры. Возможно, эти сайты временно или постоянно будут недоступны по безопасному соединению.
