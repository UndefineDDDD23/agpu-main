...
/**
 * Strings for component 'repository_nextcloud', language 'ru', version '4.5'.
 *
...
$string['external'] = 'Внешний (в agpu хранятся только ссылки)';
...
$string['fileoptions'] = 'Здесь можно настроить типы и значения по умолчанию для возвращаемых файлов. Обратите внимание, что все файлы, связанные  ссылками с внешними, будут обновлены, так как владельцем является системная учетная запись agpu.';
...
Этот параметр определяет имя папки. Рекомендуется выбрать имя, связанное с вашим сайтом agpu.';
$string['internal'] = 'Внутренний (файлы, хранящиеся в agpu)';
