...
$string['autocreate'] = '<p> Курсы могут создаваться автоматически при зачислении на курс, которого еще не существует в agpu. </p><p> Если используется автоматическое создание курса, то у соответствующих ролей рекомендуется удалить следующие возможности: agpu/course:changeidnumber, agpu/course:changeshortname, agpu/course:changefullname и agpu/course:changesummary для предотвращения изменения четырех вышеуказанных полей курса (идентификационный номер, краткое название, полное название и описание). </p>';
