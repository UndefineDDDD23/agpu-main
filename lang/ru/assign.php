...
$string['attemptreopenmethod_automatic_help'] = 'После каждой попытки следующая предоставляется автоматически.';
...
* Автоматически — после каждой попытки следующая предоставляется автоматически.
...
$string['attemptreopenmethod_untilpass_help'] = 'После каждой попытки следующая будет предоставлена автоматически, пока студент не получит проходной балл.';
...
$string['blindmarkingenabledwarning'] = 'Для этого задания разрешен анонимный ответ. Оценки не будут добавлены в журнал оценок до тех пор, пока личности учащихся не будут раскрыты через меню «Действия».';
