...
/**
 * Strings for component 'theme_canvas', language 'ru', version '4.5'.
 *
...
$string['choosereadme'] = '«Canvas» - родительская тема оформления agpu 2.0 от Патрика Молли (Patrick Malley).';
