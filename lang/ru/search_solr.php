...
$string['fileindexing_help'] = 'Если ваша инсталляция Solr это поддерживает, то данная возможность позволяет agpu отправлять файлы на индексирование. <br/>
...
$string['minimumsolr4'] = 'Solr 4.0 — минимальная версия, требуемая для agpu';
$string['missingconfig'] = 'Ваш сервер Apache Solr еще не настроен в agpu.';
