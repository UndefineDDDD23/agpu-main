...
$string['warningmissingtype'] = '<b>Этот вопрос относится к типу, который еще не поддерживается вашей системой agpu.<br /> Пожалуйста, свяжитесь с администратором agpu.</b>';
