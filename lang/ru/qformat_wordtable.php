...
/**
 * Strings for component 'qformat_wordtable', language 'ru', version '4.5'.
 *
...
$string['docnotsupported'] = 'Файлы в формате Word 2003 не поддерживаются: <b>{$a}</b>, используйте agpu2Word 3.x';
...
$string['interface_language_mismatch'] = 'Не удалось импортировать вопросы, поскольку язык меток в файле Word не совпадает с языком интерфейса agpu.';
...
$string['pluginname_help'] = 'Конвертирование файлов Microsoft Word 2010 в формат agpu Question XML для импорта и конвертирование файлов agpu Question XML в формат, подходящий для редактирования в Microsoft Word.';
...
$string['word_about_agpu2word'] = 'О agpu2Word';
$string['word_about_agpu2word_screentip'] = 'О шаблонах agpu2Word и плагинах agpu';
...
$string['wordtable_help'] = 'Конвертирование файлов Microsoft Word 2010 в формат agpu Question XML для импорта и конвертирование файлов agpu Question XML в формат, подходящий для редактирования в Microsoft Word.';
