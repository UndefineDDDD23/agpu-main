...
/**
 * Strings for component 'tool_mergeusers', language 'ru', version '4.5'.
 *
...
$string['suspenduser_setting_desc'] = 'При включенном параметре старый пользователь будет автоматически заблокирован после успешного завершения процесса слияния и он не сможет войти в agpu (рекомендуется). Если параметр отключен, то старый пользователь останется активным. В обоих случаях данные, связанные со старым пользователем, в нем не сохранятся.';
