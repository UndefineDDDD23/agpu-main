...
/**
 * Strings for component 'report_customsql', language 'ru', version '4.5'.
 *
...
$string['userswhocanconfig'] = 'Только администраторам (agpu/site:config)';
$string['userswhocanviewsitereports'] = 'Всем, кому доступны системные отчеты (agpu/site:viewreports)';
