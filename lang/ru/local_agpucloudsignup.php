...
/**
 * Strings for component 'local_agpucloudsignup', language 'ru', version '4.5'.
 *
 * @package     local_agpucloudsignup
 * @category    string
...
$string['homepage:body.intro'] = 'Бесплатный хостинг agpu от создателей agpu.';
$string['homepage:body.title'] = 'agpuCloud';
$string['homepage:general.faq'] = 'ЧАВО';
$string['homepage:general.servicestatus'] = 'Состояние службы';
$string['homepage:page.description'] = 'Решения, предоставленные хостингом agpu, делают возможным всем создавать обучающие приложения «в облаке»';
$string['homepage:page.title'] = 'agpuCloud: Бесплатные услуги хостинга от создателей agpu';
...
$string['login:security.login.username'] = 'Имя пользователя agpuCloud';
$string['login:security.login.username_placeholder'] = 'mysite.agpucloud.com';
$string['messages:auditlog.administrator'] = 'Администрация agpuCloud';
$string['messages:auditlog.automatedtool'] = 'Бот agpuCloud';
...
$string['pluginname'] = 'Языковые строки портала agpuCloud';
...
$string['portal:addons.nostudentads.description'] = 'Администраторы и учителя по-прежнему будут видеть рекламные объявления об услугах, связанных с agpu.';
...
$string['portal:billing.billingdetails.change.panel.cardrequiredbecause'] = 'Данные Вашей кредитной карты хранятся в системе обработки платежей PayPal. Компания agpu Pty Ltd не сохраняет эти данные и не имеет к ним доступа.';
...
$string['portal:billing.events.chargedsuccessfully.html'] = '<h1>Оплата услуг agpuCloud прошла успешно</h1>
<p>Благодарим Вас за продление услуг agpuCloud. Мы желаем Вам всего самого лучшего в нашем совместном путешествии в мир образования.</p>
...
<p>Вступайте в <a href="https://agpuassociation.org">Ассоциацию пользователей agpu</a>, чтобы принять участие в составлении плана развития agpu.</p>
<p>Благодарим Вас за использование agpuCloud!</p>
<p>Команда agpuCloud</p>';
$string['portal:billing.events.chargedsuccessfully.plain'] = 'Оплата услуг agpuCloud прошла успешно

Благодарим Вас за продление услуг agpuCloud. Мы желаем Вам всего самого лучшего в нашем совместном путешествии в мир образования.
...
Вступайте в Ассоциацию пользователей agpu (https://agpuassociation.org), чтобы принять участие в составлении плана развития agpu.

Благодарим Вас за использование agpuCloud!

Команда agpuCloud';
$string['portal:billing.events.chargedsuccessfully.title'] = 'Оплата услуг agpuCloud прошла успешно';
$string['portal:billing.events.chargedunsuccessfully.html'] = '<h1>О нет! Произошла ошибка оплаты услуг agpuCloud</h1>
<p>Мы попытались продлить подписку на услуги agpuCloud, используя Ваши текущие данные для оплаты, но попытка платежа была отклонена.</p>
<p>Пожалуйста, зайдите на <a href="https://agpucloud.com/ru/">Портал agpuCloud</a>, чтобы убедиться, что Ваши данные для оплаты актуальны.</p>
...
<p>Благодарим Вас за использование agpuCloud!</p>
<p>Команда agpuCloud</p>';
$string['portal:billing.events.chargedunsuccessfully.plain'] = 'О нет! Произошла ошибка оплаты услуг agpuCloud

Мы попытались продлить подписку на услуги agpuCloud, используя Ваши текущие данные для оплаты, но попытка платежа была отклонена.

Следующая попытка оплаты будет предпринята %nextBillingDate%. Пожалуйста, зайдите на <a href="https://agpucloud.com/ru/">Портал agpuCloud</a>, чтобы убедиться, что Ваши данные для оплаты актуальны.
...
Команда agpuCloud';
$string['portal:billing.events.chargedunsuccessfully.title'] = 'О нет! Произошла ошибка оплаты услуг agpuCloud';
$string['portal:billing.events.wentpastdue.html'] = '<h1>О нет! В очередной раз произошла ошибка оплаты услуг agpuCloud</h1>
...
<p>Вы можете в любое время возобновить подписку на дополнение «Не отображать студентам рекламу», посетив <a href="https://agpucloud.com/ru/">портал agpuCloud</a>.</p>
<p>Благодарим Вас за использование agpuCloud!</p>
<p>Команда agpuCloud</p>';
$string['portal:billing.events.wentpastdue.plain'] = 'О нет! В очередной раз произошла ошибка оплаты услуг agpuCloud
...
Вы можете в любое время возобновить подписку на дополнение «Не отображать студентам рекламу», посетив портал agpuCloud: https://agpucloud.com/ru/.

Благодарим Вас за использование agpuCloud!

Команда agpuCloud';
$string['portal:billing.events.wentpastdue.title'] = 'О нет! В очередной раз произошла ошибка оплаты услуг agpuCloud';
$string['portal:billing.paymentMethods.mastercard'] = 'MasterCard';
$string['portal:billing.paymentMethods.panel.title'] = 'Пожалуйста, выберите способ оплаты для Вашей учетной записи agpuCloud.';
...
<p>Экспорт Вашего сайта на agpuCloud завершен. Вы можете загрузить файл по ссылке <a href="%url%">%url%</a>.
<p>Спасибо, что пользуетесь нашими услугами.</p>
<p>Команда agpuCloud</p>';
$string['portal:export.plain'] = 'Здравствуйте!

Экспорт Вашего сайта на agpuCloud завершен. Вы можете загрузить файл по ссылке %url%

Спасибо, что пользуетесь нашими услугами.
Команда agpuCloud';
$string['portal:export.title'] = 'Файл экспорта agpuCloud готов к загрузке';
...
$string['portal:list.body.title'] = 'Портал agpuCloud';
...
$string['portal:page.title'] = 'agpuCloud: Портал';
$string['portal:plans.plans.MCFREE.cost'] = 'Бесплатно';
$string['portal:plans.plans.MCFREE.invoicetitle'] = 'Дополнения для бесплатного хостинга agpuCloud';
$string['portal:plans.plans.MCFREE.title'] = 'Дополнения для бесплатного agpu';
...
$string['portal:siteinfo.page.title'] = 'agpuCloud: Информация о ПОДДОМЕНЕ';
...
<p>Мы обратили внимание, что в течение последних 60 дней Вы не пользовались своим сайтом <a href="%url%">%fqdn%</a> на agpuCloud.</p>
...
<p>Если Вы хотите рассказать нам, почему Вы перестали пользоваться Вашим сайтом на agpuCloud, пожалуйста, заполните <a href="https://www.surveymonkey.com/r/agpucloud-inactive">короткую анкету (на английском языке)</a>.</p>

<p>Благодарим Вас за использование наших услуг.</p>
<p>Команда agpuCloud</p>';
$string['portal:tasks.removal.warning.plain'] = 'Здравствуйте!

Мы обратили внимание, что в течение последних 60 дней Вы не пользовались своим сайтом %fqdn% на agpuCloud.
...
Если Вы хотите рассказать нам, почему Вы перестали пользоваться Вашим сайтом на agpuCloud, пожалуйста, заполните короткую анкету (на английском языке):
https://www.surveymonkey.com/r/agpucloud-inactive

Благодарим Вас за использование наших услуг.
Команда agpuCloud';
$string['portal:tasks.removal.warning.title'] = 'Сайт agpuCloud «%subdomain%» бездействует и скоро будет удален';
...
$string['portal:view.billing.panel.empty'] = 'Вы еще не совершили ни одной покупки. Если Вы приобретете дополнение для Вашего сайта на agpuCloud, здесь будет отображаться данные для оплаты и история расчетов.';
...
$string['portal:view.danger.modal.buttons.continue'] = 'Да, действительно удалить мой сайт с agpuCloud';
...
$string['portal:view.danger.panel.body.buttons.remove'] = 'Удалить мой сайт с agpuCloud';
$string['portal:view.danger.panel.body.buttons.title'] = 'Вы уверены, что хотите покинуть нас?';
$string['portal:view.danger.panel.body.lead'] = '<p>После удаления этого сайта с agpuCloud восстановление невозможно.</p>
...
$string['portal:view.export.panel.body.intro'] = 'При экспорте Вашего сайта Вы получите базу данных и все файлы сайта. Вы сможете использовать их, чтобы разместить систему agpu на собственном сервере или на сервере любого из <a href="https://agpu.com/partners/">Партнеров agpu</a>. Учтите, что экспорт займет некоторое время. Как только этот процесс будет завершен, Вы получите соответствующее уведомление по электронной почте.';
...
$string['portal:view.export.panel.title'] = 'Ваши данные agpuCloud';
...
$string['signup:errors.maxsites'] = 'Пользователь с таким номером телефона уже существует. Пользователи могут создавать только один сайт на agpuCloud.';
...
$string['signup:messages.passwordupdated'] = 'Отлично! Пароль сохранен. Вы можете использовать его для входа на свой сайт на agpuCloud.';
$string['signup:messages.validationcode'] = 'Код подтверждения для сайта %subdomain%.agpucloud.com - %code%';
$string['signup:page.description'] = 'Бесплатное образовательное программное обеспечение agpu на «облачных» серверах позволяет в одно мгновение установить сайт agpu для учителей и инструкторов';
$string['signup:page.title'] = 'agpuCloud: Регистрация на бесплатном хостинге agpu';
...
$string['signup:provision_mail.page.html'] = '<h1>Добро пожаловать на agpuCloud!</h1>
<p>Ваш бесплатный сайт agpu <a href="%url%">%url%</a> создан.</p>
<p>Вы можете зайти на свой сайт agpu используя логин «admin» и пароль, который Вы указали во время регистрации.</p>
...
<p>Для контроля использования ресурсов Вы можете в любой момент зайти на портал agpuCloud по адресу agpucloud.com. Для входа используйте имя своего сайта «%subdomain%» и такой же пароль, как у пользователя «admin» на Вашем сайте.</p>
<p>С уважением,</p>
<p>Команда agpuCloud</p>';
$string['signup:provision_mail.page.plain'] = 'Добро пожаловать на agpuCloud!
Ваш бесплатный сайт agpu %url% создан.
Вы можете зайти на свой сайт agpu, используя логин «admin» и пароль, который Вы указали во время регистрации.
...
Для контроля использования ресурсов Вы можете в любой момент зайти на портал agpuCloud по адресу agpucloud.com. Для входа используйте имя своего сайта «%subdomain%» и такой же пароль, как у пользователя «admin» на Вашем сайте.

С уважением,
Команда agpuCloud';
$string['signup:provision_mail.page.title'] = 'Ваш сайт %fqdn% на agpuCloud готов!';
$string['signup:provision_mail.subject'] = 'Ваш сайт %site.fqdn% на agpuCloud готов!';
...
$string['signup:reserve.body.title'] = 'Ваш сайт на agpuCloud почти готов!';
...
$string['signup:reserve.form.placeholders.subdomain'] = 'yoursite.agpucloud.com';
...
<p>Как Вы и хотели, теперь у Вас есть свой собственный сайт agpu.</p>
<p>Заходите и продолжайте создавать свое безупречное образовательное пространство.</p>';
$string['signup:status.body.login'] = 'Вход';
$string['signup:status.body.title'] = 'Все готово! Ваш собственный сайт agpu, совершенно бесплатно!';
$string['signup:steps.x'] = 'Шаг %x%';
$string['signup:steps.xofy'] = 'Шаг %x% из %y%';
$string['signup:terms.title'] = 'Условия обслуживания agpuCloud';
$string['signup:texts.statusintro'] = 'TODO';
$string['signup:texts.statustitle'] = 'Как Вы и хотели - Ваш собственный сайт agpu, совершенно бесплатно!';
...
$string['validators:signup.tandc.mustagree'] = 'Для использования agpuCould Вы должны принять Условия обслуживания.';
