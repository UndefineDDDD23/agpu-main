...
Пользовательский интерфейс и баллы отслеживаются с использованием xAPI и доступны через Журнал оценок agpu.
...
$string['modulename_link'] = 'https://h5p.org/agpu-more-help';
...
$string['welcomegettingstarted'] = 'Чтобы начать работу с H5P и agpu, ознакомьтесь с <a {$a->agpu_tutorial}>руководством</a> и <a {$a->example_content}>примером контента</a> на странице H5P.org для вдохновения.';
