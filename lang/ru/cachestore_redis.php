...
* Если у вас есть только один экземпляр agpu, использующий этот сервер, вы можете оставить значение по умолчанию.
...
$string['usecompressor_help'] = 'Задает компрессор, который будет использоваться после сериализации. Это делается на уровне agpu Cache API, а не на уровне php-redis.';
