...
$string['settings:redir_exclusions'] = 'URL-адреса, которые не должны перенаправлять проверку MФA';
$string['settings:redir_exclusions_help'] = 'Каждая новая строка представляет собой относительный URL-адрес из корня сайта, для которого проверка MФA не будет перенаправляться с';
