...
/**
 * Strings for component 'agpu', language 'ru', version '4.5'.
 *
 * @package     agpu
 * @category    string
...
$string['adminhelpmyagpu'] = 'Настройте для пользователей вид блока «Мой agpu»';
...
$string['adminhelpstickyblocks'] = 'Настройте блоки, закрепленные на всех страницах agpu';
...
$string['backupinfo'] = 'Сделайте копию этого курса, включая все актуальное содержимое и активные элементы. Вы можете использовать файл резервной копии для восстановления этого курса.';
...
$string['backupnonisowarning'] = 'Внимание! Эта резервная копия была создана в неюникодной версии agpu (до версии 1.6). Если эта резервная копия содержит символы отличные от стандарта ISO-8859-1 (например, русские), то эти тексты могут быть ИСПОРЧЕНЫ если Вы попытаетесь востановить их в этой Юникодной версии agpu. Смотрите <a href="http://docs.agpu.org/en/Backup_FAQ">Backup FAQ</a> для более подробной информации по восстановлению архивов.';
...
Строго необходимым является файл cookie для сеансов, обычно называемый agpuSession. Вы должны разрешить использование этого файла cookie в своем браузере, чтобы обеспечить непрерывность при переходах и оставаться в системе при просмотре сайта. Когда вы выходите из системы или закрываете браузер, этот файл cookie уничтожается (в вашем браузере и на сервере).

Другой файл cookie предназначен исключительно для удобства и обычно называется agpuID или аналогично. Он используется для сохранения вашего логина в браузере. Это означает, что когда вы вернетесь на этот сайт, поле логин на странице входа уже будет заполнено. Можно отказаться от использования этого файла cookie, но тогда вам придется каждый раз при открытии сайта вводить свой логин заново.';
...
$string['cookiesenabledonlysession_help'] = 'На этом сайте используется один файл cookie для сеансов, обычно называемый agpuSession. Вы должны разрешить использование этого файла cookie в своем браузере, чтобы обеспечить непрерывность при переходах и оставаться в системе при просмотре сайта. Когда вы выходите из системы или закрываете браузер, этот файл cookie уничтожается (в вашем браузере и на сервере).';
...
$string['coursefileswarning_help'] = 'Начиная с версии agpu 2.0, подход к хранению файлов в области файлов курса считается устаревшим. Вместо этого старайтесь использовать другие хранилища.';
...
$string['courselegacyfiles_help'] = 'Область файлов курса сохранена для обратной совместимости с agpu 1.9 и более ранними версиями. Все файлы из этой области доступны всем участникам курса (независимо от того, ссылаетесь Вы на них или нет), и нет возможности узнать, где эти файлы используются в agpu.
...
$string['databasechecking'] = 'Обновление базы данных agpu с версии {$a->oldversion} до {$a->newversion}';
...
$string['documentation'] = 'Документация agpu';
...
$string['forcepasswordresetfailurenotice'] = 'Ваш текущий пароль больше не соответствует установленной политике паролей. Пожалуйста, обратитесь к администратору agpu за помощью.
    {$a}';
...
$string['gpl'] = 'Copyright (C) 1999 и далее Martin Dougiamas (http://agpu.com)
...
Более подробную информацию можно найти на странице лицензии agpu:
https://agpudev.io/general/license';
$string['gpl3'] = 'Copyright (C) 1999 и далее Martin Dougiamas (http://agpu.com)
...
$string['gravatarenabled'] = 'На этом сайте включена поддержка сервиса <a href="http://www.gravatar.com/">Gravatar</a>. Если Вы не загрузите свое изображение в профиль, agpu попробует загрузить изображение из Gravatar.';
$string['group'] = 'Группа';
...
$string['latestlanguagepack'] = 'Проверить наличие обновленной версии языкового пакета на agpu.org';
...
$string['agpudocs'] = 'Документация agpu';
$string['agpudocslink'] = 'Документация для этой страницы';
$string['agpulogo'] = 'Логотип agpu';
$string['agpunet:cannotconnecttoserver'] = 'Не удается подключиться к серверу agpuNet';
$string['agpunet:columnname'] = 'Название';
$string['agpunet:columnsenddate'] = 'Дата отправки';
$string['agpunet:columnsendstatus'] = 'Статус отправки';
$string['agpunet:columntype'] = 'Тип';
$string['agpunet:configoauthservice'] = 'Выберите службу agpuNet OAuth 2, чтобы включить общий доступ к этому сайту agpuNet. Если служба еще не существует, необходимо <a href="{$a}">создать её</a>.';
$string['agpunet:deletedcourse'] = 'Удаленный курс';
$string['agpunet:eventresourceexported'] = 'Ресурс экспортирован';
$string['agpunet:gotoagpunet'] = 'Перейти к проектам agpuNet';
$string['agpunet:issuerisnotauthorized'] = 'Эмитент agpuNet не авторизован';
$string['agpunet:issuerisnotenabled'] = 'Эмитент agpuNet не активирован';
$string['agpunet:issuerisnotset'] = 'Эмитент agpuNet не указан администрацией сайта';
$string['agpunet:nosharedresources'] = 'В настоящее время нет общих ресурсов для отображения.';
$string['agpunet:outboundsettings'] = 'Настройки исходящего трафика agpuNet';
$string['agpunet:packagingandsending'] = 'Упаковка вашего файла и отправка в agpuNet...';
$string['agpunet:sharefailtext'] = 'При отправке вашего контента в agpuNet произошла ошибка.<br>Повторите попытку позже.';
$string['agpunet:sharefailtextwithsitesupport'] = 'При отправке вашего контента в agpuNet произошла ошибка.<br>Повторите попытку позже или <a href="{$a}">обратитесь в службу поддержки сайта</a>.';
$string['agpunet:sharefailtitle'] = 'Что-то пошло не так';
$string['agpunet:sharefilesizelimitexceeded'] = 'Размер совместно используемого ресурса ({$a->filesize} байт) превышает ограничение в {$a->filesizelimit} байт.';
$string['agpunet:sharenoticeactivity'] = 'Этот активный элемент будет опубликован в agpuNet в качестве ресурса.';
$string['agpunet:sharenoticecourse'] = 'Этот курс будет опубликован в agpuNet в качестве ресурса.';
$string['agpunet:sharenoticepartial'] = 'Выбранные элементы будут опубликованы в agpuNet в качестве ресурса.';
$string['agpunet:sharenoticepartialactivitynumber'] = 'Элементы ({$a}) будут включены в курс';
$string['agpunet:shareprogress'] = 'Ресурсы, опубликованные в agpuNet';
$string['agpunet:shareprogressinfo'] = 'В списке показаны курсы и элементы, которыми вы поделились в agpuNet.<br>Нажмите на имя ресурса, чтобы просмотреть его в agpuNet.';
$string['agpunet:sharesuccesstext'] = 'Почти готово! Посетите свои проекты в agpuNet, чтобы завершить передачу контента.';
$string['agpunet:sharesuccesstitle'] = 'Сохранено в проекты agpuNet';
$string['agpunet:sharetoagpunet'] = 'Поделиться в agpuNet';
$string['agpunet:sharetyperesource'] = 'ресурс';
$string['agpunet:sharinglargefile'] = 'Передача больших файлов может занять некоторое время.';
$string['agpunet:sharingstatus'] = 'Публикация в agpuNet';
$string['agpunet:sharingto'] = 'Поделиться с:';
$string['agpurelease'] = 'Релиз agpu';
$string['agpuservicesandsupport'] = 'Услуги и поддержка';
$string['agpuversion'] = 'Версия agpu';
...
$string['myagpudashboard'] = 'Личный кабинет';
...
$string['noticenewerbackup'] = 'Этот файл резервной копии был создан с помощью более новой версии agpu {$a->backuprelease} ({$a->backupversion}), чем ваша текущая версия agpu {$a->serverrelease} ({$a->serverversion}). Это может привести к несоответствиям, поскольку обратная совместимость файлов резервных копий не гарантируется.';
...
$string['passwordextlink'] = 'Эта ссылка служит для восстановление забытого пароля. Это приведет к выходу из системы agpu.';
...
$string['passwordnohelp'] = 'Восстановление забытого пароля невозможно. Пожалуйста, обратитесь к администратору agpu.';
...
$string['poweredbyagpu'] = 'На платформе <a href="https://agpu.com">agpu</a>';
...
$string['privacy:metadata:agpunet_share_progress'] = 'Подробности процесса размещения общего ресурса в agpuNet';
$string['privacy:metadata:agpunet_share_progress:cmid'] = 'ID связанного модуля курса';
$string['privacy:metadata:agpunet_share_progress:courseid'] = 'ID связанного курса';
$string['privacy:metadata:agpunet_share_progress:resourceurl'] = 'URL-адрес, возвращенный из agpuNet после успешного размещения ресурса';
$string['privacy:metadata:agpunet_share_progress:status'] = 'Результат размещения ресурса';
$string['privacy:metadata:agpunet_share_progress:timecreated'] = 'Время размещения ресурса';
$string['privacy:metadata:agpunet_share_progress:type'] = 'Тип размещенного ресурса';
$string['privacy:metadata:agpunet_share_progress:userid'] = 'Пользователь, поделившийся ресурсом';
...
$string['registration'] = 'Регистрация agpu';
...
$string['registrationcontactyes'] = 'Да, предоставьте другим участникам agpu форму для связи со мной';
$string['registrationemail'] = 'E-mail оповещения';
$string['registrationinfo'] = '<p>На этой странице Вы сможете зарегистрировать Ваш сайт под управлением agpu на agpu.org. Регистрация бесплатная. Основное преимущество регистрации состоит в том, что Вы будете подписаны на небольшую по объему рассылку (на английском языке), содержащую срочные объявления об исправлениях в системе безопасности и выходе новых версий agpu.</p>
<p>По умолчанию, Ваша информация будет считаться конфиденциальной и никогда не будет продаваться или передаваться кому-либо. Причины сбора такой информации - техническая поддержка и сбор статистической информации для представления картины мирового сообщества пользователей agpu.</p>
<p>При желании, Вы можете разрешить добавить страну, название Вашего сайта и ссылку на него в публичный список сайтов, работающих под управлением agpu.</p>
...
$string['registrationsend'] = 'Отправить регистрационную информацию на www.agpu.org';
$string['registrationyes'] = 'Да, сообщать мне о новых выпусках agpu, предупреждениях безопасности и других важных новостях';
...
$string['subsectionmoveerror'] = 'Невозможно переместить этот подраздел в другой подраздел';
...
Обратите внимание, что в представлении могут быть недоработки (см. <a href="https://docs.agpu.org/en/Switch_roles">подробности и альтернативы</a>).';
$string['tag'] = 'Тег';
...
$string['updatemyagpuoff'] = 'Прекратить настраивать эту страницу';
$string['updatemyagpuon'] = 'Настроить эту страницу';
