...
$string['configexternalblogcrontime'] = 'Как часто agpu должен проверять новые записи во внешних блогах.';
$string['configmaxexternalblogsperuser'] = 'Количество внешних блогов, на которые каждый пользователь может сделать ссылку в своем блоге agpu.';
$string['configuseblogassociations'] = 'Разрешить связывать записи блогов с курсами и элементами курса.';
$string['configuseexternalblogs'] = 'Разрешить пользователям указывать RSS-ленты внешних блогов. agpu будет регулярно проверять такие RSS-ленты и копировать новые записи в локальные блоги пользователей.';
