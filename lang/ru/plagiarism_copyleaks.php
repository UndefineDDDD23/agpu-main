...
/**
 * Strings for component 'plagiarism_copyleaks', language 'ru', version '4.5'.
 *
...
$string['privacy:metadata:core_files'] = 'Copyleaks хранит файлы, которые были загружены в agpu для формирования представления Copyleaks';
...
$string['privacy:metadata:plagiarism_copyleaks_files'] = 'Информация, которая связывает отправку agpu с отправкой Copyleaks.';
