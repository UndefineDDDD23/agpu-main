...
/**
 * Strings for component 'tool_qeupgradehelper', language 'ru', version '4.5'.
 *
...
$string['veryoldattemtps'] = 'Ваш сайт имеет попытки теста ({$a}), которые не были полностью обновлены при обновлении с agpu 1.4 до agpu 1.5. Эти попытки будут рассмотрены перед основным обновлением. Вы должны предусмотреть необходимое дополнительное время для этого.';
