...
Система обмена сообщениями agpu';
...
$string['cfg_limitedwidth_desc'] = 'Используйте более компактную область содержимого органайзера в стиле agpu 4.x. agpu использует стандартный размер по умолчанию, но этот может оказаться слишком широким в случае длинных записей в таблице.';
...
$string['myagpu_app_slot'] = 'Встреча на {$a->date} в {$a->time}';
$string['myagpu_attended'] = '{$a->attended} из {$a->total} студентов участвовали во встрече';
$string['myagpu_attended_group'] = '{$a->attended} из {$a->total} групп участвовали во встрече';
$string['myagpu_attended_group_short'] = '{$a->attended} из {$a->total} групп посетили хотя бы одну встречу';
$string['myagpu_attended_short'] = '{$a->attended} из {$a->total} участников посетили хотя бы одну встречу';
$string['myagpu_completed_app'] = 'Вы участвовали во встрече {$a->date} в {$a->time}';
$string['myagpu_completed_app_group'] = 'Ваша группа {$a->groupname} участвовала во встрече {$a->date} в {$a->time}';
$string['myagpu_missed_app'] = 'Вы не присутствовали на встрече {$a->date} в {$a->time}';
$string['myagpu_missed_app_group'] = 'Ваша группа {$a->groupname} не присутствовала на встрече {$a->date} в {$a->time}';
$string['myagpu_next_slot'] = 'Следующий временной интервал на {$a->date} в {$a->time}.';
$string['myagpu_no_reg_slot'] = 'Вы забронировали временные интервалы ({$a->booked}), но еще не достигли минимального количества временных интервалов ({$a->slotsmin}).';
$string['myagpu_no_reg_slot_group'] = 'Ваша группа {$a->groupname} забронировала временные интервалы ({$a->booked}), но еще не достигла минимального количества временных интервалов ({$a->slotsmin}).';
$string['myagpu_no_slots'] = 'Нет предстоящих временных интервалов.';
$string['myagpu_organizer_expired'] = 'Срок действия этого органайзера истек {$a->date} в {$a->time}. Вы больше не можете его использовать.';
$string['myagpu_organizer_expires'] = 'Срок действия этого органайзера истекает {$a->date} в {$a->time}';
$string['myagpu_pending_app'] = 'Ваша встреча ожидает оценки';
$string['myagpu_pending_app_group'] = 'Встреча вашей группы {$a->groupname} ожидает оценки';
$string['myagpu_reg_slot'] = 'Вы забронировали временные интервалы ({$a->booked}) и, таким образом, достигли минимума бронирований ({$a->slotsmin}) .';
$string['myagpu_reg_slot_group'] = 'Ваша группа {$a->groupname} временные интервалы ({$a->booked}) и, таким образом, достигла минимума бронирований ({$a->slotsmin}).';
$string['myagpu_registered'] = '{$a->registered}/{$a->total} студентов зарегистрировались на встречу';
$string['myagpu_registered_group'] = '{$a->registered}/{$a->total} групп зарегистрировались на встречу';
$string['myagpu_registered_group_short'] = '{$a->registered} из {$a->total} групп забронировали минимальное количество интервалов: {$a->slotsmin}.';
$string['myagpu_registered_short'] = '{$a->registered} из {$a->total} участников забронировали минимальное количество интервалов: {$a->slotsmin}.';
$string['myagpu_upcoming_app'] = 'Ваша встреча состоится {$a->date} в {$a->time} в {$a->location}.';
$string['myagpu_upcoming_app_group'] = 'Встреча вашей группы {$a->groupname} состоится {$a->date} в {$a->time} в {$a->location}.';
...
$string['register_promotion_student:group:subject'] = 'Органайзер agpu: Группа перемещена в очереди';
...
$string['register_promotion_student:subject'] = 'Органайзер agpu: Перемещение в очереди';
...
$string['synchronizegroupmembers_help'] = 'Если участники группы agpu изменятся, то изменения будут внесены в забронированные слоты.';
