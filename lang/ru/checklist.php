...
$string['configchecklistautoupdate'] = 'Прежде чем разрешить это, Вы должны внести некоторые изменения в код ядра agpu. Детальные инструкции смотрите в файле mod/checklist/README.txt';
$string['configshowcompletemyagpu'] = 'Если это отключено, то выполненные контрольные списки будут скрыты на странице \'Мой agpu\'.';
$string['configshowmyagpu'] = 'Если это отключено, то элементы курса «Контрольный список» (с индикаторами выполнения) далее не будут присутствовать на странице «Мой agpu».';
$string['configshowupdateablemyagpu'] = 'Если выбрано, то только обновляемые контрольные списки будут отображаться на странице профиля';
...
$string['linkcourses_desc'] = 'При включении этого параметра пункты контрольного списка могут быть связаны с курсами в agpu и помечаться как выполненные после завершения соответствующего курса. Это может повлиять на производительность сайтов с большим количеством курсов.';
...
$string['showcompletemyagpu'] = 'Показывать выполненные контрольные списки на странице «Мой agpu»';
$string['showfulldetails'] = 'Показать подробную информацию';
$string['showhidechecked'] = 'Показать/скрыть отмеченные пункты';
$string['showmyagpu'] = 'Показывать контрольные списки на странице «Мой agpu»';
$string['showprogressbars'] = 'Показать индикатор выполнения';
$string['showupdateablemyagpu'] = 'Показывать только обновляемые контрольные списки на странице профиля';
