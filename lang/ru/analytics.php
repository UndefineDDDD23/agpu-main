...
$string['percentonline'] = 'Процент в agpu';
$string['percentonline_help'] = 'Если ваша организация предлагает смешанные или гибридные курсы, какой процент студенческой работы проводится онлайн в agpu? Введите число от 0 до 100.';
