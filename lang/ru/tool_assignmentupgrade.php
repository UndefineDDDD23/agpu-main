...
$string['notupgradedintro'] = 'На этой странице перечислены задания, созданные в более старой версии agpu. Они не были обновлены до нового модуля «Задание» в agpu 2.3. Если задания были созданы с помощью пользовательского подтипа, то не все они могут быть обновлены. Подтип должен быть обновлен до новой версии «Задание» для завершения обновления.';
