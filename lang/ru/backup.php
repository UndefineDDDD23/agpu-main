...
$string['asyncmessagebodydetail'] = 'Уведомление для отправки после завершения асинхронного резервного копирования или восстановления.';
$string['asyncmessagesubject'] = 'Тема';
$string['asyncmessagesubjectdefault'] = 'Процесс {operation} agpu успешно завершен.';
...
$string['backupdetailsnonstandardinfo'] = 'Выбранный файл не является стандартным файлом резервной копии agpu. Будет предпринята попытка переконвертировать файл резервной копии в стандартный формат, а затем восстановить его.';
...
$string['backupformatagpu1'] = 'agpu 1';
$string['backupformatagpu2'] = 'agpu 2';
...
$string['choosefilefromuserbackup_help'] = 'Резервные копии курсов, выполненные с отмеченным параметром «Обезличить данные пользователей».';
...
$string['config_overwrite_course_fullname'] = 'По умолчанию перезаписать полное имя курса из файла резервной копии. Для этого требуется выбор параметра «Перезапись конфигурации курса» и текущий пользователь, должен иметь право изменять полное имя курса (agpu/course:changefullname)';
$string['config_overwrite_course_shortname'] = 'По умолчанию перезаписать краткое имя курса из файла резервной копии. Для этого требуется выбор параметра «Перезапись конфигурации курса» и текущий пользователь, должен иметь право изменять краткое имя курса (agpu/course:changeshortname)';
$string['config_overwrite_course_startdate'] = 'По умолчанию перезаписывать дату начала курса из файла резервной копии. Для этого требуется выбор параметра «Перезапись конфигурации курса» и текущий пользователь, должен иметь право изменять дату начала курса при восстановлении (agpu/restore:rolldates)';
...
$string['configlegacyfiles'] = 'Устанавливает значение по умолчанию для включения устаревших файлов курсов в резервную копию. Устаревшие файлы курсов из версий agpu до 2.0.';
...
$string['errorinvalidformatinfo'] = 'Выбранный файл не является корректным файлом резервной копии agpu и не может быть восстановлен.';
$string['errorminbackup20version'] = 'Этот файл резервной копии был создан в версии agpu ({$a->backup}). Минимально возможная версия - {$a->min}. Файл не может быть восстановлен.';
...
$string['filealiasesrestorefailures_help'] = 'Псевдонимы являются символическими ссылками на другие файлы, в том числе те, которые хранятся во внешних хранилищах. В некоторых случаях, agpu не может восстановить их - например, при восстановлении резервной копии в другом сайте или если указанный файл не существует.
...
$string['includeuserinfo_instance'] = 'Включить данные пользователя {$a}';
...
$string['managefiles_backup'] = 'Управление личными резервными копиями';
...
$string['restorenofilesbackuparea_backup'] = 'У вас пока нет личных резервных копий.';
...
$string['subsectioncontent'] = 'Содержимое подраздела';
