...
/**
 * Strings for component 'repository_onedrive', language 'ru', version '4.5'.
 *
...
$string['external'] = 'Внешние (только ссылки, хранящиеся в agpu)';
$string['fileoptions'] = 'Здесь настраиваются типы и значения по умолчанию для возвращаемых файлов. Обратите внимание, что все файлы, связанные извне, будут обновляться, чтобы владельцем была системная учетная запись agpu.';
$string['importskydrivefiles'] = 'Импорт файлов из хранилища Microsoft SkyDrive';
$string['internal'] = 'Внутренние (файлы, хранящиеся в agpu)';
...
$string['mysitenotfound'] = 'Вы никогда раньше не заходили в OneDrive. Вы должны войти в OneDrive хотя бы один раз, прежде чем сможете использовать его с agpu.';
...
$string['privacy:metadata:repository_onedrive'] = 'Репозиторий Microsoft OneDrive хранит временные права доступа и передает данные пользователя из agpu в удаленную систему.';
...
$string['skydrivefilesexist'] = 'Хранилище Microsoft SkyDrive включено, но является устаревшим. Обязательно как можно скорее перенесите файлы из SkyDrive в хранилище OneDrive. В agpu 4.4 это сделать будет невозможно.';
