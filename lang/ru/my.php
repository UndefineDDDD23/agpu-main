...
$string['defaultpage'] = 'Страница «Мой agpu» по умолчанию';
...
$string['pinblocksexplan'] = 'Любая настройка блока, установленная здесь будет видима (и не редактируема) для любого пользователя системы на его странице «Мой agpu»';
