...
$string['seb:manage_seb_usesebclientconfig'] = 'Изменить настройку теста SEB: использовать конфигурацию пользователя SEB';
...
<br/>Никаких настроек Safe Exam Browser нет на стороне agpu. Тест можно выполнить с любой конфигурацией браузера Safe Exam.';
