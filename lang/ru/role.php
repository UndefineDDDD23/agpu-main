...
$string['ai:acceptpolicy'] = 'Устанавливать принятие пользователями политики ИИ';
...
$string['agpunet:shareactivity'] = 'Делиться активными элементами в agpuNet';
$string['agpunet:sharecourse'] = 'Делиться курсом в agpuNet';
