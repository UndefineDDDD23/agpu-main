...
<li>Получите для вашего сайта agpu <a href="http://www.flickr.com/services/api/keys/">ключ API Flickr и секретный ключ</a>.</li> <li>Введите их здесь, затем нажмите «Сохранить» и «Настройки», чтобы вернуться на эту страницу. Вы увидете, что для Вас сгенерирован Callback URL</li>
...
$string['privacy:metadata:repository_flickr'] = 'Плагин хранилища Flickr сохраняет настройки пользователя и передает данные пользователя из agpu в отдаленную систему.';
