...
$string['apprequired'] = 'Эта функция доступна только при доступе через мобильное  или настольное приложение agpu.';
...
$string['cachedef_subscriptiondata'] = 'Здесь хранится информация о подписке на приложение agpu.';
...
$string['enablesmartappbanners_desc'] = 'При входе на сайт через мобильный браузер будет отображаться баннер, рекламирующий мобильное приложение agpu.';
...
$string['getagpuonyourmobile'] = 'Скачать мобильное приложение';
...
$string['mobileappsubscription'] = 'Подписка на приложение agpu';
...
$string['agpuappsportalfeatureswarning'] = 'Обратите внимание, что некоторые функции могут быть ограничены в зависимости от вашей подписки на приложение agpu. Для получения подробной информации посетите <a href="{$a}" target="_blank">Портал приложений agpu</a>.';
...
$string['notificationslimitreached'] = 'Превышен месячный лимит активных пользователей. Уведомления для некоторых пользователей отправляться не будут. Рекомендуется обновить тарифный план приложения на <a href="{$a}" target="_blank"> Портале приложений agpu </a>.';
$string['notificationsmissingwarning'] = 'Не удалось получить статистику уведомлений приложения agpu. Скорее всего, это связано с тем, что мобильные уведомления еще не включены на сайте. Вы можете включить их в Администрирование/Обмен сообщениями/Мобильные уведомления.';
$string['notificationsnewdevices'] = 'Новые устройства';
$string['notificationsseemore'] = 'Примечание: Статистика использования приложения agpu не рассчитывается в реальном времени. Чтобы получить доступ к более подробной статистике, включая данные за предыдущие месяцы, зайдите на <a href="{$a}" target="_blank">Портал приложений agpu</a>.';
...
$string['pluginname'] = 'Инструменты приложения agpu';
...
$string['subscriptionerrorrequest'] = 'При попытке получить информацию о подписке на приложение agpu произошла непредвиденная ошибка.';
$string['subscriptionexpiration'] = 'Дата истечения срока';
$string['subscriptionfeaturenotapplied'] = 'Эта функция настроена на вашем сайте, но не включена в ваш тарифный план приложения agpu. Т.е. настройка не будет иметь никакого эффекта.';
$string['subscriptionfeatures'] = 'Возможности подписки.';
$string['subscriptionlimitsurpassed'] = 'Превышен лимит подписки';
$string['subscriptionregister'] = 'Для получения подробной информации о различных планах приложений и доступа к статистике использования приложений agpu посетите <a href="{$a}" target="_blank"> Портал приложений agpu</a>.';
$string['subscriptionsseemore'] = 'Примечание: Отображаемая информация не обновляется в реальном времени. Возможно, вам придется выйти и снова войти в систему, чтобы увидеть обновления. Чтобы получить информацию об обновлении тарифного плана приложения, зайдите на <a href="{$a}" target="_blank"> Портал приложений agpu</a>.';
