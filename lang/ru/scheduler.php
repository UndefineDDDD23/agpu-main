...
/**
 * Strings for component 'scheduler', language 'ru', version '4.5'.
 *
 * @package     scheduler
 * @category    string
...
$string['explaingeneralconfig'] = 'Эти параметры могут быть установлены только на уровне сайта и будут применены ко всем элементам курса «Планирование встреч» на этом сайте agpu.';
...
Учителя определяют промежутки времени для встреч, затем студенты выбирают один из них в agpu.
