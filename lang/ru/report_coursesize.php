...
/**
 * Strings for component 'report_coursesize', language 'ru', version '4.5'.
 *
...
$string['coursesize_desc'] = '<p>Этот отчет содержит только приблизительные значения. Если файл  несколько раз использовался в курсе или в нескольких курсах, отчет учитывает каждый экземпляр, хотя agpu хранит на диске только одну физическую версию.</p>';
