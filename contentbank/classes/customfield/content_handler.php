...
class content_handler extends \core_customfield\handler {
    ...
    public function can_configure(): bool {
        return has_capability('agpu/contentbank:configurecustomfields', $this->get_configuration_context());
    }
    ...
    public function can_edit(field_controller $field, int $instanceid = 0): bool {
        ...
        return (!$field->get_configdata_property('locked') ||
                has_capability('agpu/contentbank:changelockedcustomfields', $context));
    }
    ...
    public function get_configuration_url(): \agpu_url {
        return new \agpu_url('/contentbank/customfield.php');
    }
