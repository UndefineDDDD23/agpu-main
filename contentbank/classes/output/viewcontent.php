...
class viewcontent implements renderable, templatable {
    ...
    protected function get_edit_actions_dropdown(): ?array {
        ...
        if ($this->contenttype->can_manage($this->content)) {
            ...
            switch($this->content->get_visibility()) {
                ...
                case content::VISIBILITY_PUBLIC:
                    ...
                    break;
                default:
                    $url = new \agpu_url('/contentbank/index.php', ['contextid' => $this->content->get_contextid()]);
                    throw new agpu_exception('contentvisibilitynotfound', 'error', $url, $this->content->get_visibility());
            }
        ...
        if ($this->contenttype->can_download($this->content)) {
            $url = new agpu_url($this->contenttype->get_download_url($this->content));
    ...
    public function export_for_template(renderer_base $output): stdClass {
        ...
        if ($this->contenttype->can_edit($this->content)) {
            ...
            $editcontenturl = new agpu_url('/contentbank/edit.php', $urlparams);
        ...
        if (has_capability('agpu/contentbank:access', $context)) {
            $closeurl = new agpu_url('/contentbank/index.php', ['contextid' => $context->id]);
