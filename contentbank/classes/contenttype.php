...
abstract class contenttype {
    ...
    public function upload_content(stored_file $file, ?\stdClass $record = null): content {
        ...
        try {
            ...
            throw new \agpu_exception($e->errorcode);
        }
    ...
    public function get_view_url(content $content): string {
        return new agpu_url('/contentbank/view.php', ['id' => $content->get_id()]);
    }
    ...
    final public function can_access(): bool {
        ...
        $hascapabilities = has_capability('agpu/contentbank:access', $this->context)
    ...
    final public function can_upload(): bool {
        ...
        $hascapabilities = has_capability('agpu/contentbank:upload', $this->context)
    ...
    final public function can_delete(content $content): bool {
        ...
        $hascapability = has_capability('agpu/contentbank:deleteanycontent', $this->context);
        if ($content->get_content()->usercreated == $USER->id) {
            ...
            $hascapability = $hascapability || has_capability('agpu/contentbank:deleteowncontent', $this->context);
        }
    ...
    final public function can_manage(content $content): bool {
        ...
        $hascapability = has_capability('agpu/contentbank:manageanycontent', $this->context);
        if ($content->get_content()->usercreated == $USER->id) {
            // This content has been created by the current user; check if they can manage their content.
            $hascapability = $hascapability || has_capability('agpu/contentbank:manageowncontent', $this->context);
        }
    ...
    final public function can_edit(?content $content = null): bool {
        ...
        $hascapabilities = has_all_capabilities(['agpu/contentbank:useeditor', $editioncap], $this->context);
    ...
    final public function can_download(content $content): bool {
        ...
        $hascapability = has_capability('agpu/contentbank:downloadcontent', $this->context);
    ...
    final public function can_copy(content $content): bool {
        ...
        $hascapability = has_capability('agpu/contentbank:copyanycontent', $this->context);
        if (!$hascapability && ($content->get_content()->usercreated == $USER->id)) {
            $hascapability = has_capability('agpu/contentbank:copycontent', $this->context);
        }
