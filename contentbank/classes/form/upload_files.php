...
class upload_files extends \core_form\dynamic_form {
    ...
    protected function check_access_for_dynamic_submission(): void {
        require_capability('agpu/contentbank:upload', $this->get_context_for_dynamic_submission());
        ...
        if ($id) {
            ...
            if (!$contenttype->can_manage($content) || !$contenttype->can_upload()) {
                throw new \agpu_exception('nopermissions', 'error', '', null, get_string('replacecontent', 'contentbank'));
            }
        }
    }
    ...
    protected function get_options(): array {
        ...
        if (has_capability('agpu/user:ignoreuserquota', $this->get_context_for_dynamic_submission())) {
    ...
    public function process_dynamic_submission() {
        ...
        if (!empty($files)) {
            ...
            try {
                ...
                $url = new \agpu_url('/contentbank/view.php', $params);
                ...
                if ($this->get_data()->id) {
                    ...
                    $url = new \agpu_url('/contentbank/index.php', [
                        'contextid' => $this->get_context_for_dynamic_submission()->id,
                        'errormsg' => $e->errorcode],
                    );
                }
