...
class contenttype_test extends \advanced_testcase {
    ...
    public function test_can_delete(): void {
        ...
        unassign_capability('agpu/contentbank:deleteanycontent', $this->managerroleid);
        $this->assertTrue($this->contenttype->can_delete($managercontent));
    ...
    public function rename_content_provider() {
        return [
            ...
            'Name with symbols' => ['Follow us: @agpu', 'Follow us: @agpu', true],
    ...
    public function test_can_manage(): void {
        ...
        unassign_capability('agpu/contentbank:manageowncontent', $teacherroleid);
    ...
    public function test_can_download(): void {
        ...
        unassign_capability('agpu/contentbank:downloadcontent', $this->managerroleid);
