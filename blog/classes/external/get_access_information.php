 ...
 *
 * @package    core_blog
 * @copyright  2024 Juan Leyva <juan@agpu.com>
 * @category   external
...
class get_access_information extends external_api {
    ...
    public static function execute(): array {
        ...
        return [
            'canview' => has_capability('agpu/blog:view', $context),
            'cansearch' => has_capability('agpu/blog:search', $context),
            'canviewdrafts' => has_capability('agpu/blog:viewdrafts', $context),
            'cancreate' => has_capability('agpu/blog:create', $context),
            'canmanageentries' => has_capability('agpu/blog:manageentries', $context),
            'canmanageexternal' => has_capability('agpu/blog:manageexternal', $context),
            'warnings' => [],
        ];
    }
