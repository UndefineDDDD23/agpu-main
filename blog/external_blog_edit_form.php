...
/**
 * agpuform for the user interface for managing external blog links.
 *
 * @package    agpucore
 * @subpackage blog
...
class blog_edit_external_form extends agpuform {
    public function definition() {
        ...
        // To filter external blogs by their tags we do not need to check if tags in agpu are enabled.
