...
class provider_test extends provider_testcase {
    ...
    public function test_export_data_for_user(): void {
        ...
        // External blogs.
        $ex1 = $this->create_external_blog(['userid' => $u1->id, 'url' => 'https://agpu.org', 'name' => 'agpu RSS']);
    ...
    public function test_delete_data_for_users_external_blog(): void {
        ...
        $post = $this->create_external_blog(['userid' => $u1->id, 'url' => 'https://agpu.org', 'name' => 'agpu RSS']);
        $post2 = $this->create_external_blog(['userid' => $u2->id, 'url' => 'https://agpu.com', 'name' => 'Some other thing']);
