...
final class externallib_test extends externallib_advanced_testcase {
    ...
    public static function get_enrolled_users_visibility_provider(): array {
        return array(
            ...
            'Course with separate groups, default behavior (not filtering but having agpu/site:accessallgroups)' =>
            array(
                'settings' => array(
                    'coursegroupmode' => VISIBLEGROUPS,
                    'withcapability' => null,
                    'groupid' => null,
                    'onlyactive' => false,
                    'allowedcaps' => array('agpu/site:accessallgroups'),
                ),
                'results' => array( // Everybody can view everybody.
                    'user0' => array('canview' => array('user0', 'user1', 'user2', 'user2su', 'user31', 'user32', 'userall')),
                    'user1' => array('canview' => array('user0', 'user1', 'user2', 'user2su', 'user31', 'user32', 'userall')),
            ...
            'Course with separate groups, filtering onlyactive (missing agpu/course:enrolreview)' =>
            array(
                'settings' => array(
                    'coursegroupmode' => SEPARATEGROUPS,
                    'withcapability' => null,
            ...
            'Course with separate groups, filtering onlyactive (having agpu/course:enrolreview)' =>
            array(
                'settings' => array(
                    'coursegroupmode' => SEPARATEGROUPS,
                    'withcapability' => null,
                    'groupid' => null,
                    'onlyactive' => true,
                    'allowedcaps' => array('agpu/course:enrolreview'),
                ),
            ...
            'Course with separate groups, filtering by groupid (not having agpu/site:accessallgroups)' =>
            array(
                'settings' => array(
                    'coursegroupmode' => SEPARATEGROUPS,
                    'withcapability' => null,
            ...
            'Course with separate groups, filtering by groupid (having agpu/site:accessallgroups)' =>
            array(
                'settings' => array(
                    'coursegroupmode' => SEPARATEGROUPS,
                    'withcapability' => null,
                ...
                'results' => array( // All users with 'agpu/site:accessallgroups' can view group 2
            ...
            'Course with separate groups, filtering by withcapability (not having agpu/role:review)' =>
            array(
                'settings' => array(
                    'coursegroupmode' => SEPARATEGROUPS,
                    'withcapability' => 'agpu/course:bulkmessaging',
                    'groupid' => null,
                    'onlyactive' => false,
                    'allowedcaps' => array(),
                ),
                'results' => array( // No user has 'agpu/role:review' so exception.
                    'user0' => array('exception' => array(
                        'type' => 'required_capability_exception',
            ...
            'Course with separate groups, filtering by withcapability (having agpu/role:review)' =>
            array(
                'settings' => array(
                    'coursegroupmode' => SEPARATEGROUPS,
                    'withcapability' => 'agpu/course:bulkmessaging',
                    'groupid' => null,
                    'onlyactive' => false,
                    'allowedcaps' => array('agpu/role:review'),
                ),
                'results' => array( // No user has withcapability, but all have 'agpu/role:review'. Empties.
            ...
            'Course with separate groups, filtering by withcapability (having agpu/role:review & agpu/course:bulkmessaging)' =>
            array(
                'settings' => array(
                    'coursegroupmode' => SEPARATEGROUPS,
                    'withcapability' => 'agpu/course:bulkmessaging',
                    'groupid' => null,
                    'onlyactive' => false,
                    'allowedcaps' => array('agpu/role:review', 'agpu/course:bulkmessaging'),
                ),
                'results' => array( // Users (previous) have withcapability, and all have 'agpu/role:review'.
                    'user0' => array('canview' => array()),
    ...
    public function test_get_enrolled_users_active_suspended(): void {
        ...
        $roleid = $this->getDataGenerator()->create_role();
        // Allow the specified capabilities.
        assign_capability('agpu/course:enrolreview', CAP_ALLOW, $roleid, $coursecontext);
        assign_capability('agpu/user:viewalldetails', CAP_ALLOW, $roleid, $coursecontext);
    ...
    public function test_get_users_courses(): void {
        ...
        foreach ($enrolledincourses as $courseenrol) {
            if ($courseenrol['id'] == $course1->id) {
                ...
                $url = "https://www.example.com/agpu/pluginfile.php/{$contexts[$course1->id]->id}/course/generated/course.svg";
                ...
                $url = "https://www.example.com/agpu/pluginfile.php/{$contexts[$course2->id]->id}/course/generated/course.svg";
                $this->assertEquals($url, $courseenrol['courseimage']);
            }
        }
    ...
    public function test_get_users_courses_can_view_participants(): void {
        ...
        assign_capability('agpu/course:viewparticipants', CAP_PROHIBIT, $studentrole, $context->id);
    ...
    public function get_enrolled_users_setup($capability) {
        ...
        $this->assignUserCapability('agpu/user:viewdetails', $return->context->id, $return->roleid);
    ...
    public function test_get_enrolled_users_without_parameters(): void {
        $capability = 'agpu/course:viewparticipants';
