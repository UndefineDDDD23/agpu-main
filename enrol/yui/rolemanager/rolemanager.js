YUI.add('agpu-enrol-rolemanager', function(Y) {

    var MOD_NAME                    = 'agpu role manager',
        MOD_USER                    = 'agpu role user',
        MOD_PANEL                   = 'agpu role assignment panel',
        USERIDS                     = 'userIds',
        COURSEID                    = 'courseId',
        USERID                      = 'userId',
        CONTAINER                   = 'container',
    ...
    Y.extend(ROLEPANEL, Y.Base, {
        ...
        initializer : function() {
            ...
            var element = Y.Node.create('<div class="popover popover-bottom"><div class="arrow"></div>' +
                                        ...
                                        M.util.get_string('closebuttontitle', 'agpu') + '">' +
...
}, '@VERSION@', {requires:['base','node','io-base','json-parse','test','agpu-core-notification']});
