...
navigation_node::override_active_url(new agpu_url('/admin/settings.php', array('section'=>'manageenrols')));
admin_externalpage_setup('enroltestsettings');

$returnurl = new agpu_url('/admin/settings.php', array('section'=>'manageenrols'));
...
if (!$enrol) {
    ...
    $url = new agpu_url('/enrol/test_settings.php');
