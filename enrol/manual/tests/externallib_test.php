...
class externallib_test extends externallib_advanced_testcase {
    ...
    public function test_enrol_users(): void {
        ...
        $this->assignUserCapability('agpu/course:view', $context1->id, $roleid);
        $this->assignUserCapability('agpu/role:assign', $context1->id, $roleid);
        $this->assignUserCapability('enrol/manual:enrol', $context2->id, $roleid);
        $this->assignUserCapability('agpu/course:view', $context2->id, $roleid);
        $this->assignUserCapability('agpu/role:assign', $context2->id, $roleid);
    ...
    public function test_unenrol_user_single(): void {
        ...
        $this->assignUserCapability('agpu/course:view', $coursecontext, $roleid);
        $this->assignUserCapability('agpu/role:assign', $coursecontext, $roleid);
    ...
    public function test_unenrol_user_error_no_capability(): void {
        ...
        $roleid = $this->assignUserCapability('agpu/course:view', $coursecontext);
        try {
            enrol_manual_external::unenrol_users(array(
                array('userid' => $student->id, 'courseid' => $course->id),
            ));
