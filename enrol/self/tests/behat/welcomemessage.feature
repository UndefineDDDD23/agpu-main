...
Feature: A course welcome message will be sent to the user when they auto-enrol themself in a course
  ...
  Scenario: Manager should see the new settings for course welcome message
    ...
    And I should see "Accepted formats: Plain text or agpu-auto format. HTML tags and multi-lang tags are also accepted, as well as the following placeholders:"
    And I set the field "Send course welcome message" to "No"
    And I should not see "Custom welcome message"
    And I should not see "Accepted formats: Plain text or agpu-auto format. HTML tags and multi-lang tags are also accepted, as well as the following placeholders:"
