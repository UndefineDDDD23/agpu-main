...
if (empty($messagelaunch)) {
    throw new agpu_exception('Bad launch. Deep linking launch data could not be found');
}
...
$auth->complete_login(
    ...
    new agpu_url('/enrol/lti/launch_deeplink.php', ['launchid' => $messagelaunch->getLaunchId()]),
...
$url = new agpu_url('/enrol/lti/launch_deeplink.php');
$PAGE->set_url($url);
