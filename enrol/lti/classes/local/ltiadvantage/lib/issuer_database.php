...
class issuer_database implements IDatabase {
    ...
    public function findRegistrationByIssuer(string $iss, ?string $clientId = null): ?LtiRegistration {
        ...
        global $CFG;
        require_once($CFG->libdir . '/agpulib.php'); // For get_config() usage.
        ...
        // that is a part of the initiate login URI allows agpu to locate the registration for that unique client, without the
