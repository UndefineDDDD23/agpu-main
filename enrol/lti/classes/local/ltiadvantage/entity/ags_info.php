...
class ags_info {
    ...
    /** @var \agpu_url|null The service URL used to get/put lineitems, if supported*/
    private $lineitemsurl;

    /** @var \agpu_url|null The lineitemurl, which is only present when a single lineitem is supported.*/
    private $lineitemurl;
     ...
     *
     * @param \agpu_url|null $lineitemsurl The service URL used to get/put lineitems, if supported.
     * @param \agpu_url|null $lineitemurl The lineitemurl, which is only present when a single lineitem is supported.
     * @param array $scopes The array of supported scopes for this service instance.
     */
    private function __construct(?\agpu_url $lineitemsurl, ?\agpu_url $lineitemurl, array $scopes) {
     ...
     */
    public static function create(?\agpu_url $lineitemsurl = null, ?\agpu_url $lineitemurl = null,
     ...
     *
     * @return \agpu_url the url.
     */
    public function get_lineitemsurl(): ?\agpu_url {
     ...
     *
     * @return \agpu_url|null the url, or null if not present.
     */
    public function get_lineitemurl(): ?\agpu_url {
