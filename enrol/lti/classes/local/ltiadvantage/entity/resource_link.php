...
class resource_link {
     ...
     *
     * @param \agpu_url|null $lineitemsurl the service URL for get/put of line items, if supported.
     * @param \agpu_url|null $lineitemurl the service URL if only a single line item is present in the platform.
     * @param string[] $scopes the string array of grade service scopes which may be used by the service.
     */
    public function add_grade_service(?\agpu_url $lineitemsurl = null, ?\agpu_url $lineitemurl = null, array $scopes = []) {
     ...
     *
     * @param \agpu_url $contextmembershipurl the service URL for memberships.
     * @param string[] $serviceversions the string array of supported service versions.
     */
    public function add_names_and_roles_service(\agpu_url $contextmembershipurl, array $serviceversions): void {
     ...
     *
     * @param int $userid the id of the agpu user record.
