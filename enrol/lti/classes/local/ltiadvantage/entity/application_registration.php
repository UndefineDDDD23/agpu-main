 ...
 * Each registered application may contain one or more deployments of the agpu tool.
...
class application_registration {
    ...
    /** @var \agpu_url the issuer identifying the platform, as provided by the platform. */
    private $platformid;

    /** @var string the client id as provided by the platform. */
    private $clientid;

    /** @var \agpu_url the authentication request URL, as provided by the platform. */
    private $authenticationrequesturl;

    /** @var \agpu_url the certificate URL, as provided by the platform. */
    private $jwksurl;

    /** @var \agpu_url the access token URL, as provided by the platform. */
     ...
     * @param \agpu_url|null $platformid the URL of application
     * @param string|null $clientid unique id for the client on the application
     * @param \agpu_url|null $authenticationrequesturl URL to send OIDC Auth requests to.
     * @param \agpu_url|null $jwksurl URL to use to get public keys from the application.
     * @param \agpu_url|null $accesstokenurl URL to use to get an access token from the application, used in service calls.
     * @param int|null $id the id of the object instance, if being created from an existing store item.
     */
    private function __construct(string $name, string $uniqueid, ?\agpu_url $platformid, ?string $clientid,
            ?\agpu_url $authenticationrequesturl, ?\agpu_url $jwksurl, ?\agpu_url $accesstokenurl, ?int $id = null) {
     ...
     * @param string $name the descriptor for this application registration.
     * @param string $uniqueid a unique identifier for the registration used in place of client_id in the login URI.
     * @param \agpu_url $platformid the URL of application
     * @param string $clientid unique id for the client on the application
     * @param \agpu_url $authenticationrequesturl URL to send OIDC Auth requests to.
     * @param \agpu_url $jwksurl URL to use to get public keys from the application.
     * @param \agpu_url $accesstokenurl URL to use to get an access token from the application, used in service calls.
     * @param int|null $id the id of the object instance, if being created from an existing store item.
     ...
     */
    public static function create(string $name, string $uniqueid, \agpu_url $platformid, string $clientid,
            \agpu_url $authenticationrequesturl, \agpu_url $jwksurl, \agpu_url $accesstokenurl,
     ...
     * Get the platform id.
     *
     * @return \agpu_url|null the platformid/issuer URL.
     */
    public function get_platformid(): ?\agpu_url {
     ...
     *
     * @param \agpu_url $platformid the platform id / iss to set.
     */
    public function set_platformid(\agpu_url $platformid): void {
        $this->platformid = $platformid;
    }
     ...
     *
     * @return \agpu_url|null the authentication request URL.
     */
    public function get_authenticationrequesturl(): ?\agpu_url {
     ...
     *
     * @param \agpu_url $authenticationrequesturl the authentication request URL.
     */
    public function set_authenticationrequesturl(\agpu_url $authenticationrequesturl): void {
        $this->authenticationrequesturl = $authenticationrequesturl;
    }
     ...
     * Get the JWKS URL.
     *
     * @return \agpu_url|null the JWKS URL.
     */
    public function get_jwksurl(): ?\agpu_url {
        return $this->jwksurl;
    }
     ...
     *
     * @param \agpu_url $jwksurl the JWKS URL.
     */
    public function set_jwksurl(\agpu_url $jwksurl): void {
        $this->jwksurl = $jwksurl;
    }
     ...
     *
     * @return \agpu_url|null the access token URL.
     */
    public function get_accesstokenurl(): ?\agpu_url {
     ...
     *
     * @param \agpu_url $accesstokenurl the access token URL.
     */
    public function set_accesstokenurl(\agpu_url $accesstokenurl): void {
        $this->accesstokenurl = $accesstokenurl;
    }
