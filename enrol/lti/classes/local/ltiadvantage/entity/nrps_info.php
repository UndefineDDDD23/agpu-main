...
class nrps_info {
    ...
    /** @var \agpu_url the memberships URL for the service. */
     ...
     *
     * @param \agpu_url $contextmembershipsurl the memberships URL.
     * @param string[] $serviceversions the supported service versions.
     */
    private function __construct(\agpu_url $contextmembershipsurl, array $serviceversions = [self::SERVICE_VERSION_2]) {
     ...
     */
    public static function create(\agpu_url $contextmembershipsurl,
     ...
     *
     * @return \agpu_url the service URL.
     */
    public function get_context_memberships_url(): \agpu_url {
