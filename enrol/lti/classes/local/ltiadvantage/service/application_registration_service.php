...
class application_registration_service {
    ...
    private function registration_from_dto(\stdClass $dto): application_registration {
        ...
        $registration->set_platformid(new \agpu_url($dto->platformid));
        $registration->set_clientid($dto->clientid);
        $registration->set_accesstokenurl(new \agpu_url($dto->accesstokenurl));
        $registration->set_jwksurl(new \agpu_url($dto->jwksurl));
        $registration->set_authenticationrequesturl(new \agpu_url($dto->authenticationrequesturl));
