...
class issuer_database_test extends \advanced_testcase {
    ...
    /**
     * Test the agpu implementation of the library database method test_find_registration_by_issuer().
     *
    ...
    public function test_find_registration_by_issuer(): void {
        ...
        $appreg = application_registration::create(
            'My platform',
            'a2c94a2c94',
            new \agpu_url('https://lms.example.com'),
            'client-id-123',
            new \agpu_url('https://lms.example.com/lti/auth'),
            new \agpu_url('https://lms.example.com/lti/jwks'),
            new \agpu_url('https://lms.example.com/lti/token')
        );
    ...
    /**
     * Test the agpu implementation of the library database method test_find_deployment().
     *
