...
class resource_link_repository_test extends \advanced_testcase {
    ...
    protected function generate_resource_link($id = 'res-link-1'): resource_link {
        $registration = application_registration::create(
            'Test',
            'a2c94a2c94',
            new \agpu_url('http://lms.example.org'),
            'clientid_123',
        ...
        $resourcelink->add_grade_service(
            new \agpu_url('https://lms.example.com/context/24/lineitems'),
            new \agpu_url('https://lms.example.com/context/24/lineitem/3'),
            [
        ...
        $resourcelink->add_names_and_roles_service(
            new \agpu_url('https://lms.example.com/context/24/memberships'),
            [1.0, 2.0]
        );
    ...
    public function test_save_existing(): void {
        ...
        $newreslink->add_grade_service(
            new \agpu_url('https://lms.example.org/context/lineitems')
        );
