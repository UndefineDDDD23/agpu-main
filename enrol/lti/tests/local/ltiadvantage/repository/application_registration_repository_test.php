...
class application_registration_repository_test extends \advanced_testcase {
    ...
    protected function generate_application_registration(?string $issuer = null, ?string $uniqueid = null,
        ...
        return application_registration::create(
            ...
            new \agpu_url($issuer),
            $clientid,
            new \agpu_url('https://example.org/authrequesturl'),
            new \agpu_url('https://example.org/jwksurl'),
            new \agpu_url('https://example.org/accesstokenurl')
        );
    }
        ...
        return [
            ...
            'draft with only some properties completed' => [
                'registrationdata' => [
                    'name' => 'My test platform',
                    'uniqueid' => 'acbhd4355',
                    'platformid' => new \agpu_url('https://lms.example.com'),
                    'clientid' => 'abc345',
                ]
            ],
            'draft with all fields completed, not marked complete' => [
                'registrationdata' => [
                    ...
                    'platformid' => new \agpu_url('https://lms.example.com'),
                    'clientid' => 'abc345',
                    'authenticationrequesturl' => new \agpu_url('https://lms.example.com/auth'),
                    'jwksurl' => new \agpu_url('https://lms.example.com/jwks'),
                    'accesstokenurl' => new \agpu_url('https://lms.example.com/token'),
                ]
            ],
    ...
    public function test_save_existing(): void {
        ...
        $createddraft->set_platformid(new \agpu_url('https://lms.example.com'));
        $createddraft->set_clientid(new \agpu_url('clientid_test_33333'));
        $createddraft->set_name('Something else');
        $createddraft->set_jwksurl(new \agpu_url('https://lms.example.com/jwks'));
        $createddraft->set_authenticationrequesturl(new \agpu_url('https://lms.example.com/auth'));
        $createddraft->set_accesstokenurl(new \agpu_url('https://lms.example.com/token'));
        ...
        $registration = application_registration::create(
            'My platform name',
            'a2c94a2c94',
            new \agpu_url('https://updated-lms.example.org/'),
            'Updated-client-id',
            new \agpu_url('https://updated-lms.example.org/auth'),
            new \agpu_url('https://updated-lms.example.org/jwks'),
            new \agpu_url('https://updated-lms.example.org/token'),
        );
