...
class application_registration_service_test extends \lti_advantage_testcase {
    ...
    public function test_update_application_registration(): void {
        ...
        $this->assertEquals(new \agpu_url($updatedto->platformid), $reg->get_platformid());
        $this->assertEquals($updatedto->clientid, $reg->get_clientid());
        $this->assertEquals(new \agpu_url($updatedto->authenticationrequesturl), $reg->get_authenticationrequesturl());
        $this->assertEquals(new \agpu_url($updatedto->jwksurl), $reg->get_jwksurl());
        $this->assertEquals(new \agpu_url($updatedto->accesstokenurl), $reg->get_accesstokenurl());
