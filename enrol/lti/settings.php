...
$settings = new admin_settingpage($section, "User default values", 'agpu/site:config', $this->is_enabled() === false);
...
$settings = new admin_settingpage('enrolsettingslti_registrations', "Tool registration", 'agpu/site:config',
    $this->is_enabled() === false);
