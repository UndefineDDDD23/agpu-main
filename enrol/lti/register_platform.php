...
$toolregistrationurl = new agpu_url($CFG->wwwroot . "/" . $CFG->admin . "/settings.php",
...
$pagesetup = function(string $pagetitle) {
    ...
    navigation_node::override_active_url(
        new agpu_url('/admin/settings.php', ['section' => 'enrolsettingslti_registrations'])
    );
...
if ($action == 'view') {
    ...
    $pageurl = new agpu_url('/enrol/lti/register_platform.php', ['action' => 'view', 'regid' => $regid]);
    ...
    $pageurl = new agpu_url('/enrol/lti/register_platform.php', ['action' => 'add']);
    ...
    if ($data = $mform->get_data()) {
        ...
        redirect(new agpu_url('/enrol/lti/register_platform.php',
    ...
    $pageurl = new agpu_url('/enrol/lti/register_platform.php', ['action' => 'edit', 'regid' => $regid]);
    $viewurl = new agpu_url('/enrol/lti/register_platform.php', ['action' => 'view', 'regid' => $regid]);
    ...
    if (!optional_param('confirm', false, PARAM_BOOL)) {
        ...
        $continueurl = new agpu_url('/enrol/lti/register_platform.php', $continueparams);
