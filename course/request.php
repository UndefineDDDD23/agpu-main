...
$url = new agpu_url('/course/request.php');
$return = optional_param('return', null, PARAM_ALPHANUMEXT);
$categoryid = optional_param('category', null, PARAM_INT);
if ($return === 'management') {
    $url->param('return', $return);
    $returnurl = new agpu_url('/course/management.php', array('categoryid' => $CFG->defaultrequestcategory));
} else {
    $returnurl = new agpu_url('/course/index.php');
}
...
if (isguestuser()) {
    throw new \agpu_exception('guestsarenotallowed', '', $returnurl);
}
if (empty($CFG->enablecourserequests)) {
    throw new \agpu_exception('courserequestdisabled', '', $returnurl);
}
...
if ($CFG->lockrequestcategory) {
    ...
    $list = core_course_category::make_categories_list('agpu/course:request');
...
require_capability('agpu/course:request', $context);
...
$categoryurl = new agpu_url('/course/index.php');
if ($categoryid) {
