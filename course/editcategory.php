...
$url = new agpu_url('/course/editcategory.php');
if ($id) {
    ...
    navigation_node::override_active_url(new agpu_url('/course/index.php', ['categoryid' => $category->id]));
    ...
    if ($parent) {
        ...
        navigation_node::override_active_url(new agpu_url('/course/index.php', ['categoryid' => $parent]));
...
$manageurl = new agpu_url('/course/management.php');
