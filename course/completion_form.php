 ...
 */
class course_completion_form extends agpuform {
    ...
    public function definition() {
        ...
        $roles = get_roles_with_capability('agpu/course:markcomplete', CAP_ALLOW, context_course::instance($course->id, IGNORE_MISSING));
