...
navigation_node::override_active_url(new agpu_url('/course/completion.php', array('id' => $course->id)));
$PAGE->set_url(new agpu_url('/course/editbulkcompletion.php', ['id' => $courseid]));
$PAGE->set_title($course->shortname);
$PAGE->set_heading($course->fullname);
$PAGE->set_pagelayout('admin');

if (!core_completion\manager::can_edit_bulk_completion($course)) {
    require_capability('agpu/course:manageactivities', context_course::instance($course->id));
}
...
$returnurl = new agpu_url('/course/bulkcompletion.php', ['id' => $course->id]);
