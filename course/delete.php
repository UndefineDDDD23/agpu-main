...
if ($SITE->id == $course->id || !can_delete_course($id)) {
    ...
    throw new \agpu_exception('cannotdeletecourse');
}
...
navigation_node::override_active_url(new agpu_url('/course/management.php', array('categoryid'=>$course->category)));
...
if (!async_helper::is_async_pending($id, 'course', 'backup')) {
    ...
    $continueurl = new agpu_url('/course/delete.php', array('id' => $course->id, 'delete' => md5($course->timemodified)));
