...
class availability implements named_templatable, renderable {
    ...
    protected function get_info(\renderer_base $output): array {
        ...
        $canviewhidden = has_capability('agpu/course:viewhiddensections', $context, $USER);

        $editurl = new \agpu_url(
     ...
     *
     * @deprecated since agpu 4.3 MDL-78204. Please use {@see self::get_availability_data} instead.
     * @todo MDL-78489 This will be deleted in agpu 4.7.
