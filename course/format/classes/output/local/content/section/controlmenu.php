...
class controlmenu extends basecontrolmenu {
    ...
    public function section_control_items() {
        ...
        if (!$isstealth && has_capability('agpu/course:update', $coursecontext, $user)) {
        ...
        if ($section->section) {
            ...
            if (!$isstealth) {
                if (has_capability('agpu/course:sectionvisibility', $coursecontext, $user)) {
                ...
                if (!$sectionreturn && has_capability('agpu/course:movesections', $coursecontext, $user)) {
                    if ($usecomponents) {
