...
class cm implements named_templatable, renderable {
    ...
    protected function add_editor_data(stdClass &$data, renderer_base $output): bool {
        ...
        $editcaps = [];
        if (has_capability('agpu/course:activityvisibility', $coursecontext)) {
            $editcaps = ['agpu/course:activityvisibility'];
        }
    ...
    protected function load_classes() {
        ...
        if ($mod->uservisible) {
            ...
            $accessiblebutdim = (!$mod->visible || $conditionalhidden) &&
                has_capability('agpu/course:viewhiddenactivities', $mod->context);
