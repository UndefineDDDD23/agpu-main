...
Feature: Verify edit utils availability
  ...
  As a student with capability 'agpu/course:manageactivities'
  ...
  Background:
    ...
    And the following "permission overrides" exist:
      ...
      | agpu/course:manageactivities | Allow      | author | Course       | C1        |
  ...
  @javascript
  Scenario: Section adding should be available to students if they also have the capability 'agpu/course:update'.
    Given the following "permission overrides" exist:
      | capability           | permission | role   | contextlevel | reference |
      | agpu/course:update | Allow      | author | Course       | C1        |
