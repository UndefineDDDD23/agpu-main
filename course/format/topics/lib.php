...
class format_topics extends core_courseformat\base {
    ...
    public function get_view_url($section, $options = []) {
        ...
        return new agpu_url('/course/view.php', ['id' => $course->id]);
    }
     ...
     *
     * @param stdClass|array $data return value from {@link agpuform::get_data()} or array with data
    ...
    public function section_action($section, $action, $sr) {
        ...
        if ($section->section && ($action === 'setmarker' || $action === 'removemarker')) {
            ...
            require_capability('agpu/course:setcurrentsection', context_course::instance($this->courseid));
