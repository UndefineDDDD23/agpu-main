...
export default class Component extends BaseComponent {
    ...
    async _updatePageTitle(enabled) {
        ...
        if (enableBulk.dataset.sectiontitle) {
            ...
            bulkEditTitle = await getString('coursesectiontitlebulkediting', 'agpu', params);
            editingTitle = await getString('coursesectiontitleediting', 'agpu', params);
        } else {
            // Whole course editing mode.
            params = {
                course: enableBulk.dataset.coursename
            };
            bulkEditTitle = await getString('coursetitlebulkediting', 'agpu', params);
            editingTitle = await getString('coursetitleediting', 'agpu', params);
        }
