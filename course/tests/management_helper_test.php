...
class management_helper_test extends \advanced_testcase {
    ...
    /** Category management capability: agpu/category:manage */
    const CATEGORY_MANAGE = 'agpu/category:manage';
    /** View hidden category capability: agpu/category:viewhiddencategories */
    const CATEGORY_VIEWHIDDEN = 'agpu/category:viewhiddencategories';
    /** View course capability: agpu/course:visibility */
    const COURSE_VIEW = 'agpu/course:visibility';
    /** View hidden course capability: agpu/course:viewhiddencourses */
    const COURSE_VIEWHIDDEN = 'agpu/course:viewhiddencourses';
     ...
     *
     * In order to show/hide the user must have agpu/category:manage on the parent context.
     * In order to view hidden categories the user must have agpu/category:viewhiddencategories
     */
    ...
    public function test_action_category_move_courses_into(): void {
        ...
        } catch (\agpu_exception $exception) {
    ...
    public function test_get_category_listitem_actions(): void {
        ...
        $PAGE->set_url(new \agpu_url('/course/management.php'));
