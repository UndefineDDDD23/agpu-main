...
if (!$course->visible and !has_capability('agpu/course:viewhiddencourses', $context)) {
    throw new \agpu_exception('coursehidden', '', $CFG->wwwroot .'/');
}
require_capability('agpu/course:tag', $context);
...
$redirecturl = $returnurl ? new agpu_url($returnurl) : course_get_url($course);
