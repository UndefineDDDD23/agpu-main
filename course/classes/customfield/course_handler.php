...
class course_handler extends \core_customfield\handler {
    ...
    public function can_configure(): bool {
        return has_capability('agpu/course:configurecustomfields', $this->get_configuration_context());
    }
    ...
    public function can_edit(field_controller $field, int $instanceid = 0): bool {
        if ($instanceid) {
            ...
            return (!$field->get_configdata_property('locked') ||
                    has_capability('agpu/course:changelockedcustomfields', $context));
        } else {
            ...
            if ($context->contextlevel == CONTEXT_SYSTEM) {
                ...
                return (!$field->get_configdata_property('locked') ||
                    guess_if_creator_will_have_course_capability('agpu/course:changelockedcustomfields', $context));
            }
        }
    }
    ...
    public function can_view(field_controller $field, int $instanceid): bool {
        ...
        if ($visibility == self::NOTVISIBLE) {
            ...
            return has_capability('agpu/course:update', $this->get_instance_context($instanceid));
        } else {
            return true;
        }
    }
     ...
     *
     * @return \agpu_url The URL to configure custom fields for this component
     */
    public function get_configuration_url(): \agpu_url {
        return new \agpu_url('/course/customfield.php');
    }
