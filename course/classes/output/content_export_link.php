...
class content_export_link {
    ...
    public static function get_attributes(\context $context): \stdClass {
        ...
        $downloadattr->url = new \agpu_url('/course/downloadcontent.php', ['contextid' => $context->id]);
        ...
        $downloadlink = new \agpu_url('/course/downloadcontent.php', ['contextid' => $context->id, 'download' => 1]);
