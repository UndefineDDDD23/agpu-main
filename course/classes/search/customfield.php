 ...
 *
 * @package core_course
 * @copyright Toni Barbera <toni@agpu.com>
...
class customfield extends \core_search\base {
     ...
     * @return \agpu_recordset|null Recordset or null if no change possible
     */
    ...
    public function check_access($id) {
        ...
        $userenrolled = is_enrolled($context) &&
            ($course->visible || has_capability('agpu/course:viewhiddencourses', $context));
    ...
    public function get_context_url(\core_search\document $doc) {
        return new \agpu_url('/course/view.php', array('id' => $doc->get('courseid')));
    }
