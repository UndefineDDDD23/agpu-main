 ...
 *
 * @package     core_course
 * @copyright   2022 David Matamoros <davidmc@agpu.com>
...
class enrolment extends base {
    ...
    protected function get_all_columns(): array {
        ...
        // Enrolment method column (Deprecated since agpu 4.3, to remove in MDL-78118).
        $columns[] = (new column(
            'method',
        ...
        $columns[] = (new column(
            'timecreated',
            new lang_string('timecreated', 'agpu'),
            $this->get_entity_name()
        ))
            ->add_joins($this->get_joins())
        ...
        // Role column (Deprecated since agpu 4.3, to remove in MDL-78118).
        $ctx = database::generate_alias();
        $ra = database::generate_alias();
        $r = database::generate_alias();
        $columns[] = (new column(
            'role',
            new lang_string('role', 'agpu'),
            $this->get_entity_name()
        ))
            ->add_joins($this->get_joins())
    ...
    protected function get_all_filters(): array {
        ...
        // Enrolment method (Deprecated since agpu 4.3, to remove in MDL-78118).
