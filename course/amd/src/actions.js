...
define(
    ...
    function(
        ...
        var SELECTOR = {
            ...
            MENU: '.agpu-actionmenu[data-enhance=agpu-core-actionmenu]',
        ...
        Y.use('agpu-course-coursebase', function() {
        ...
        /**
         * Wrapper for Y.agpu.core_course.util.cm.getId
         *
        ...
        var getModuleId = function(element) {
            ...
            let id;
            Y.use('agpu-course-util', function(Y) {
                id = Y.agpu.core_course.util.cm.getId(Y.Node(item));
            });
            return id;
        };

        /**
         * Wrapper for Y.agpu.core_course.util.cm.getName
         *
         * @param {JQuery} element
         * @returns {String}
         */
        var getModuleName = function(element) {
            var name;
            Y.use('agpu-course-util', function(Y) {
                name = Y.agpu.core_course.util.cm.getName(Y.Node(element.get(0)));
            });
        ...
        // From agpu 4.0 all edit actions are being re-implemented as state mutation.
        ...
        courseeditor.addMutations({
            /**
             * Compatibility function to update agpu 4.0 course state using legacy actions.
             *
