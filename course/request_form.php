 ...
 */
class course_request_form extends agpuform {
    function definition() {
        global $CFG, $DB, $USER;
        ...
        if (empty($CFG->lockrequestcategory)) {
            $displaylist = core_course_category::make_categories_list('agpu/course:request');
 ...
 */
class reject_request_form extends agpuform {
    function definition() {
        $mform =& $this->_form;
