 ...
 * mod/{modname}/mod_form.php replaced deprecated mod/{modname}/mod.html agpuform.
 *
 * @package   core_course
 * @copyright Andrew Nicols <andrew@nicols.co.uk>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class agpuform_mod extends agpuform {
    ...
    public function __construct($current, $section, $cm, $course) {
        ...
        if (is_null($this->_modname)) {
            ...
            if (!preg_match('/^mod_([^_]+)_mod_form$/', get_class($this), $matches)) {
                ...
                throw new \agpu_exception('unknownmodulename');
            }
     ...
     */
    public function agpuform_mod($current, $section, $cm, $course) {
    ...
    protected function standard_coursemodule_elements() {
        ...
        if (!empty($this->_cm) && !has_capability('agpu/course:activityvisibility', $this->get_context())) {
        ...
        if (has_capability('agpu/course:setforcedlanguage', $this->get_context())) {
        ...
        if ($CFG->downloadcoursecontentallowed) {
                ...
                if (has_capability('agpu/course:configuredownloadcontent', $this->get_context())) {
    ...
    protected function add_rating_settings($mform, int $itemnumber) {
        ...
        $rolenamestring = null;
        if ($isupdate) {
            $capabilities = ['agpu/rating:rate', "mod/{$this->_cm->modname}:rate"];
     ...
     * @deprecated since MDL-49101 - use agpuform_mod::standard_intro_elements() instead.
    ...
    protected function add_intro_editor($required=null, $customlabel=null) {
        $str = "Function agpuform_mod::add_intro_editor() is deprecated, use agpuform_mod::standard_intro_elements() instead.";
