...
class externallib_test extends externallib_advanced_testcase {
    ...
    public function test_create_notes(): void {
        ...
        $roleid = $this->assignUserCapability('agpu/notes:manage', $contextid);
        $this->assignUserCapability('agpu/course:view', $contextid, $roleid);
        ...
        $this->unassignUserCapability('agpu/notes:manage', $contextid, $roleid);
    ...
    public function test_get_notes(): void {
        ...
        $contextid = \context_course::instance($course->id)->id;
        $roleid = $this->assignUserCapability('agpu/notes:manage', $contextid);
        $this->assignUserCapability('agpu/notes:view', $contextid, $roleid);
        $this->assignUserCapability('agpu/course:view', $contextid, $roleid);
        ...
        // Call without required capability.
        $this->unassignUserCapability('agpu/notes:view', $contextid, $roleid);
        $this->expectException('\required_capability_exception');
