...
class core_notes_external extends external_api {
                ...
                'notes' => new external_multiple_structure(
                    new external_single_structure(
                        array(
                            ...
                            'courseid' => new external_value(PARAM_INT, 'course id of the note (in agpu a note can only be created into a course, even for site and personal notes)'),
                            'text' => new external_value(PARAM_RAW, 'the text of the message - text or HTML'),
                            'format' => new external_format_value('text', VALUE_DEFAULT, FORMAT_agpu),
    ...
    public static function create_notes($notes = array()) {
        ...
        foreach ($params['notes'] as $note) {
            ...
            if (empty($courses[$note['courseid']])) {
                ...
                require_capability('agpu/notes:manage', $context);
            }
            ...
            if ($success) {
                ...
                // See http://docs.agpu.org/dev/Errors_handling_in_web_services#When_to_send_a_warning_on_the_server_side .
                $resultnote['noteid'] = -1;
    ...
    public static function get_notes($notes) {
        ...
        foreach ($params['notes'] as $noteid) {
            ...
            if (isset($note->id)) {
                ...
                $context = context_course::instance($note->courseid);
                self::validate_context($context);
                require_capability('agpu/notes:view', $context);
    ...
    public static function get_course_notes($courseid, $userid = 0) {
        ...
        $canmanagesystemnotes = has_capability('agpu/notes:manage', $systemcontext);
        ...
        if ($course->id == SITEID) {
            ...
            $canmanagecoursenotes = has_capability('agpu/notes:manage', $context);
        }
        self::validate_context($context);
        ...
        if ($course->id != SITEID) {
            ...
            if (has_capability('agpu/notes:view', $context)) {
            ...
            if (!empty($user)) {
                ...
                foreach ($usercourses as $c) {
                    ...
                    if (has_capability('agpu/notes:view', context_course::instance($c->id))) {
