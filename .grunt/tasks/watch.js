    ...
    const watchHandler = function() {
        ...
        watchmanClient.on('subscription', function(resp) {
            ...
            resp.files.forEach(function(file) {
                ...
                var fullPath = grunt.agpuEnv.fullRunDir + '/' + file.name;
                Object.keys(watchConfig).forEach(function(task) {
                    ...
                    if (match) {
                        ...
                        var relativePath = fullPath.replace(grunt.agpuEnv.gruntFilePath + '/', '');
        ...
        watchmanClient.command(['watch-project', grunt.agpuEnv.fullRunDir], function(watchError, watchResponse) {
            if (watchError) {
            ...
            watchmanClient.command(['clock', watch], function(clockError, clockResponse) {
                ...
                watchmanClient.command(['subscribe', watch, 'grunt-watch', sub], function(subscribeError) {
                    ...
                    grunt.log.ok('Listening for changes to files in ' + grunt.agpuEnv.fullRunDir);
                });
            });
        });
    };
