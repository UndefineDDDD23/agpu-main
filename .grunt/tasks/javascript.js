...
module.exports = grunt => {
    ...
    grunt.config.merge({
        rollup: {
                ...
                plugins: [
                    ...
                    babel({
                        ...
                        plugins: [
                            ...
                            //
                            // It also adds the agpu plugin name to the AMD module definition
            ...
            dist: {
                files: [{
                    expand: true,
                    src: grunt.agpuEnv.files ? grunt.agpuEnv.files : grunt.agpuEnv.amdSrc,
                    rename: babelRename
                }],
            },
        },
    ...
    grunt.config.merge({
        watch: {
            amd: {
                files: grunt.agpuEnv.inComponent
    ...
    grunt.agpuEnv.startupTasks.push('js');
