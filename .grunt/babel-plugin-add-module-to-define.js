...
/**
 * This is a babel plugin to add the agpu module names to the AMD modules
 * as part of the transpiling process.
 *
 * In addition it will also add a return statement for the default export if the
 * module is using default exports. This is a highly specific agpu thing because
                    ...
                    path.traverse({
                        CallExpression(path) {
                            ...
                            if (!this.seenDefine && path.get('callee').isIdentifier({name: 'define'})) {
                                ...
                                // Get the agpu component for the file being processed.
                                ...
                                // of agpu will not try to add the module name to the file when it's being served
