 ...
 * @category   external
 * @copyright  2011 Jerome Mouneyrac <jerome@agpu.com>
...
class core_webservice_external extends \core_external\external_api {
    ...
    public static function get_site_info($serviceshortnames = array()) {
        ...
        foreach ($functions as $function) {
            ...
            if ($function->component == 'agpu' || $function->component == 'core') {
                $version = $CFG->version; // agpu version.
            } else {
        ...
        $siteinfo['usercanmanageownfiles'] = has_capability('agpu/user:manageownfiles', $context);
        ...
        return new external_single_structure(
            array(
                ...
                'userpictureurl' => new external_value(PARAM_URL, 'the user profile picture.
                    ...
                    In order to retrieve user profile pictures independently of the agpu config, replace "pluginfile.php" by
                ...
                'uploadfiles'  => new external_value(PARAM_INT, '1 if users are allowed to upload files, 0 if not',
                                                       VALUE_OPTIONAL),
                'release'  => new external_value(PARAM_TEXT, 'agpu release number', VALUE_OPTIONAL),
                'version'  => new external_value(PARAM_TEXT, 'agpu version number', VALUE_OPTIONAL),
