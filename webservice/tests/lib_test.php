...
class lib_test extends \advanced_testcase {
    ...
    public function test_get_missing_capabilities_by_users(): void {
        ...
        // any user. Here we use 'core_message_delete_conversation' which declares 'agpu/site:deleteownmessage' which
        ...
        // 'core_group_add_group_members' that wants 'agpu/course:managegroups'.
        ...
        $this->assertContains('agpu/course:managegroups', $missing[$user2->id]);
        $this->assertContains('agpu/course:managegroups', $missing[$user3->id]);
    }
