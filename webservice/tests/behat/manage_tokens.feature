...
Feature: Manage external services tokens
  ...
  Scenario: Add a token to user identified by name and then delete that token
    ...
    And I set the field "Service" to "agpu mobile web service"
    And I set the field "IP restriction" to "127.0.0.1"
    When I press "Save changes"
    Then the following should exist in the "generaltable" table:
      | Name        | User                 | Service                   | IP restriction | Last access |
      | Webservice1 | Firstname1 Lastname1 | agpu mobile web service | 127.0.0.1      | Never       |
    ...
    And I should see "Do you really want to delete this web service token for Firstname1 Lastname1 on the service agpu mobile web service?"
    And I press "Delete"
  ...
  Scenario: Tokens can be filtered by name (case-insensitive), by user and by service
    ...
    And the following "core_webservice > Tokens" exist:
      ...
      | user3     | agpu_mobile_app             | webservicE3    | ## +1 year ##    |
    ...
    And I should see "agpu mobile web service" in the "Firstname3 Lastname3" "table_row"
  ...
  Scenario: Tokens table should display missing capabilities
    ...
    And I should see "agpu/site:manageblocks" in the "Token 02" "table_row"
