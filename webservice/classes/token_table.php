 ...
 * @copyright  2017 John Okely <john@agpu.com>
 ...
 * @todo MDL-79909 This will be deleted in agpu 6.0.
 */
...
class token_table extends \table_sql {
    ...
    public function __construct($id, $filterdata = null) {
        ...
        $this->showalltokens = has_capability('agpu/webservice:managealltokens', $context);
        $this->hasviewfullnames = has_capability('agpu/site:viewfullnames', $context);
    ...
    public function col_fullname($data) {
        ...
        $userprofilurl = new \agpu_url('/user/profile.php', ['id' => $data->userid]);
        ...
        if ($data->serviceshortname <> agpu_OFFICIAL_MOBILE_SERVICE && !is_siteadmin($data->userid)
     ...
     * @return string Content for the column
     *
     * @deprecated since agpu 4.3 MDL-76656. Please do not use this function anymore.
     * @todo MDL-78605 Final deprecation in agpu 4.7.
     */
    ...
    public function col_creatorlastname($data) {
        ...
        $creatorprofileurl = new \agpu_url('/user/profile.php', ['id' => $data->creatorid]);
