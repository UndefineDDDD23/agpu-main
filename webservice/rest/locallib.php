...
class webservice_rest_server extends webservice_base_server {
    ...
    public function set_rest_format(): void {
        ...
        $restformatisset = isset($methodvariables['agpuwsrestformat'])
                && (($methodvariables['agpuwsrestformat'] == 'xml' || $methodvariables['agpuwsrestformat'] == 'json'));
        $this->restformat = $restformatisset ? $methodvariables['agpuwsrestformat'] : 'xml';
    }
    ...
    protected function parse_request() {
        ...
        unset($methodvariables['agpuwsrestformat']);
