...
abstract class base {
    ...
    /**
     * Returns the agpu component name.
     *
     ...
     *
     * It depends on whether it is a agpu subsystem or a plugin as plugin-related config should remain in their own scope.
     *
     * @access private
     ...
     *
     * Since agpu 3.4, subclasses should instead implement get_document_recordset, which has
     ...
     * @return \agpu_recordset|null|false Recordset / null if no results / false if not supported
     * @since agpu 3.4
     */
