...
class engine_test extends \advanced_testcase {
    ...
    public function setUp(): void {
        ...
        // Add agpu fields if they don't exist.
    ...
    public function tearDown(): void {
        ...
        if ($this->generator) {
            // agpu DML freaks out if we don't teardown the temp table after each run.
    ...
    /**
     * Tests with bogus content (that can be entered into agpu) to see if it crashes.
     */
    public function test_bogus_content(): void {
        ...
        // It is possible to enter into a agpu database content containing these characters,
    ...
    public function test_deleted_contexts_and_courses(): void {
        ...
        // Finally let's delete using agpu functions to check that works. Single context first.
     ...
     *
     * This is used to test data contained in the index without going through agpu processing.
     *
