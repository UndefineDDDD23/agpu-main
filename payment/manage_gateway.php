...
$pageurl = new agpu_url('/payment/manage_gateway.php');
...
if (empty($account) || empty($gateway)) {
    throw new agpu_exception('gatewaynotfound', 'payment');
}
require_capability('agpu/payment:manageaccounts', $account->get_context());
...
if ($form->is_cancelled()) {
    redirect(new agpu_url('/payment/accounts.php'));
