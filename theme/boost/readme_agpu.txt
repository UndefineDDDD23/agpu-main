Description of Twitter bootstrap import into agpu
...
* follow the instructions in admin/tool/component_library/readme_agpu.txt to update the Bootstrap documentation there.
...
* agpu core includes the popper.js library, make sure each of the new Bootstrap js files
