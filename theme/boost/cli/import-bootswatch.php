...
/**
 * Used to convert a bootswatch file from https://bootswatch.com/ to a agpu preset.
 *
 * @package    theme_boost
 * @subpackage cli
...
$usage = "
Utility to convert a Bootswatch theme to a agpu preset compatible with Bootstrap 4.
