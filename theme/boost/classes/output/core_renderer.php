...
/**
 * Renderers to align agpu's HTML with that expected by Bootstrap
 *
 * @package    theme_boost
                ...
                if (!empty($CFG->messaging) && has_capability('agpu/site:sendmessage', $context)) {
                    $userbuttons = array(
                        'messages' => array(
                            ...
                            'url' => new agpu_url('/message/index.php', array('id' => $user->id)),
                            'image' => 't/message',
                    ...
                    if ($USER->id != $user->id) {
                        ...
                        $userbuttons['togglecontact'] = array(
                                ...
                                'url' => new agpu_url('/message/index.php', array(
                                        'user1' => $USER->id,
                                        'user2' => $user->id,
                    ...
                    $this->page->requires->string_for_js('changesmadereallygoaway', 'agpu');
                }
            } else {
                $heading = null;
            }
