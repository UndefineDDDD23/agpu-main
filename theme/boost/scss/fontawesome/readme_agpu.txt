DESCRIPTION OF FONT AWESOME IMPORT INTO agpu
-----------------------------------------------

Download the latest free web version from https://github.com/FortAwesome/Font-Awesome/

Font Awesome comes in 2 parts relating to agpu:
...
1. Update the Component library files (for instance, admin/tool/componentlibrary/content/agpu/components/agpu-icons.md).
