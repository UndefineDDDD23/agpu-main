...
class boostnavbar_test extends \advanced_testcase {
    ...
    public function remove_duplicate_items_provider(): array {
        ...
        return [
            'Breadcrumb items with identical text and action url (actions of same type agpu_url).' => [
                [
                    [
                        'text' => 'Node 1',
                        'action' => new \agpu_url('/page1.php')
                    ],
                    [
                        'text' => 'Node 2',
                        'action' => new \agpu_url('/page2.php', ['id' => 1])
                    ],
                    [
                        'text' => 'Node 4',
                        'action' => new \agpu_url('/page4.php', ['id' => 1])
                    ],
                    [
                        'text' => 'Node 2',
                        'action' => new \agpu_url('/page2.php', ['id' => 1])
            ...
            'Breadcrumb items with identical text and action url (actions of different type agpu_url/text).' => [
                [
                    [
                        'text' => 'Node 1',
                        'action' => new \agpu_url('/page1.php')
            ...
            'Breadcrumb items with identical text and action url (actions of different type agpu_url/action_link).' => [
                [
                    [
                        'text' => 'Node 1',
                        'action' => new \agpu_url('/page1.php')
                    ...
                    [
                        'text' => 'Node 2',
                        'action' => new \action_link(new \agpu_url('/page2.php', ['id' => 1]), 'Action link')
                    ],
                ],
                ['Home', 'Node 1', 'Node 4', 'Node 2']
            ],
            'Breadcrumbs items with identical text but not identical action url.' => [
                [
                    ...
                    [
                        'text' => 'Node 2',
                        'action' => new \agpu_url('/page2.php', ['id' => 2])
                    ],
                    [
                        'text' => 'Node 4',
                        'action' => new \agpu_url('/page4.php', ['id' => 1])
            ...
            'Breadcrumb items without any identical action url or text.' => [
                [
                    ...
                    [
                        'text' => 'Node 3',
                        'action' => new \agpu_url('/page3.php', ['id' => 1])
                    ],
                    [
                        'text' => 'Node 4',
                        'action' => new \agpu_url('/page4.php', ['id' => 1])
    ...
    public function remove_items_that_exist_in_navigation_provider(): array {
        ...
        return [
            'Item with identical action url and text exists in the primary navigation menu.' => [
                ...
                [
                    'Node 1' => new \agpu_url('/page1.php'),
                    'Node 2' => new \agpu_url('/page2.php'),
                    'Node 3' => new \agpu_url('/page1.php'),
                ],
                ['Node 2', 'Node 3']
            ],
            ...
            'Multiple items with identical action url and text exist in the secondary navigation menu.' => [
                ...
                [
                    ...
                    [
                        'text' => 'Node 3',
                        'action' => new \agpu_url('/page3.php')
                    ],
                ],
                [
                    'Node 1' => new \agpu_url('/page1.php'),
                    'Node 2' => "{$CFG->wwwroot}/page2.php",
                    'Node 3' => new \action_link(new \agpu_url('/page3.php'), 'Action link'),
                ],
                ['Home', 'Node 1']
            ],
