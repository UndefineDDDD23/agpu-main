...
if ($courseid) {
    ...
    if (isset($backup)) {
        ...
        $baseurl = new agpu_url('/report/backups/index.php', array('courseid' => $courseid));
...
foreach ($rs as $backuprow) {
    ...
    $backuplogsurl = new agpu_url('/report/backups/index.php', array('courseid' => $backuprow->courseid));
