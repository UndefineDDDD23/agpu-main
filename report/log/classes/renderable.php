...
class report_log_renderable implements renderable {
    ...
    /** @var agpu_url url of report page */
    public $url;
    ...
    /**
     * @var array group ids
     * @deprecated since agpu 4.4 - please do not use this public property
     ...
     * @param agpu_url|string $url (optional) page url.
    ...
    public function get_selected_user_fullname() {
        ...
        return fullname($user, has_capability('agpu/site:viewfullnames', $context));
    }
        ...
        if ($this->showusers) {
            if ($courseusers) {
                foreach ($courseusers as $courseuser) {
                     $users[$courseuser->id] = fullname($courseuser, has_capability('agpu/site:viewfullnames', $context));
                }
            }
