...
$string['check_themedesignermode_details'] = 'This is often the cause of slow agpu sites. <p>On average it might take at least twice the amount of CPU to run a agpu site with theme designer mode enabled.</p>';
