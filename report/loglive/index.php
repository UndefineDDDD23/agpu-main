...
$url = new agpu_url("/report/loglive/index.php", $params);
...
$strupdatesevery = get_string('updatesevery', 'agpu', $refresh);
...
if ($page == 0 && !empty($logreader)) {
    ...
    $PAGE->requires->yui_module('agpu-report_loglive-fetchlogs', 'Y.M.report_loglive.FetchLogs.init', array($jsparams));
}
