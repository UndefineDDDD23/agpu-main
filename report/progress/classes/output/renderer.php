...
class renderer extends plugin_renderer_base {
     ...
     */
    public function render_include_activity_select(\agpu_url $url, array $activitytypes,
     ...
     * @throws \coding_exception
     */
    public function render_activity_order_select(\agpu_url $url, string $activityorder): string {
     ...
     * @return string HTML
     */
    public function render_groups_select(\agpu_url $url, \stdClass $course): string {
     ...
     * @throws \coding_exception
     */
    public function render_activity_section_select(\agpu_url $url, string $activitysection, array $sections): string {
     ...
     * @throws \coding_exception
     */
    public function render_download_buttons(\agpu_url $url): string {
