...
if (!report_outline_can_access_user_report($user, $course)) {
    throw new \agpu_exception('nocapability', 'report_outline');
}
...
if ($courseid != SITEID) {
    ...
    if ($mode === 'outline') {
        echo $OUTPUT->heading(get_string('outlinereport', 'agpu'), 2, 'main mt-4 mb-4');
    } else {
        echo $OUTPUT->heading(get_string('completereport', 'agpu'), 2, 'main mt-4 mb-4');
    }
}
