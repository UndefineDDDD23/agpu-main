...
if (!report_stats_can_access_user_report($user, $course)) {
    ...
    throw new \agpu_exception('nocapability', 'report_stats');
}
...
if ($courseid != SITEID) {
    ...
    echo $OUTPUT->heading(get_string('statistics', 'agpu'), 2, 'main mt-4 mb-4');
}
...
if (empty($CFG->enablestats)) {
    throw new \agpu_exception('statsdisable', 'error');
}
...
if (empty($timeoptions)) {
    throw new \agpu_exception('nostatstodisplay', '',
...
$table->head = array(get_string('periodending','agpu',$period),$param->line1,$param->line2,$param->line3);
