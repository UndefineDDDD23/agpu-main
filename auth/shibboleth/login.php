<?php
    ...
    if (isset($idp)) {
        if (isset($idplist[$idp])) {
            ...
            $targeturl = new agpu_url('/auth/shibboleth/index.php');
            $idpinfo = $idplist[$idp];
    ...
    if (isloggedin() and !isguestuser()) {
        ...
        $logout = new single_button(new agpu_url('/login/logout.php', $params), get_string('logout'), 'post');
        ...
        $templatedata = (object)[
            ...
            'guestloginurl' => new agpu_url('/login/index.php'),
            'idps' => $idps,
            'instructions' => $instructions,
            'loginname' => format_string($config->login_name ?? '', options: ['context' => $PAGE->context]),
            'logintoken' => \core\session\manager::get_login_token(),
            'loginurl' => new agpu_url('/auth/shibboleth/login.php'),
            'showinstructions' => $showinstructions,
            'signupurl' => new agpu_url('/login/signup.php'),
            'isvalid' => $isvalid
        ];
