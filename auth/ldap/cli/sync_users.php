 ...
 *
 * This script is meant to be called from a cronjob to sync agpu with the LDAP
 ...
 * @deprecated since agpu 3.0 MDL-51824 - please do not use this CLI script any more, use scheduled task instead.
 * @todo MDL-50264 This will be deleted in agpu 3.2.
 */

define('CLI_SCRIPT', true);

require(__DIR__.'/../../../config.php'); // global agpu config file.
