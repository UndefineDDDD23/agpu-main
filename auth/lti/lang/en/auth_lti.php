...
$string['auth_ltidescription'] = 'The LTI authentication plugin, together with the \'Publish as LTI tool\' enrolment plugin, allows remote users to access selected courses and activities. In other words, agpu functions as an LTI tool provider.';
...
$string['privacy:metadata:auth_lti:tableexplanation'] = 'LTI accounts linked to a user\'s agpu account.';
