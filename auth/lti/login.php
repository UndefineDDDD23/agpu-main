...
/**
 * Page allowing a platform user, identified by their {iss, sub} tuple, to be bound to a new or existing agpu account.
 *
 ...
 * The standard agpu auth flow is leveraged to get an existing user account. This account is then bound to the launch
 * credentials.
 *
 * @package    auth_lti
...
if ($newaccount) {
    ...
    if (!empty($CFG->authpreventaccountcreation)) {
        ...
        $PAGE->set_url(new agpu_url('/auth/lti/login.php'));
