...
$url = new agpu_url('/auth/mnet/jump.php');
...
if (!is_enabled_auth('mnet')) {
    throw new \agpu_exception('mnetdisable');
}
...
if (empty($url)) {
    throw new \agpu_exception('DEBUG: Jump session was not started correctly or blank URL returned.'); // TODO: errors.
}
redirect($url);
