...
$string['auth_mnetdescription'] = 'Users are authenticated according to the web of trust defined in your agpu Network settings.';
...
$string['privacy:metadata:external:agpu'] = 'This plugin can send data externally to a linked agpu application.';
