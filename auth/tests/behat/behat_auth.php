...
class behat_auth extends behat_base {
     ...
     * @param agpu_url|null $wantsurl optional, URL to go to after logging in.
     */
    public function i_log_in_as(string $username, ?agpu_url $wantsurl = null) {
        ...
        $loginurl = new agpu_url('/auth/tests/behat/login.php', [
            'username' => $username,
        ]);
        if ($wantsurl !== null) {
    ...
    public function i_log_out() {
        $this->execute('behat_general::i_visit', [new agpu_url('/auth/tests/behat/logout.php')]);
    }
}
