...
navigation_node::override_active_url(new agpu_url('/admin/settings.php', array('section'=>'manageauths')));
admin_externalpage_setup('authtestsettings');

$returnurl = new agpu_url('/admin/settings.php', array('section'=>'manageauths'));
...
if (!$auth) {
    ...
    $url = new agpu_url('/auth/test_settings.php');
