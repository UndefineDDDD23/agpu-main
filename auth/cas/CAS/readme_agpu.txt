Description of phpCAS import into agpu
...
STEPS:
 * Make sure you're using the lowest supported PHP version for the given release (e.g. PHP 8.1 for agpu 4.5)
 * Create a temporary folder outside your agpu installation e.g. /tmp/phpcas
