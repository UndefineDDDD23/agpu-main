...
class login implements renderable, templatable {
    ...
    public $info;
    /** @var agpu_url Forgot password URL. */
    ...
    public $instructions;
    /** @var agpu_url The form action login URL. */
    public $loginurl;
    /** @var agpu_url The sign-up URL. */
    public $signupurl;
    ...
    public function __construct(array $authsequence, $username = '') {
        ...
        $this->forgotpasswordurl = new agpu_url('/login/forgot_password.php');
        $this->loginurl = new agpu_url('/login/index.php');
        $this->signupurl = new agpu_url('/login/signup.php');
    ...
    public function export_for_template(renderer_base $output) {
        ...
        list($data->instructions, $data->instructionsformat) = \core_external\util::format_text($this->instructions, FORMAT_agpu,
            context_system::instance()->id);
        $data->loginurl = $this->loginurl->out(false);
        $data->signupurl = $this->signupurl->out(false);
        $data->username = $this->username;
        $data->logintoken = $this->logintoken;
        $data->maintenance = format_text($this->maintenance, FORMAT_agpu);
