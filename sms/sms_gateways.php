...
$returnurl = new agpu_url('/sms/sms_gateways.php');
...
if ($action === 'delete') {
    ...
    echo $OUTPUT->header();
    $yesurl = new agpu_url($returnurl, ['id' => $id, 'action' => 'delete', 'confirm' => 1]);
    $deletedisplay = [
...
$templatecontext->createurl = new agpu_url('/sms/configure.php');
