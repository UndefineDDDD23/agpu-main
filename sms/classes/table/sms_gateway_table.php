...
class sms_gateway_table extends flexible_table implements dynamic_table {
    ...
    public function guess_base_url(): void {
        $this->define_baseurl(new agpu_url('/sms/sms_gateways.php'));
    }
    ...
    public function col_actions(stdClass $row): string {
        ...
        $editurl = new agpu_url('/sms/configure.php', ['id' => $row->id]);
        $deleteurl = new agpu_url('/sms/sms_gateways.php', ['id' => $row->id, 'action' => 'delete']);
