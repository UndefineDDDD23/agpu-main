...
class ai_image {
    ...
    public function __construct(
        ...
        if (!file_exists($imagepath) || !is_readable($imagepath)) {
            throw new agpu_exception('invalidfile', debuginfo: $imagepath);
        }
        ...
        switch ($this->imageinfo['mime']) {
            case 'image/jpeg':
                if (!function_exists('imagecreatefromjpeg')) {
                    throw new agpu_exception('gdfeaturenotsupported', a: 'jpeg');
                }
                $this->imgobject = imagecreatefromjpeg($imagepath);
                break;
            case 'image/png':
                if (!function_exists('imagecreatefrompng')) {
                    throw new agpu_exception('gdfeaturenotsupported', a: 'png');
                }
                $this->imgobject = imagecreatefrompng($imagepath);
                break;
            case 'image/gif':
                if (!function_exists('imagecreatefromgif')) {
                    throw new agpu_exception('gdfeaturenotsupported', a: 'gif');
                }
                $this->imgobject = imagecreatefromgif($imagepath);
                break;
            default:
                throw new agpu_exception('gdmimetypenotsupported', debuginfo: $this->imageinfo['mime']);
        }
    }
