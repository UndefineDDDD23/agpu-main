...
abstract class data_controller {
    ...
    public static function create(int $id, ?\stdClass $record = null, ?field_controller $field = null): data_controller {
        ...
        if (!class_exists($customfieldtype) || !is_subclass_of($customfieldtype, self::class)) {
            throw new \agpu_exception('errorfieldtypenotfound', 'core_customfield', '', s($type));
        }
     ...
     */
    public function instance_form_definition_after_data(\agpuQuickForm $mform) {
     ...
     * @param \agpuQuickForm $mform
     */
    abstract public function instance_form_definition(\agpuQuickForm $mform);
