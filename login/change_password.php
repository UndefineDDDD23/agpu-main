...
if (!get_user_preferences('auth_forcepasswordchange', false)) {
    require_capability('agpu/user:changeownpassword', $systemcontext);
}
...
if (is_mnet_remote_user($USER)) {
    ...
    throw new \agpu_exception('userchangepasswordlink', 'mnet', '', $message);
}
...
if (!$userauth->can_change_password()) {
    throw new \agpu_exception('nopasswordchange', 'auth');
}
...
if ($mform->is_cancelled()) {
    ...
    notice($strpasswordchanged, new agpu_url($PAGE->url, array('return'=>1)));
