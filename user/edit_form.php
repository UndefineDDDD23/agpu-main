 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class user_edit_form extends agpuform {
    ...
    public function definition() {
        ...
        // Print the required agpu fields first.
        $mform->addElement('header', 'agpu', $strgeneral);
        ...
        if ($usernotfullysetup) {
            ...
            if ($mform->elementExists('agpu_additional_names')) {
                $mform->insertElementBefore($userpicturewarning, 'agpu_additional_names');
            } else if ($mform->elementExists('agpu_interests')) {
                $mform->insertElementBefore($userpicturewarning, 'agpu_interests');
            } else {
                $mform->insertElementBefore($userpicturewarning, 'agpu_optional');
            }
    ...
    public function validation($usernew, $files) {
        ...
        if (isset($usernew->email) and !empty($CFG->verifychangedemail) and !isset($errors['email']) and !has_capability('agpu/user:update', context_system::instance())) {
