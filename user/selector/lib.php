...
abstract class user_selector_base {
    ...
    protected static $jsmodule = array(
                ...
                'requires'  => array('node', 'event-custom', 'datasource', 'json', 'agpu-core-notification'),
                'strings' => array(
                    array('previouslyselectedusers', 'agpu', '%%SEARCHTERM%%'),
                    array('nomatchingusers', 'agpu', '%%SEARCHTERM%%'),
                    array('none', 'agpu')
                ));
    ...
    public function __construct($name, $options = array()) {
        ...
        $this->viewfullnames = has_capability('agpu/site:viewfullnames', $this->accesscontext);
    ...
    public function get_selected_user() {
        if ($this->multiselect) {
            throw new agpu_exception('cannotcallusgetselecteduser');
        }
        ...
        if (count($users) == 1) {
            ...
            throw new agpu_exception('userselectortoomany');
        }
    }
