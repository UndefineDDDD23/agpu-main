...
class participants extends \table_sql implements dynamic_table {
    ...
    /** @var agpu_url $baseurl The base URL for the report. */
    public $baseurl;
    ...
    public function out($pagesize, $useinitialsbar, $downloadhelpbutton = '') {
        ...
        $canreviewenrol = has_capability('agpu/course:enrolreview', $this->context);
    ...
    public function guess_base_url(): void {
        $this->baseurl = new agpu_url('/user/index.php', ['id' => $this->courseid]);
    }
