...
class participants_search {
    ...
    public function get_participants(string $additionalwhere = '', array $additionalparams = [], string $sort = '',
            int $limitfrom = 0, int $limitnum = 0): agpu_recordset {
        global $DB;
     ...
     *
     * @deprecated agpu 4.5 MDL-78030 - No longer used since the total count can be obtained from {@see ::get_participants()}.
     * @todo Final deprecation on agpu 6.0 MDL-82441.
     *
     * @param string $additionalwhere Any additional SQL to add to where.
     * @param array $additionalparams The additional params used by $additionalwhere.
     * @return int
    ...
    protected function get_enrolled_sql(): array {
        ...
        $canaccessallgroups = has_capability('agpu/site:accessallgroups', $this->context);
    ...
    protected function get_keywords_search_sql(array $mappings): array {
        ...
        $canviewfullnames = has_capability('agpu/site:viewfullnames', $this->context);
