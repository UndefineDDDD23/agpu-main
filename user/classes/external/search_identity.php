 ...
 * @package     core_user
 * @category    external
 * @copyright   2021 David Mudrák <david@agpu.com>
...
class search_identity extends external_api {
    ...
    public static function execute(string $query): array {
        ...
        require_capability('agpu/user:viewalldetails', $context);

        $hasviewfullnames = has_capability('agpu/site:viewfullnames', $context);
