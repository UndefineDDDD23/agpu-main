...
class private_files extends \core_form\dynamic_form {
    ...
    public function definition() {
        ...
        if ($maxareabytes != FILE_AREA_MAX_BYTES_UNLIMITED) {
            ...
            if ($fileareainfo['filecount']) {
                ...
                $quotamsg = get_string('quotausage', 'agpu', $a);
        ...
        if ($link = $this->get_emaillink()) {
            $emaillink = html_writer::link(new agpu_url('mailto:' . $link), $link);
            $mform->addElement('static', 'emailaddress', '',
                get_string('emailtoprivatefiles', 'agpu', $emaillink));
        }
    ...
    public function check_access_for_dynamic_submission(): void {
        require_capability('agpu/user:manageownfiles', $this->get_context_for_dynamic_submission());
    }
