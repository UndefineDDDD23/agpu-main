...
class profile_field_form extends dynamic_form {
    ...
    protected function check_access_for_dynamic_submission(): void {
        require_capability('agpu/site:config', $this->get_context_for_dynamic_submission());
    }
    ...
    protected function get_page_url_for_dynamic_submission(): agpu_url {
        ...
        return new agpu_url('/user/profile/index.php',
    ...
    public function get_field_record() {
        ...
        if (!$this->fieldrecord) {
            ...
            if (!\core_component::get_component_directory('profilefield_'.$this->fieldrecord->datatype)) {
                throw new \agpu_exception('fieldnotfound', 'customfield');
            }
        }
