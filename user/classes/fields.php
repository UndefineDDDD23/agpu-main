...
class fields {
    ...
    public static function get_identity_fields(?\context $context, bool $allowcustom = true): array {
        ...
        if ($context && !has_capability('agpu/site:viewuseridentity', $context)) {
            return [];
        }
    ...
    /**
     * Similar to {@see \agpu_database::sql_fullname} except it returns all user name fields as defined by site config, in a
