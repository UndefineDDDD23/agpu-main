...
final class participants_search_test extends advanced_testcase {
    ...
    /**
     * Helper to convert a agpu_recordset to an array of records.
     *
     * @param agpu_recordset $recordset
     * @return array
     */
    protected function convert_recordset_to_array(agpu_recordset $recordset): array {
        $records = [];
    ...
    public function test_roles_filter(array $usersdata, array $testroles, int $jointype, int $count, array $expectedusers): void {
        ...
        $this->assertInstanceOf(agpu_recordset::class, $rs);
