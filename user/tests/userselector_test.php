...
class userselector_test extends \advanced_testcase {
    ...
    public function test_hidden_siteidentity_fields_course_prevented_access(): void {
        ...
        assign_capability('agpu/course:viewhiddenuserfields', CAP_PREVENT, $env->teacherrole->id, $env->coursecontext->id);
    ...
    public function test_hidden_siteidentity_fields_schismatic_access(): void {
        ...
        assign_capability('agpu/user:viewhiddendetails', CAP_PREVENT, $env->managerrole->id, SYSCONTEXTID, true);
    ...
    public function test_hidden_siteidentity_fields_hard_to_prevent_access(): void {
        ...
        assign_capability('agpu/user:viewhiddendetails', CAP_PREVENT, $env->managerrole->id, SYSCONTEXTID, true);
        assign_capability('agpu/course:viewhiddenuserfields', CAP_PREVENT, $env->managerrole->id, SYSCONTEXTID, true);
