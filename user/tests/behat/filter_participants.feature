...
Feature: Course participants can be filtered
  ...
  Background:
    ...
    And the following "users" exist:
      ...
      | student4 | Student   | 4        | student4@agpu.com       | SID4     | AT      | SCITY4 | 0           |                    |
  ...
  Scenario: Filter match by one or more keywords and modified match types
    ...
    # Match:
    #   Keyword None ["1@example", "agpu"].
    When I set the field "Type..." to "1@example, agpu"
    And I click on "Apply filters" "button"
  ...
  Scenario: Filter by user identity fields when cannot see the field data
    Given the following "role capability" exists:
      | role                         | editingteacher |
      | agpu/site:viewuseridentity | prevent        |
