...
Feature: Custom profile fields should be visible and editable by those with the correct permissions.
  ...
  @javascript
  Scenario: User with agpu/user:update but without agpu/user:viewalldetails or agpu/site:viewuseridentity can only update visible profile fields.
    Given the following "roles" exist:
      | name         | shortname   | description | archetype |
      | Update Users | updateusers | updateusers |           |
    And the following "permission overrides" exist:
      | capability                   | permission | role        | contextlevel | reference |
      | agpu/user:update           | Allow      | updateusers | System       |           |
      | agpu/site:viewuseridentity | Prohibit   | updateusers | System       |           |
  ...
  @javascript
  Scenario: User with agpu/user:viewalldetails and agpu/site:viewuseridentity but without agpu/user:update can view all profile fields.
    Given the following "roles" exist:
      | name             | shortname      | description    | archetype |
      | View All Details | viewalldetails | viewalldetails |           |
    And the following "permission overrides" exist:
      | capability                 | permission | role           | contextlevel | reference |
      | agpu/user:viewalldetails | Allow      | viewalldetails | System       |           |
    And the following "users" exist:
      | username            | firstname      | lastname | email                      |
  ...
  @javascript
  Scenario: User with agpu/user:viewalldetails and agpu/user:update and agpu/site:viewuseridentity capabilities can view and edit all profile fields.
    Given the following "roles" exist:
      | name                              | shortname                    | description                  | archetype |
      | View All Details and Update Users | viewalldetailsandupdateusers | viewalldetailsandupdateusers |           |
    And the following "permission overrides" exist:
      | capability                 | permission | role                         | contextlevel | reference |
      | agpu/user:viewalldetails | Allow      | viewalldetailsandupdateusers | System       |           |
      | agpu/user:update         | Allow      | viewalldetailsandupdateusers | System       |           |
    And the following "users" exist:
      | username                          | firstname                    | lastname | email                                    |
  ...
  Scenario: Users can view but not edit custom profile fields when denied the edit own profile capability.
    ...
    And the following "permission overrides" exist:
      | capability                 | permission | role               | contextlevel | reference |
      | agpu/user:editownprofile | Prohibit   | denyeditownprofile | System       |           |
    And the following "role assigns" exist:
      | user                | role               | contextlevel | reference |
  ...
  Scenario: User with parent permissions on other user context can view and edit all profile fields.
    ...
    And the following "permission overrides" exist:
      | capability                  | permission | role   | contextlevel | reference           |
      | agpu/user:viewalldetails  | Allow      | parent | User         | userwithinformation |
      | agpu/user:viewdetails     | Allow      | parent | User         | userwithinformation |
      | agpu/user:editprofile     | Allow      | parent | User         | userwithinformation |
