...
final class externallib_test extends externallib_advanced_testcase {
    ...
    public function test_get_users(): void {
        ...
        $roleid = $this->assignUserCapability('agpu/user:viewdetails', $context->id);
        ...
        try {
            ...
            // Call the external function.
            $result = core_user_external::get_users($searchparams);
            $this->fail('Expecting \'keyalreadyset\' agpu_exception to be thrown.');
    ...
    public function test_get_course_user_profiles(): void {
        ...
        $data = $this->get_course_user_profiles_setup('agpu/user:viewdetails');
    ...
    public function test_create_users(): void {
        ...
        $roleid = $this->assignUserCapability('agpu/user:create', $context->id);
        $this->assignUserCapability('agpu/user:editprofile', $context->id, $roleid);
        ...
        $this->unassignUserCapability('agpu/user:create', $context->id, $roleid);
    ...
    public function test_create_users_invalid_parameter(array $data, $expectmessage): void {
        ...
        $this->resetAfterTest(true);
        $this->assignUserCapability('agpu/user:create', SYSCONTEXTID);
    ...
    public function test_delete_users(): void {
        ...
        $context = \context_system::instance();
        $roleid = $this->assignUserCapability('agpu/user:delete', $context->id);
        ...
        // Call without required capability.
        $this->unassignUserCapability('agpu/user:delete', $context->id, $roleid);
        $this->expectException('required_capability_exception');
        core_user_external::delete_users(array($user1->id, $user2->id));
    }
    ...
    public function test_update_users(): void {
        ...
        $context = \context_system::instance();
        $roleid = $this->assignUserCapability('agpu/user:update', $context->id);
        $this->assignUserCapability('agpu/user:editprofile', $context->id, $roleid);
        ...
        // Call without required capability.
        $this->unassignUserCapability('agpu/user:update', $context->id, $roleid);
        $this->expectException('required_capability_exception');
        core_user_external::update_users(array($user1));
    }
    ...
    public function test_add_user_private_files(): void {
        ...
        $context = \context_system::instance();
        $roleid = $this->assignUserCapability('agpu/user:manageownfiles', $context->id);
    ...
    public function test_agree_site_policy(): void {
        ...
        try {
            $result = core_user_external::agree_site_policy();
            $this->fail('Expecting \'usernotfullysetup\' agpu_exception to be thrown');
        } catch (\agpu_exception $e) {
