...
final class users_test extends core_reportbuilder_testcase {
    ...
    public function test_datasource_non_default_columns(): void {
        ...
        $generator->create_column(['reportid' => $report->get('id'), 'uniqueidentifier' => 'user:agpunetprofile']);
        ...
        $this->assertEquals($user->agpunetprofile, $agpunetprofile);
    ...
    public static function datasource_filters_provider(): array {
        return [
            ...
            'Filter agpunetprofile' => ['user:agpunetprofile', [
                'user:agpunetprofile_operator' => text::IS_EQUAL_TO,
                'user:agpunetprofile_value' => '@zoe1@example.com',
            ], true],
            'Filter agpunetprofile (no match)' => ['user:agpunetprofile', [
                'user:agpunetprofile_operator' => text::IS_EQUAL_TO,
                'user:agpunetprofile_value' => '@alfie1@example.com',
            ], false],
    ...
    public function test_datasource_filters(string $filtername, array $filtervalues, bool $expectmatch): void {
        ...
        $user = $this->getDataGenerator()->create_user([
            ...
            'agpunetprofile' => '@zoe1@example.com',
            'interests' => ['Horses'],
            'lastip' => '0.0.0.0',
        ]);
