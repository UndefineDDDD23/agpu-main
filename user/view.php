...
if ($courseid == SITEID) {   // Since agpu 2.0 all site-level profiles are shown by profile.php.
...
// Set the agpu docs path explicitly because the default behaviour
...
if (!$currentuser and !$user->deleted
  ...
  and has_capability('agpu/user:viewdetails', $usercontext)) {
...
$fullname = fullname($user, has_capability('agpu/site:viewfullnames', $coursecontext));
...
if ($currentuser) {
    ...
    if (!is_enrolled($coursecontext, $user->id)) {
        ...
        //       to profile would not work - maybe a new capability - agpu/user:freely_acessile_profile_for_anybody
