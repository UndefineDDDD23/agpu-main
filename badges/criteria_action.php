...
if ($delete && has_capability('agpu/badges:configurecriteria', $context)) {
    ...
    if (!$confirm) {
        ...
        echo $OUTPUT->header();
        $formcontinue = new single_button(new agpu_url('/badges/criteria_action.php', $optionsyes), get_string('yes'));
