...
$return = new agpu_url('/badges/criteria.php', array('id' => $badgeid));
$badge = new badge($badgeid);
$context = $badge->get_context();
$navurl = new agpu_url('/badges/index.php', array('type' => $badge->type));

require_capability('agpu/badges:configurecriteria', $context);
...
$PAGE->navbar->add($badge->name, new agpu_url('overview.php', array('id' => $badge->id)))
    ->add(get_string('bcriteria', 'badges'), new agpu_url('criteria.php', ['id' => $badge->id]))
...
if (!empty($addcourse)) {
    if ($data = $mform->get_data()) {
        ...
        redirect(new agpu_url('/badges/criteria_settings.php',
