...
class standard_action_bar extends base_action_bar {
    ...
    public function __construct(
        ...
        /** @var agpu_url $backurl BackURL to be used when the back button is required. */
        protected ?agpu_url $backurl = null,
    ) {
    ...
    public function export_for_template(renderer_base $output): array {
        ...
        if ($this->showaddbadge && has_capability('agpu/badges:createbadge', $this->page->context)) {
