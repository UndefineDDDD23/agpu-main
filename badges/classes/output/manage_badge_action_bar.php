...
class manage_badge_action_bar extends base_action_bar {
     ...
     */
    public function __construct(badge $badge, agpu_page $page) {
    ...
    public function export_for_template(renderer_base $output): array {
        ...
        $elements['button'] = new single_button(new agpu_url('/badges/index.php', $params), get_string('back'), 'get');
    ...
    protected function get_badge_administration_mapping_construct(): array {
        return [
            ...
            'bdetails' => [
                ...
                'capability' => 'agpu/badges:configuredetails'
            ],
            'bcriteria' => [
                'url' => '/badges/criteria.php',
                'capability' => 'agpu/badges:configurecriteria'
            ],
            'bmessage' => [
                'url' => '/badges/edit.php',
                'additionalparams' => ['action' => 'message'],
                'capability' => 'agpu/badges:configuremessages'
            ],
            'bawards' => [
                'url' => '/badges/recipients.php',
                'capability' => 'agpu/badges:viewawarded'
            ],
            'bendorsement' => [
    ...
    protected function generate_badge_navigation(): array {
        ...
        foreach ($construct as $stringidentifier => $checks) {
            ...
            $url = new agpu_url($checks['url'], $params + ($checks['additionalparams'] ?? []));
