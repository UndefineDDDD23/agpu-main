...
class award_criteria_course extends award_criteria {
    ...
    public function config_form_criteria($data) {
        ...
        $editurl = new agpu_url('/badges/criteria_settings.php', array('badgeid' => $this->badgeid, 'edit' => true, 'type' => $this->criteriatype, 'crit' => $this->id));
        $deleteurl = new agpu_url('/badges/criteria_action.php', array('badgeid' => $this->badgeid, 'delete' => true, 'type' => $this->criteriatype));
