...
/**
 * agpu's lib to use for the Google API.
 *
 * @package    core
 ...
 *
 * This automatically sets the config to agpu's defaults.
 *
...
function get_google_client() {
    ...
    $config->setApplicationName('agpu ' . $CFG->release);
    $config->setIoClass('agpu_google_curlio');
