 ...
 *
 * Modified by Dongsheng Cai <dongsheng@agpu.com>
 * ChangeLog:
 ...
 *
 * Modified by David Mudrak <david@agpu.com>
 * ChangeLog:
 *   1. upload() method uses agpu stored_file
...
class phpFlickr {
    ...
    function __construct($api_key, $secret = NULL, $token = '')
    {
        ...
        // Initialize curl helper, set custom user agent as Flickr blocks our "agpuBot" agent string.
