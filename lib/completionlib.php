...
function completion_can_view_data($userid, $course = null) {
    ...
    if (has_capability('agpu/user:viewuseractivitiesreport', $personalcontext)) {
        return true;
...
class completion_info {
     ...
     *
     * @param stdClass $course agpu course object.
     */
    ...
    /**
     * @deprecated since agpu 2.0 - Use display_help_icon instead.
     */
    ...
    /**
     * @deprecated since agpu 4.0 - The 'Your progress' info isn't displayed any more.
     */
    ...
    public function get_completion($user_id, $criteriatype) {
        ...
        if (empty($completions)) {
            ...
            throw new \agpu_exception('multipleselfcompletioncriteria', 'completion');
        }
    ...
    /**
     * @deprecated since agpu 2.8 MDL-46290.
     */
    ...
    public function user_can_override_completion($user) {
        return has_capability('agpu/course:overridecompletion', context_course::instance($this->course_id), $user);
    }
     ...
     * @return void
     * @throws agpu_exception if trying to override without permission.
     */
        ...
        if ($override) {
            if (!$this->user_can_override_completion($USER)) {
                throw new required_capability_exception(context_course::instance($this->course_id),
                                                        'agpu/course:overridecompletion', 'nopermission', '');
            }
        }
    ...
    public function is_tracked_user($userid) {
        return is_enrolled(context_course::instance($this->course->id), $userid, 'agpu/course:isincompletionreports', true);
    }
    ...
    public function get_num_tracked_users($where = '', $whereparams = array(), $groupid = 0) {
        ...
        list($enrolledsql, $enrolledparams) = get_enrolled_sql(
                context_course::instance($this->course->id), 'agpu/course:isincompletionreports', $groupid, true);
    ...
    public function get_tracked_users($where = '', $whereparams = array(), $groupid = 0,
        ...
        list($enrolledsql, $params) = get_enrolled_sql(
                ...
                'agpu/course:isincompletionreports', $groupid, true);
     ...
     * @throws agpu_exception Exception with the error string as debug info
     */
    public function internal_systemerror($error) {
        global $CFG;
        throw new agpu_exception('err_system','completion',
