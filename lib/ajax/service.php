...
/**
 * This file is used to call any registered externallib function in agpu.
 *
...
foreach ($requests as $request) {
    ...
    if ($response['error']) {
        $haserror = true;
        if (!NO_agpu_COOKIES) {
            // If there was an error, and this HTTP request includes a agpu cookie (and therefore a login), reject all
            // subsequent changes.
            //
