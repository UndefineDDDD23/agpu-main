...
require_once(__DIR__.'/pdo_agpu_recordset.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class pdo_agpu_database extends agpu_database {
    ...
    /**
     * Factory method that creates a recordset for return by a query. The generic pdo_agpu_recordset
     * class should fit most cases, but pdo_agpu_database subclasses can override this method to return
     * a subclass of pdo_agpu_recordset.
     * @param object $sth instance of PDOStatement
     * @return object instance of pdo_agpu_recordset
     */
    protected function create_recordset($sth) {
        return new pdo_agpu_recordset($sth);
    }
    ...
    /**
     * Get a number of records as an agpu_recordset.  $sql must be a complete SQL query.
    ...
    public function set_field_select($table, $newfield, $newvalue, $select, ?array $params=null) {
        ...
        if (is_null($newvalue)) {
            ...
            default:
                ...
                throw new \agpu_exception(unknowparamtype, 'error', '', $this->lastError);
            }
        }
