...
require_once(__DIR__.'/pdo_agpu_database.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sqlite3_pdo_agpu_database extends pdo_agpu_database {
    ...
    protected function configure_dbconnection() {
        ...
        // this is required in case that the agpudata folder is web accessible and
     ...
     * else the file will be <agpu data path>/<dbname>.sq3.php
