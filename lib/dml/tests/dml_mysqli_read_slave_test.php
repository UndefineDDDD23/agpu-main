...
/**
 * DML read/read-write database handle tests for mysqli_native_agpu_database
 *
 * @package    core
 * @category   dml
...
require_once(__DIR__.'/fixtures/read_slave_agpu_database_mock_mysqli.php');

/**
 * DML mysqli_native_agpu_database read slave specific tests
 *
 * @package    core
 * @category   dml
 * @copyright  2018 Catalyst IT
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers     \mysqli_native_agpu_database
 */
class dml_mysqli_read_slave_test extends \base_testcase {
    ...
    public function test_lock(): void {
        $DB = new read_slave_agpu_database_mock_mysqli();
