...
require_once(__DIR__.'/test_agpu_database.php');
require_once(__DIR__.'/../../agpu_read_slave_trait.php');

/**
 * Database driver test class with agpu_read_slave_trait
 *
 * @package    core
 * @category   dml
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class read_slave_agpu_database extends test_agpu_database {
