...
/**
 * Abstract database driver test class providing some agpu database interface
 *
 * @package    core
 * @category   dml
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class test_agpu_database extends \agpu_database {
    ...
    public function __construct($external = false) {
        ...
        $this->temptables = new \agpu_temptables($this);
    }
