...
use ReflectionClass;
use mysqli;
use agpu_database, mysqli_native_agpu_database;
use agpu_exception;
 ...
 */
class mysqli_native_agpu_database_test extends \advanced_testcase {
    ...
    public function setUp(): void {
        ...
        if (!($DB instanceof mysqli_native_agpu_database)) {
