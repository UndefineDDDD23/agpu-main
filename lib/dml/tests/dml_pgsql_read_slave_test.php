...
/**
 * DML read/read-write database handle tests for pgsql_native_agpu_database
 *
 * @package    core
 * @category   dml
...
require_once(__DIR__.'/fixtures/read_slave_agpu_database_mock_pgsql.php');

/**
 * DML pgsql_native_agpu_database read slave specific tests
 *
 * @package    core
 * @category   dml
 * @copyright  2018 Catalyst IT
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers     \pgsql_native_agpu_database
 */
class dml_pgsql_read_slave_test extends \advanced_testcase {
    ...
    public function test_cursors(): void {
        $DB = new read_slave_agpu_database_mock_pgsql();
     ...
     * results in pgsql_native_agpu_database differently.
     *
     * @return void
     */
