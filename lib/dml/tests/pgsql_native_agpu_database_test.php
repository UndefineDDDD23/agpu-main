...
use agpu_database, pgsql_native_agpu_database;
use xmldb_table;
use agpu_exception;
 ...
 */
class pgsql_native_agpu_database_test extends \advanced_testcase {
    ...
    public static function setUpBeforeClass(): void {
        global $CFG;
        require_once($CFG->libdir.'/dml/pgsql_native_agpu_database.php');
    ...
    public function setUp(): void {
        ...
        if (!($DB instanceof pgsql_native_agpu_database)) {
