...
/**
 * Native Aurora MySQL class representing agpu database interface.
 *
 * @package    core_dml
...
require_once(__DIR__.'/mysqli_native_agpu_database.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class auroramysql_native_agpu_database extends mysqli_native_agpu_database {
