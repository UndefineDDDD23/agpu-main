Description of import of various jQuery libraries into agpu:
...
1/ Download compressed and uncompressed jQuery JS from http://jquery.com/download/,
   ...
   delete old files
   edit plugins.php and lib/requirejs/agpu-config.js
...
4/ Update the version of jquery in core_privacy\local\request\agpu_content_writer::write_html_data() and privacy/templates/htmlpage.mustache.
...
in agpu code instead. Please note that in third party libraries there are still usages of jQuery.trim
