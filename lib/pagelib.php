...
/**
 * This file contains the agpu_page class. There is normally a single instance
 ...
 * @property-read agpu_url $url The agpu url object for this page.
 */
class agpu_page {
    ...
    /**
     * @var agpu_url The URL for this page. This is mandatory and must be set
     ...
     */
    protected $_blockseditingcap = 'agpu/site:manageblocks';
     ...
     * initialised via {@link agpu_page::initialise_theme_and_output()} which
    ...
    /**
     * Please do not call this method directly, use the ->state syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->headerprinted syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->course syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->cm syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->activityrecord syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->activityname syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->category syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->categories syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->context syntax. {@link agpu_page::__get()}.
     * @return context the main context to which this page belongs.
     */
    protected function magic_get_context() {
        global $CFG;
        if (is_null($this->_context)) {
            if (CLI_SCRIPT or NO_agpu_COOKIES) {
    ...
    /**
     * Please do not call this method directly, use the ->pagetype syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->pagelayout syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->layout_options syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->subpage syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->bodyclasses syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->title syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->heading syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->docspath syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->url syntax. {@link agpu_page::__get()}.
     * @return agpu_url the clean URL required to load the current page. (You
    ...
    /**
     * Please do not call this method directly, use the ->blocks syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->requires syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->cacheable syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->focuscontrol syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->button syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->theme syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->devicetypeinuse syntax. {@link agpu_page::__get()}.
    ...
    /**
     * Please do not call this method directly use the ->opencontainers syntax. {@link agpu_page::__get()}
     ...
     * In the agpu_page class all properties must be set using the appropriate
    ...
    public function set_state($state) {
        if ($state != $this->_state + 1 || $state > self::STATE_DONE) {
            throw new coding_exception('Invalid state passed to agpu_page::set_state. We are in state ' .
    ...
    public function set_course($course) {
        ...
        if (empty($course->id)) {
            throw new coding_exception('$course passed to agpu_page::set_course does not look like a proper course object.');
        }
     ...
     * {@link https://docs.agpu.org/dev/Themes_overview#Layouts}
     ...
     * available for your version of agpu is {@link theme/base/config.php}
     *
    ...
    public function add_body_class($class) {
        if ($this->_state > self::STATE_BEFORE_HEADER) {
            throw new coding_exception('Cannot call agpu_page::add_body_class after output has been started.');
        }
     ...
     * - The most identifying information should come first. (e.g. Submit assignment | Assignment | agpu)
     *
    ...
    public function set_title($title, bool $appendsitename = true) {
        ...
        if ($appendsitename) {
            ...
            if (empty(trim($site->{$sitenamedisplay} ?? ''))) {
                // If for some reason the site name is not yet set, fall back to 'agpu'.
                $title .= self::TITLE_SEPARATOR . 'agpu';
            } else {
    ...
    /**
     * Sets some HTML to use next to the heading {@link agpu_page::set_heading()}
     *
     ...
     *
     * @param string $path the path to use at the end of the agpu docs URL.
     */
     ...
     *
     * @param agpu_url|string $url URL relative to $CFG->wwwroot or {@link agpu_url} instance
    ...
    public function set_url($url, ?array $params = null) {
        ...
        $this->_url = new agpu_url($url, $params);
     ...
     * @param string|agpu_url $url The URL of the alternate version.
     * @param string $mimetype The mime-type of the alternate version.
     * @throws coding_exception
     */
    public function add_alternate_version($title, $url, $mimetype) {
        if ($this->_state > self::STATE_BEFORE_HEADER) {
            throw new coding_exception('Cannot call agpu_page::add_alternate_version after output has been started.');
        }
        $alt = new stdClass;
        $alt->title = $title;
        $alt->url = $url;
     ...
     *
     * Normally the default of 'agpu/site:manageblocks' is used, but a few
     * pages like the My agpu page need to use a different capability
     * like 'agpu/my:manageblocks'.
     *
     ...
     *
     * Due to agpu architectural decision and non-SPA approach, a lot of page setup is
    ...
    public function get_edited_page_hash(): ?string {
        ...
        if ($this->_blockseditingcap !== 'agpu/site:manageblocks') {
    ...
    public static function retrieve_edited_page(string $hash, $strictness = IGNORE_MISSING): ?self {
        ...
        if (!$data || !is_array($data)
            ...
            if ($strictness === MUST_EXIST) {
                throw new agpu_exception('editedpagenotfound');
            }
            return null;
        }

        if (!empty($CFG->agpupageclass)) {
            if (!empty($CFG->agpupageclassfile)) {
                require_once($CFG->agpupageclassfile);
            }
            $classname = $CFG->agpupageclass;
        } else {
        ...
        $page->set_url(new agpu_url($data['url']));
        $keys = ['pagelayout', 'pagetype', 'subpage'];
        foreach ($keys as $key) {
    ...
    /**
     * Method for use by agpu core to set up the theme. Do not
     ...
     * page.
     *
     * This will load {@link agpu_page::$_module} with a row from the related
     * module table in the database.
     * For instance if {@link agpu_page::$_cm} is a forum then a row from the
    ...
    protected function load_category($categoryid) {
        ...
        if (!$category) {
            throw new agpu_exception('unknowncategory');
        }
