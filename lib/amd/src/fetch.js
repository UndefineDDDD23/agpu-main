...
/**
 * The core/fetch module allows you to make web service requests to the agpu API.
 *
 * @module     core/fetch
...
/**
 * A class to handle requests to the agpu REST API.
 *
 * @class Fetch
 */
export default class Fetch {
    /**
     * Make a single request to the agpu API.
     *
    ...
    /**
     * Make a request to the agpu API.
     *
     * @param {string} component The frankenstyle component name
     * @param {string} action The component action to perform
     * @param {object} params
    ...
    /**
     * Make a PATCH request to the agpu API.
     *
     * @param {string} component The frankenstyle component name
     * @param {string} action The component action to perform
     * @param {object} params
