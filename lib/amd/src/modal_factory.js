 ...
 * @todo       Final deprecation in agpu 4.7/5.2. See MDL-79128/
 */
...
export const create = (modalConfig, triggerElement) => {
    window.console.warn(
        'The modal_factory has been deprecated since agpu 4.3. Please use the create method on your target modal type instead.',
    );
