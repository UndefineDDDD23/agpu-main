 ...
 * @copyright   2021 David Matamoros <davidmc@agpu.com> based on code from Marina Glancy
...
export const init = () => {
    ...
    tabToggle.on('click', (event) => {
        ...
        getStrings([
            {key: 'changesmade', component: 'agpu'},
            {key: 'changesmadereallygoaway', component: 'agpu'},
