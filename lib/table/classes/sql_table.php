...
class sql_table extends flexible_table {
    ...
    public $is_sortable = true; // phpcs:ignore agpu.NamingConventions.ValidVariableName.MemberNameUnderscore

    /** @var bool Overriding default for this */
    public $is_collapsible = true; // phpcs:ignore agpu.NamingConventions.ValidVariableName.MemberNameUnderscore
    ...
    public function close_recordset() {
        if (
            $this->rawdata && ($this->rawdata instanceof \core\dml\recordset_walk ||
                $this->rawdata instanceof agpu_recordset)
        ) {
            $this->rawdata->close();
            $this->rawdata = null;
        }
