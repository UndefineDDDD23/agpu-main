...
/**
 * Unit tests for agpuQuickForm_date_selector
 *
 * Contains test cases for testing agpuQuickForm_date_selector
 *
 * @package    core_form
 * @category   test
...
use agpuform;
use agpuQuickForm_date_selector;
...
class dateselector_test extends \advanced_testcase {
    ...
    public function test_exportvalue(): void {
        ...
        foreach ($testvals as $vals) {
            ...
            $this->assertTrue($el instanceof agpuQuickForm_date_selector);
 ...
 */
class temp_form_date extends agpuform {
    /**
     * Form definition.
     */
