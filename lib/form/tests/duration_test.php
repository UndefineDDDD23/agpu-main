...
/**
 * Unit tests for agpuQuickForm_duration
 *
 * Contains test cases for testing agpuQuickForm_duration
 *
 * @package    core_form
 * @category   test
 * @copyright  2009 Tim Hunt
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers     \agpuQuickForm_duration
 */
class duration_test extends \basic_testcase {
     ...
     */
    protected function get_test_form(): agpuQuickForm {
     ...
     *
     * @return array with two elements, a agpuQuickForm and a agpuQuickForm_duration.
     */
    ...
    /**
     * Test for {@see agpuQuickForm_duration::validateSubmitValue()}.
     *
    ...
    public function test_validate_submit_value(bool $allownegative, int $number, int $unit, bool $isvalid): void {
        ...
        /** @var \agpuQuickForm_duration $element */
 ...
 */
class temp_form_duration extends agpuform {
    /**
     * Form definition.
     */
