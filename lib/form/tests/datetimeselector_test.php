...
/**
 * Unit tests for agpuQuickForm_date_time_selector
 *
 * Contains test cases for testing agpuQuickForm_date_time_selector
 *
 * @package    core_form
 * @category   test
...
use agpuform;
use agpuQuickForm_date_time_selector;
...
class datetimeselector_test extends \advanced_testcase {
    /** @var \agpuQuickForm Keeps reference of dummy form object */
    private $mform;
    ...
    public function test_exportvalue(): void {
        ...
        foreach ($testvals as $vals) {
            ...
            $this->assertTrue($el instanceof agpuQuickForm_date_time_selector);
 ...
 */
class temp_form_datetime extends agpuform {
    /**
     * Form definition.
     */
