 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class agpuQuickForm_filepicker extends HTML_QuickForm_input implements templatable {
     ...
     */
    public function agpuQuickForm_filepicker($elementName=null, $elementLabel=null, $attributes=null, $options=null) {
    ...
    function toHtml() {
        ...
        $nonjsfilepicker = new agpu_url('/repository/draftfiles_manager.php', array(
            'env'=>'filepicker',
            'action'=>'browse',
            'itemid'=>$draftitemid,
            'subdirs'=>0,
