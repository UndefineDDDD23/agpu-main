 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class agpuQuickForm_modgrade extends agpuQuickForm_group {
    ...
    /** @var agpuQuickForm_select $gradetypeformelement */
    private $gradetypeformelement;

    /** @var agpuQuickForm_select $scaleformelement */
    private $scaleformelement;

    /** @var agpuQuickForm_text $maxgradeformelement */
     ...
     */
    public function agpuQuickForm_modgrade($elementname = null, $elementlabel = null, $options = array(), $attributes = null) {
     ...
     * @param agpuQuickForm $caller calling object
     * @return mixed
     */
