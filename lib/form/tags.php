 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class agpuQuickForm_tags extends agpuQuickForm_autocomplete {
    /**
    ...
    protected function is_tagging_enabled() {
        ...
        // Backward compatibility with code developed before agpu 3.0 where itemtype/component were not specified.
        return true;
    }
     ...
     */
    public function agpuQuickForm_tags($elementName = null, $elementLabel = null, $options = array(), $attributes = null) {
    ...
    function toHtml(){
        ...
        $managelink = '';
        if (has_capability('agpu/tag:manage', context_system::instance()) && $this->showstandard) {
            $url = new agpu_url('/tag/manage.php', array('tc' => $this->get_tag_collection()));
