 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class agpuQuickForm_duration extends agpuQuickForm_group {
    /**
    ...
    */
        ...
        if (isset($options['defaultunit'])) {
            if (!array_key_exists($options['defaultunit'], $this->get_units())) {
                throw new coding_exception($options['defaultunit'] .
                        ' is not a recognised unit in agpuQuickForm_duration.');
            }
     ...
     */
    public function agpuQuickForm_duration($elementName = null, $elementLabel = null,
            $options = [], $attributes = null) {
