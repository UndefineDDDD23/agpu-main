 ...
 */
abstract class dynamic_form extends \agpuform {
     ...
     * Example:
     *     $id = $this->optional_param('id', 0, PARAM_INT);
     *     return new agpu_url('/my/page/where/form/is/used.php', ['id' => $id]);
     *
     * @return agpu_url
     */
    abstract protected function get_page_url_for_dynamic_submission(): agpu_url;
}
