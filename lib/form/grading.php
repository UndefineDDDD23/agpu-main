...
if (class_exists('HTML_QuickForm')) {
    HTML_QuickForm::registerRule('gradingvalidated', 'callback', '_validate', 'agpuQuickForm_grading');
}
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class agpuQuickForm_grading extends HTML_QuickForm_input implements templatable {
     ...
     */
    public function agpuQuickForm_grading($elementName=null, $elementLabel=null, $attributes=null) {
    ...
    public function onQuickFormEvent($event, $arg, &$caller) {
        if ($event == 'createElement') {
            ...
            if (!is_array($attributes) || !array_key_exists('gradinginstance', $attributes) || !($attributes['gradinginstance'] instanceof gradingform_instance)) {
                throw new agpu_exception('exc_gradingformelement', 'grading');
            }
        }
