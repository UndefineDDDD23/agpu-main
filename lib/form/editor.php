 ...
 */
class agpuQuickForm_editor extends HTML_QuickForm_element implements templatable {
     ...
     */
    public function agpuQuickForm_editor($elementName=null, $elementLabel=null, $attributes=null, $options=null) {
    ...
    function setHelpButton($_helpbuttonargs, $function='_helpbutton') {
        throw new coding_exception('setHelpButton() can not be used any more, please see agpuQuickForm::addHelpButton().');
    }
    ...
    function toHtml() {
        ...
        if ($maxfiles != 0 ) {
            ...
            if (has_capability('agpu/h5p:deploy', $ctx)) {
        ...
        // TODO Remove this in MDL-77334 for agpu 4.6.
        ...
        // during agpu installation, user area doesn't exist
        ...
        if (!during_initial_install() && empty($CFG->adminsetuppending)) {
            ...
            if ($maxfiles != 0 ) {
                ...
                $editorurl = new agpu_url("$CFG->wwwroot/repository/draftfiles_manager.php", array(
                    'action'=>'browse',
                    'env'=>'editor',
                    'itemid'=>$draftitemid,
                    'subdirs'=>$subdirs,
