 ...
 *     - Message API: {@link http://docs.agpu.org/dev/Message_API}
...
$messageproviders = array (
    ...
    // Cron-based notifications about available agpu and/or additional plugin updates.
    ...
    'courserequested' => array (
        ...
        'capability'  => 'agpu/site:approvecourse'
    ),

    // Course request approval notification.
    'courserequestapproved' => array (
        'capability'  => 'agpu/course:request',
        'defaults' => [
            'popup' => MESSAGE_PERMITTED + MESSAGE_DEFAULT_ENABLED,
            'email' => MESSAGE_PERMITTED + MESSAGE_DEFAULT_ENABLED,
            'airnotifier' => MESSAGE_PERMITTED + MESSAGE_DEFAULT_ENABLED,
    ...
    'badgerecipientnotice' => array (
        ...
        'capability'  => 'agpu/badges:earnbadge'
    ),
