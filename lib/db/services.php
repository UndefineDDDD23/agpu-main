 ...
 * processed and registered into the agpu DB after any
 * install or upgrade operation. All plugins support this.
 *
 * For more information, take a look to the documentation available:
 *     - Webservices API: {@link https://agpudev.io/docs/apis/subsystems/external/writing-a-service}
 *     - External API: {@link https://agpudev.io/docs/apis/subsystems/external/functions}
...
$functions = array(
    ...
    'core_badges_get_user_badges' => array(
        ...
        'type'          => 'read',
        'capabilities'  => 'agpu/badges:viewotherbadges',
    ...
    'core_calendar_update_event_start_day' => array(
        ...
        'classpath' => 'calendar/externallib.php',
        'type' => 'write',
        'capabilities' => 'agpu/calendar:manageentries, agpu/calendar:manageownentries, agpu/calendar:managegroupentries',
        'ajax' => true,
        'services' => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_cohort_add_cohort_members' => array(
        ...
        'type' => 'write',
        'capabilities' => 'agpu/cohort:assign'
    ),
    'core_cohort_create_cohorts' => array(
        ...
        'type' => 'write',
        'capabilities' => 'agpu/cohort:manage'
    ),
    ...
    'core_comment_get_comments' => array(
        ...
        'type' => 'read',
        'capabilities' => 'agpu/comment:view',
        'services' => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_completion_override_activity_completion_status' => array(
        ...
        'type'          => 'write',
        'capabilities'  => 'agpu/course:overridecompletion',
        'ajax'          => true,
    ),
    'core_course_create_categories' => array(
        ...
        'type' => 'write',
        'capabilities' => 'agpu/category:manage'
    ),
    'core_course_create_courses' => array(
        ...
        'type' => 'write',
        'capabilities' => 'agpu/course:create, agpu/course:visibility'
    ),
    ...
    'core_course_delete_courses' => array(
        ...
        'type' => 'write',
        'capabilities' => 'agpu/course:delete'
    ),
    ...
    'core_course_duplicate_course' => array(
        ...
        'type' => 'write',
        'capabilities' => 'agpu/backup:backupcourse, agpu/restore:restorecourse, agpu/course:create'
    ),
    'core_course_get_categories' => array(
        ...
        'type' => 'read',
        'capabilities' => 'agpu/category:viewhiddencategories',
        'services' => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    'core_course_get_contents' => array(
        ...
        'type' => 'read',
        'capabilities' => 'agpu/course:update, agpu/course:viewhiddencourses',
        'services' => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_courseformat_update_course' => [
        ...
        'type'          => 'write',
        'ajax'          => true,
        'capabilities'  => 'agpu/course:sectionvisibility, agpu/course:activityvisibility',
    ],
    ...
    'core_course_get_courses' => array(
        ...
        'type' => 'read',
        'capabilities' => 'agpu/course:view, agpu/course:update, agpu/course:viewhiddencourses',
        'ajax' => true,
        'services' => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    'core_course_import_course' => array(
        ...
        'type' => 'write',
        'capabilities' => 'agpu/backup:backuptargetimport, agpu/restore:restoretargetimport'
    ),
    ...
    'core_course_update_courses' => array(
        ...
        'type' => 'write',
        'capabilities' => 'agpu/course:update, agpu/course:changecategory, agpu/course:changefullname, '
            . 'agpu/course:changeshortname, agpu/course:changeidnumber, agpu/course:changesummary, agpu/course:visibility'
    ),
    ...
    'core_enrol_get_enrolled_users' => array(
        ...
        'type' => 'read',
        'capabilities' => 'agpu/user:viewdetails, agpu/user:viewhiddendetails, agpu/course:useremail, agpu/user:update, '
    ...
    'core_enrol_get_potential_users' => array(
        ...
        'ajax' => true,
        'type' => 'read',
        'capabilities' => 'agpu/course:enrolreview',
        'readonlysession' => true,
    ),
    'core_enrol_search_users' => [
        ...
        'ajax' => true,
        'type' => 'read',
        'capabilities' => 'agpu/course:viewparticipants',
        'services' => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ],
    ...
    'core_files_upload' => array(
        'classname' => 'core_files_external',
        'methodname' => 'upload',
        'description' => 'upload a file to agpu',
        'type'        => 'write',
        'classpath'   => 'files/externallib.php',
    ),
    ...
    'core_grades_create_gradecategories' => array (
        ...
        'type' => 'write',
        'capabilities' => 'agpu/grade:manage',
    ),
    ...
    'core_group_add_group_members' => array(
        ...
        'type' => 'write',
        'capabilities' => 'agpu/course:managegroups',
    ),
    ...
    'core_message_delete_conversations_by_id' => array(
        ...
        'type' => 'write',
        'capabilities' => 'agpu/site:deleteownmessage',
        'ajax' => true,
        'services' => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_message_send_instant_messages' => array(
        ...
        'type' => 'write',
        'capabilities' => 'agpu/site:sendmessage',
        'ajax' => true,
        'services' => array(agpu_OFFICIAL_MOBILE_SERVICE),
        'readonlysession' => true,
    ),
    ...
    'core_message_get_user_notification_preferences' => array(
        ...
        'type' => 'read',
        'capabilities' => 'agpu/user:editownmessageprofile',
        'services' => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_message_delete_message_for_all_users' => array(
        ...
        'type' => 'write',
        'capabilities' => 'agpu/site:deleteanymessage',
        'ajax' => true,
        'services' => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_notes_create_notes' => array(
        ...
        'type' => 'write',
        'ajax' => true,
        'capabilities' => 'agpu/notes:manage',
        'services' => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_output_load_fontawesome_icon_system_map' => array(
        ...
        'description' => 'Load the mapping of agpu pix names to fontawesome icon names',
        'type' => 'read',
        'loginrequired' => false,
        'ajax' => true,
    ),
    ...
    'core_question_update_flag' => array(
        ...
        'type'          => 'write',
        'capabilities'  => 'agpu/question:flag',
        'services'      => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_search_get_results' => [
        ...
        'type' => 'read',
        'capabilities' => 'agpu/search:query',
        'services' => [agpu_OFFICIAL_MOBILE_SERVICE],
    ],
    ...
    'core_user_add_user_private_files' => array(
        ...
        'type' => 'write',
        'capabilities' => 'agpu/user:manageownfiles',
        'services' => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_user_search_identity' => array(
        ...
        'type' => 'read',
        'capabilities' => 'agpu/user:viewalldetails',
        'ajax' => true,
        'loginrequired' => true,
    ),
    'core_user_remove_user_device' => array(
        ...
        'classpath' => 'user/externallib.php',
        'description' => 'Remove a user device from the agpu database.',
        'type' => 'write',
        'services' => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_user_update_user_preferences' => array(
        ...
        'type' => 'write',
        'capabilities' => 'agpu/user:editownmessageprofile, agpu/user:editmessageprofile',
        'ajax' => true,
        'services' => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_user_view_user_profile' => array(
        ...
        'type' => 'write',
        'capabilities' => 'agpu/user:viewdetails',
        'services' => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_user_update_picture' => array(
        ...
        'type' => 'write',
        'capabilities' => 'agpu/user:editownprofile, agpu/user:editprofile',
        'services' => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_competency_create_competency_framework' => array(
        ...
        'type'         => 'write',
        'capabilities' => 'agpu/competency:competencymanage',
        'ajax'         => true,
    ),
    ...
    'core_competency_add_competency_to_course' => array(
        ...
        'type'         => 'write',
        'capabilities' => 'agpu/competency:coursecompetencymanage',
        'ajax'         => true,
    ),
    'core_competency_add_competency_to_template' => array(
        ...
        'type'         => 'write',
        'capabilities' => 'agpu/competency:templatemanage',
        'ajax'         => true,
    ),
    ...
    'core_competency_create_plan' => array(
        ...
        'type'         => 'write',
        'capabilities' => 'agpu/competency:planmanage',
        'ajax'         => true,
    ),
    ...
    'core_competency_plan_request_review' => array(
        ...
        'type'         => 'write',
        'capabilities' => 'agpu/competency:planmanagedraft',
        'ajax'         => true,
    ),
    ...
    'core_competency_create_user_evidence_competency' => array(
        ...
        'type'         => 'read',
        'capabilities' => 'agpu/competency:userevidencemanageown, agpu/competency:competencyview',
        'ajax'         => true,
    ),
    ...
    'core_competency_user_competency_start_review' => array(
        ...
        'type'         => 'write',
        'capabilities' => 'agpu/competency:competencygrade',
        'ajax'         => true,
    ),
    ...
    'core_competency_user_competency_viewed' => array(
        ...
        'type'         => 'read',
        'capabilities' => 'agpu/competency:usercompetencyview',
        'ajax'         => true,
        'services'     => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_competency_update_course_competency_settings' => array(
        ...
        'type'          => 'write',
        'capabilities'  => 'agpu/competency:coursecompetencyconfigure',
        'ajax'          => true,
    ),
    'core_competency_delete_evidence' => array(
        ...
        'type'          => 'write',
        'capabilities'  => 'agpu/competency:evidencedelete',
        'ajax'          => true,
        'services'      => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_block_fetch_addable_blocks' => array(
        ...
        'type'          => 'read',
        'capabilities'  => 'agpu/site:manageblocks',
        'ajax'          => true,
        'services'      => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_contentbank_delete_content' => [
        ...
        'type'          => 'write',
        'ajax'          => true,
        'capabilities'  => 'agpu/contentbank:deleteanycontent',
    ],
    'core_contentbank_rename_content' => [
        ...
        'type'          => 'write',
        'ajax'          => true,
        'capabilities'  => 'agpu/contentbank:manageowncontent',
    ],
    'core_contentbank_copy_content' => [
        ...
        'type'          => 'write',
        'ajax'          => 'true',
        'capabilities'  => 'agpu/contentbank:copycontent, agpu/contentbank:copyanycontent',
    ],
    ...
    'core_agpunet_send_activity' => [
        'classname'   => 'core\external\agpunet_send_activity',
        'description' => 'Send activity to agpuNet',
        'type'        => 'read',
        'ajax'        => true,
    ],
    'core_agpunet_get_share_info_activity' => [
        'classname'   => 'core\external\agpunet_get_share_info_activity',
        'description' => 'Get information about an activity being shared',
        'type'        => 'read',
        'ajax'        => true,
    ],
    'core_agpunet_auth_check' => [
        'classname'   => 'core\external\agpunet_auth_check',
        'description' => 'Check a user has authorized for a given agpuNet site',
        'type'        => 'write',
        'ajax'        => true,
    ],
    'core_agpunet_get_shared_course_info' => [
        'classname'   => 'core\external\agpunet_get_shared_course_info',
        'description' => 'Get information about an course being shared',
        'type'        => 'read',
        'ajax'        => true,
    ],
    'core_agpunet_send_course' => [
        'classname'   => 'core\external\agpunet_send_course',
        'description' => 'Send course to agpuNet',
        'type'        => 'read',
        'ajax'        => true,
    ],
