...
/**
 * This file keeps track of upgrades to agpu.
 *
...
/**
 * Main upgrade tasks to be executed on agpu version bump
 *
 * This function is automatically executed after one bump in the agpu core
 ...
 *     // help you here. See {@link https://agpudev.io/general/development/tools/xmldb}.
 ...
 *     - Data definition API: {@link https://agpudev.io/docs/apis/core/dml/ddl}
...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2023090200.01) {
        // Define table agpunet_share_progress to be created.
        $table = new xmldb_table('agpunet_share_progress');

        // Adding fields to table agpunet_share_progress.
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        ...
        // Adding keys to table agpunet_share_progress.
        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id']);

        // Conditionally launch create table for agpunet_share_progress.
        if (!$dbman->table_exists($table)) {
            $dbman->create_table($table);
        }
