 ...
 * upgrade process of agpu.
 *
 * For further documentation, visit {@link http://docs.agpu.org/en/DDL_functions}
 *
 * @package    core
 * @subpackage ddl
...
/**
 * DDL exception class, use instead of throw new \agpu_exception() and "return false;" in ddl code.
 */
class ddl_exception extends agpu_exception {
    /**
