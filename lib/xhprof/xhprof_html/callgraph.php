...
// Start agpu modification: agpuize this script.
...
// Start agpu modification: use own XHProfRuns implementation.
// $xhprof_runs_impl = new XHProfRuns_Default();
$xhprof_runs_impl = new agpu_xhprofrun();
