Description of XHProf 2.3.9 library/viewer import into agpu
...
Added (commit #2 - always taken from current agpu.git master):
 * index.html - prevent directory browsing on misconfigured servers
 * xhprof_agpu.php - containing all the stuff needed to run the xhprof profiler within agpu
 * readme_agpu.txt - this file ;-)

Our changes:  Look for "agpu" in code (commit #3 - always mimic from current agpu.git master):
 * xhprof_html/index.php  ----|
 * xhprof_html/callgraph.php -|=> Changed to use own DB iXHProfRuns implementation (agpu_xhprofrun)
...
20221214 - MDL-76397 - Stevani Andolo (stevandoagpu): Upgrade to 2.3.9 release;
