...
class portfolio_add_button {
     ...
     * @param string $component This is the name of the component in agpu, eg 'mod_forum'
     */
    ...
    public function to_html($format=null, $addstr=null) {
        ...
        $url = new agpu_url('/portfolio/add.php');
        ...
        // If we just want a agpu_url to redirect to, do it now.
        if ($format == PORTFOLIO_ADD_agpu_URL) {
            return $url;
        }
 ...
 * Setup page export
 *
 * @param agpu_page $PAGE global variable from page object
