 ...
 *
 * For places in agpu that want to add export functionality to subclass.
 *
...
abstract class portfolio_caller_base {
     ...
     *
     * @param agpuform $mform passed by reference, add elements to it.
    ...
    /**
     * Just like the agpu form validation function,
     ...
     *
     * @param agpu_page $PAGE global page object
     */
...
abstract class portfolio_module_caller_base extends portfolio_caller_base {
     ...
     *
     * @param agpu_page $PAGE global PAGE
     */
