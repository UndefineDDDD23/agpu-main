...
class HTML_QuickForm extends HTML_Common {
    ...
    function &createElement($elementType)
    {
        if (!isset($this) || !($this instanceof HTML_QuickForm)) {
            // Several form elements in agpu core before 3.2 were calling this method
            ...
            // https://github.com/agpu/agpu/commit/721e2def56a48fab4f8d3ec7847af5cd03f5ec79
    ...
    function &_loadElement($event, $type, $args)
    {
        ...
        $elementObject = new $className(); //agpu: PHP 5.3 compatibility
        for ($i = 0; $i < 6; $i++) {
            if (!isset($args[$i])) {
                $args[$i] = null;
            }
    ...
    */
    function &defaultRenderer()
    {
        if (!isset($GLOBALS['_HTML_QuickForm_default_renderer'])) {
            ...
            $GLOBALS['_HTML_QuickForm_default_renderer'] = new HTML_QuickForm_Renderer_Default(); //agpu: PHP 5.3 compatibility
        }
    ...
    function toArray($collectHidden = false)
    {
        ...
        $renderer = new HTML_QuickForm_Renderer_Array($collectHidden); //agpu: PHP 5.3 compatibility
        $this->accept($renderer);
