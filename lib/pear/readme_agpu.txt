agpu-SPECIFIC PEAR MODIFICATIONS
==================================

XML/Parser
=================
1/ changed ereg_ to preg_
* http://cvs.agpu.org/agpu/lib/pear/XML/Parser.php.diff?r1=1.1&r2=1.2
...
- QF2: https://github.com/pear/HTML_QuickForm2 (https://agpu.org/mod/forum/discuss.php?d=200124)
- Quickform (fork): https://github.com/openpsa/quickform

MDL-20876 - replaced split() with explode() or preg_split() where appropriate
MDL-40267 - agpu core_text strlen functions used for range rule rule to be utf8 safe.
...
MDL-78145 - PHP 8.2 compliance. Added a missing class property that still need to be declared
            ...
            And also remove the $_elementIdx because it is not needed in agpu code.
