YUI.add('agpu-core-actionmenu', function (Y, NAME) {

/**
 * Provides drop down menus for list of action links.
 *
 * @module agpu-core-actionmenu
 */
...
ACTIONMENU.prototype = {
    ...
    handleKeyboardEvent: function(e) {
        ...
        if (e.keyCode === 27) {
            ...
            if (!found) {
                Y.log("Unable to find this menu item in the list of menu children", 'debug', 'agpu-core-actionmenu');
                return;
            }
