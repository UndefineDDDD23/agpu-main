...
class ddl_test extends \database_driver_testcase {
    ...
    protected function setUp(): void {
        ...
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('course', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, '0');
        $table->add_field('name', XMLDB_TYPE_CHAR, '30', null, null, null, 'agpu');
    ...
    public function test_create_table(): void {
        ...
        $this->assertSame('agpu', $columns['name']->default_value);
        ...
        $this->assertSame('agpu', $dbrec->name);
    ...
    public function test_add_field(): void {
        ...
        // In any case, floats aren't officially supported by agpu, with number/decimal type being the correct ones, so
    ...
    public function testChangeFieldDefault() {
        ...
        $table->add_field('name', XMLDB_TYPE_CHAR, '30', null, XMLDB_NOTNULL, null, 'agpu');
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));
        $dbman->create_table($table);

        $field = new xmldb_field('name');
        $field->set_attributes(XMLDB_TYPE_CHAR, '30', null, XMLDB_NOTNULL, null, 'agpu2');
        ...
        $this->assertSame('agpu2', $record->name);
    ...
    public function testDeleteTablesFromXmldbFile() {
        ...
        // TODO: drop UNSINGED completely in agpu 2.4.
    ...
    public function test_temp_tables(): void {
        ...
        $this->assertTrue($columns['name']->has_default);
        $this->assertEquals('agpu', $columns['name']->default_value);
    ...
    public function test_leftover_temp_tables_cache(): void {
        ...
        $rc = new \ReflectionClass('agpu_database');
        ...
        if (!$reserved) {
            ...
            switch ($dbfamily) {
                case 'mysql':
                    $this->assertSame("`$columnname`", $gen->getEncQuoted($columnname));
                    break;
                case 'mssql': // The agpu connection runs under 'QUOTED_IDENTIFIER ON'.
                case 'oracle':
                case 'postgres':
                case 'sqlite':
                default:
