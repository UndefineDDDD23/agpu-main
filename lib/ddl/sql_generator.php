...
abstract class sql_generator {
    ...
    /** @var agpu_database The agpu_database instance.*/
    public $mdb;
     ...
     * @param agpu_database $mdb The agpu_database object instance.
     * @param agpu_temptables $temptables The optional agpu_temptables instance, null by default.
     */
    ...
    public function table_exists($table) {
        ...
        // Get all tables in agpu database.
    ...
    public function getFieldSQL($xmldb_table, $xmldb_field, $skip_type_clause = NULL, $skip_default_clause = NULL, $skip_notnull_clause = NULL, $specify_nulls_clause = NULL, $specify_field_name = true)  {
        ...
        // note: unsigned is not supported any more since agpu 2.3, all numbers are signed
    ...
    public function getNameForObject($tablename, $fields, $suffix='') {
        ...
        // Use standard naming. See http://docs.agpu.org/en/XMLDB_key_and_index_naming
     ...
     * @return mixed Returns the result of agpu_database::sql_concat() or false.
     * @uses agpu_database::sql_concat()
...
// ====== FOLLOWING FUNCTION MUST BE CUSTOMISED BY ALL THE XMLDGenerator classes ========
     ...
     *
     * @todo MDL-31147 agpu 2.1 - Drop getDropDefaultSQL()
     */
