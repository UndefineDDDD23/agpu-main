...
Feature: Tiny noautolink
  ...
  Background:
    ...
    And I set the field "Description" to "<p>https://agpu.org</p>"
  ...
  Scenario: Add and remove auto-link prevention to URLs
    ...
    Then the field "Description" matches value "<p><span class='nolink'>https://agpu.org</span></p>"
    ...
    And the field "Description" matches value "<p>https://agpu.org</p>"
