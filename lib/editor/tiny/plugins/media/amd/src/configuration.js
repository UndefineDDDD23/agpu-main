...
const configureMenu = (menu) => {
    // Replace the standard Media plugin with the agpu embed.
    ...
    // Replace the standard image plugin with the agpu image.
...
const configureToolbar = (toolbar) => {
    ...
    // The agpu integration ensures that there is a section called 'content'.
