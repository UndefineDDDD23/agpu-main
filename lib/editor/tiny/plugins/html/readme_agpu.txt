Description of updating JS-Beautify and CodeMirror libraries into agpu.
...
Most agpu LMS development systems should have at least npm and npx installed.
...
Next, you need to run the build script for the agpu plugin.
From the root of the plugin (e.g lib/editor/tiny/plugins/html), run:
cd amd
grunt
