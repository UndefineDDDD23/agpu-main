YUI.add('agpu-editor_atto-menu', function (Y, NAME) {
...
var LOGNAME = 'agpu-editor_atto-menu';
var MENUDIALOGUE = '' +
...
/**
 * A Menu for the Atto editor used in agpu.
 *
...
Y.extend(Menu, M.core.dialogue, {
    ...
    initializer: function(config) {
        ...
        var content = bb.one('.agpu-dialogue-wrap');
        content.removeClass('agpu-dialogue-wrap')
            .addClass('agpu-dialogue-content');
...
}, '@VERSION@', {"requires": ["agpu-core-notification-dialogue", "node", "event", "event-custom"]});
