YUI.add('agpu-editor_atto-plugin', function (Y, NAME) {
 ...
 * Atto editor plugin.
 *
 * @module agpu-editor_atto-plugin
...
/**
 * A Plugin for the Atto Editor used in agpu.
 *
...
var DISABLED = 'disabled',
    HIGHLIGHT = 'highlight',
    LOGNAME = 'agpu-editor_atto-editor-plugin',
    CSS = {
...
EditorPluginButtons.prototype = {
    ...
    _normalizeIcon: function(config) {
        if (!config.iconurl) {
            ...
            if (!config.iconComponent || config.iconComponent == 'agpu') {
