YUI.add('agpu-editor_atto-editor', function (Y, NAME) {
...
/**
 * The Atto WYSIWG pluggable editor, written for agpu.
 *
 * @module     agpu-editor_atto-editor
 * @package    editor_atto
 * @copyright  2013 Damyon Wiese  <damyon@agpu.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @main       agpu-editor_atto-editor
 */
...
var LOGNAME = 'agpu-editor_atto-editor';
var CSS = {
...
// Function for agpu's initialisation.
 ...
 *
 * @module     agpu-editor_atto-notify
 * @submodule  notify
 * @package    editor_atto
...
var LOGNAME_NOTIFY = 'agpu-editor_atto-editor-notify',
    NOTIFY_INFO = 'info',
...
EditorNotify.prototype = {
    ...
    setupNotifications: function() {
        ...
        preload1.src = M.util.image_url('i/warning', 'agpu');
        preload2.src = M.util.image_url('i/info', 'agpu');
    ...
    showMessage: function(message, type, timeout) {
        ...
        if (type === NOTIFY_WARNING) {
            messageTypeIcon = '<img class="icon" src="' +
                              M.util.image_url('i/warning', 'agpu') +
                              '" alt="' + M.util.get_string('warning', 'agpu') + '"/>';
        } else if (type === NOTIFY_INFO) {
            messageTypeIcon = '<img class="icon" src="' +
                              M.util.image_url('i/info', 'agpu') +
                              '" alt="' + M.util.get_string('info', 'agpu') + '"/>';
        } else {
        }
 ...
 *
 * @module     agpu-editor_atto-autosave
...
var SUCCESS_MESSAGE_TIMEOUT = 5000,
    ...
    LOGNAME_AUTOSAVE = 'agpu-editor_atto-editor-autosave';
 ...
 * A autosave function for the Atto editor.
 *
 * @module     agpu-editor_atto-autosave-io
...
Y.Base.mix(Y.M.editor_atto.Editor, [EditorFilepicker]);
    ...
    "requires": [
        ...
        "node-event-simulate",
        "yui-throttle",
        "agpu-core-notification-dialogue",
        "agpu-editor_atto-rangy",
        "handlebars",
        "timers",
