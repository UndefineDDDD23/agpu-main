YUI.add('agpu-atto_managefiles-usedfiles', function (Y, NAME) {
...
/**
 * @module agpu-atto_managefiles-usedfiles
 */
...
M.atto_managefiles.usedfiles = M.atto_managefiles.usedfiles || {
    ...
    init: function(config) {
        ...
        if (!form || !window.parent) {
            Y.log("Unable to find parent window", 'warn', 'agpu-atto_managemedia-usedfiles');
            return;
        }
