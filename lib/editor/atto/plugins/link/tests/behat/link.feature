...
Feature: Add links to Atto
  ...
  Scenario: Insert a links
    Given the following "user private file" exists:
      | user     | admin                                          |
      | filepath | lib/editor/atto/tests/fixtures/agpu-logo.png |
  ...
  Scenario: Insert a link without providing text to display
    ...
    And I should see "https://agpu.org/"
    And I click on "Link" "button"
    ...
    And I should see "https://agpu.org/</a>"
  ...
  Scenario: Insert a link with providing text to display
    ...
    And I set the field "Enter a URL" to "https://agpu.org/"
    And I click on "Create link" "button"
    Then I should see "agpu - Open-source learning platform"
    And I click on "Link" "button"
    ...
    And I click on "Show more buttons" "button"
    And I click on "HTML" "button"
    And I should see "agpu - Open-source learning platform</a>"
    And I should not see "https://agpu.org/</a>"
  ...
  Scenario: Insert a link for an image
    ...
    And I click on "agpu-logo.png" "link"
    And I click on "Select this file" "button"
    And I set the field "Describe this image for someone who cannot see it" to "It's the agpu"
    ...
    And I click on "HTML" "button"
    Then I should see "<a href=\"https://agpu.org/\" title=\"agpu - Open-source learning platform\"><img"
    And I click on "HTML" "button"
    And I select the text in the "Description" Atto editor
    And I press the shift left key
    And I click on "Insert or edit image" "button"
    And the field "Describe this image for someone who cannot see it" matches value "It's the agpu"
