YUI.add('agpu-atto_media-button', function (Y, NAME) {
                ...
                '<legend class="d-flex align-items-center px-1">' +
                    '<div class="position-relative d-flex ftoggler align-items-center position-relative me-1">' +
                        '<a role="button" data-toggle="collapse" href="#{{id}}" aria-expanded="false"' +
                            ...
                            '<span class="expanded-icon icon-no-margin p-2" title="{{get_string "collapse" "agpu"}}">' +
                                '<i class="icon fa fa-chevron-down fa-fw " aria-hidden="true"></i>' +
                            '</span>' +
                            '<span class="collapsed-icon icon-no-margin p-2" title="{{get_string "expand" "agpu"}}">' +
...
}, '@VERSION@', {"requires": ["agpu-editor_atto-plugin", "agpu-form-shortforms"]});
