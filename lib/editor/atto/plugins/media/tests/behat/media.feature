...
Feature: Add media to Atto
  ...
  Background:
    Given the following "user private files" exist:
      | user  | filepath                                          |
      | admin | lib/editor/atto/tests/fixtures/agpu-logo.webm   |
      | admin | lib/editor/atto/tests/fixtures/agpu-logo.mp4    |
      | admin | lib/editor/atto/tests/fixtures/agpu-logo.png    |
  ...
  Scenario: Insert some media as a link
    ...
    And I click on "agpu-logo.webm" "link"
    And I click on "Select this file" "button"
    And the field "Enter name" matches value "agpu-logo.webm"
    And I wait until the page is ready
    And I click on "Insert media" "button"
    When I click on "Save changes" "button"
    Then "//a[. = 'agpu-logo.webm']" "xpath_element" should exist
  ...
  Scenario: Insert some media as a plain video
    ...
    And I click on "Private files" "link" in the ".fp-repo-area" "css_element"
    And I click on "agpu-logo.mp4" "link"
    And I click on "Select this file" "button"
    When I click on "Insert media" "button"
    Then "//video[descendant::source[contains(@src, 'agpu-logo.webm')]][descendant::source[contains(@src, 'agpu-logo.mp4')]]" "xpath_element" should exist
  ...
  Scenario: Insert some media as a video with display settings
    ...
    And I click on "Private files" "link" in the ".agpu-dialogue-base[aria-hidden='false'] .fp-repo-area" "css_element"
    And I click on "agpu-logo.png" "link"
    And I click on "Select this file" "button" in the ".agpu-dialogue-base[aria-hidden='false']" "css_element"
    ...
    And I click on "Display options" "link"
    When I click on "Insert media" "button"
    Then "//video[descendant::source[contains(@src, 'agpu-logo.webm')]][contains(@poster, 'agpu-logo.png')][@width=420][@height=69][@title='VideoTitle']" "xpath_element" should exist
  ...
  Scenario: Insert some media as a video with advanced settings
    ...
    When I click on "Insert media" "button"
    Then "//video[descendant::source[contains(@src, 'agpu-logo.webm')]][@controls='true'][@loop='true'][@autoplay='true'][@autoplay='true']" "xpath_element" should exist
  ...
  Scenario: Insert some media as a plain audio
    ...
    And I click on "Select this file" "button"
    When I click on "Insert media" "button"
    Then "//audio[descendant::source[contains(@src, 'agpu-logo.mp4')]]" "xpath_element" should exist
  ...
  Scenario: Insert some media as an audio with display settings
    ...
    When I click on "Insert media" "button"
    Then "//audio[descendant::source[contains(@src, 'agpu-logo.mp4')]][@title='AudioTitle']" "xpath_element" should exist
  ...
  Scenario: Insert some media as an audio with advanced settings
    ...
    When I click on "Insert media" "button"
    Then "//audio[descendant::source[contains(@src, 'agpu-logo.mp4')]][@controls='true'][@loop='true'][@autoplay='true'][@autoplay='true']" "xpath_element" should exist
