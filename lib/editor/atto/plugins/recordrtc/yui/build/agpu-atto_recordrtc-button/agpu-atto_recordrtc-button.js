YUI.add('agpu-atto_recordrtc-button', function (Y, NAME) {
...
/**
 * @module agpu-atto_recordrtc-button
 */
...
}, '@VERSION@', {"requires": ["agpu-editor_atto-plugin", "agpu-atto_recordrtc-recording"]});
