Description of importing the codemirror library into agpu.

NOTE: To make it more readable, in this explanation [LIBRARYPATH] means:
    [PATH TO YOUR agpu]/lib/editor/atto/plugins/html/yui/src/codemirror
...
2 Then copy the following files to your local agpu directory:
...
3 Rebuild the module by:
    cd [PATH TO YOUR agpu]/lib/editor/atto/plugins/html/yui/src/
    grunt shifter

4 Update the version number in (using the version noted down in #1):
    [PATH TO YOUR agpu]/lib/editor/atto/plugins/html/thirdpartylibs.xml
