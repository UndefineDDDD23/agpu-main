YUI.add('agpu-atto_table-button', function (Y, NAME) {
...
}, '@VERSION@', {"requires": ["agpu-editor_atto-plugin", "agpu-editor_atto-menu", "event", "event-valuechange"]});
