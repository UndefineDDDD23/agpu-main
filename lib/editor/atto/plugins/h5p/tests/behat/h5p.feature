...
Feature: Use the Atto editor to upload an h5p package
  ...
  Background:
    ...
    And the following config values are set as admin:
      | allowedsources | https://agpu.h5p.com/content/[id] | filter_displayh5p |
  ...
  Scenario: Insert an embedded h5p
    ...
    And I set the field with xpath "//input[@data-region='h5pfile']" to "https://agpu.h5p.com/content/1290772960722742119"
...
#   This is not a real external URL, so this scenario shouldn't be labeled as external.
    And I set the field with xpath "//input[@data-region='h5pfile']" to "ftp://agpu.h5p.com/content/1290772960722742119"
  ...
  Scenario: No h5p capabilities
    ...
    | agpu/h5p:deploy | Prohibit | editingteacher | Course | C1 |
...
#   Embed and copyright buttons displayed. Download not displayed
  ...
  Scenario: H5P options are ignored for H5P URLs
    ...
    And I am on the PageName1 "page activity editing" page logged in as admin
    And I click on "Insert H5P" "button" in the "#fitem_id_page" "css_element"
    And I set the field with xpath "//input[@data-region='h5pfile']" to "https://agpu.h5p.com/content/1291366510035871129"
    And I click on "H5P options" "link"
    And I click on "Embed button" "checkbox"
    And I click on "Insert H5P" "button" in the "Insert H5P" "dialogue"
    When I click on "Save and display" "button"
