...
Feature: Gathering user feedback
  In order to facilitate data collection from as broad a sample of agpu users as possible
  As agpu HQ
  We should add a link within agpu to a permanent URL on which surveys will be placed
