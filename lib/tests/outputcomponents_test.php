...
final class outputcomponents_test extends \advanced_testcase {
     ...
     *
     * @deprecated since agpu 3.11 MDL-45242
     */
    ...
    public function test_get_url(): void {
        ...
        $this->assertSame('https://www.example.com/agpu', $CFG->wwwroot);
        ...
        $up2 = new user_picture($user2);
        $this->assertSame('http://www.gravatar.com/avatar/ab53a2911ddf9b4817ac01ddcd3d975f?s=35&d=http%3A%2F%2Fwww.example.com%2Fagpu%2Fpix%2Fu%2Ff2.png', $up2->get_url($page, $renderer)->out(false));
        ...
        $up2 = new user_picture($user2);
        $this->assertSame('https://secure.gravatar.com/avatar/ab53a2911ddf9b4817ac01ddcd3d975f?s=35&d=https%3A%2F%2Fwww.example.com%2Fagpu%2Fpix%2Fu%2Ff2.png', $up2->get_url($page, $renderer)->out(false));
        ...
        // $up2 = new user_picture($user2);
        // $this->assertEquals('http://www.gravatar.com/avatar/ab53a2911ddf9b4817ac01ddcd3d975f?s=35&d=http%3A%2F%2Fwww.example.com%2Fagpu%2Ftheme%2Fafterburner%2Fpix_core%2Fu%2Ff2.png', $up2->get_url($page, $renderer)->out(false));

        // $up2 = new user_picture($user2);
        // $this->assertSame('https://secure.gravatar.com/avatar/ab53a2911ddf9b4817ac01ddcd3d975f?s=35&d=https%3A%2F%2Fwww.example.com%2Fagpu%2Ftheme%2Fafterburner%2Fpix_core%2Fu%2Ff2.png', $up2->get_url($page, $renderer)->out(false));
    ...
    public function test_basic_syntax(): void {
        $definition = <<<EOF
agpu community|http://agpu.org
-agpu free support|http://agpu.org/support
-agpu development|http://agpu.org/development
--agpu Tracker|http://tracker.agpu.org
--agpu Docs|http://docs.agpu.org
-agpu News|http://agpu.org/news
agpu company||agpu trust pty
-Hosting|http://agpu.com/hosting|Commercial hosting
-Support|http://agpu.com/support|Commercial support
EOF;
        ...
        $this->assertEquals('agpu community', $item->get_text());
        $itemurl = $item->get_url();
        $this->assertTrue($itemurl instanceof \agpu_url);
        $this->assertEquals('http://agpu.org', $itemurl->out());
        ...
        $this->assertSame('agpu company', $item->get_text());
        $this->assertNull($item->get_url());
        $this->assertSame('agpu trust pty', $item->get_title());
