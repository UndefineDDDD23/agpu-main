...
class authlib_test extends \advanced_testcase {
    ...
    public function test_signup_validate_data_same_email(): void {
        ...
        // the default `validate_email()` and agpu does not yet provide a CFG switch to allow such emails.  So we
        ...
        $defaultvalidator = \agpu_phpmailer::$validator;
        \agpu_phpmailer::$validator = function($address) {
        ...
        // Emails in agpu are supposed to be case-insensitive (and accent-sensitive but accents are not yet supported).
        ...
        // Please note that agpu does not normally support such emails yet. We test the DB search sensitivity here.
        ...
        \agpu_phpmailer::$validator = $defaultvalidator;
    }
