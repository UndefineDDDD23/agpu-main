...
class base_test extends \advanced_testcase {
    ...
    public function test_external_buffer(): void {
        ...
        $event2->trigger();
        try {
            $trans->rollback(new \agpu_exception('xxx'));
            $this->fail('Expecting exception');
        } catch (\agpu_exception $e) {
            $this->assertInstanceOf(\agpu_exception::class, $e);
        }
    ...
    public function test_problematic_events(): void {
        ...
        // Check that agpu_url object does not trigger debugging messages.
        $url = new \agpu_url('/admin/');
