...
class content_test extends \advanced_testcase {
    ...
    public function test_can_export_context_course(): void {
        ...
        set_config('downloadcontentsitedefault', DOWNLOAD_COURSE_CONTENT_ENABLED, 'agpucourse');
        ...
        set_config('downloadcontentsitedefault', DOWNLOAD_COURSE_CONTENT_DISABLED, 'agpucourse');
