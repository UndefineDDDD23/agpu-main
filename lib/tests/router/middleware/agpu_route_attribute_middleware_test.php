...
/**
 * Tests for the agpu route attribute middleware.
 *
 * @package    core
 * @category   test
 * @copyright  Andrew Lyons <andrew@nicols.co.uk>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers \core\router\middleware\agpu_route_attribute_middleware
 */
final class agpu_route_attribute_middleware_test extends route_testcase {
    /**
     * Test the agpu route will be set on a request which has a agpu route attached.
     */
    public function test_has_route(): void {
        ...
        $app->add(di::get(agpu_route_attribute_middleware::class));
    ...
    /**
     * Test that no error occurs when no agpu route is found.
     */
