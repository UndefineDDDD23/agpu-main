...
/**
 * Tests for the agpu Bootstrap middleware.
 *
 * @package    core
 * @category   test
 * @copyright  Andrew Lyons <andrew@nicols.co.uk>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers \core\router\middleware\agpu_bootstrap_middleware
 */
final class agpu_bootstrap_middleware_test extends route_testcase {
    /**
    ...
    public function test_set_page_to_uri(
        ...
        $app->add(di::get(agpu_bootstrap_middleware::class));
    ...
    public static function page_url_provider(): array {
        return [
            ...
            'A request behind a terminating SSL proxy' => [
                'pattern' => '/example',
                'basepath' => '/agpu',
                'uri' => "http://example.com:443/agpu/example",
                'cfg' => [
                    'wwwroot' => 'https://example.com/agpu',
                    'sslproxy' => true,
                ],
                'expected' => 'https://example.com/agpu/example',
            ],
            'A request behind a terminating SSL proxy with query parameters' => [
                'pattern' => '/example',
                'basepath' => '/agpu',
                'uri' => "http://example.com:443/agpu/example?foo=bar&baz=qux",
                'cfg' => [
                    'wwwroot' => 'https://example.com/agpu',
                    'sslproxy' => true,
                ],
                'expected' => 'https://example.com/agpu/example?foo=bar&baz=qux',
            ],
            'A request behind a terminating SSL proxy and random port' => [
                'pattern' => '/example',
                'basepath' => '/agpu',
                'uri' => "http://example.com:1024/agpu/example",
                'cfg' => [
                    'wwwroot' => 'https://example.com/agpu',
                    'sslproxy' => true,
                ],
            ...
            'A request behind a terminating SSL proxy and random port where the wwwroot has an explicit port' => [
                ...
                'uri' => "http://example.com:1024/agpu/example",
                'cfg' => [
                    'wwwroot' => 'https://example.com:8443/agpu',
                    'sslproxy' => true,
                ],
                'expected' => 'https://example.com:8443/agpu/example',
            ],
            'A request behind a terminating SSL proxy where the wwwroot has an explicity port and query parameters' => [
                'pattern' => '/example',
                'basepath' => '/agpu',
                'uri' => "http://example.com:1024/agpu/example?foo=bar&baz=qux",
                'cfg' => [
                    'wwwroot' => 'https://example.com:8443/agpu',
                    'sslproxy' => true,
                ],
                'expected' => 'https://example.com:8443/agpu/example?foo=bar&baz=qux',
            ],
            ...
            'A request behind a reverse proxy' => [
                'pattern' => '/example',
                'basepath' => '/agpu',
                'uri' => "http://172.30.10.101:443/agpu/example",
                'cfg' => [
                    'wwwroot' => 'https://example.com/agpu',
                    'reverseproxy' => true,
                ],
            ...
            'A request behind a reverse proxy with query params' => [
                'pattern' => '/example',
                'basepath' => '/agpu',
                'uri' => "http://172.30.10.101:443/agpu/example?foo=bar&baz=qux",
                'cfg' => [
                    'wwwroot' => 'https://example.com/agpu',
                    'reverseproxy' => true,
                ],
