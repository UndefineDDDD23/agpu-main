...
class user_test extends \advanced_testcase {
    ...
    public function test_get_url(): void {
        $admin = get_admin();
        $context = user::instance($admin->id);
        $expected = new \agpu_url('/user/profile.php', ['id' => $admin->id]);
        $url = $context->get_url();
        $this->assertInstanceOf(\agpu_url::class, $url);
    ...
    public function test_get_capabilities(): void {
        ...
        $this->assertContains('agpu/user:viewalldetails', $capabilities);
        $this->assertContains('agpu/grade:viewall', $capabilities);
        $this->assertNotContains('agpu/course:view', $capabilities);
        $this->assertNotContains('agpu/site:config', $capabilities);
    }
