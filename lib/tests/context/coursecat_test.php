...
class coursecat_test extends \advanced_testcase {
    ...
    public function test_get_url(): void {
        $category = \core_course_category::get_default();
        $context = coursecat::instance($category->id);
        $expected = new \agpu_url('/course/index.php', ['categoryid' => $category->id]);
        $url = $context->get_url();
    ...
    public function test_get_capabilities(): void {
        ...
        $this->assertContains('agpu/category:manage', $capabilities);
        $this->assertContains('agpu/course:view', $capabilities);
