...
/**
 * Test coverage for agpunet share recorder.
 *
 * @package   core
 * @copyright 2023 David Woloszyn <david.woloszyn@agpu.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @coversDefaultClass \core\agpunet\share_recorder
 */
class share_recorder_test extends \advanced_testcase {

    /**
     * Test inserting and updating an activity share progress to agpuNet.
     *
    ...
    public function test_activity_share_progress(): void {
        ...
        $courseid = 10;
        $cmid = 20;
        $resourceurl = 'https://agpunet.test/files/testresource.mbz';
        ...
        $record = $DB->get_record('agpunet_share_progress', ['id' => $shareid]);
        ...
        // Update the record with the returned data from agpuNet.
    ...
    /**
     * Test inserting and updating a course share progress to agpuNet.
