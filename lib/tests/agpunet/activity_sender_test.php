 ...
 *
 * @coversDefaultClass \core\agpunet\activity_sender
 * @package core
...
class activity_sender_test extends \advanced_testcase {
    ...
    public function test_get_resource_description(): void {
        ...
        $activity = $this->generator->create_module('assign', [
            ...
            'intro' => '<p>This is an example agpu activity description.</p>
<p>&nbsp;</p>
...
<p>The last word of this sentence is in <strong>bold</strong></p>'
        ...
        $this->assertEquals('This is an example agpu activity description.
 
...
The last word of this sentence is in bold', $processeddescription);
    ...
    public function test_share_resource(ResponseInterface $httpresponse, array $expected): void {
        ...
        if ($result['responsecode'] == 201) {
            $description = "The user with id '{$USER->id}' successfully shared activities to agpuNet with the " .
                "following course module ids, from context with id '{$this->coursecontext->id}': '{$this->moduleinstance->cmid}'.";
        } else {
            $description = "The user with id '{$USER->id}' failed to share activities to agpuNet with the " .
                "following course module ids, from context with id '{$this->coursecontext->id}': '{$this->moduleinstance->cmid}'.";
        }
        ...
        return [
            'Success' => [
                'http_response' => new Response(
                    ...
                    json_encode([
                        'homepage' => 'https://agpunet.example.com/drafts/view/activity_backup_1.mbz',
                    ]),
                ),
                'expected' => [
                    'response_code' => 201,
                    'resource_url' => 'https://agpunet.example.com/drafts/view/activity_backup_1.mbz',
                ],
            ],
            'Fail with 200 status code' => [
                'http_response' => new Response(
                    ...
                    ['Content-Type' => 'application/json'],
                    json_encode([
                        'homepage' => 'https://agpunet.example.com/drafts/view/activity_backup_2.mbz',
                    ]),
                ),
                'expected' => [
                    'response_code' => 200,
                    'resource_url' => 'https://agpunet.example.com/drafts/view/activity_backup_2.mbz',
                ],
            ],
