...
class upgradelib_test extends advanced_testcase {
    ...
    /**
     * Test the check_oracle_usage check when the agpu instance is not using Oracle as a database architecture.
     *
    ...
    /**
     * Test the check_oracle_usage check when the agpu instance is using Oracle as a database architecture.
     *
     * @covers ::check_oracle_usage
     */
...
calendar,core_calendar|/calendar/view.php?view=month',
     ...
     *
     * @covers ::agpu_needs_upgrading
     */
    public function test_agpu_upgrade_check_outageless(): void {
        global $CFG;
        $this->resetAfterTest();
        // Get a baseline.
        $this->assertFalse(agpu_needs_upgrading());

        // First lets check a plain upgrade ready.
        $CFG->version = '';
        $this->assertTrue(agpu_needs_upgrading());
        ...
        $this->assertTrue(agpu_needs_upgrading(false));
    }
     ...
     */
    public function test_agpu_start_upgrade_outageless(): void {
        global $CFG;
        $this->resetAfterTest();
     ...
     */
    public function test_agpu_set_upgrade_timeout_outageless(): void {
        global $CFG;
        $this->resetAfterTest();
        $this->assertObjectNotHasProperty('upgraderunning', $CFG);
