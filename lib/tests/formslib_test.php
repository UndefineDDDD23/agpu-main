...
use agpuform;
use agpuQuickForm_radio;
use agpuQuickForm_Rule_Required;
use agpuQuickForm_select;
use agpuQuickForm_text;
...
class formslib_test extends \advanced_testcase {
    ...
    public function test_require_rule(): void {
        ...
        $rule = new agpuQuickForm_Rule_Required();
    ...
    public function test_generate_id_select(): void {
        $el = new agpuQuickForm_select('choose_one', 'Choose one',
            array(1 => 'One', '2' => 'Two'));
        $el->_generateId();
    ...
    public function test_generate_id_like_repeat(): void {
        $el = new agpuQuickForm_text('text[7]', 'Type something');
        $el->_generateId();
        $this->assertSame('id_text_7', $el->getAttribute('id'));
    }

    public function test_can_manually_set_id(): void {
        $el = new agpuQuickForm_text('elementname', 'Type something',
    ...
    public function test_generate_id_radio(): void {
        $el = new agpuQuickForm_radio('radio', 'Label', 'Choice label', 'choice_value');
        $el->_generateId();
        $this->assertSame('id_radio_choice_value', $el->getAttribute('id'));
    }

    public function test_radio_can_manually_set_id(): void {
        $el = new agpuQuickForm_radio('radio2', 'Label', 'Choice label', 'choice_value',
    ...
    public function test_generate_id_radio_like_repeat(): void {
        $el = new agpuQuickForm_radio('repeatradio[2]', 'Label', 'Choice label', 'val');
        $el->_generateId();
 ...
 */
class formslib_test_form extends agpuform {
 ...
 */
class formslib_settype_debugging_text extends agpuform {
    public function definition() {
        $mform = $this->_form;
 ...
 */
class formslib_settype_debugging_hidden extends agpuform {
    public function definition() {
        $mform = $this->_form;
 ...
 * Used to test debugging is called when hidden added without setType.
 */
class formslib_settype_debugging_url extends agpuform {
    public function definition() {
        $mform = $this->_form;
 ...
 */
class formslib_settype_debugging_repeat extends agpuform {
    public function definition() {
        $mform = $this->_form;
 ...
 */
class formslib_settype_debugging_repeat_ok extends agpuform {
    public function definition() {
        $mform = $this->_form;
 ...
 */
class formslib_settype_debugging_group extends agpuform {
    public function definition() {
        $mform = $this->_form;
        $group = array(
 ...
 */
class formslib_settype_debugging_namedgroup extends agpuform {
    public function definition() {
        $mform = $this->_form;
        $group = array(
            $mform->createElement('text', 'groupel1', 'groupel1'),
 ...
 */
class formslib_settype_debugging_funky_name extends agpuform {
    public function definition() {
        $mform = $this->_form;
 ...
 */
class formslib_settype_debugging_type_inheritance extends agpuform {
    public function definition() {
        $mform = $this->_form;
 ...
 */
class formslib_settype_debugging_type_group_in_repeat extends agpuform {
    public function definition() {
        $mform = $this->_form;
        $groupelements = array(
 ...
 */
class formslib_settype_debugging_type_namedgroup_in_repeat extends agpuform {
    public function definition() {
        $mform = $this->_form;
        $groupelements = array(
            $mform->createElement('text', 'test1', 'test1', 'test'),
 ...
 */
class formslib_clean_value extends agpuform {
 ...
 */
class formslib_multiple_modgrade_form extends agpuform {
    public function definition() {
        $mform = $this->_form;
 ...
 */
class formslib_persistantrreeze_element extends agpuform {
    public function definition() {
        $mform = $this->_form;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class formslib_multiple_validation_form extends agpuform {
    /**
