...
class user_test extends \advanced_testcase {
    ...
    public function test_get_noreply_user(): void {
        ...
        file_put_contents($langfolder . '/agpu.php', $langconfig);
    ...
    public function test_display_profile_url(): void {
        ...
        $this->assertEquals("https://www.example.com/agpu/user/profile.php?id={$user->id}",
            \core_user::get_profile_url($user)->out());

        // Display profile url at course context.
        $course = $this->getDataGenerator()->create_course();
        $coursecontext = \context_course::instance($course->id);
        $this->assertEquals("https://www.example.com/agpu/user/view.php?id={$user->id}&amp;course={$course->id}",
