...
class primary_test extends \advanced_testcase {
    ...
    public function setUp(): void {
        ...
        $pageurl = new \agpu_url('/mod/assign/view.php', ['id' => $cm->instance]);
        $PAGE->set_cm($cm);
        ...
        return [
            'Simple custom menu' => [
                ...
                Netflix|https://netflix.com/au", [
                    (object) [
                        'text' => 'Course search',
                        'url' => 'https://www.example.com/agpu/course/search.php',
                        'title' => '',
                        'sort' => 1,
                        'children' => [],
                        'haschildren' => false,
            ...
            'Complex, nested custom menu' => [
                ...
                --agpu Docs|https://docs.agpu.org
                -agpu News|http://agpu.org/news
                agpu company
                -agpu commercial hosting|http://agpu.com/hosting
                -agpu commercial support|http://agpu.com/support", [
                    (object) [
                        'text' => 'agpu community',
                        'url' => 'http://agpu.org',
                        'title' => '',
                        ...
                        'children' => [
                            (object) [
                                'text' => 'agpu free support',
                                'url' => 'http://agpu.org/support',
                                'title' => '',
                                'sort' => 2,
                                'children' => [],
                                'haschildren' => false,
                            ...
                            (object) [
                                'text' => 'agpu development',
                                'url' => 'http://agpu.org/development',
                                'title' => '',
                                'sort' => 3,
                                'children' => [
                                    (object) [
                                        'text' => 'agpu Tracker',
                                        'url' => 'http://tracker.agpu.org',
                                        'title' => '',
                                        'sort' => 4,
                                        'children' => [],
                                        'haschildren' => false,
                    ...
                    (object) [
                        ...
                        'children' => [
                            (object) [
                                'text' => 'agpu commercial hosting',
                                'url' => 'http://agpu.com/hosting',
                                'title' => '',
                                'sort' => 8,
                                'children' => [],
                                'haschildren' => false,
                            ...
                            (object) [
                                'text' => 'agpu commercial support',
                                'url' => 'http://agpu.com/support',
                                'title' => '',
                                'sort' => 9,
                                'children' => [],
                                'haschildren' => false,
