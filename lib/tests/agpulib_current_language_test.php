...
/**
 * Unit tests for current_language() in agpulib.php.
 *
 * @package   core
 * @category  test
 ...
 */
class agpulib_current_language_test extends \advanced_testcase {
...
/**
 * Test helper class for test which need agpu to think there are other languages installed.
 *
 * @copyright 2022 The Open University
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
