...
class provider_test extends provider_testcase {
    ...
    public function test_get_contexts_for_userid(): void {
        ...
        // Insert a record.
        $this->insert_dummy_agpunet_share_progress_record($user->id);
    ...
    public function test_get_users_in_context(): void {
        ...
        $this->insert_dummy_agpunet_share_progress_record($user1->id);
        $this->insert_dummy_agpunet_share_progress_record($user2->id);
    ...
    public function test_export_user_data(): void {
        ...
        $subcontexts = [
            get_string('privacy:metadata:agpunet_share_progress', 'agpu')
        ];
        ...
        $userdata = $DB->get_record('agpunet_share_progress', ['userid' => $user1->id]);
    ...
    public function test_delete_data_for_all_users_in_context(): void {
        ...
        // Get all users' data.
        $usersdata = $DB->get_records('agpunet_share_progress', []);
    ...
    /**
     * Helper function to insert a agpuNet share progress record for use in the tests.
     *
     * @param int $userid The ID of the user to link the record to.
     */
    protected function insert_dummy_agpunet_share_progress_record(int $userid): void {
