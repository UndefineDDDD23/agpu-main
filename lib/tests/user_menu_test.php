 ...
 *
 * @package    core
 * @copyright  2015 Jetha Chan <jetha@agpu.com>
...
class user_menu_test extends \advanced_testcase {
    ...
    public function custom_user_menu_data() {
        return array(
            ...
            array('#my1files,agpu|/user/files.php', 1, 1),
            array('#my1files,agpuakjladf|/user/files.php', 1, 1),
...
#f234|2', 5, 3),
    ...
    public function test_custom_user_menu($data, $entrycount, $dividercount): void {
        ...
        // Test using an admin user at the root of agpu; this way we don't have to create a test user with avatar.
        $this->setAdminUser();
        $PAGE->set_url('/');
        $CFG->theme = 'classic';
