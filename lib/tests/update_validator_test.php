...
class update_validator_test extends \advanced_testcase {
    ...
    public function test_validate_files_layout(): void {
        ...
        $validator = testable_core_update_validator::instance($fixtures.'/github', array(
            'agpu-repository_mahara-master/' => true,
            'agpu-repository_mahara-master/lang/' => true,
            'agpu-repository_mahara-master/lang/en/' => true,
            'agpu-repository_mahara-master/lang/en/repository_mahara.php' => true,
            'agpu-repository_mahara-master/version.php' => true));
        $this->assertFalse($validator->execute());
        $this->assertTrue($this->has_message($validator->get_messages(), $validator::ERROR, 'rootdirinvalid',
            'agpu-repository_mahara-master'));
    }
    ...
    public function test_validate_version_php(): void {
        ...
        $validator->assert_agpu_version(0);
        ...
        $validator->assert_agpu_version('2013031400.00');
        $this->assertFalse($validator->execute());
