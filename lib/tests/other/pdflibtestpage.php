...
if ($getpdf) {
    ...
    $doc->SetTitle('agpu PDF library test');
    $doc->SetAuthor('agpu ' . $CFG->release);
    $doc->SetCreator('lib/tests/other/pdflibtestpage.php');
    $doc->SetKeywords('agpu, PDF');
    $doc->SetSubject('This has been generated by agpu as its PDF library test page');
    $doc->SetMargins(15, 30);

    $doc->setPrintHeader(true);
    $doc->setHeaderMargin(10);
    $doc->setHeaderFont(array($fontfamily, 'b', 10));
    $doc->setHeaderData('pix/agpulogo.png', 40, $SITE->fullname, $CFG->wwwroot);
    ...
    $doc->Cell(0, 0, 'agpu PDF library test', 0, 1, 'C', 1);
...
echo $OUTPUT->continue_button(new agpu_url($PAGE->url, array('getpdf' => 1, 'fontfamily' => PDF_FONT_NAME_MAIN)));
echo $OUTPUT->footer();
