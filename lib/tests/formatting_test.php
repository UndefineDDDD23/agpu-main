...
/**
 * Tests for agpu's String Formatter.
 *
 * @package   core
...
class formatting_test extends \advanced_testcase {
    ...
    public function test_format_text_format_agpu(): void {
        ...
        $this->assertMatchesRegularExpression(
            ...
            $formatter->format_text('<p>:-)</p>', FORMAT_agpu)
        );
    }
    ...
    public function test_format_text_format_agpu_no_filters(): void {
        ...
        $this->assertEquals(
            ...
            $formatter->format_text('<p>:-)</p>', FORMAT_agpu, filter: false)
        );
    }
    ...
    public static function format_text_blanktarget_testcases(): array {
        return [
            ...
            'Link with Frank\'s casket inscription' => [
                // phpcs:ignore agpu.Files.LineLength
