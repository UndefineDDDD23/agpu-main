...
class modinfolib_test extends advanced_testcase {
    ...
    public function test_cm_info_properties(): void {
        ...
        $this->assertEquals(new agpu_url('/mod/assign/view.php', array('id' => $moduledb->id)), $cm->url);
    ...
    /**
     * Tests that if the modinfo cache returns a newer-than-expected version, agpu won't rebuild
     * it.
     *
