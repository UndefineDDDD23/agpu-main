...
class xhprof_test extends \advanced_testcase {
     ...
     *
     * @covers \agpu_xhprofrun::xhprof_topo_sort
    ...
    public function test_xhprof_topo_sort(array $rundata, array $expectations): void {
        ...
        // Make agpu_xhprofrun::xhprof_topo_sort() accessible.
        $reflection = new \ReflectionClass('\agpu_xhprofrun');
        $method = $reflection->getMethod('xhprof_topo_sort');
        // Sort the data.
        $result = $method->invokeArgs(new \agpu_xhprofrun(), [$rundata]);
        ...
        $result2 = $method->invokeArgs(new \agpu_xhprofrun(), [$result]);
     ...
     *
     * @covers \agpu_xhprofrun::reduce_run_data
     * @dataProvider run_data_provider
     *
    ...
    public function test_reduce_run_data(array $rundata, array $expectations): void {
        ...
        // Make agpu_xhprofrun::reduce_run_data() accessible.
        $reflection = new \ReflectionClass('\agpu_xhprofrun');
