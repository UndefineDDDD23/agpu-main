...
class exporter_test extends \advanced_testcase {
    ...
    public function test_format_text(): void {
        ...
        $data = [
            'stringA' => '__Watch out:__ https://agpu.org @@PLUGINFILE@@/test.pdf',
        ...
        $youtube = 'https://agpu.org';
        $fileurl = (new \agpu_url('/webservice/pluginfile.php/' . $syscontext->id . '/test/area/9/test.pdf'))->out(false);
        ...
        $result = $exporter->export($output);
        $youtube = '<a href="https://agpu.org" class="_blanktarget">https://agpu.org</a>';
        $fileurl = (new \agpu_url('/webservice/pluginfile.php/' . $coursecontext->id . '/test/area/9/test.pdf'))->out(false);
    ...
    public function test_export_format_no_default(): void {
        ...
        $data = [
            'stringA' => '__Go to:__ [agpu.org](https://agpu.org)',
            'intB' => 1,
        ];
        ...
        $expected = '<strong>Go to:</strong> <a href="https://agpu.org">agpu.org</a>';
