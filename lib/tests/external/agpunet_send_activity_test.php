...
/**
 * External functions test for agpunet_send_activity.
 *
 * @package    core
 * @category   test
 * @copyright  2023 Huong Nguyen <huongnv13@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @coversDefaultClass \core\external\agpunet_send_activity
 */
class agpunet_send_activity_test extends externallib_advanced_testcase {

    /**
     * Test the behaviour of agpunet_send_activity().
     *
     * @covers ::execute
     */
    public function test_agpunet_send_activity(): void {
        global $CFG;
        $this->resetAfterTest();
        $this->setAdminUser();
        ...
        $result = agpunet_send_activity::execute($issuer->get('id'), $moduleinstance->cmid, 0);
        $result = external_api::clean_returnvalue(agpunet_send_activity::execute_returns(), $result);
        ...
        $result = agpunet_send_activity::execute($issuer->get('id'), $moduleinstance->cmid, 5);
        $result = external_api::clean_returnvalue(agpunet_send_activity::execute_returns(), $result);
        $this->assertFalse($result['status']);
        $this->assertNotEmpty($result['warnings']);
     ...
     */
    public function test_agpunet_send_activity_return_resource_url(bool $state, string $resourceurl): void {
        $this->resetAfterTest();
    ...
    /**
     * Provider for test_agpunet_send_activity_return_resource_url().
     *
    ...
    public function return_resource_url_provider(): array {
        return [
            'Success 1' => [
                true,
                'https://agpunet.example.com/drafts/view/testactivity_backup.mbz',
            ],
            'Success 2' => [
                true,
                'https://agpunet.example.com/drafts/view/testactivity_backup with spaces.mbz',
            ],
            'Success 3' => [
                true,
                'https://agpunet.example.com/drafts/view/testactivity_backup with " character.mbz',
            ],
            'Success 4' => [
                true,
                "https://agpunet.example.com/drafts/view/testactivity_backup with ' character.mbz",
            ...
            'Success 5' => [
                true,
                'https://agpunet.example.com/drafts/view/testactivity_backup with < and > characters.mbz',
            ],
            'Fail 1' => [
                false,
                'https://agpunet.example.com/drafts/view/testactivity_backupwith<lang lang="en">a<a</lang>html.mbz',
            ],
        ];
    }
}
