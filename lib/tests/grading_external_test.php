...
class grading_external_test extends \externallib_advanced_testcase {
    ...
    public function test_get_definitions(): void {
        ...
        $roleid = $this->assignUserCapability('agpu/course:viewparticipants', $coursecontext->id, 3);
    ...
    public function test_save_definitions_rubric(): void {
        ...
        $this->assignUserCapability('agpu/grade:managegradingforms', $context->id, $teacherrole->id);
