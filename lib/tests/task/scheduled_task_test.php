...
class scheduled_task_test extends \advanced_testcase {
    ...
    public function test_timezones(): void {
        ...
        // I used http://www.timeanddate.com/worldclock/fixedtime.html?msg=agpu+Test&iso=20160502T01&p1=113
    ...
    public function test_reset_scheduled_tasks_for_component_customised(): void {
        ...
        $tasks = manager::load_scheduled_tasks_for_component('agpu');
        ...
        // Now call reset.
        manager::reset_scheduled_tasks_for_component('agpu');
    ...
    public function test_reset_scheduled_tasks_for_component_deleted(): void {
        ...
        $tasklist = manager::load_scheduled_tasks_for_component('agpu');
        ...
        $this->assertTaskEquals($task, $taskafterreset);
        $this->assertCount(count($tasklist), manager::load_scheduled_tasks_for_component('agpu'));
    }
    ...
    public function test_reset_scheduled_tasks_for_component_delete(): void {
        ...
        $count = $DB->count_records('task_scheduled', array('component' => 'agpu'));
        $allcount = $DB->count_records('task_scheduled');

        $task = new scheduled_test_task();
        $task->set_component('agpu');
        ...
        $aftercount = $DB->count_records('task_scheduled', array('component' => 'agpu'));
        ...
        $this->assertEquals($count, $DB->count_records('task_scheduled', array('component' => 'agpu')));
