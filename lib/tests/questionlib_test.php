...
class questionlib_test extends \advanced_testcase {
    ...
    public function test_question_save_from_deletion_quiz_with_long_name(): void {
        ...
        // agpu doesn't allow you to enter a name longer than 255 characters.
    ...
    public function question_capability_on_question_provider() {
        return [
            'Unrelated capability which is present' => [
                'capabilities' => [
                    'agpu/question:config' => CAP_ALLOW,
                ],
            ...
            'Unrelated capability which is prevented' => [
                'capabilities' => [
                    'agpu/question:config' => CAP_PREVENT,
                ],
                'testcapability' => 'config',
                'isowner' => true,
                'expect' => false,
            ...
            'Related capability which is allowed at all, unset at mine' => [
                'capabilities' => [
                    'agpu/question:editall' => CAP_ALLOW,
                ],
                'testcapability' => 'edit',
                'isowner' => true,
                'expect' => true,
            ...
            'Related capability which is allowed at all, prevented at mine' => [
                'capabilities' => [
                    'agpu/question:editall' => CAP_ALLOW,
                    'agpu/question:editmine' => CAP_PREVENT,
                ],
                'testcapability' => 'edit',
                'isowner' => true,
                'expect' => true,
            ...
            'Related capability which is unset all, allowed at mine' => [
                'capabilities' => [
                    'agpu/question:editall' => CAP_PREVENT,
                    'agpu/question:editmine' => CAP_ALLOW,
                ],
                'testcapability' => 'edit',
                'isowner' => true,
                'expect' => true,
    ...
    public function test_question_has_capability_on_object_with_null_createdby(): void {
        ...
        assign_capability('agpu/question:editmine', CAP_ALLOW, $role, $context->id);
