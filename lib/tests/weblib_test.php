...
class weblib_test extends advanced_testcase {
    ...
    public function test_clean_text(): void {
        ...
        $this->assertSame('lala xx', clean_text($text, FORMAT_agpu));
    ...
    public function test_format_text_trusted(): void {
        ...
        $this->assertSame('<div class="text_to_html">lala xx</div>',
            format_text($text, FORMAT_agpu, ['trusted' => true]));
        ...
        $this->assertSame('<div class="text_to_html">lala xx</div>',
            format_text($text, FORMAT_agpu, ['trusted' => false]));
        $this->assertSame('lala xx',
...
I'm writing to you from the agpu Majlis in Muscat, Oman, where we just had several days of agpu community goodness.

URL outside a tag: https://agpu.org/logo/logo-240x60.gif
Plugin url outside a tag: @@PLUGINFILE@@/logo-240x60.gif

External link 1:<img src='https://agpu.org/logo/logo-240x60.gif' alt='agpu'/>
External link 2:<img alt="agpu" src="https://agpu.org/logo/logo-240x60.gif"/>
Internal link 1:<img src='@@PLUGINFILE@@/logo-240x60.gif' alt='agpu'/>
Internal link 2:<img alt="agpu" src="@@PLUGINFILE@@logo-240x60.gif"/>
...
Anchor + ext. img:<a title="bananas" href="../logo-240x60.gif"><img alt="agpu" src="@@PLUGINFILE@@logo-240x60.gif"/></a>
Ext. anchor + img:<a href="@@PLUGINFILE@@logo-240x60.gif"><img alt="agpu" src="https://agpu.org/logo/logo-240x60.gif"/></a>
SOURCE;
        $expected = <<<EXPECTED
Hello!
...
Ext. anchor + img:<img alt="agpu" src="https://agpu.org/logo/logo-240x60.gif" />
EXPECTED;
...
<span lang='fr' class='multilang'>français</span>", FORMAT_HTML, "english català español français")
    ...
    public function data_validate_email() {
        return [
            ...
            [
                'email' => 'agpu@example.com',
                'result' => true
            ],
            [
                'email' => 'agpu@localhost.local',
                'result' => true
            ],
            [
                'email' => 'verp_email+is=mighty@agpu.org',
                'result' => true
            ],
            [
            ...
            [
                'email' => 'posts+AAAAAAAAAAIAAAAAAAAGQQAAAAABFSXz1eM/P/lR2bYyljM+@posts.agpu.org',
                'result' => true
            ],

            // Test addresses that should NOT pass.
            [
                'email' => 'agpu@localhost',
                'result' => false
            ],
            [
                'email' => '"attacker\\" -oQ/tmp/ -X/var/www/vhost/agpu/backdoor.php  some"@email.com',
                'result' => false
            ],
            [
