 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class core_max_input_vars_form extends agpuform {
    /**
     * Form definition.
     */
    public function definition() {
        ...
        // without using a agpu form element.
...
$PAGE->set_url(new agpu_url('/lib/tests/fixtures/max_input_vars.php'));
...
if ($type && ($result = $mform->get_data())) {
    ...
    switch ($type[0]) {
        case 'c' :
            ...
            // Check using agpu form and _param functions too.
        ...
        case 'a' :
            ...
            // Check using agpu _param function. The form does not include these
