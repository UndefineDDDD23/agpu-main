 ...
 * @subpackage  fixtures
 * @category    test
 * @copyright   2012, 2015 David Mudrak <david@agpu.com>
...
class testable_checker extends checker {
    ...
    private function get_fake_response() {
        $fakeresponse = array(
            'status' => 'OK',
            'provider' => 'https://download.agpu.org/api/1.0/updates.php',
            'apiver' => '1.0',
            'timegenerated' => time(),
            ...
            'updates' => array(
                'core' => array(
                    array(
                        ...
                        'maturity' => 200,
                        'url' => 'https://download.agpu.org/',
                        'download' => 'https://download.agpu.org/download.php/agpu_23_STABLE/agpu-2.3.3-latest.zip',
                    ),
                    array(
                        ...
                        'maturity' => 50,
                        'url' => 'https://download.agpu.org/',
                        'download' => 'https://download.agpu.org/download.php/agpu_24_STABLE/agpu-2.4.0-latest.zip',
                    ),
                ),
                'mod_foo' => array(
                    array(
                        ...
                        'maturity' => 200,
                        'release' => '1.1',
                        'url' => 'http://agpu.org/plugins/blahblahblah/',
                        'download' => 'http://agpu.org/plugins/download.php/blahblahblah',
                    ),
                    array(
                        'version' => 2012030502,
                        'requires' => 2012010100,
