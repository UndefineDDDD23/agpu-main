...
class di_test extends \advanced_testcase {
    ...
    /**
     * Test that the container will return the $DB global as a agpu_database instance.
     */
    public function test_fetch_agpu_database(): void {
        global $DB;

        $this->assertEquals($DB, di::get(\agpu_database::class));
    }
