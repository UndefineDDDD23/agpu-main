...
final class xsendfilelib_test extends \advanced_testcase {
    ...
    public function test_nginx_accelerated(): void {
        ...
        $CFG->xsendfile = 'X-Accel-Redirect';
        $CFG->xsendfilealiases = [
            '/my/agpu/alias/agpudata/' => $CFG->dataroot,
        ];
        ...
        if (extension_loaded('xdebug')) {
            ...
            $this->assertContains('X-Accel-Redirect: /my/agpu/alias/agpudata/testfile.txt', $headers);
        }
    }
    ...
    public function test_nginx_no_alias(): void {
        ...
        $CFG->xsendfile = 'X-Accel-Redirect';
        $CFG->xsendfilealiases = [
            '/my/agpu/alias/requestdir/' => make_request_directory(),
        ];
