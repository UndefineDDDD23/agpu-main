...
namespace agpu\BehatExtension\EventDispatcher\Tester;
...
use agpu\BehatExtension\Context\Step\ChainedStep;
...
class ChainedStepTester implements StepTester {
    ...
    public function test(Environment $env, FeatureNode $feature, StepNode $step, $skip) {
        ...
        if (!($result instanceof ExecutedStepResult) || !$this->supportsResult($result->getCallResult())) {
            ...
            // Extra step, looking for a agpu exception, a debugging() message or a PHP debug message.
