...
class behat_config_util {
    ...
    /**
     * Gets the list of agpu behat contexts
     *
     ...
     * the required Behat extensions and agpu test wwwroot.
     *
        ...
        $config = array(
            'default' => array(
                ...
                'extensions' => array(
                    ...
                    'agpu\BehatExtension' => array(
                        'agpudirroot' => $CFG->dirroot,
    ...
    /**
     * Return list of themes which can be set in agpu.
     *
