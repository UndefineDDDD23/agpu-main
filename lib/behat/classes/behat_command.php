...
class behat_command {
     ...
     * Docs url
     */
    const DOCS_URL = 'https://agpudev.io/general/development/tools/behat';

    /**
     * Ensures the behat dir exists in agpudata
     *
    ...
    public static function behat_setup_problem() {
        ...
        if (!self::are_behat_dependencies_installed()) {
            ...
            // Returning composer error code to avoid conflicts with behat and agpu error codes.
