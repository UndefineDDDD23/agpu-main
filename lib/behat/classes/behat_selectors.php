...
class behat_selectors {
    ...
    /**
     * Returns the behat selector and locator for a given agpu selector and locator
     *
     * @param string $selectortype The agpu selector type, which includes agpu selectors
