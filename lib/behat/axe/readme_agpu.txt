Description of axe import into agpu
...
2/ Copy the following file to your local agpu directory, to replace the old one:

cp /tmp/axe/node_modules/axe-core/axe.min.js [PATH TO YOUR agpu]/lib/behat/axe/
...
[PATH TO YOUR agpu]/lib/tests/behat/behat_accessibility.php to reflect the new version number.
