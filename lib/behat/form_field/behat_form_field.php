...
class behat_form_field implements behat_session_interface {
     ...
     * in cases like agpu form group elements we can not find the type of
     ...
     * agpu form elements we will need to refactor this simple HTML elements
     * guess method.
     *
