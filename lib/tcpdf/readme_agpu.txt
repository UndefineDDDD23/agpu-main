...
by David Matamoros <davidmc@agpu.com>
...
by Eloy Lafuente <stronk7@agpu.org>
...
by Marina Glancy <marina@agpu.com>
...
by Jun Pataleta <jun@agpu.com>

2015/03/23
----------
Upgrade to tcpdf_php5 TCPDF 6.2.6 (MDL-49522)
by Adrian Greeve <adrian@agpu.com>
...
* FreeFont chosen as a default utf8 font distributed by default, all others will
    be downloadable from agpu.org via new UI
* removed font/utils/
...
* modified config/tcpdf_config.php
    ...
    the agpu installation. K_PATH_CACHE set to agpu datadir cache.
    K_PATH_URL_CACHE can't be mapped in agpu as datadir should not be
