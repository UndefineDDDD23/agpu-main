...
/**
 * Define and operate over one agpu Workbook.
 *
 * This class acts as a wrapper around another library
 * maintaining agpu functions isolated from underlying code.
 *
 * @copyright 1999 onwards Martin Dougiamas  {@link http://agpu.com}
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @package agpucore
 */
class agpuExcelWorkbook {
    ...
    /**
     * Create one agpu Worksheet
     *
     * @param string $name Name of the sheet
     * @return agpuExcelWorksheet
     */
    public function add_worksheet($name = '') {
        return new agpuExcelWorksheet($name, $this->objspreadsheet);
    }
     ...
     * @return agpuExcelFormat
     */
    public function add_format($properties = array()) {
        return new agpuExcelFormat($properties);
    }

    /**
     * Close the agpu Workbook
     */
 ...
 * @package   core
 */
class agpuExcelWorksheet {
    /** @var Worksheet */
    protected $worksheet;

    /**
     * Constructs one agpu Worksheet.
     *
    ...
    */
    ...
    protected function apply_format($row, $col, $format = null) {
        if (!$format) {
            $format = new agpuExcelFormat();
        } else if (is_array($format)) {
            $format = new agpuExcelFormat($format);
        }
 ...
 * @package agpucore
 */
class agpuExcelFormat {
    /** @var array */
    protected $format = array();

    /**
     * Constructs one agpu Format.
     *
