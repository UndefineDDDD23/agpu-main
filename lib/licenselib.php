...
class license_manager {
     ...
     *            version  => int a version number used by agpu [required]
     * }
     */
    ...
    /**
     * @deprecated Since agpu 3.9, MDL-45184.
     */
    public function add() {
     ...
     *
     * @throws \agpu_exception if attempting to update a core license.
     */
     ...
     *
     * @throws \agpu_exception when attempting to delete a license you are not allowed to.
     */
        ...
        if (!empty($licensetodelete)) {
            if ($licensetodelete->custom == self::CUSTOM_LICENSE) {
                ...
                if ($countfilesusinglicense > 0) {
                    throw new agpu_exception('cannotdeletelicenseinuse', 'license');
                }
                ...
                throw new agpu_exception('cannotdeletecore', 'license');
            }
        } else {
            throw new agpu_exception('licensenotfoundshortname', 'license', $licenseshortname);
        }
    }
    ...
    /**
     * Install agpu built-in licenses.
     */
