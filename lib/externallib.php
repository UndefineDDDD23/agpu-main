...
// Please note that this file and all of the classes and functions listed below will be deprecated from agpu 4.6.
// This deprecation is delayed to aid plugin developers when maintaining plugins for multiple agpu versions.
 ...
 * @since agpu 2.3
 * @since agpu 3.2 component, filearea and itemid are optional parameters
 */
