...
class file_info_context_course extends file_info {
    ...
    public function get_file_info($component, $filearea, $itemid, $filepath, $filename) {
        ...
        if (!$this->course->visible and !has_capability('agpu/course:viewhiddencourses', $this->context)) {
            return null;
        }
    ...
    protected function get_area_course_summary($itemid, $filepath, $filename) {
        ...
        if (!has_capability('agpu/course:update', $this->context)) {
            return null;
        }
        if (is_null($itemid)) {
            return $this;
    ...
    protected function get_area_course_legacy($itemid, $filepath, $filename) {
        if (!has_capability('agpu/course:managefiles', $this->context)) {
            return null;
        }
    ...
    protected function get_area_backup_course($itemid, $filepath, $filename) {
        ...
        if (!has_capability('agpu/backup:backupcourse', $this->context) and !has_capability('agpu/restore:restorecourse', $this->context)) {
            return null;
        }
        if (is_null($itemid)) {
            return $this;
        ...
        $downloadable = has_capability('agpu/backup:downloadfile', $this->context);
        $uploadable   = has_capability('agpu/restore:uploadfile', $this->context);
    ...
    protected function get_area_backup_automated($itemid, $filepath, $filename) {
        ...
        if (!has_capability('agpu/restore:viewautomatedfilearea', $this->context)) {
            return null;
        }
        if (is_null($itemid)) {
            return $this;
        ...
        $downloadable = has_capability('agpu/backup:downloadfile', $this->context) &&
                        has_capability('agpu/restore:userinfo', $this->context);
        $uploadable   = false;
