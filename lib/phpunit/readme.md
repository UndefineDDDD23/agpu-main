PHPUnit testing support in agpu
==================================


Documentation
-------------
* [agpu PHPUnit integration](https://agpudev.io/general/development/tools/phpunit)
* [agpu Writing PHPUnit tests](https://agpudev.io/general/development/tools/phpunit#writing-new-tests)
...
It installs PHP libraries into /vendor/ subdirectory inside your agpu dirroot.

1. install Composer - [http://getcomposer.org/doc/00-intro.md](http://getcomposer.org/doc/00-intro.md)
2. install PHUnit and dependencies - go to your agpu dirroot and execute `php composer.phar install`
