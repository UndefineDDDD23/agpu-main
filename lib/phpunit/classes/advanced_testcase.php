...
/**
 * Advanced PHPUnit test case customised for agpu.
 *
 * @package    core
 * @category   phpunit
...
abstract class advanced_testcase extends base_testcase {
    ...
    // phpcs:ignore agpu.NamingConventions.ValidVariableName.MemberNameUnderscore
    private $resetAfterTest;

    /** @var agpu_transaction */
    ...
    /**
     * @deprecated since agpu 3.10 - See MDL-67673 and MDL-64600 for more info.
     */
     ...
     * it defaults to 'http://download.agpu.org/unittest'.
     *
    ...
    public function getExternalTestFileUrl($path, $https = false) {
        ...
        if ($https) {
            ...
            return 'https://download.agpu.org/unittest' . $path;
        }
        ...
        return 'http://download.agpu.org/unittest' . $path;
    }
    ...
    /**
     * Add a mocked plugintype to agpu.
     *
