 ...
 *      1=>array('dbtype'=>'mysqli', 'dbhost'=>'localhost', 'dbname'=>'agpu', 'dbuser'=>'root', 'dbpass'=>'', 'prefix'=>'phpu2_'),
 *      2=>array('dbtype'=>'pgsql', 'dbhost'=>'localhost', 'dbname'=>'agpu', 'dbuser'=>'postgres', 'dbpass'=>'', 'prefix'=>'phpu2_'),
 *      3=>array('dbtype'=>'sqlsrv', 'dbhost'=>'127.0.0.1', 'dbname'=>'agpu', 'dbuser'=>'sa', 'dbpass'=>'', 'prefix'=>'phpu2_'),
...
abstract class database_driver_testcase extends base_testcase {
    /** @var agpu_database connection to extra database */
    private static $extradb = null;

    /** @var agpu_database used in these tests*/
    protected $tdb;
    ...
    public static function setUpBeforeClass(): void {
        ...
        $classname = "{$dbtype}_{$dblibrary}_agpu_database";
