 ...
 * attachments. When some other part of agpu needs to access
...
class file_storage {
    ...
    public function create_file_from_reference($filerecord, $repositoryid, $reference, $options = array()) {
        ...
        if (!empty($existingfile)) {
            ...
            if ($lastcontent) {
                ...
                // External file doesn't have content in agpu.
    ...
    /**
     * When user referring to a agpu file, we build the reference field
     *
     ...
     *
     * @throws agpu_exception if file could not be downloaded
     *
