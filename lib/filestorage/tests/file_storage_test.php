...
class file_storage_test extends \advanced_testcase {
    ...
    public function test_create_file_from_string(): void {
        ...
        // Number of files installed in the database on a fresh agpu site.
    ...
    public function test_before_file_created_hook_executed_nochange(): void {
        global $TESTCALLBACK; // phpcs:ignore agpu.NamingConventions.ValidVariableName.VariableNameLowerCase
    ...
    public function test_before_file_created_hook_executed_filepath(): void {
        ...
        $TESTCALLBACK = function( // phpcs:ignore agpu.NamingConventions.ValidVariableName.VariableNameLowerCase
