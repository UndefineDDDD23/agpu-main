...
class file_system_filedir_test extends \advanced_testcase {
    ...
    /**
     * Test that the standard agpu warning message is put into the filedir.
     *
     * @covers ::__construct
     */
    public function test_warnings_put_in_place(): void {
        ...
        $this->assertEquals(
            'This directory contains the content of uploaded files and is controlled by agpu code. ' .
    ...
    public function test_remove_file_empty(): void {
        ...
        $DB = $this->getMockBuilder(\agpu_database::class)
