...
class tgz_packer extends file_packer {
    ...
    /**
     * @var string Name of special archive index file added by agpu.
     */
     ...
     */
    const ARCHIVE_INDEX_COUNT_PREFIX = 'agpu archive file index. Count: ';
     ...
     * @throws agpu_exception If error
     */
