Description of PhpSpreadsheet import into agpu
...
STEPS:
 * Create a temporary folder outside your agpu installation
 ...
 * Check any new libraries that have been added and make sure they do not exist in agpu already.
 ...
 * Go to http://<your agpu root>/lib/tests/other/spreadsheettestpage.php and test the generated files


CHANGES:

 * Add the next agpu hack at the beginning of the function sysGetTempDir()
