Description of MatthiasMullie\Minify import into agpu

1) Go to https://github.com/matthiasmullie/minify/releases

Download the latest minify "Source code (zip)" and unzip it:

mv minify-X.Y.ZZ/src /path/to/agpu/lib/minify/matthiasmullie-minify/
mv minify-X.Y.ZZ/data /path/to/agpu/lib/minify/matthiasmullie-minify/
...
mv path-converter-A.B.C/src/ /path/to/agpu/lib/minify/matthiasmullie-pathconverter/
