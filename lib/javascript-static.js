...
// Miscellaneous core Javascript functions for agpu
...
M.util.image_url = function(imagename, component) {
    ...
    if (!component || component == '' || component == 'agpu' || component == 'core') {
        component = 'core';
    }
...
M.util.CollapsibleRegion = function(Y, id, userpref, strtooltip) {
    ...
    if (this.div.hasClass('collapsed')) {
        ...
        this.icon = Y.Node.create('<img src="'+M.util.image_url(collapsedimage, 'agpu')+'" alt="" class="icon" />');
        // Shrink the div as it is collapsed by default
        this.div.setStyle('height', caption.get('offsetHeight')+'px');
    } else {
        // Add the correct image and record the YUI node created in the process
        this.icon = Y.Node.create('<img src="'+M.util.image_url('t/expanded', 'agpu')+'" alt="" class="icon" />');
    }
    a.append(this.icon);
    ...
    animation.on('end', function() {
        ...
        if (this.div.hasClass('collapsed')) {
            this.icon.set('src', M.util.image_url(collapsedimage, 'agpu'));
        } else {
            this.icon.set('src', M.util.image_url('t/expanded', 'agpu'));
        }
...
/**
 * Makes a best effort to connect back to agpu to update a user preference,
 * however, there is no mechanism for finding out if the update succeeded.
 *
 * Before you can use this function in your JavsScript, you must have called
 * user_preference_allow_ajax_update from agpulib.php to tell agpu that
    ...
    require(
        ...
        function(Notification, Str, FormChangeChecker, Normalise) {
            ...
            Notification.saveCancelPromise(
                ...
                message,
                continuelabel || Str.get_string('yes', 'agpu'),
            )
            .then(() => {
                if (callback) {
    ...
    Y.use('node', 'event-mouseenter', function(){
        ...
        var colourpicker = {
            ...
            init : function() {
                ...
                this.image.setAttribute('src', M.util.image_url('i/colourpicker', 'agpu'));
        ...
        M.util.block_hider = M.util.block_hider || (function(){
            ...
            Y.extend(blockhider, Y.Base, blockhider.prototype, {
                ...
                ATTRS : {
                    ...
                    preference : {},
                    iconVisible : {
                        value : M.util.image_url('t/switch_minus', 'agpu')
                    },
                    iconHidden : {
                        value : M.util.image_url('t/switch_plus', 'agpu')
                    },
                    block : {
 ...
 */
YUI.add('agpu-core-io', function(Y) {
 ...
 * same way as PHP get_string() in agpu does.
 *
...
M.util.add_lightbox = function(Y, node) {
    var WAITICON = {'pix':"i/loading_small",'component':'agpu'};
...
/**
 * @deprecated since agpu 3.3, but shouldn't be used in earlier versions either.
 */
