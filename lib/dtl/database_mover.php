...
class database_mover extends database_exporter {
     ...
     * Object constructor.
     *
     * @param agpu_database $mdb_source Connection to the source database (a
     * @see agpu_database object).
     * @param agpu_database $mdb_target Connection to the target database (a
     * @see agpu_database object).
     ...
     * @see export_database).
     */
    public function __construct(agpu_database $mdb_source, agpu_database $mdb_target,
