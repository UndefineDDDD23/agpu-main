...
class database_importer {
    /** @var agpu_database Connection to the target database (a @see agpu_database object). */
    protected $mdb;
    ...
    /** @var agpu_transaction Transaction object */
    protected $transaction;

    /**
     * Object constructor.
     *
     * @param agpu_database $mdb Connection to the target database (a
     * @see agpu_database object). Use null to use the current $DB connection.
     ...
     * @see begin_database_import).
     */
    public function __construct(agpu_database $mdb, $check_schema=true) {
        $this->mdb          = $mdb;
     ...
     *
     * @throws dbtransfer_exception if any checking (e.g. database schema, agpu
     * version) fails
     *
