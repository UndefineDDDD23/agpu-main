...
class testing_generator_test extends \advanced_testcase {
    ...
    public function test_create(): void {
        ...
        $this->assertSame(FORMAT_agpu, $category->descriptionformat);
        ...
        $this->assertSame(FORMAT_agpu, $cohort->descriptionformat);
        ...
        $this->assertSame(FORMAT_agpu, $course->summaryformat);
    ...
    public function test_create_module(): void {
        ...
        // Note: module can have more autocompletion rules as defined in agpuform_mod::add_completion_rules().
