Description of import of various YUI libraries into agpu:
...
* Verify our simpleyui rollup contents in /theme/yui_combo.php.
  e.g. http://[youragpu]/theme/yui_combo.php?rollup/3.18.1/yui-agpusimple.js

If you need to patch the YUI library between its official releases, you *must* read
http://docs.agpu.org/dev/YUI/Patching.
