...
class html_writer {
     ...
     *
     * @param string|agpu_url $url The URL
     ...
     * @return string HTML fragment
     */
    public static function input_hidden_params(agpu_url $url, ?array $exclude = null) {
     ...
     * @param agpu_url|string $url optional url of the external script, $code ignored if specified
