...
class core_renderer_maintenance extends core_renderer {
     ...
     * @param single_button|agpu_url|string $continue The single_button component representing the Continue answer.
     * @param single_button|agpu_url|string $cancel The single_button component representing the Cancel answer.
    ...
    public function confirm($message, $continue, $cancel, array $displayoptions = []) {
        ...
        // from any previous version of agpu).
        if ($continue instanceof single_button) {
            ...
            throw new coding_exception('The continue param to $OUTPUT->confirm() must be either a URL' .
                                       ' (string/agpu_url) or a single_button instance.');
        }

        if ($cancel instanceof single_button) {
            $output = '';
        } else if (is_string($cancel)) {
            $cancel = new single_button(new agpu_url($cancel), get_string('cancel'), 'get');
