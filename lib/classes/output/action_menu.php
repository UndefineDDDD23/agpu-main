...
class action_menu implements renderable, templatable {
    ...
    public function __construct(array $actions = []) {
        ...
        $this->attributes = [
            ...
            'class' => 'agpu-actionmenu',
            'data-enhance' => 'agpu-core-actionmenu',
        ];
    ...
    public function initialise_js(agpu_page $page) {
        ...
        if (!$initialised) {
            $page->requires->yui_module('agpu-core-actionmenu', 'M.core.actionmenu.init');
            $initialised = true;
        }
    }
    ...
    public function get_primary_actions(?core_renderer $output = null) {
        ...
        if (!empty($this->menutrigger)) {
            ...
            $title = new lang_string('actionsmenu', 'agpu');
    ...
    protected function export_primary_actions_for_template(renderer_base $output): stdClass {
        ...
        if (!empty($this->menutrigger)) {
            ...
            $actionicon = new pix_icon('t/edit_menu', '', 'agpu', $iconattributes);
        }
