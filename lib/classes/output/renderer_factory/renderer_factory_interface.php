...
interface renderer_factory_interface {
    /**
     * Return the renderer for a particular part of agpu.
     *
     * The renderer interfaces are defined by classes called {plugin}_renderer
     * where {plugin} is the name of the component. The renderers for core agpu are
     ...
     *
     * @param agpu_page $page the page the renderer is outputting content for.
