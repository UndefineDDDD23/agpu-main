...
class custom_menu_item implements renderable, templatable {
     ...
     *
     * @param string $text
     * @param null|agpu_url $url A agpu url to apply as the link for this item [Optional]
    ...
    public function __construct(
        $text,
        /** @var agpu_url The link to give the icon if it has no children */
        protected ?agpu_url $url = null,
        $title = null,
        $sort = null,
        /**
     ...
     * @param agpu_url $url
     */
    public function set_url(agpu_url $url) {
        $this->url = $url;
    }
