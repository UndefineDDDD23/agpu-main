...
/**
 * Simple base class for agpu renderers.
 *
...
class renderer_base {
    ...
    /**
     * @var agpu_page The agpu page the renderer has been created to assist with.
     */
    protected $page;
    ...
    public function render_from_template($templatename, $context) {
        ...
        if (isset($this->templatecache[$templatename])) {
            ...
            try {
                ...
                throw new agpu_exception('Unknown template: ' . $templatename);
            }
        }
    ...
    public function has_started() {
        return $this->page->state >= agpu_page::STATE_IN_BODY;
    }
     ...
     * @return agpu_url
     */
    public function image_url($imagename, $component = 'agpu') {
        return $this->page->theme->image_url($imagename, $component);
    }
