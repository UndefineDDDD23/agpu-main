...
class mustache_template_source_loader {
     ...
     *
     * @param string $component The agpu component (e.g. core_message)
     ...
     * ]
     *
     * @param string $templatecomponent The agpu component (e.g. core_message)
     ...
     * @param string|null $lang agpu translation language, null means use current.
     * @return array
     */
