...
class language_menu implements renderable, templatable {
    /** @var \agpu_page $page the agpu page that the languague menu belongs to */
    protected $page;
     ...
     *
     * @param \agpu_page $page the agpu page that the languague menu belongs to.
     */
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        foreach ($this->langs as $langtype => $langname) {
            ...
            $node = [
                ...
                'link' => true,
                'isactive' => $isactive,
                'url' => $isactive ? new \agpu_url('#') : new \agpu_url($this->page->url, ['lang' => $langtype]),
            ];
            if (!empty($attributes)) {
