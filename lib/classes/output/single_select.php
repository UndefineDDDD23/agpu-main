...
class single_select implements renderable, templatable {
    /**
     * @var agpu_url Target url - includes hidden fields
     */
    public $url;
     ...
     */
    public function set_old_help_icon($helppage, $title, $component = 'agpu') {
     ...
     */
    public function set_help_icon($identifier, $component = 'agpu') {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        // Form parameters.
        $actionurl = new agpu_url($this->url);
        if ($this->method === 'post') {
