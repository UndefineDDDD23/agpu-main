 ...
 *
 * It can be used in agpu pages where config.php has been included without any further includes.
 *
...
class url {
     ...
     *
     * @param self|string $url - agpu_url means make a copy of another
     *      agpu_url and change parameters, string means full url or shortened
    ...
    public function __construct(
        ...
        if ($url instanceof self) {
            ...
            $parts = parse_url($url);
            if ($parts === false) {
                throw new agpu_exception('invalidurl');
            }
     ...
     *
     * @param self $url The agpu_url object to compare
    ...
    /**
     * Create a new agpu_url instance from routed path.
     *
...
class_alias(url::class, \agpu_url::class);
