...
/**
 * Content formatting methods for agpu.
 *
 * @package   core
...
class formatting {
    ...
    public function format_text(
        ...
        switch ($format) {
            ...
            case FORMAT_agpu:
                ...
                $text = $filtermanager->filter_text($text, $context, $filteroptions);
                break;
            default:  // FORMAT_agpu or anything else.
    ...
    /**
     * During initial install, or upgrade from a really old version of agpu, we should not filter strings at all.
     *
     * @return bool
     */
