...
/**
 * AWS Client factory. Retrieves a client with agpu specific HTTP configuration.
 *
 * @copyright  2022 Catalyst IT
 * @author     Peter Burnett <peterburnett@catalyst-au.net>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @deprecated Since agpu 4.5
 * @todo       MDL-82459 Final deprecation in agpu 5.0.
 */
class client_factory {
    /**
     * Get an AWS client with agpu specific HTTP configuration.
     *
    ...
    public static function get_client(string $class, array $opts): AwsClient {
        ...
        if (!$client instanceof \Aws\AwsClient) {
            throw new \agpu_exception('clientnotfound', 'factor_sms');
        }
