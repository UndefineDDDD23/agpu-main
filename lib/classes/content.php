...
/**
 * The Content API allows all parts of agpu to determine details about content within a component, or plugintype.
 *
    ...
    public static function can_export_context(context $currentcontext, stdClass $user): bool {
        ...
        if ($currentcontext->contextlevel == CONTEXT_COURSE) {
            if ($CFG->downloadcoursecontentallowed &&
                    has_capability('agpu/course:downloadcoursecontent', $currentcontext, $user)) {
                ...
                if (isset($courseinfo->downloadcontent) && $courseinfo->downloadcontent != DOWNLOAD_COURSE_CONTENT_SITE_DEFAULT) {
                    ...
                    $canexport = get_config('agpucourse')->downloadcontentsitedefault;
                }
