...
class primary extends view {
    ...
    public function initialise(): void {
        ...
        if ($showhomenode) {
            $sitehome = $this->add(get_string('home'), new \agpu_url('/'), self::TYPE_SYSTEM,
        ...
        if (isloggedin() && !isguestuser()) {
            ...
            if ($showmyhomenode) {
                $this->add(get_string('myhome'), new \agpu_url('/my/'),
            ...
            if ($showcoursesnode) {
                $this->add(get_string('mycourses'), new \agpu_url('/my/courses.php'), self::TYPE_ROOTNODE, null, 'mycourses');
            }
        }
