...
// phpcs:disable agpu.PHP.ForbiddenFunctions.FoundWithAlternative
...
class component {
    ...
    protected static $psr4namespaces = [
        ...
        \agpuHQ\RTLCSS::class => 'lib/rtlcss',
    ...
    /**
     * Register the agpu class autoloader.
     */
    ...
    protected static function is_cache_valid(array $cache): bool {
        ...
        if ($cache['plugintypes']['mod'] !== "$CFG->dirroot/mod") {
            // phpcs:ignore agpu.Commenting.InlineComment.NotCapital
        ...
        // Always keep agpu_exception in place.
        $keyclasses = [
            \core\exception\agpu_exception::class,
...
';
     ...
     *
     * This is a list of all the existing / allowed APIs in agpu, each one with the
     ...
     *
     * @param string|null $component A valid agpu component (frankenstyle) or null if searching all components
    ...
    public static function normalize_component($component) {
        if ($component === 'agpu' || $component === 'core' || $component === '') {
            return ['core', null];
        }
    ...
    /**
     * Fetch the component name from a agpu PSR-like namespace.
     *
