...
/**
 * Base agpu Exception class
 *
 * Although this class is defined here, you cannot throw a agpu_exception until
 * after agpulib.php has been included (which will happen very soon).
 *
 * @package    core
 ...
 */
class agpu_exception extends \Exception {
    ...
    public function __construct($errorcode, $module = '', $link = '', $a = null, $debuginfo = null) {
        ...
        if (!$haserrorstring && $isinphpunittest) {
            ...
            $message .= PHP_EOL . '$a contents: ' . print_r($a, true); // phpcs:ignore agpu.PHP.ForbiddenFunctions.Found
        }
...
class_alias(agpu_exception::class, \agpu_exception::class);
