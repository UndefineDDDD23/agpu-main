...
use core\agpunet\activity_sender;
...
/**
 * The external API to send activity to agpuNet.
 *
 * @package    core
 * @copyright  2023 Huong Nguyen <huongnv13@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class agpunet_send_activity extends external_api {
    ...
    /**
     * External function to send the activity to agpuNet.
     *
     * @param int $issuerid The agpuNet OAuth 2 issuer ID
     * @param int $cmid The course module ID of the activity that being shared
     * @param int $shareformat The share format being used, as defined by \core\agpunet\activity_sender
     * @return array
     * @since agpu 4.2
     */
    public static function execute(int $issuerid, int $cmid, int $shareformat): array {
        ...
        if (!$oauthclient->is_logged_in()) {
            return self::return_errors($issuerid, 'erroroauthclient', get_string('agpunet:issuerisnotauthorized', 'agpu'));
        }
        ...
        try {
            ...
            $activitysender = new activity_sender($cmid, $USER->id, $agpunetclient, $oauthclient, $shareformat);
