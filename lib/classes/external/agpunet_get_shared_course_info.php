...
/**
 * The external API to get agpuNet information about the course to be shared.
 *
 * @package    core
 ...
 * @since      agpu 4.3
 */
class agpunet_get_shared_course_info extends external_api {
    ...
    public static function execute(int $courseid): array {
        ...
        if (empty($issuerid)) {
            return self::return_errors(0, 'errorissuernotset', get_string('agpunet:issuerisnotset', 'agpu'));
        }
        ...
        if (!utilities::is_valid_instance($issuer)) {
            return self::return_errors($issuerid, 'errorissuernotenabled', get_string('agpunet:issuerisnotenabled', 'agpu'));
        }
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            ...
            'server' => new external_value(PARAM_TEXT, 'agpuNet server'),
            'supportpageurl' => new external_value(PARAM_URL, 'Support page URL'),
            'issuerid' => new external_value(PARAM_INT, 'agpuNet issuer id'),
