...
use core\router\middleware\agpu_bootstrap_middleware;
use core\router\middleware\agpu_route_attribute_middleware;
 ...
 * agpu Router.
 *
 * This class represents the agpu Router, which handles all aspects of Routing in agpu.
 *
...
class router {
    ...
    protected function guess_basepath(): string {
        ...
        // agpu is not guaranteed to exist at the domain root.
     ...
     *
     * @param string $basepath The base path of the agpu instance
     */
    protected function create_app(
        ...
        // Configure the basepath for agpu.
    ...
    protected function add_middleware(): void {
        ...
        // Add Middleware to Bootstrap agpu from a request.
        $this->app->add(di::get(agpu_bootstrap_middleware::class));

        // Add the agpu route attribute to the request.
        // This must be processed after the Routing Middleware has been processed on the request.
        $this->app->add(di::get(agpu_route_attribute_middleware::class));
        ...
        // Add the Error Handling Middleware and configure it to show agpu Errors for HTML pages.
