...
/**
 * agpu OpenApi Specification class.
 *
 * @package    core
    ...
    \JsonSerializable
{
    ...
    public function __construct() {
        $this->data = (object) [
            ...
            'info' => (object) [
                'title' => 'agpu LMS',
                'description' => 'REST API for agpu LMS',
                'summary' => 'agpu LMS REST API',
                'license' => (object) [
            ...
            'externalDocs' => (object) [
                'description' => 'agpu Developer Docs',
                'url' => 'https://agpudev.io',
            ],
        ];
    ...
    protected function finalise(): self {
        ...
        // Add the agpu site version here.
     ...
     * Add an API Path.
     *
     * @param string $component The agpu component
    ...
    public function add_path(
        ...
        // Therefore we must handle that in agpu, adding path variants with and without each optional parameter.
