 ...
 */
class agpu_bootstrap_middleware implements MiddlewareInterface {
    #[\Override]
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface {
        ...
        if ($routeattribute && !$routeattribute->cookies) {
            // @codeCoverageIgnoreStart
            // This request should not access agpu cookies.
        ...
        if (!$routeattribute || !$routeattribute->abortafterconfig) {
            // Do not load the full agpu stack. This is a lightweight request.
            $this->load_full_agpu();
        }

        // Set the URL for the page.
        // Normally in agpu this is a largely hard-coded value with only the query string changing dynamically in the page.
