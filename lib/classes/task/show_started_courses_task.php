 ...
 *
 * @package   core
 * @copyright 2023 Sara Arjona <sara@agpu.com> based on code from 2016 Tim Gagen and Amanda Doughty
...
class show_started_courses_task extends scheduled_task {
     ...
     *
     * @param \agpu_recordset $courses
     * @param int $visibility The given courses will be set to this visibility
     * @return void
     */
    private function update_courses_visibility(\agpu_recordset $courses, int $visibility): void {
        global $DB;
