...
class di {
    ...
    public static function set(string $id, mixed $value): void {
        ...
        // If agpu switches to alternative DI resolution, this method _must_ be updated to work with it.
    ...
    protected static function create_container(): ContainerInterface {
        ...
        $builder->addDefinitions([
            ...
            // The database.
            \agpu_database::class => $DB,

            // The string manager.
            \core_string_manager::class => fn() => get_string_manager(),

            // The agpu Clock implementation, which itself is an extension of PSR-20.
            // Alias the PSR-20 clock interface to the agpu clock. They are compatible.
