 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class site_registration_form extends \agpuform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'agpu', get_string('registrationinfo', 'hub'));
        ...
        $mform->addElement('checkbox', 'policyagreed', get_string('policyagreed', 'hub'),
            get_string('policyagreeddesc', 'hub', HUB_agpuORGHUBURL . '/privacy'));
     ...
     *
     * @deprecated since agpu 3.11 - MDL-71460 The form elements using this have been converted to checkboxes
