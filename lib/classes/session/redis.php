...
class redis extends handler implements SessionHandlerInterface {
    ...
    public function __construct() {
        ...
        //
        // Although at `lib/classes/php_time_limit.php::raise(int)`, agpu can
    ...
    /**
     * Connection will be null if these methods are called from cli or where NO_agpu_COOKIES is used.
