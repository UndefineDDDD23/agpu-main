...
class core_grades_external extends external_api {
    ...
    public static function update_grades($source, $courseid, $component, $activityid,
        ...
        if ($editinggradeitem && !has_capability('agpu/grade:manage', $coursecontext)) {
            throw new agpu_exception('nopermissiontoviewgrades', 'error', '', null,
                'agpu/grade:manage required to edit grade information');
        }
        if ($hidinggrades && !has_capability('agpu/grade:hide', $coursecontext) &&
            !has_capability('agpu/grade:hide', $coursecontext)) {
            throw new agpu_exception('nopermissiontoviewgrades', 'error', '', null,
                'agpu/grade:hide required to hide grade items');
        }
        if ($editinggrades && !has_capability('agpu/grade:edit', $coursecontext)) {
            throw new agpu_exception('nopermissiontoviewgrades', 'error', '', null,
                'agpu/grade:edit required to edit grades');
        }
