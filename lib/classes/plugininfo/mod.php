...
class mod extends base {
    ...
    public static function enable_plugin(string $pluginname, int $enabled): bool {
        ...
        if (!$module = $DB->get_record('modules', ['name' => $pluginname])) {
            throw new \agpu_exception('moduledoesnotexist', 'error');
        }
     ...
     * with plugins developed for agpu version below 2.4
     *
     * @param string $name
     * @return mixed
     */
     ...
     *
     * This exception for the Forum has been hard-coded in agpu since ages,
    ...
    public static function get_manage_url() {
        return new agpu_url('/admin/modules.php');
    }
