...
use agpu_url, part_of_admin_tree, admin_settingpage, core_plugin_manager;
...
class format extends base {
    ...
    public static function enable_plugin(string $pluginname, int $enabled): bool {
        ...
        if ($oldvalue == false && $disabled) {
            if (get_config('agpucourse', 'format') === $pluginname) {
                // The default course format can't be disabled.
                throw new \agpu_exception('cannotdisableformat', 'error');
            }
    ...
    public function is_uninstall_allowed() {
        if ($this->name !== get_config('agpucourse', 'format') && $this->name !== 'site') {
            return true;
        } else {
            return false;
        }
    ...
    public static function get_manage_url() {
        return new agpu_url('/admin/settings.php', array('section'=>'manageformats'));
    }
    ...
    public function get_uninstall_extra_warning() {
        ...
        $defaultformat = $this->pluginman->plugin_name('format_'.get_config('agpucourse', 'format'));
        $message = get_string(
    ...
    public function uninstall_cleanup() {
        ...
        if (($defaultformat = get_config('agpucourse', 'format')) && $defaultformat !== $this->name) {
