...
class calendartype extends base {
    ...
    public function is_uninstall_allowed() {
        ...
        // type used before the calendar types were introduced as plugins in agpu. If all calendar types were
        // deleted then agpu would break completely wherever any dates are displayed.
