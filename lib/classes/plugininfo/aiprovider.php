...
class aiprovider extends base {
    ...
    public function load_settings(
        ...
        $settings = new \core_ai\admin\admin_settingspage_provider(
            ...
            req_capability: 'agpu/site:config',
            hidden: true,
        );
        ...
        foreach ($actionlist as $action) {
            ...
            if (!empty($actionsettings)) {
                ...
                $settings = new \admin_settingpage($section . '_' . $actionname, $action::get_name(), 'agpu/site:config', true);
                $descplaceholder = [
    ...
    public static function get_manage_url(): agpu_url {
        return new agpu_url('/admin/settings.php', [
            'section' => 'aiprovider',
        ]);
    }
