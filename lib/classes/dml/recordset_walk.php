...
/**
 * Iterator that walks through a agpu_recordset applying the provided function.
 *
...
class recordset_walk implements \Iterator {
    ...
    /**
     * @var \agpu_recordset The recordset.
     */
    protected $recordset;
     ...
     *
     * @param \agpu_recordset $recordset Recordset to iterate.
     ...
     */
    public function __construct(\agpu_recordset $recordset, callable $callback, $callbackextra = null) {
    ...
    public function rewind(): void {
        // No rewind as it is not implemented in agpu_recordset.
        return;
    }
