...
/**
 * agpuNet send attempt event.
 *
 * @package    core
 * @copyright  2023 Michael Hawkins <michaelh@agpu.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class agpunet_resource_exported extends \core\event\base {
    ...
    public static function get_name(): string {
        return get_string('agpunet:eventresourceexported');
    }
    ...
    public function get_description() {
        ...
        if (!empty($this->other['cmids'])) {
            ...
            $description = "The user with id '{$this->userid}' {$outcome} activities to agpuNet with the " .
            ...
            $description = "The user with id '{$this->userid}' {$outcome} course to agpuNet with the " .
    ...
    public function get_url() {
        return new \agpu_url($this->other['resourceurl']);
    }
}
