 ...
 *
 * Please note that, from agpu 4.4, you can instead use the \core\attribute\hook\replaces_callback attribute.
 *
 * @package   core
 * @author    Petr Skoda
...
interface deprecated_callback_replacement {
     ...
     * for this hook (to allow plugin compatibility with multiple agpu branches).
     *
     * @return array
     */
