 ...
 * agpu events the definitions from PSR-14 should be interpreted as:
 *
 *  1. Event --> Hook
...
final class manager implements
     ...
     *   Please note that in agpu the callable must be a string.
     */
     ...
     * @return bool
     * @deprecated in favour of get_hooks_deprecating_plugin_callback since agpu 4.4.
     * @todo Remove in agpu 4.8 (MDL-80327).
     */
     ...
     * to allow compatibility of contrib plugins with multiple agpu branches.
     *
     * @param string $component
     * @param string $plugincallback short callback name without the component prefix
     * @return bool
