...
/**
 * Parameter validation helpers for agpu.
 *
 * @package    core
...
enum param: string {
    ...
    public function required_param_array(string $paramname): array {
        ...
        if (!is_array($param)) {
            throw new \agpu_exception('missingparam', '', '', $paramname);
        }
     ...
     * @param bool $require
     * @return mixed
     * @throws agpu_exception If the parameter was not found and the value is required
     */
    ...
    protected function clean_param_value_file(mixed $param): string {
        ...
        $param = (string)fix_utf8($param);
        // phpcs:ignore agpu.Strings.ForbiddenStrings.Found
