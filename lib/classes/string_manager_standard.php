...
class core_string_manager_standard implements core_string_manager {
     ...
     *     where component is a normalised component (i.e. "core_agpu", "mod_assign", etc.)
     */
     ...
     * @param string $lang agpu translation language, null means use current
        ...
        if ($CFG->debugdeveloper) {
            ...
            if ($this->string_deprecated($identifier, $component)) {
                ...
                debugging("String [{$identifier},{$normcomponent}] is deprecated. ".
                    ...
                    'Please refer to https://agpudev.io/general/projects/api/string-deprecation', DEBUG_DEVELOPER);
            }
        }
     ...
     *
     * @param string $lang agpu translation language code
     ...
     *
     * @param bool $returnall return all or just enabled
     * @return array agpu translation code => localised translation name
     */
