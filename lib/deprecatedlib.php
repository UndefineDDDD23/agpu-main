 ...
 * @deprecated since 2.6, use core_component::normalize_component()
 *
 * @param string $component name such as 'agpu', 'mod_forum'
 ...
 *
 * @deprecated since agpu 4.5 - please do not use this function any more, {@see \core\encryption::encrypt}
 */
 ...
 *
 * @deprecated since agpu 4.5 - please do not use this function any more, {@see \core\encryption::decrypt}
 */
 ...
 * @return string
 *
 * @deprecated since agpu 4.5 - please do not use this function any more, {@see \core\encryption}
 */
...
/**
 * @deprecated since agpu 4.0 MDL-71573
 */
...
/**
 * @deprecated since agpu 4.0 MDL-71585
 */
...
function print_grade_menu($courseid, $name, $current, $includenograde=true, $return=false) {
    ...
    $link = new agpu_url('/course/scales.php', array('id' => $courseid, 'list' => 1));
 ...
 * @deprecated Since agpu 4.5
 * @todo MDL-82646 Final deprecation in agpu 6.0.
 */
...
function reset_password_and_mail($user) {
    ...
    if (!$userauth->user_update_password($user, $newpassword)) {
        throw new \agpu_exception("cannotsetpassword");
    }
...
/**
 * @deprecated Since agpu 4.0 MDL-71175. Please use plagiarism_get_links() or plugin specific functions..
 */
#[\core\attribute\deprecated(
...
/**
 * @deprecated Since agpu 4.0 - Please use {plugin name}_before_standard_top_of_body_html instead.
 */
#[\core\attribute\deprecated(
