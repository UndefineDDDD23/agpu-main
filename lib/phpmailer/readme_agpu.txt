Description of PHPMailer library import into agpu
...
2. Remove everything inside lib/phpmailer/ folder except README_agpu.txt, agpu_phpmailer.php and agpu_phpmailer_oauth.php.
