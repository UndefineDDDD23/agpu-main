...
/**
 * Minimalistic library, usable even when no other agpu libs are loaded.
 *
 ...
 * Can not use optional param because agpulib.php is not loaded yet
 * @param string $name
 * @param mixed $default
 * @param string $type
 * @return mixed
 ...
 *
 * Note: Can not use optional param because agpulib.php is not loaded yet.
 *
 * @param string $value
 * @param string $type
 * @return mixed
 ...
 *
 * This is based on the current agpu version.
 *
