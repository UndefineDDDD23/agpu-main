...
if (!$confirm or !confirm_sesskey()) {
    ...
    echo $OUTPUT->confirm(get_string('emoticonsreset', 'admin'),
        new agpu_url($PAGE->url, array('confirm' => 1)),
        new agpu_url('/admin/settings.php', array('section' => 'htmlsettings')));
    echo $OUTPUT->footer();
    die();
}
...
redirect(new agpu_url('/admin/settings.php', array('section' => 'htmlsettings')));
