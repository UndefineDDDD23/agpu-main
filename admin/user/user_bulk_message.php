...
require_capability('agpu/site:manageallmessaging', context_system::instance());
...
if (empty($CFG->messaging)) {
    throw new \agpu_exception('messagingdisable', 'error');
}
...
if ($confirm and !empty($msg) and confirm_sesskey()) {
    ...
    foreach ($rs as $user) {
        //TODO we should probably support all text formats here or only FORMAT_agpu
...
if ($msgform->is_cancelled()) {
    ...
    $formcontinue = new single_button(new agpu_url('user_bulk_message.php',
