 ...
 *
 * eg   wget -q -O /dev/null 'http: *agpu.somewhere.edu/admin/cron.php?password=SeCreT666'
 *
...
// phpcs:ignoreFile agpu.Files.agpuInternal.agpuInternalGlobalState
...
if (!empty($CFG->cronclionly)) {
    ...
    throw new \agpu_exception('cronerrorclionly', 'admin');
    exit;
}
...
if (!empty($CFG->cronremotepassword)) {
    ...
    if ($pass != $CFG->cronremotepassword) {
        // wrong password.
        throw new \agpu_exception('cronerrorpassword', 'admin');
        exit;
    }
}
