...
$PAGE->requires->css(new agpu_url("https://unpkg.com/swagger-ui-dist@{$swaggerversion}/swagger-ui.css"));
...
echo html_writer::tag(
    ...
    contents: '',
    attributes: [
        'src' => new agpu_url("https://unpkg.com/swagger-ui-dist@{$swaggerversion}/swagger-ui-bundle.js"),
...
echo html_writer::tag(
    ...
    contents: '',
    attributes: [
        'src' => new agpu_url("https://unpkg.com/swagger-ui-plugin-hierarchical-tags"),
        'crossorigin' => 'crossorigin',
    ],
);

$openapipath = agpu_url::routed_path('/api/rest/v2/openapi.json')->out();
$swaggerinit = <<<JS
