...
abstract class plugin_management_table extends flexible_table implements dynamic_table {
     ...
     * @return agpu_url
     */
    abstract protected function get_action_url(array $params = []): agpu_url;
     ...
     *
     * Default implementation for plugin management tables is to require 'agpu/site:config' capability
     *
