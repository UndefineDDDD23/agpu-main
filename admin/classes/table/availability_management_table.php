...
class availability_management_table extends plugin_management_table {
    ...
    protected function get_action_url(array $params = []): agpu_url {
        return new agpu_url('/admin/tool/availabilityconditions/', $params);
    }

    public function guess_base_url(): void {
        $this->define_baseurl(
            new agpu_url('/admin/tool/availabilityconditions/')
        );
    }
    ...
    protected function col_defaultdisplaymode(stdClass $row): string {
        ...
        $urldisplaymode = new agpu_url('/' . $CFG->admin . '/tool/availabilityconditions/', $paramsdisplaymode);
