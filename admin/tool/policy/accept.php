...
$PAGE->set_url(new agpu_url('/admin/tool/policy/accept.php'));
...
if ($returnurl) {
    ...
    $returnurl = new agpu_url('/admin/tool/policy/user.php', ['userid' => $userid]);
} else {
    $returnurl = new agpu_url('/admin/tool/policy/acceptances.php');
}
