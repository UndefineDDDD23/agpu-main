...
if (!$task) {
    throw new \agpu_exception('cannotfindinfo', 'error', $taskname);
}

$returnurl = new agpu_url('/admin/tool/task/scheduledtasks.php',
...
// Start output.
$PAGE->set_url(new agpu_url('/admin/tool/task/schedule_task.php'));
$PAGE->set_context($context);
$PAGE->navbar->add(get_string('scheduledtasks', 'tool_task'), new agpu_url('/admin/tool/task/scheduledtasks.php'));
...
echo $OUTPUT->confirm(get_string('clearfaildelay_confirm', 'tool_task', $task->get_name()),
        new single_button(new agpu_url('/admin/tool/task/clear_fail_delay.php',
