...
$string['authconfirm'] = 'This action will grant permanent API access to agpu for the authenticated account. This is intended to be used as a system account for managing files owned by agpu.';
...
$string['issuerrequireconfirmation_help'] = 'Require that all users verify their email address before they can log in with OAuth. This applies to newly created accounts as part of the login process, or when an existing agpu account is connected to an OAuth login via matching email addresses.';
...
$string['agpunet_service'] = 'agpuNet';
...
$string['userfieldinternalfield_help'] = 'Name of the agpu user field that should be mapped from the external field.';
