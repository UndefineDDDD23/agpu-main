...
$PAGE->navbar->override_active_url(new agpu_url('/admin/tool/oauth2/issuers.php'), true);
...
if ($mform && $mform->is_cancelled()) {
    redirect(new agpu_url('/admin/tool/oauth2/userfieldmappings.php', ['issuerid' => $issuerid]));
} else if ($action == 'edit') {
    ...
    if (!optional_param('confirm', false, PARAM_BOOL)) {
        ...
        $continueurl = new agpu_url('/admin/tool/oauth2/userfieldmappings.php', $continueparams);
        $cancelurl = new agpu_url('/admin/tool/oauth2/userfieldmappings.php');
        echo $OUTPUT->header();
    ...
    $addurl = new agpu_url('/admin/tool/oauth2/userfieldmappings.php', ['action' => 'edit', 'issuerid' => $issuerid]);
