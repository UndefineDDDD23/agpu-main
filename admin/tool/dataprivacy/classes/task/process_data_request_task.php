    ...
    public function execute() {
        ...
        switch ($request->type) {
            case api::DATAREQUEST_TYPE_EXPORT:
                ...
                // systems, not just one agpu instance, so we don't want every instance emailing
                // the user.)
                ...
                // We want to notify the user in agpu about the processing results.
                $message->notification = 1;
                $datarequestsurl = new agpu_url('/admin/tool/dataprivacy/mydatarequests.php');
                ...
                $downloadurl = agpu_url::make_pluginfile_url($usercontext->id, 'tool_dataprivacy', 'export', $thing->get_itemid(),
            ...
            case api::DATAREQUEST_TYPE_DELETE:
                ...
                // No point notifying a deleted user in agpu.
                ...
                break;
            default:
                throw new agpu_exception('errorinvalidrequesttype', 'tool_dataprivacy');
        }
