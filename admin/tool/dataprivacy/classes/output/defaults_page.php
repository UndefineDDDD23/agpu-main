...
class defaults_page implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        // Set tab URLs.
        $coursecaturl = new agpu_url('/admin/tool/dataprivacy/defaults.php', ['mode' => CONTEXT_COURSECAT]);
        $courseurl = new agpu_url('/admin/tool/dataprivacy/defaults.php', ['mode' => CONTEXT_COURSE]);
        $moduleurl = new agpu_url('/admin/tool/dataprivacy/defaults.php', ['mode' => CONTEXT_MODULE]);
        $blockurl = new agpu_url('/admin/tool/dataprivacy/defaults.php', ['mode' => CONTEXT_BLOCK]);
