...
$string['requiresattentionexplanation'] = 'This plugin does not implement the agpu privacy API. If this plugin stores any personal data it will not be able to be exported or deleted through agpu\'s privacy system.';
