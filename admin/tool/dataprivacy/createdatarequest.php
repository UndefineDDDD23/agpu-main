...
$url = new agpu_url('/admin/tool/dataprivacy/createdatarequest.php', ['manage' => $manage, 'type' => $requesttype]);
...
if ($manage) {
    ...
    $returnurl = new agpu_url($CFG->wwwroot . '/admin/tool/dataprivacy/datarequests.php');
    ...
    $returnurl = new agpu_url($CFG->wwwroot . '/admin/tool/dataprivacy/mydatarequests.php');
