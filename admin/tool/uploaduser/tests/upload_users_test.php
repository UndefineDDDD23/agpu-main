...
class upload_users_test extends advanced_testcase {
    ...
    public function test_user_can_upload_with_course_enrolment(): void {
        ...
        assign_capability('agpu/site:uploadusers', CAP_ALLOW, $uploadroleid, $systemcontext->id);
        ...
        assign_capability('agpu/course:enrolreview', CAP_ALLOW, $enrolroleid, $coursecatcontext->id);
        assign_capability('agpu/role:assign', CAP_ALLOW, $enrolroleid, $coursecatcontext->id);
