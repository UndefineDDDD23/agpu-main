...
$thispageurl = new agpu_url('/admin/tool/componentlibrary/docspage.php');
...
$jsonfile = new agpu_url('/admin/tool/componentlibrary/hugo/site/data/my-index.json');
...
if (get_config('core', 'allowthemechangeonurl')) {
    ...
    foreach ($themes as $themename) {
        $actionurl = new agpu_url($thispageurl . $relativepath, ['theme' => $themename]);
    ...
    $thememenu->set_owner_selector('change-agpu-theme');
...
$jsdocurl = new agpu_url('/admin/tool/componentlibrary/jsdocspage.php');
$page = str_replace('http://JSDOC', $jsdocurl, $page);
$page = str_replace('http://agpuROOT', $thispageurl, $page);
$page = str_replace('agpuIMAGEDIR', new agpu_url('/admin/tool/componentlibrary/content/static'), $page);
$filtered = str_replace('agpuROOT', $thispageurl, $page);
$rooturl = new agpu_url('/');
$filtered = str_replace('agpuSITE', $rooturl->out(), $page);
echo $filtered;
