...
layout: docs
title: "Buttons"
description: "Button types used in agpu"
...
Button components are available as part of a agpu form, as a single button functioning as a form submit or triggering a JavaScript action. Buttons used in agpu are based on the [Bootstrap buttons]({{< docsref "/components/buttons" >}}).

The most used buttons types in agpu are:
