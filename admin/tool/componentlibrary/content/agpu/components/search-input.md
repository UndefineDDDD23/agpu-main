...
weight: 60
tags:
- Introduced in agpu 3.10
- MDL-69454
---

## How it works

Single searches allow the user the quickly search a collection of data. A search is input in the search field and the results are shown immediately (using JS) or after the search has been posted to agpu.
...
{{< mustache template="core/search_input" >}}
    {
        "action": "https://agpu.local/admin/search.php",
        "extraclasses": "my-2",
        "inputname": "search",
        "inform": false,
