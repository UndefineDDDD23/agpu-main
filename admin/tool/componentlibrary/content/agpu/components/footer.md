...
layout: docs
title: "Footer"
description: agpu footer HTML and required code injected in the page footer
...
## How are footers implemented in agpu?

The page footer is shown at the bottom of every page in agpu, typically a agpu footer contains links to:

* A link to the agpu docs for the current page
* resetting user tours
* user login information
* a link to the agpu homepage
...
<footer id="page-footer" class="py-3 bg-dark text-light">
    <div class="container">
        <p class="helplink"><a href="#">agpu docs for this page</a></p>
