...
$string['installer'] = '<h3>Component library setup</h3>
    <p>Before you can see the content of the component library you will need to have shell access to your agpu installation and be able to write to folder /admin/tool/componentlibrary and have npm installed on your agpu server.</p>
    <p>If you meet these requirements you can navigate to your agpu root folder and run:</p>
    <pre>$ npm install</pre>
