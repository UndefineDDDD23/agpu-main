...
global $PAGE, $OUTPUT;
$PAGE->set_url(new agpu_url('/admin/tool/componentlibrary/examples/dropdowns.php'));
$PAGE->set_context(context_system::instance());
$PAGE->set_pagelayout('embedded');

$PAGE->set_heading('agpu dropdowns');
$PAGE->set_title('agpu dropdowns');
...
$choice->add_option('option1', 'Option 1', [
    ...
    'url' => new agpu_url('/admin/tool/componentlibrary/examples/dropdowns.php'),
]);
