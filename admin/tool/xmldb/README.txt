...
Complete Documentation:
  ...
  http://docs.agpu.org/en/XMLDB_Defining_one_XML_structure
...
under agpu > 1.7 to store all the DB info in a
...
under your agpu/admin dir and point your browser (as admin)
to http://your.server/agpu/admin/xmldb
...
"generators" needed in order to use it to create agpu DB structures
for each RDBMS flavour.

Once the interface was finished (2-3 days from now) related documentation
will be sent to http://docs.agpu.org/en/XML_database_schema in order
