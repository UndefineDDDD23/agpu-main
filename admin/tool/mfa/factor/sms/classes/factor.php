...
class factor extends object_factor_base {
     ...
     * @return \agpuQuickForm $mform
     */
    public function login_form_definition(\agpuQuickForm $mform): \agpuQuickForm {
     ...
     *
     * @param \agpuQuickForm $mform Form to inject global elements into.
     * @return \agpuQuickForm $mform
     */
    public function login_form_definition_after_data(\agpuQuickForm $mform): \agpuQuickForm {
     ...
     * @return \agpuQuickForm $mform
     */
    public function setup_factor_form_definition(\agpuQuickForm $mform): \agpuQuickForm {
        ...
        if (!empty(
            ...
            redirect(
                new \agpu_url('/admin/tool/mfa/user_preferences.php'),
     ...
     * @return \agpuQuickForm $mform
     */
    public function setup_factor_form_definition_after_data(\agpuQuickForm $mform): \agpuQuickForm {
        global $OUTPUT;
        ...
        $editphonenumber = \html_writer::link(
            new \agpu_url('/admin/tool/mfa/factor/sms/editphonenumber.php', ['sesskey' => sesskey()]),
    ...
    public function setup_user_factor(stdClass $data): ?stdClass {
        ...
        if (empty($SESSION->tool_mfa_sms_number)) {
            ...
            $addurl = new \agpu_url('/admin/tool/mfa/action.php', [
                'action' => 'setup',
                'factor' => 'sms',
            ]);
            redirect($addurl);
