...
// phpcs:disable agpu.Files.RequireLogin.Missing
require_once(__DIR__ . '/../../../config.php');

// No require_login, unauthenticated page.
$PAGE->set_context(\context_system::instance());
$PAGE->set_url(new agpu_url('/admin/tool/mfa/guide.php'));
...
$PAGE->navbar->add(get_string('guidance', 'tool_mfa'), new \agpu_url('/admin/tool/mfa/guide.php'));
...
// Parses and returns the text after default agpu filters with cleaning disabled, to allow for any inline styles.
echo format_text($html, FORMAT_agpu, ['noclean' => true]);
echo $OUTPUT->footer();
