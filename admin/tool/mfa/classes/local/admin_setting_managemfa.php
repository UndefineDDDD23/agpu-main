...
class admin_setting_managemfa extends \admin_setting {
    ...
    public function define_manage_mfa_table() {
        ...
        foreach ($factors as $factor) {
            ...
            $settingsurl = new \agpu_url('settings.php', $settingsparams);
            ...
            if ($factor->is_enabled()) {
                ...
                $hideshowurl = new \agpu_url('tool/mfa/index.php', $hideshowparams);
                ...
                if ($order > 1) {
                    ...
                    $upurl = new \agpu_url('tool/mfa/index.php', $upparams);
                ...
                if ($order < count($enabledfactors)) {
                    ...
                    $downurl = new \agpu_url('tool/mfa/index.php', $downparams);
