...
abstract class area_test_base extends \advanced_testcase {
     ...
     * @param \agpu_recordset $rs
     * @return array
     */
    public function array_from_recordset(\agpu_recordset $rs): array {
        $records = [];
     ...
     * @return void
     */
    public function assert_area_in_recordset(\agpu_recordset $areasrs, string $component, int $contextid, int $itemid,
