...
abstract class area_base {
     ...
     */
    abstract public function find_relevant_areas(\core\event\base $event): ?\agpu_recordset;
     ...
     * @return \agpu_recordset|null
     */
    abstract public function find_course_areas(int $courseid): ?\agpu_recordset;
    ...
    /**
     * The standard agpu parameter DML parameter substitution doesn't work on all versions of MySQL or Postgres, so we need to use
