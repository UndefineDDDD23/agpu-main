...
abstract class module_area_base extends area_base {
     ...
     * @throws \dml_exception
     */
    protected function find_fields_in_module_table(array $params = []): \agpu_recordset {
        global $DB;
        $where = [];
    ...
    public static function get_edit_url(\stdClass $componentinfo): \agpu_url {
        return new \agpu_url('/course/mod.php', ['update' => $componentinfo->cmid, 'sr' => null, 'sesskey' => sesskey()]);
    }
}
