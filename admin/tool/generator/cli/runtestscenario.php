...
$help = "
Run a feature file into the current agpu instance. The feature file can only
...
Example from agpu root directory:
...
try {
    ...
    echo "  Please,try running \"php admin/tool/behat/cli/init.php\" from your agpu root directory.\n";
    exit(0);
}
