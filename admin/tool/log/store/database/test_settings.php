...
navigation_node::override_active_url(new agpu_url('/admin/settings.php', array('section' => 'logsettingdatabase')));
...
if (!$db = \agpu_database::get_driver_instance($dbtype, $dblibrary, true)) {
