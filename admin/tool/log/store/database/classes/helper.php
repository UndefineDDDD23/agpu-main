...
class helper {
    ...
    public static function get_drivers() {
        return array(
            ...
            'native/mysqli'  => \agpu_database::get_driver_instance('mysqli', 'native')->get_name(),
            'native/mariadb' => \agpu_database::get_driver_instance('mariadb', 'native')->get_name(),
            'native/pgsql'   => \agpu_database::get_driver_instance('pgsql', 'native')->get_name(),
            'native/oci'     => \agpu_database::get_driver_instance('oci', 'native')->get_name(),
            'native/sqlsrv'  => \agpu_database::get_driver_instance('sqlsrv', 'native')->get_name()
        );
    }
