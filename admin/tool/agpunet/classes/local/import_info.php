...
class import_info {
    ...
    public static function load(string $id): ?import_info {
        ...
        global $SESSION;
        return isset($SESSION->agpunetimports[$id]) ? unserialize($SESSION->agpunetimports[$id]) : null;
    }
    ...
    public function save(): void {
        global $SESSION;
        $SESSION->agpunetimports[$this->id] = serialize($this);
    }
    ...
    public function purge(): void {
        global $SESSION;
        unset($SESSION->agpunetimports[$this->id]);
    }
}
