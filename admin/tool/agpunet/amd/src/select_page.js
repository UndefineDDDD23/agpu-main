...
/**
 * When returning to agpu let the user select which course to add the resource to.
 *
 * @module     tool_agpunet/select_page
...
define([
    ...
    var renderNoCourses = function(areaReplace) {
        return Templates.renderPix('courses', 'tool_agpunet').then(function(img) {
            return img;
        }).then(function(img) {
    ...
    var renderCourses = function(areaReplace, courses) {
        return Templates.render('tool_agpunet/view-cards', {
            courses: courses
        }).then(function(html, js) {
            Templates.replaceNodeContents(areaReplace, html, js);
    ...
    var searchCourses = function(inputValue, page, areaReplace) {
        ...
        Ajax.call([{
            methodname: 'tool_agpunet_search_courses',
            args: args
    ...
    /**
     * Define our own debounce function as agpu 3.7 does not have it.
     *
     * @method debounce
     * @from underscore.js
