...
use tool_agpunet\local\import_handler_info;
...
/**
 * Class tool_agpunet_import_handler_registry_testcase, providing test cases for the import_handler_registry class.
 *
