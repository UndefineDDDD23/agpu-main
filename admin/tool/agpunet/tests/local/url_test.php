...
/**
 * Class tool_agpunet_url_testcase, providing test cases for the url class.
 *
...
class url_test extends \advanced_testcase {
    ...
    public function url_provider() {
        return [
            'No path' => [
                'url' => 'https://example.agpu.net',
                'host' => 'example.agpu.net',
                'path' => null,
                'exception' => false,
            ],
            'Slash path' => [
            ...
            'Path includes file and extension' => [
                'url' => 'https://example.agpu.net/uploads/123456789/pic.png',
                'host' => 'example.agpu.net',
                'path' => '/uploads/123456789/pic.png',
                'exception' => false,
            ],
            'Path includes file, extension and params' => [
                'url' => 'https://example.agpu.net/uploads/123456789/pic.png?option=1&option2=test',
                'host' => 'example.agpu.net',
                'path' => '/uploads/123456789/pic.png',
                'exception' => false,
            ],
