...
if ($oldextension) {
    ...
    if (!array_key_exists($oldextension, $mimetypes)) {
        throw new agpu_exception('error_notfound', 'tool_filetypes');
    }
...
$backurl = new \agpu_url('/admin/tool/filetypes/index.php');
...
$PAGE->set_url(new \agpu_url('/admin/tool/filetypes/edit.php', array('oldextension' => $oldextension)));
