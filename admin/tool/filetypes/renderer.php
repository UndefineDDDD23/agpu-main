    ...
    public function edit_table(array $filetypes, array $deleted, $restricted) {
        ...
        if (count($combined) > 1) {
            ...
            foreach ($combined as $extension => $filetype) {
                ...
                $reverturl = new \agpu_url('/admin/tool/filetypes/revert.php',
                ...
                if (!empty($filetype['deleted'])) {
                    ...
                    if (!$restricted) {
                        ...
                        $editurl = new \agpu_url('/admin/tool/filetypes/edit.php',
                                array('oldextension' => $extension));
                        $editbutton = html_writer::link($editurl, $this->pix_icon('t/edit',
                                get_string('edita', 'agpu', s($extension))));
                        $deleteurl = new \agpu_url('/admin/tool/filetypes/delete.php',
                                array('extension' => $extension));
        ...
        if (!$restricted) {
            $out .= $this->single_button(new agpu_url('/admin/tool/filetypes/edit.php',
