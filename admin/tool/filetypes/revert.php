...
/**
 * Resets a file type to the default agpu values.
 *
...
$redirecturl = new \agpu_url('/admin/tool/filetypes/index.php');
...
$PAGE->set_url(new \agpu_url('/admin/tool/filetypes/revert.php', array('extension' => $extension)));
...
$reverturl = new \agpu_url('revert.php', array('extension' => $extension, 'revert' => 1));
