...
$PAGE->set_url(new \agpu_url('/admin/tool/filetypes/delete.php', array('extension' => $extension)));
...
$deleteurl = new \agpu_url('delete.php', array('extension' => $extension, 'delete' => 1));
