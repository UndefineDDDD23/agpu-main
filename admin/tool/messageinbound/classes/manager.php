...
class manager {
    ...
    protected function get_imap_client(
        ...
        if ($success) {
            ...
            throw new \agpu_exception('imapconnectfailure', 'tool_messageinbound', '', null, 'Could not connect to IMAP server.');
        }
    }
    ...
    private function inform_user_of_success(\stdClass $messagedata, $handlerresult) {
        ...
        $messagepreferencesurl = new \agpu_url("/message/notificationpreferences.php", array('id' => $USER->id));
