Description of Roundcube Framework 1.6.6 library import into agpu

We now use the client part of Roundcube Framework as a library in agpu.
This library is used to receive emails from agpu.
...
3. Copy the following files from the temp folder to the agpu folder admin/tool/messageinbound/roundcube:
   - rcube_charset.php
