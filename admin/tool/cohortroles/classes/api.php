...
class api {
     ...
     *
     * Requires agpu/role:manage capability at the system context.
     *
    ...
    public static function create_cohort_role_assignment(stdClass $record) {
        ...
        require_capability('agpu/role:manage', $context);
     ...
     * Perform a search based on the provided filters and return a paginated list of records.
     *
     * Requires agpu/role:manage capability at system context.
     *
     * @return int
     */
