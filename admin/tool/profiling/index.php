...
// TODO: Move all the DB stuff to profiling_db_xxxx() function in xhprof_agpu.php
...
if ($listurl) {
    $listurlnav = new agpu_url('/admin/tool/profiling/index.php', array('listurl' => $listurl));
