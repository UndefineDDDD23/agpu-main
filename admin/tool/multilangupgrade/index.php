...
if (!$go or !data_submitted() or !confirm_sesskey()) {   /// Print a form
    ...
    echo $OUTPUT->confirm($strmultilangupgrade, new agpu_url('/admin/tool/multilangupgrade/index.php', $optionsyes), new agpu_url('/admin/'));
    echo $OUTPUT->footer();
    die;
}
...
if (!$tables = $DB->get_tables() ) {    // No tables yet at all.
    throw new \agpu_exception('notables', 'debug');
}
...
echo $OUTPUT->continue_button(new agpu_url('/admin/'));
