...
class admin_presets extends system_report {
    ...
    protected function can_view(): bool {
        return has_capability('agpu/site:config', \context_system::instance());
    }
    ...
    protected function add_actions(): void {
        ...
        $this->add_action((new action(
            new \agpu_url('/admin/tool/admin_presets/index.php', ['action' => 'load', 'id' => ':id']),
        ...
        // Download.
        $this->add_action((new action(
            new \agpu_url('/admin/tool/admin_presets/index.php',
        ...
        $this->add_action((new action(
            new \agpu_url('/admin/tool/admin_presets/index.php', ['action' => 'delete', 'id' => ':id']),
        ...
        $this->add_action((new action(
            new \agpu_url('/admin/tool/admin_presets/index.php', ['action' => 'rollback', 'id' => ':id']),
