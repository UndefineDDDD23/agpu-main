    ...
    public function export_for_template(renderer_base $output): stdClass {
        ...
        foreach ($this->presets as $preset) {
            ...
            $data = [
                ...
                'release' => format_text($preset->agpurelease, FORMAT_PLAIN),
            ...
            if ($this->showactions) {
                ...
                $loadlink = new \agpu_url('/admin/tool/admin_presets/index.php', ['action' => 'load', 'id' => $preset->id]);
                $actionsmenu->add(new \action_menu_link_secondary(
                    $loadlink, new \pix_icon('t/play', ''),
                    get_string('applyaction', 'tool_admin_presets')
                ));
                $downloadlink = new \agpu_url('/admin/tool/admin_presets/index.php',
                ...
                if ($preset->iscore == manager::NONCORE_PRESET) {
                    $deletelink = new \agpu_url('/admin/tool/admin_presets/index.php',
                ...
                if ($DB->get_records('adminpresets_app', ['adminpresetid' => $preset->id])) {
                    ...
                    $rollbacklink = new \agpu_url('/admin/tool/admin_presets/index.php', $params);
                    $actionsmenu->add(new \action_menu_link_secondary(
                        $rollbacklink,
