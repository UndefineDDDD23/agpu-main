...
class helper_test extends \advanced_testcase {
    ...
    public function test_get_restore_content_dir(): void {
        ...
        $bc = new \backup_controller(\backup::TYPE_1COURSE, $c1->id, \backup::FORMAT_agpu,
        ...
        // Creating backup file.
        $bc = new \backup_controller(\backup::TYPE_1COURSE, $c2->id, \backup::FORMAT_agpu,
            \backup::INTERACTIVE_NO, \backup::MODE_GENERAL, 2);
        $bc->execute_plan();
        $result = $bc->get_results();
        $this->assertTrue(isset($result['backup_destination']));
    ...
    public function test_get_custom_course_field_data(): void {
        ...
        role_change_permission($managerrole->id, $context, 'agpu/course:changelockedcustomfields', CAP_PROHIBIT);
