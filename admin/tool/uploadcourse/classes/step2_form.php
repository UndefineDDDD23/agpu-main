...
class tool_uploadcourse_step2_form extends tool_uploadcourse_base_form {
    ...
    public function definition() {
        ...
        if ($CFG->downloadcoursecontentallowed &&
                has_capability('agpu/course:configuredownloadcontent', context::instance_by_id($contextid))) {
    ...
    public function definition_after_data() {
        ...
        $format = course_get_format((object)array('format' => get_config('agpucourse', 'format')));
