...
Feature: Edit capabilities
  In order to extend and restrict agpu features
  ...
  Scenario: Default system capabilities modification
    ...
    And I fill the capabilities form with the following permissions:
      ...
      | agpu/site:messageanyuser | Inherit |
      | agpu/grade:managesharedforms | Prevent |
      | agpu/course:request | Prohibit |
    And I press "Save changes"
    When I follow "Edit Teacher role"
    Then "block/mnet_hosts:myaddinstance" capability has "Allow" permission
    And "agpu/site:messageanyuser" capability has "Not set" permission
    And "agpu/grade:managesharedforms" capability has "Prevent" permission
    And "agpu/course:request" capability has "Prohibit" permission
