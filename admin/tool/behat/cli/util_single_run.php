...
/**
 * CLI tool with utilities to manage Behat integration in agpu
 *
...
More info in https://agpudev.io/general/development/tools/behat/running
";
...
if ($options['install']) {
    ...
    $featurestepscmd .= ' --dry-run --format=agpu_stepcount';
