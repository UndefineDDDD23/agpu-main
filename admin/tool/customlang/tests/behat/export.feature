...
Feature: Within a agpu instance, an administrator should be able to export modified langstrings.
  ...
  Scenario: Export the php-file including a customised langstring.
    ...
    And I set the field "Select component(s) to export" to "agpu.php"
