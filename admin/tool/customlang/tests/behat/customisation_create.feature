...
Feature: Within a agpu instance, an administrator should be able to modify langstrings for the entire agpu installation.
  ...
  Background:
    ...
    And I set the field "Show strings of these components" to "agpu.php"
    And I set the field "String identifier" to "agpudocslink"
    And I press "Show strings"
    And I set the field "core/agpudocslink" to "agpu documents"

  @javascript
  Scenario: Edit an string but don't save it to lang pack.
    When I press "Apply changes and continue editing"
    Then I should not see "agpu documents" in the "page-footer" "region"
  ...
  Scenario: Customize an string as admin and save it to lang pack.
    ...
    And I should see "agpu documents" in the "page-footer" "region"
