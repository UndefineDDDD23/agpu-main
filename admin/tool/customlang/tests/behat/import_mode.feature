...
Feature: Within a agpu instance, an administrator should be able to import langstrings with several modes.
  ...
  Scenario: Update only customized strings
    ...
    And I press "Continue"
    And I upload "admin/tool/customlang/tests/fixtures/agpu.php" file to "Language component(s)" filemanager
