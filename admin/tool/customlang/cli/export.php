...
Useful for uploading custom langstrings to AMOS or importing or syncing them to other agpu instances.
...
Export just the english files of agpu core and the activity 'quiz' in a subfolder in my home folder:
\$ sudo -u www-data /usr/bin/php admin/tool/customlang/cli/export.php --lang='en' --components='agpu,quiz' --target='~/customdir'
