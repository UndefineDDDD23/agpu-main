 ...
 * @category    output
 * @copyright   2013 David Mudrak <david@agpu.com>
...
class tool_installaddon_renderer extends plugin_renderer_base {
    ...
    public function index_page() {
        ...
        $permcheckurl = new agpu_url('/admin/tool/installaddon/permcheck.php');
        $this->page->requires->yui_module('agpu-tool_installaddon-permcheck', 'M.tool_installaddon.permcheck.init',
     ...
     * @return string
     */
    public function zip_not_valid_plugin_package_page(agpu_url $continueurl) {
     ...
     * @return string
     */
    public function remote_request_invalid_page(agpu_url $continueurl) {
     ...
     * @return string
     */
    public function remote_request_alreadyinstalled_page(stdClass $data, agpu_url $continueurl) {
     ...
     * @param stdClass $data decoded request data
     * @param agpu_url $continueurl
     * @param agpu_url $cancelurl
     * @return string
     */
    public function remote_request_confirm_page(stdClass $data, agpu_url $continueurl, agpu_url $cancelurl) {
     ...
     * @param agpu_url $continueurl to repeat the write permission check
     * @param agpu_url $cancelurl to cancel the installation
     * @return string
     */
    public function remote_request_permcheck_page(stdClass $data, $plugintypepath, agpu_url $continueurl, agpu_url $cancelurl) {
     ...
     * @return string
     */
    public function remote_request_non_installable_page(stdClass $data, agpu_url $continueurl) {
