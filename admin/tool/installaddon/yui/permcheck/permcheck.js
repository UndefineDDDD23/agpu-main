 ...
 *
 * @module      agpu-tool_installaddon-permcheck
 * @author      David Mudrak <david@agpu.com>
 */
YUI.add('agpu-tool_installaddon-permcheck', function(Y) {
    ...
    M.tool_installaddon.permcheck = {
        ...
        check_for_permission : function(plugintypesel) {
            ...
            Y.log('Selected plugin type: ' + plugintype, 'debug', 'agpu-tool_installaddon-permcheck');
                ...
                'on' : {
                    ...
                    'success': function(transid, outcome, args) {
                        ...
                        try {
                            ...
                            if (response.error) {
                                Y.log(response.error, 'error', 'agpu-tool_installaddon-permcheck');
                                ...
                                Y.log(response, 'debug', 'agpu-tool_installaddon-permcheck');
                                this.showresult(M.util.get_string('permcheckerror', 'tool_installaddon', response), 'error');
                            }

                        } catch (e) {
                            Y.log(e, 'error', 'agpu-tool_installaddon-permcheck');
                            this.showresult(M.util.get_string('permcheckerror', 'tool_installaddon'), 'error');
                        }
                    },
                    'failure': function(transid, outcome, args) {
                        Y.log(outcome.statusText, 'error', 'agpu-tool_installaddon-permcheck');
