...
class manager_test extends \advanced_testcase {
     ...
     *
     * @return agpu_database
     */
    public function mock_database() {
        global $DB;

        $DB = $this->getMockBuilder('agpu_database')->getMock();
    ...
    public function test_get_matching_tours(array $alltours, string $url, array $expected): void {
        ...
        $matches = \tool_usertours\manager::get_matching_tours(new \agpu_url($url));
    ...
    public function test_get_matching_tours_for_user_without_site_policy_agreed(): void {
        ...
        $matches = \tool_usertours\manager::get_matching_tours(new \agpu_url('/'));
