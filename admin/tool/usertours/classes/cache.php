...
EOF;
     ...
     *
     * @param   agpu_url  $targetmatch    The URL to match.
     */
    public static function get_matching_tourdata(\agpu_url $targetmatch) {
        ...
        $isfrontpage = $targetmatch->compare(new \agpu_url('/'), URL_MATCH_BASE);
        $isdashboard = $targetmatch->compare(new \agpu_url('/my/'), URL_MATCH_BASE);
        $ismycourses = $targetmatch->compare(new \agpu_url('/my/courses.php'), URL_MATCH_BASE);
