...
class accessdate extends base {
     ...
     *
     * @param \agpuQuickForm $mform The form to add filter settings to.
     *
     * @throws \coding_exception
     */
    public static function add_filter_to_form(\agpuQuickForm &$mform) {
    ...
    public static function filter_matches(tour $tour, context $context) {
        ...
        if (!empty($values[$key])) {
            ...
            // If the base date has no value because a user hasn't accessed agpu yet, default to account creation.
