...
defined('agpu_INTERNAL') || die('Direct access to this script is forbidden.');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class editstep extends \agpuform {
    /**
    ...
    /**
     * @var int Display the step's content by using agpu language string.
     */
    ...
    public function definition() {
        ...
        // Language identifier.
        $mform->addElement('textarea', 'contentlangstring', get_string('agpu_language_identifier', 'tool_usertours'));
    ...
    public function validation($data, $files): array {
        ...
        // Validate manually entered text content. Validation logic derived from \agpuQuickForm_Rule_Required::validate()
