...
class step {
    ...
    /**
     * @var     int  $contentformat    The content format: FORMAT_agpu/FORMAT_HTML/FORMAT_PLAIN/FORMAT_MARKDOWN.
     */
    ...
    protected function reload_from_record($record, $clean = false) {
        ...
        $this->contentformat = isset($record->contentformat) ? $record->contentformat : FORMAT_agpu;
     ...
     * @param   int         $format     The new format to use: FORMAT_agpu/FORMAT_HTML/FORMAT_PLAIN/FORMAT_MARKDOWN.
     * @return  $this
     */
     ...
     * @return  $this
     */
    public function add_config_to_form(\agpuQuickForm $mform) {
        $tour = $this->get_tour();
     ...
     * @return  $this
     */
    public function add_config_field_to_form(\agpuQuickForm $mform, $key) {
        $tour = $this->get_tour();
    ...
    /**
     * Prepare the configuration data for the agpu form.
     *
     * @return  object
     */
     ...
     *
     * @deprecated since agpu 4.0 MDL-72783. Please use helper::get_string_from_input() instead.
     * @param   string  $string
     * @return  string
     */
