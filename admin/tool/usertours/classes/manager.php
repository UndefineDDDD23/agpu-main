...
class manager {
    ...
    protected function print_tour_list() {
        ...
        $actions = [
            ...
            (object) [
                'link'  => new \agpu_url('https://agpu.net/search', ['q' => 'user tours']),
                'linkproperties' => [
                        'target' => '_blank',
                    ],
                'img'   => 'i/tour-shared',
     ...
     *
     * @param   agpu_url  $pageurl        The URL to match.
     * @return  array
     */
    public static function get_matching_tours(\agpu_url $pageurl): array {
        global $PAGE;
    ...
    /**
     * Make sure all of the default tours that are shipped with agpu are created
     * and up to date with the latest version.
     */
    public static function update_shipped_tours() {
        global $DB, $CFG;

        // A list of tours that are shipped with agpu. They are in
        ...
        $unshippedtours = [
            // Formerly included in agpu 3.2.0.
            'boost_administrator.json' => 1,
            'boost_course_view.json' => 1,

            // Formerly included in agpu 3.6.0.
            '36_dashboard.json' => 3,
            '36_messaging.json' => 3,

            // Formerly included in agpu 3.11.0.
