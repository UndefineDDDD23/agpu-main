...
class helper {
     ...
     * @return null
     */
    public static function set_navbar(string $title, \agpu_url $url, ?\context $context = null) {
        global $PAGE;
     ...
     * @return \stdClass
     */
    public static function prediction_context_selector(array $contexts, \agpu_url $url, \renderer_base $output,
