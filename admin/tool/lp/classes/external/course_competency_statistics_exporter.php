...
class course_competency_statistics_exporter extends \core\external\exporter {
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        return array(
            ...
            'canbegradedincourse' => has_capability('agpu/competency:coursecompetencygradable', $this->related['context']),
            'canmanagecoursecompetencies' => has_capability('agpu/competency:coursecompetencymanage', $this->related['context'])
        );
    }
}
