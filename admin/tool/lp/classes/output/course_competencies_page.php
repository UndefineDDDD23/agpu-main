...
class course_competencies_page implements renderable, templatable {
    ...
    public function __construct($courseid, $moduleid) {
        ...
        $this->canmanagecoursecompetencies = has_capability('agpu/competency:coursecompetencymanage', $this->context);
        $this->canconfigurecoursecompetencies = has_capability('agpu/competency:coursecompetencyconfigure', $this->context);
        $this->cangradecompetencies = has_capability('agpu/competency:competencygrade', $this->context);
        ...
        foreach ($contexts as $context) {
            $canmanage = has_capability('agpu/competency:competencymanage', $context);
            if ($canmanage) {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $data->pluginbaseurl = (new agpu_url('/admin/tool/lp'))->out(true);

        $gradable = is_enrolled($this->context, $USER, 'agpu/competency:coursecompetencygradable');
        if ($gradable) {
