...
Feature: Manage plan workflow
  ...
  Background:
    ...
    And the following "role capabilities" exist:
      | role                   | agpu/competency:planmanageowndraft | agpu/competency:planmanageown |
      | usermanageowndraftplan | allow                                |                                 |
      | usermanageownplan      | allow                                | allow                           |
      | manageplan             | allow                                | allow                           |
    And the following "role capability" exists:
      | role                                | manageplan |
      | agpu/competency:planmanage        | allow      |
      | agpu/competency:planview          | allow      |
      | agpu/competency:planreview        | allow      |
      | agpu/competency:planrequestreview | allow      |
