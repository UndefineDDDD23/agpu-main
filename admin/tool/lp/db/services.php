...
$functions = array(
    ...
    'tool_lp_data_for_competency_frameworks_manage_page' => array(
        ...
        'type'         => 'read',
        'capabilities' => 'agpu/competency:competencyview',
        'ajax'         => true,
    ),
    ...
    'tool_lp_data_for_template_competencies_page' => array(
        ...
        'type'         => 'read',
        'capabilities' => 'agpu/competency:templateview',
        'ajax'         => true,
    ),
    ...
    'tool_lp_data_for_plan_page' => array(
        ...
        'type'         => 'read',
        'capabilities' => 'agpu/competency:planview',
        'ajax'         => true,
        'services'     => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'tool_lp_data_for_user_evidence_list_page' => array(
        ...
        'type'         => 'read',
        'capabilities' => 'agpu/competency:userevidenceview',
        'ajax'         => true,
        'services'     => array(agpu_OFFICIAL_MOBILE_SERVICE),
    ),
