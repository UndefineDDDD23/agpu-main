...
$backurl = new agpu_url('/admin/settings.php', ['section' => 'formatsetting'.$format]);
...
$confirmbutton = new single_button(
    new agpu_url('/admin/course/resetindentation.php', ['confirm' => 1, 'format' => $format, 'sesskey' => sesskey()]),
