 ...
 * where broken by a wrong upgrade step, affecting to agpu 3.9.5
 * and up.
 *
 ...
 *
 * @package core
 * @copyright 2021 onwards Simey Lameze <simey@agpu.com>
...
Fix orphaned calendar events.
  ...
  For more details:  https://tracker.agpu.org/browse/MDL-71156
...
if (agpu_needs_upgrading()) {
    cli_error('agpu upgrade pending, script execution suspended.');
}
