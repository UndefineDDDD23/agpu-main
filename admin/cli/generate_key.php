...
In normal use agpu automatically creates the key; this script is intended when setting up
a new agpu system, for cases where the secure folder is not on shared storage and the key
