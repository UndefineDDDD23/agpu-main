 ...
 */
class mnet_simple_host_form extends agpuform {
    function definition() {
        global $DB;
    ...
    function validation($data, $files) {
        ...
        if ($host = $DB->get_record('mnet_host', array('wwwroot' => $wwwroot))) {
            $str = get_string('hostexists', 'mnet', (new agpu_url('/admin/mnet/peers.php', ['hostid' => $host->id]))->out());
 ...
 */
class mnet_review_host_form extends agpuform {
    function definition() {
        global $OUTPUT;
