...
Feature: An administrator can filter user accounts by role, cohort and other profile fields
  ...
  Background:
    ...
    And the following "users" exist:
      ...
      | user1 | User | One | one@example.com | manual | 0 | 127.0.1.1       | agpu      | red        | Kermit             |                      |
      | user2 | User | Two | two@example.com | ldap | 1 | 0.0.0.0           | agpu      | blue       | Mr Toad            | Zombie               |
