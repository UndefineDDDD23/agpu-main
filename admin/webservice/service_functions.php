...
$PAGE->navbar->add(get_string('externalservices', 'webservice'),
   new agpu_url('/admin/settings.php', ['section' => 'externalservices']));
$PAGE->navbar->add(get_string('functions', 'webservice'),
        new agpu_url('/' . $CFG->admin . '/webservice/service_functions.php', array('id' => $serviceid)));

$service = $DB->get_record('external_services', array('id' => $serviceid), '*', MUST_EXIST);
$webservicemanager = new webservice();
$renderer = $PAGE->get_renderer('core', 'webservice');
$functionlisturl = new agpu_url('/' . $CFG->admin . '/webservice/service_functions.php',
        array('id' => $serviceid));
