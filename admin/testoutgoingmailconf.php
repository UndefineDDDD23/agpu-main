 ...
 *
 * @copyright 2019 Victor Deniz <victor@agpu.com>, based on Michael Milette <michael.milette@tngconsulting.ca> code
...
$homeurl = new agpu_url('/admin/category.php', array('category' => 'email'));
$returnurl = new agpu_url('/admin/testoutgoingconf.php');
...
if ($data) {
    ...
    // Restore agpu debugging options.
    ...
    if ($success) {
        ...
        // No communication between agpu and the SMTP server - no error output.
