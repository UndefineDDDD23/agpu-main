...
$capabilities = array(
    'agpu/backup:backupcourse',
    'agpu/category:manage',
    'agpu/course:create',
    'agpu/site:approvecourse',
    'agpu/restore:restorecourse'
);
if ($hassiteconfig or has_any_capability($capabilities, $systemcontext)) {
    ...
    $ADMIN->add('courses',
        new admin_externalpage('coursemgmt', new lang_string('coursemgmt', 'admin'),
            ...
            array('agpu/category:manage', 'agpu/course:create')
        )
    );
    $ADMIN->add('courses',
        new admin_externalpage('addcategory', new lang_string('addcategory', 'admin'),
            new agpu_url('/course/editcategory.php', array('parent' => 0)),
            array('agpu/category:manage')
        )
    );
    $ADMIN->add('courses',
        new admin_externalpage('addnewcourse', new lang_string('addnewcourse'),
            new agpu_url('/course/edit.php', array('category' => 0)),
            array('agpu/category:manage')
        )
    );
    $ADMIN->add('courses',
        new admin_externalpage('restorecourse', new lang_string('restorecourse', 'admin'),
            new agpu_url('/backup/restorefile.php', array('contextid' => context_system::instance()->id)),
            array('agpu/restore:restorecourse')
        )
    );

    // Download course content.
    $downloadcoursedefaulturl = new agpu_url('/admin/settings.php', ['section' => 'coursesettings']);
    ...
    if (!empty($CFG->enablecourserequests)) {
        $ADMIN->add('courses', new admin_externalpage('coursespending', new lang_string('pendingrequests'),
                $CFG->wwwroot . '/course/pending.php', array('agpu/site:approvecourse')));
    }
    ...
    $temp->add(new admin_setting_configselect('agpucourse/visible', new lang_string('visible'), new lang_string('visible_help'),
        1, $choices));
    ...
    $downloadcontentsitedefault = new admin_setting_configselect('agpucourse/downloadcontentsitedefault',
    ...
    $temp->add(
            new admin_setting_configtext(
                'agpucourse/participantsperpage',
    ...
    $temp->add(new admin_setting_configselect('agpucourse/format', new lang_string('format'), new lang_string('coursehelpformat'),
        'topics', $formcourseformats));

    $temp->add(new admin_setting_configtext('agpucourse/maxsections', new lang_string('maxnumberweeks'),
        new lang_string('maxnumberweeks_desc'), 52));

    $temp->add(new admin_settings_num_course_sections('agpucourse/numsections', new lang_string('numberweeks'),
    ...
    $temp->add(new admin_setting_configselect('agpucourse/hiddensections', new lang_string('hiddensections'),
    ...
    $temp->add(new admin_setting_configselect('agpucourse/coursedisplay', new lang_string('coursedisplay'),
        new lang_string('coursedisplay_help'), COURSE_DISPLAY_SINGLEPAGE, $choices));

    $temp->add(new admin_setting_configcheckbox('agpucourse/courseenddateenabled', get_string('courseenddateenabled'),
        get_string('courseenddateenabled_desc'), 1));

    $temp->add(new admin_setting_configduration('agpucourse/courseduration', get_string('courseduration'),
    ...
    $temp->add(new admin_setting_configselect('agpucourse/lang', new lang_string('forcelanguage'), '', key($languages),
        $languages));

    $options = range(0, 10);
    $temp->add(new admin_setting_configselect('agpucourse/newsitems', new lang_string('newsitemsnumber'),
        new lang_string('coursehelpnewsitemsnumber'), 5, $options));
    $temp->add(new admin_setting_configselect('agpucourse/showgrades', new lang_string('showgrades'),
        new lang_string('coursehelpshowgrades'), 1, array(0 => new lang_string('no'), 1 => new lang_string('yes'))));
    $temp->add(new admin_setting_configselect('agpucourse/showreports', new lang_string('showreports'), '', 0,
        array(0 => new lang_string('no'), 1 => new lang_string('yes'))));
    $temp->add(new admin_setting_configselect('agpucourse/showactivitydates',
    ...
    if (!empty($CFG->legacyfilesinnewcourses)) {
        ...
        $temp->add(new admin_setting_configselect('agpucourse/legacyfiles', new lang_string('courselegacyfiles'),
            new lang_string('courselegacyfiles_help'), key($choices), $choices));
    }

    $currentmaxbytes = get_config('agpucourse', 'maxbytes');
    if (isset($CFG->maxbytes)) {
        $choices = get_max_upload_sizes($CFG->maxbytes, 0, 0, $currentmaxbytes);
    } else {
        $choices = get_max_upload_sizes(0, 0, 0, $currentmaxbytes);
    }
    $temp->add(new admin_setting_configselect('agpucourse/maxbytes', new lang_string('maximumupload'),
    ...
    if (!empty($CFG->enablepdfexportfont)) {
        ...
        if (count($fontlist) > 1) {
            $temp->add(new admin_setting_configselect('agpucourse/pdfexportfont',
    ...
    $temp->add(new admin_setting_configselect('agpucourse/enablecompletion', new lang_string('completion', 'completion'),
    ...
    $temp->add(new admin_setting_configselect('agpucourse/showcompletionconditions',
    ...
    $temp->add(new admin_setting_configselect('agpucourse/groupmode', new lang_string('groupmode'), '', key($choices),$choices));
    $temp->add(new admin_setting_configselect('agpucourse/groupmodeforce', new lang_string('force'), new lang_string('coursehelpforce'), 0,array(0 => new lang_string('no'), 1 => new lang_string('yes'))));
    ...
    $temp->add(new admin_setting_configselect('agpucourse/coursecommunicationprovider',
    ...
    if (!empty($CFG->enablecompletion)) {
        $ADMIN->add('coursedefaultsettings', new admin_externalpage(
                ...
                new agpu_url('/course/defaultcompletion.php', ['id' => $SITE->id]),
    ...
    $ADMIN->add('coursedefaultsettings', new admin_externalpage(
        ...
        ['agpu/course:configurecustomfields'])
    );
    ...
    $ADMIN->add(
        ...
        new admin_externalpage(
            ...
            ['agpu/group:configurecustomfields']
        )
    );
    $ADMIN->add(
        'groups',
    ...
    $ADMIN->add('activitychooser',
        new admin_externalpage('activitychooserrecommended', new lang_string('activitychooserrecommendations', 'course'),
            new agpu_url('/course/recommendations.php'),
            array('agpu/course:recommendactivity')
        )
    );
    ...
    $temp = new admin_settingpage('backupgeneralsettings', new lang_string('generalbackdefaults', 'backup'), 'agpu/backup:backupcourse');
    ...
    $temp = new admin_settingpage('importgeneralsettings', new lang_string('importgeneralsettings', 'backup'), 'agpu/backup:backupcourse');
    ...
    $temp = new admin_settingpage('automated', new lang_string('automatedsetup','backup'), 'agpu/backup:backupcourse');
