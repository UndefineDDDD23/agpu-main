...
if ($hassiteconfig) {
    ...
    // Statistics.
    $temp = new admin_settingpage('stats', new lang_string('stats'), 'agpu/site:config', empty($CFG->enablestats));
    $temp->add(new admin_setting_configselect('statsfirstrun', new lang_string('statsfirstrun', 'admin'),
        ...
        [
            ...
            60 * 60 * 24 * 7 => new lang_string('numweeks', 'agpu', 1),
            60 * 60 * 24 * 14 => new lang_string('numweeks', 'agpu', 2),
            60 * 60 * 24 * 21 => new lang_string('numweeks', 'agpu', 3),
            60 * 60 * 24 * 28 => new lang_string('nummonths', 'agpu', 1),
            60 * 60 * 24 * 56 => new lang_string('nummonths', 'agpu', 2),
            60 * 60 * 24 * 84 => new lang_string('nummonths', 'agpu', 3),
            60 * 60 * 24 * 112 => new lang_string('nummonths', 'agpu', 4),
            60 * 60 * 24 * 140 => new lang_string('nummonths', 'agpu', 5),
            60 * 60 * 24 * 168 => new lang_string('nummonths', 'agpu', 6),
    ...
    $ADMIN->add('server', new admin_externalpage('testoutgoingmailconf', new lang_string('testoutgoingmailconf', 'admin'),
        new agpu_url('/admin/testoutgoingmailconf.php'), 'agpu/site:config', true));
    ...
    $url = new agpu_url('/admin/testoutgoingmailconf.php');
    ...
    $ADMIN->add('webservicesettings', new admin_externalpage('webservicedocumentation', new lang_string('wsdocapi', 'webservice'),
        "{$CFG->wwwroot}/{$CFG->admin}/webservice/documentation.php", 'agpu/site:config', false));
    ...
    $ADMIN->add('webservicesettings', new admin_externalpage('externalservice', new lang_string('editaservice', 'webservice'),
        "{$CFG->wwwroot}/{$CFG->admin}/webservice/service.php", 'agpu/site:config', true));
    ...
    $url = new agpu_url(get_docs_url('How_to_get_a_security_key'));
