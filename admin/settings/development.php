...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    // Sharing to agpuNet setting.
    $temp->add(new admin_setting_configcheckbox('enablesharingtoagpunet',
        new lang_string('enablesharingtoagpunet', 'core_admin'),
        new lang_string('enablesharingtoagpunet_desc', 'core_admin'), 0));
    ...
    $temp = new admin_settingpage('profiling', new lang_string('profiling', 'admin'), 'agpu/site:config', !$xhprofenabled);
