...
$baseurl = new agpu_url('/admin/roles/usersroles.php', array('userid'=>$userid, 'courseid'=>$courseid));
...
$canview = has_any_capability(array('agpu/role:assign', 'agpu/role:safeoverride',
        'agpu/role:override', 'agpu/role:manage'), $usercontext);
if (!$canview) {
...
function print_report_tree($contextid, $contexts, $systemcontext, $fullname, $allroles) {
    ...
    if (is_null($stredit)) {
        ...
        $globalroleassigner = has_capability('agpu/role:assign', $systemcontext);
