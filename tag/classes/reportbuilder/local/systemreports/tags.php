...
class tags extends system_report {
    ...
    protected function can_view(): bool {
        ...
        return !empty($CFG->usetags) && has_capability('agpu/tag:manage', system::instance());
    }
    ...
    protected function add_actions(): void {
        ...
        $this->add_action((new action(
            ...
            ->add_callback(static function(stdClass $tag): bool {
                $tag->returnurl = (new agpu_url('/tag/manage.php', ['tc' => $tag->tagcollid]))->out_as_local_url(false);
                return true;
            })
        );
