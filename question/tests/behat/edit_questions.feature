...
Feature: A teacher can edit questions in the question bank
  ...
  Scenario: Edit a previously created question without permission 'agpu/question:moveall' and 'agpu/question:movemine'
    Given I log in as "admin"
    And the following "permission overrides" exist:
      | capability               | permission | role           | contextlevel | reference |
      | agpu/question:movemine | Prevent    | editingteacher | System       |           |
      | agpu/question:moveall  | Prevent    | editingteacher | System       |           |
    When I am on the "Test question to be edited" "core_question > edit" page logged in as "teacher1"
    And I set the following fields to these values:
      | Question name | Edited question name            |
      | Question text | Write a lot about what you want |
  ...
  Scenario: Edit a previously created question without permission 'agpu/question:editall' and 'agpu/question:editmine'
    Given I log in as "admin"
    And the following "permission overrides" exist:
      | capability               | permission | role           | contextlevel | reference |
      | agpu/question:editmine | Prevent    | editingteacher | System       |           |
      | agpu/question:editall  | Prevent    | editingteacher | System       |           |
    When I am on the "Test question to be edited" "core_question > edit" page logged in as "teacher1"
    And I set the following fields to these values:
      | Question name | Edited question name            |
      | Question text | Write a lot about what you want |
