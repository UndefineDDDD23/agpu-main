    ...
    protected function resolve_page_instance_url(string $type, string $identifier): agpu_url {
        switch (strtolower($type)) {
            case 'course question bank':
                ...
                return new agpu_url('/question/edit.php', [
                    'courseid' => $this->get_course_id($identifier),
                ]);

            case 'course question categories':
                return new agpu_url('/question/bank/managecategories/category.php',
                        ['courseid' => $this->get_course_id($identifier)]);

            case 'course question import':
                return new agpu_url('/question/bank/importquestions/import.php',
                        ['courseid' => $this->get_course_id($identifier)]);
            ...
            case 'preview':
                ...
                return new agpu_url('/question/bank/previewquestion/preview.php',
                        ['id' => $questionid, $otheridtype => $otherid]);

            case 'edit':
                [$questionid, $otheridtype, $otherid] = $this->find_question_by_name($identifier);
                return new agpu_url('/question/bank/editquestion/question.php',
                        ['id' => $questionid, $otheridtype => $otherid]);
