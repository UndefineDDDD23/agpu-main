YUI.add('agpu-question-chooser', function (Y, NAME) {
 ...
 *
 * @module agpu-question-chooser
 */

Y.log("The agpu-question-chooser module has been deprecated. " +
    "Please use agpu-qbank_editquestion-chooser instead.", 'agpu-core-notification', 'warn');
...
}, '@VERSION@', {"requires": ["agpu-core-chooserdialogue"]});
