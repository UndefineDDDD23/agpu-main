...
class question_dataset_dependent_items_form extends question_wizard_form {
    ...
    public function __construct($submiturl, $question, $regenerate) {
        ...
        if (!isset($question->categoryobject)) {
            throw new agpu_exception('categorydoesnotexist', 'question');
        }
    ...
    protected function definition() {
        ...
        $mform->addElement('header', 'addhdr', get_string('add', 'agpu'));
        ...
        $addgrp = array();
        $addgrp[] =& $mform->createElement('submit', 'addbutton', get_string('add', 'agpu'));
        ...
        if ($this->noofitems > 0) {
            $mform->addElement('header', 'deleteitemhdr', get_string('delete', 'agpu'));
            $deletegrp = array();
            $deletegrp[] = $mform->createElement('submit', 'deletebutton',
                    get_string('delete', 'agpu'));
