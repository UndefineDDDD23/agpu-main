...
class qtype_ordering_test_helper extends question_test_helper {
     ...
     */
    public function make_ordering_question_agpu(): qtype_ordering_question {
    ...
    public function make_answer(int $id, string $text, int $textformat, int $order, bool $addmd5 = false): stdClass {
        ...
        $answer->feedback = '';
        $answer->feedbackformat = FORMAT_agpu;
     ...
     */
    public function get_ordering_question_form_data_agpu(): stdClass {
        $form = new stdClass();
        $form->name = 'agpu';
