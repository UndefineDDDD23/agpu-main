...
Feature: Complete an Ordering question attempt
  ...
  Background:
    Given the following "users" exist:
      ...
      | teacher1 | Teacher   | 1        | teacher1@agpu.com  |
    ...
    And the following "questions" exist:
      ...
      | Test questions   | ordering | ordering-001 | agpu   | 0          | 0          | 3           | -1          | 1           | none           |
      | Test questions   | ordering | ordering-002 | agpu   | 0          | 0          | 3           | 1           | 0           | abc            |
      | Test questions   | ordering | ordering-003 | agpu   | 0          | 1          | 6           | 2           | 1           | ABCD           |
      | Test questions   | ordering | ordering-004 | agpu   | 0          | 2          | 6           | 3           | 0           | 123            |
      | Test questions   | ordering | ordering-005 | agpu   | 0          | 0          | 3           | 4           | 1           | iii            |
      | Test questions   | ordering | ordering-006 | agpu   | 0          | 0          | 3           | 5           | 0           | IIII           |
      | Test questions   | ordering | ordering-007 | agpu   | 0          | 0          | 3           | 6           | 1           | abc            |
      | Test questions   | ordering | ordering-008 | agpu   | 0          | 0          | 3           | 7           | 0           | abc            |
