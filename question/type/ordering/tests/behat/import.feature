...
Feature: Test importing Ordering questions
  ...
  Scenario: import Matching question.
    ...
    And I upload "question/type/ordering/tests/fixtures/testquestion.agpu.xml" file to "Import" filemanager
  ...
  Scenario: Import old question.
    When I am on the "Course 1" "core_question > course question import" page logged in as teacher1
    And I set the field "id_format_xml" to "1"
    And I upload "question/type/ordering/tests/fixtures/testoldquestion.agpu.xml" file to "Import" filemanager
    And I press "id_submitbutton"
    And I press "Continue"
