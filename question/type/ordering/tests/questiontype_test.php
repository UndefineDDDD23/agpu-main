...
final class questiontype_test extends \question_testcase {
    ...
    public function test_xml_import(): void {
        ...
        $xml = file_get_contents(__DIR__ . '/fixtures/testimport.agpu.xml');
        $xmldata = xmlize($xml);
    ...
    public function test_xml_import_long(): void {
        $this->resetAfterTest();
        // Import a question from XML.
        $xml = file_get_contents(__DIR__ . '/fixtures/testimportlong.agpu.xml');
        $xmldata = xmlize($xml);
        $format = new qformat_xml();
        $imported = $format->try_importing_using_qtypes(
            $xmldata['question'], null, null, 'ordering');
        ...
        $expected->name = 'agpu agpu agpu agpu agpu agpu agpu';
    ...
    public function test_xml_export(): void {
        ...
        $question = $generator->create_question('ordering', 'agpu',
        ...
        $expectedxml = file_get_contents(__DIR__ . '/fixtures/testexport.agpu.xml');
