...
class qtype_ordering_edit_form extends question_edit_form {
     ...
     *
     * @param agpuQuickForm_editor $editor
     * @param int|string $format
     * @return int
     */
    protected function reset_editor_format(agpuQuickForm_editor $editor, int|string $format = FORMAT_agpu): int {
     ...
     * @param string $name
     */
    protected function adjust_html_editors(agpuQuickForm $mform, string $name): void {
     ...
     *
     * @param agpuQuickForm $mform the agpu form object
     * @param string $type
     * @param array $elements
     * @param array $options
     * @return void, but will update $mform
     */
    protected function add_repeat_elements(agpuQuickForm $mform, string $type, array $elements, array $options): void {
