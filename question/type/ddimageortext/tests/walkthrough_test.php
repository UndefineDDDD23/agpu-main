...
class walkthrough_test extends \qbehaviour_walkthrough_test_base {
    ...
    public function test_interactive_no_right_clears(): void {
        ...
        $dd = \test_question_maker::make_question('ddimageortext');
        $dd->hints = array(
            new question_hint_with_parts(23, 'This is the first hint.', FORMAT_agpu, false, true),
            new question_hint_with_parts(24, 'This is the second hint.', FORMAT_agpu, true, true),
        );
        $dd->shufflechoices = false;
        $this->start_attempt_at_question($dd, 'interactive', 3);
