...
/**
 * This is the base class for agpu question types.
 *
...
class question_type {
     ...
     * question bank, which it is by default since agpu 3.8. If applicable for
    ...
    public function save_question($question, $form) {
        ...
        if (!empty($result->error)) {
            throw new \agpu_exception($result->error);
        }
     ...
     *      the default 0 = FORMAT_agpu). Therefore, by default this method
    ...
    /*
     * Imports question from the agpu XML format
     *
    ...
    /*
     * Export question to the agpu XML format
     *
