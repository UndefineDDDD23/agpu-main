                    ...
                    if (empty($wrapped->questiontext)) {
                        ...
                        switch ($wrapped->qtype) {
                            ...
                            case 'subquestion_replacement':
                                continue 2;
                            default:
                                throw new \agpu_exception('unknownquestiontype', 'question', '',
                                        $wrapped->qtype);
                        }
                        $separator = '';
                    ...
                    foreach ($subquestions as $subquestion) {
                        ...
                        if ($subquestion->qtype == 'multichoice') {
                            ...
                            if ($subquestion->shuffleanswers ) {
                                $defaultvalues[$prefix.'shuffleanswers'] = get_string('yes', 'agpu');
                            } else {
                                $defaultvalues[$prefix.'shuffleanswers'] = get_string('no', 'agpu');
                            }
                        }
