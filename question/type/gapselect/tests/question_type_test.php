...
class question_type_test extends \question_testcase {
    ...
    <hint format="agpu_auto_format">
      ...
      <clearwrong />
        ...
        $expectedq->hint = array(
                array('text' => 'Try again.', 'format' => FORMAT_agpu),
    ...
    public function test_xml_export(): void {
        ...
        $qdata->options->correctfeedbackformat = FORMAT_agpu;
        $qdata->options->partiallycorrectfeedback = '<p>Your answer is partially correct.</p>';
                $qdata->options->partiallycorrectfeedbackformat = FORMAT_agpu;
        $qdata->options->shownumcorrect = true;
        $qdata->options->incorrectfeedback = '<p>Your answer is incorrect.</p>';
        $qdata->options->incorrectfeedbackformat = FORMAT_agpu;

        $qdata->options->answers = array(
            13 => new question_answer(13, 'Alpha', 0, '1', FORMAT_agpu),
            14 => new question_answer(14, 'Beta', 0, '1', FORMAT_agpu),
            15 => new question_answer(15, 'Gamma', 0, '1', FORMAT_agpu),
        );

        $qdata->hints = array(
            1 => new question_hint_with_parts(1, 'Try again.', FORMAT_agpu, true, false),
            2 => new question_hint_with_parts(2,
                    'These are the first three letters of the Greek alphabet.',
                    FORMAT_agpu, true, true),
        );
  ...
  <question type="gapselect">
    ...
    <idnumber></idnumber>
    <shuffleanswers>1</shuffleanswers>
    <correctfeedback format="agpu_auto_format">
      <text><![CDATA[<p>Your answer is correct.</p>]]></text>
    </correctfeedback>
    <partiallycorrectfeedback format="agpu_auto_format">
      <text><![CDATA[<p>Your answer is partially correct.</p>]]></text>
    </partiallycorrectfeedback>
    <incorrectfeedback format="agpu_auto_format">
      <text><![CDATA[<p>Your answer is incorrect.</p>]]></text>
    </incorrectfeedback>
    <shownumcorrect/>
    <selectoption>
