...
class edit_action extends question_action_base {
    ...
    public function init(): void {
        ...
        $this->editquestionurl = new \agpu_url('/question/bank/editquestion/question.php',
     ...
     * @return agpu_url the URL, HTML-escaped.
     */
    public function edit_question_agpu_url($questionid): agpu_url {
        return new agpu_url($this->editquestionurl, ['id' => $questionid]);
    }
    ...
    protected function get_url_icon_and_label(\stdClass $question): array {
        ...
        if (question_has_capability_on($question, 'edit')) {
            return [$this->edit_question_agpu_url($question->id), 't/edit', $this->stredit];
        } else if (question_has_capability_on($question, 'view')) {
            return [$this->edit_question_agpu_url($question->id), 'i/info', $this->strview];
        } else {
            return [null, null, null];
        }
    }
