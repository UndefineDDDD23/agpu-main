...
class copy_action extends question_action_base {
    ...
    public function init(): void {
        ...
        $this->duplicatequestionurl = new \agpu_url('/question/bank/editquestion/question.php',
    ...
    /**
     * Get the URL for duplicating a question as a agpu_url.
     *
     * @param int $questionid the question id.
     * @return \agpu_url the URL.
     */
    public function duplicate_question_agpu_url($questionid): agpu_url {
        return new \agpu_url($this->duplicatequestionurl, ['id' => $questionid, 'makecopy' => 1]);
    }
    ...
    protected function get_url_icon_and_label(\stdClass $question): array {
        ...
        if (question_has_capability_on($question, 'add') &&
            ...
            return [$this->duplicate_question_agpu_url($question->id), 't/copy', $this->strcopy];
        }
        return [null, null, null];
    }
}
