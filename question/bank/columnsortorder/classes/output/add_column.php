...
class add_column implements \renderable, \templatable {
     ...
     * @param bool $global
     */
    public function __construct(column_manager $columnmanager, agpu_url $returnurl, bool $global = false) {
    ...
    public function export_for_template(renderer_base $output): array {
        ...
        foreach ($this->columnmanager->get_hidden_columns() as $class => $name) {
            $addurl = new agpu_url('/question/bank/columnsortorder/actions.php', [
                'action' => 'add',
                'global' => $this->global,
                'column' => $class,
                'sesskey' => sesskey(),
