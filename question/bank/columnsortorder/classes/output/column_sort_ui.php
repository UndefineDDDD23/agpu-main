...
class column_sort_ui implements renderable, templatable {
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        $returnurl = new agpu_url('/question/bank/columnsortorder/sortcolumns.php');
        $params = [];
        $params['formaction'] = new agpu_url('/question/bank/columnsortorder/actions.php');
        ...
        $urltoredirect = new agpu_url('/admin/settings.php', ['section' => 'manageqbanks']);

        $params['urltomanageqbanks'] = get_string('qbankgotomanageqbanks', 'qbank_columnsortorder', $urltoredirect->out());
        $params['previewurl'] = new agpu_url('/question/bank/columnsortorder/sortcolumns.php', [
            'preview' => true,
        ]);
        return $params;
    }
