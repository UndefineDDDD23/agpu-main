 ...
 * @copyright  2016 Pau Ferrer <pau@agpu.com>
...
class submit_tags_test extends \externallib_advanced_testcase {
    ...
    public function test_submit_tags_form_no_tag_permissions(): void {
        ...
        assign_capability('agpu/question:tagmine', CAP_PROHIBIT, $teacherrole->id, $questioncontext->id);
        assign_capability('agpu/question:tagall', CAP_PROHIBIT, $teacherrole->id, $questioncontext->id);
    ...
    public function test_submit_tags_form_tagmine_permission_non_owner_question(): void {
        ...
        // Prohibit all of the tag capabilities.
        assign_capability('agpu/question:tagmine', CAP_ALLOW, $teacherrole->id, $questioncontext->id);
        assign_capability('agpu/question:tagall', CAP_PROHIBIT, $teacherrole->id, $questioncontext->id);
    ...
    protected function create_user_can_tag($course) {
        ...
        assign_capability('agpu/question:tagall', CAP_ALLOW, $roleid, $systemcontext, true);
