...
class delete_action extends question_action_base {
    ...
    public function init(): void {
        ...
        $this->deletequestionurl = new \agpu_url('/question/bank/deletequestion/delete.php');
    ...
    protected function get_url_icon_and_label(\stdClass $question): array {
        ...
        if ($question->status === question_version_status::QUESTION_STATUS_HIDDEN) {
            ...
            $url = new \agpu_url($this->deletequestionurl, $hiddenparams);
            ...
            $url = new \agpu_url($this->deletequestionurl, $deleteparams);
