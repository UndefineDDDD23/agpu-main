...
class helper {
     ...
     * @param agpu_url $returnurl url of the page to return to
    ...
    public static function question_preview_action_url($questionid, $qubaid,
            question_preview_options $options, $context, $returnurl = null, $restartversion = null): agpu_url {
        $params = [
                'id' => $questionid,
                'previewid' => $qubaid,
        ];
        ...
        return new agpu_url('/question/bank/previewquestion/preview.php', $params);
    }
     ...
     *
     * @param int $questionid the question being previewed
     * @param context $context the current agpu context
     * @param int $previewid optional previewid to sign post saved previewed answers
     * @param agpu_url $returnurl url of the page to return to
     * @return agpu_url
     */
    public static function question_preview_form_url($questionid, $context, $previewid = null, $returnurl = null): agpu_url {
        $params = [
                'id' => $questionid,
        ];
        if ($context->contextlevel == CONTEXT_MODULE) {
