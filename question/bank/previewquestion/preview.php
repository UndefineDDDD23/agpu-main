...
if ($previewid) {
    ...
    if ($quba->get_owning_context()->instanceid != $USER->id) {
        throw new agpu_exception('notyourpreview', 'question');
    }

    $slot = $quba->get_first_question_number();
    $usedquestion = $quba->get_question($slot, false);
    if ($usedquestion->id != $question->id) {
        throw new agpu_exception('questionidmismatch', 'question');
    }
...
if (data_submitted() && confirm_sesskey()) {
    ...
    try {
        ...
        throw new agpu_exception('submissionoutofsequencefriendlymessage', 'question', $actionurl);
        ...
        throw new agpu_exception('errorprocessingresponses', 'question', $actionurl,
...
$closeurl = new agpu_url('/question/edit.php', ['courseid' => $COURSE->id]);
