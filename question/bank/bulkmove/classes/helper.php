...
class helper {
     ...
     * @param \agpu_url $moveurl the url where the move script will point to.
     * @param \agpu_url $returnurl return url in case the form is cancelled.
     * @return array the data to be rendered in the mustache where it contains the dropdown, move url and return url.
     */
    public static function get_displaydata(array $addcontexts, \agpu_url $moveurl, \agpu_url $returnurl): array {
        $displaydata = [];
