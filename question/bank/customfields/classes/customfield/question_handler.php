...
class question_handler extends \core_customfield\handler {
    ...
    public function get_configuration_url(): \agpu_url {
        return new \agpu_url('/question/customfield.php');
    }
     ...
     *
     * @param \agpuQuickForm $mform The form to add the custom fields to.
     */
    public function config_form_definition(\agpuQuickForm $mform): void {
