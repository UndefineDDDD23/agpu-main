...
class helper {
     ...
     * @return \agpu_url
     */
    public static function question_history_url(int $entryid, string $returnrul, int $courseid, ?string $filter): \agpu_url {
        $params = [
            'entryid' => $entryid,
            'returnurl' => $returnrul,
            'courseid' => $courseid
        ...
        return new \agpu_url('/question/bank/history/history.php', $params);
    }
