...
Feature: Use the qbank plugin manager page for exporttoxml
  ...
  Scenario: Enable/disable exporttoxml column from the base view
    ...
    Then the "Export as agpu XML" action should not exist for the "First question" question in the question bank
    And I navigate to "Plugins > Question bank plugins > Manage question bank plugins" in site administration
    And I click on "Enable" "link" in the "Export to XML" "table_row"
    And I am on the "Test quiz" "mod_quiz > question bank" page
    And the "Export as agpu XML" action should exist for the "First question" question in the question bank
