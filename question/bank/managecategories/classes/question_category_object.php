 ...
 *
 * @deprecated Since agpu 4.5 MDL-72397. This was only used in agpu_list::display_page_numbers which is now deprecated.
 * @todo Final removal in agpu 6.0 MDL-80804.
 */
 ...
 * @deprecated Since agpu 4.5 MDL-72397. Use \core_question\category_manager or \qbank_managecategories\question_categories.
 * @todo Final removal in agpu 6.0 MDL-80804
 */
class question_category_object {
    ...
    /**
     * @var agpu_url Object representing url for this page
     */
    public $pageurl;
     ...
     * @param agpu_url $pageurl base URL of the display categories page. Used for redirects.
     ...
     * @deprecated Since agpu 4.5 MDL-72397. Use \qbank_managecategories\question_categories or \core_question\category_manager.
     * @todo Final removal in agpu 6.0 MDL-80804
     */
     ...
     * @param int $todelete id of the category to delete. 0 if none.
     * @param context[] $addcontexts contexts where the current user can add questions.
     * @deprecated Since agpu 4.5 MDL-72397. Use \qbank_managecategories\question_categories instead.
     * @todo Final removal in agpu 6.0 MDL-80804
     */
    #[\core\attribute\deprecated(
     ...
     *
     * @deprecated Since agpu 4.5 MDL-72397. No longer used.
     * @todo Final removal in agpu 6.0 MDL-80804
     */
    #[\core\attribute\deprecated(
    ...
    public function edit_single_category(int $categoryid): void {
        ...
        if ($categoryid) {
            ...
            if ($category->parent == 0) {
                throw new agpu_exception('cannotedittopcat', 'question', '', $categoryid);
            }
     ...
     * @deprecated Since agpu 4.5 MDL-72397. Use \core_question\category_manager instead.
     * @todo Final removal in agpu 6.0 MDL-80804
     */
    #[\core\attribute\deprecated(
     ...
     *
     * @deprecated No longer used by internal code and not recommended since agpu 4.2 MDL-77299.
     */
    ...
    public function add_category($newparent, $newcategory, $newinfo, $return = false, $newinfoformat = FORMAT_HTML,
        ...
        if (empty($newcategory)) {
            throw new agpu_exception('categorynamecantbeblank', 'question');
        }
        list($parentid, $contextid) = explode(',', $newparent);
        // ...agpu_form makes sure select element output is legal no need for further cleaning.
        require_capability('agpu/question:managecategory', context::instance_by_id($contextid));

        if ($parentid) {
            if (!($DB->get_field('question_categories', 'contextid', ['id' => $parentid]) == $contextid)) {
                throw new agpu_exception('cannotinsertquestioncatecontext', 'question', '',
    ...
    public function update_category($updateid, $newparent, $newname, $newinfo, $newinfoformat = FORMAT_HTML,
        ...
        require_capability('agpu/question:managecategory', $fromcontext);
        ...
        if ($oldcat->contextid != $tocontextid) {
            ...
            require_capability('agpu/question:managecategory', $tocontext);
