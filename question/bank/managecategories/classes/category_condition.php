...
class category_condition extends condition {
     ...
     * @deprecated since agpu 4.3 MDL-72321 - please do not use this function any more.
     ...
     * @param \agpu_url $pageurl the URL of this page.
     ...
     * @deprecated since agpu 4.3
     * @todo Final deprecation in agpu 4.7 MDL-78090
     */
