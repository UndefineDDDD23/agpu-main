...
class question_category_edit_form extends \core_form\dynamic_form {
     ...
     *     {@link https://agpudev.io/docs/4.2/guides/javascript/reactive#controlling-the-state-from-the-backend}
     * @throws \coding_exception
    ...
    protected function get_page_url_for_dynamic_submission(): agpu_url {
        ...
        return new agpu_url('/question/bank/managecategories/category.php', $params);
    }
}
