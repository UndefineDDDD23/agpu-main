...
final class helper_test extends manage_category_test_base {
    ...
    public function test_question_can_delete_cat_capability(): void {
        ...
        // This call should not throw an exception as admin user has the capabilities agpu/question:managecategory.
    ...
    public function test_question_category_select_menu(): void {
        ...
        ob_start();
        helper::question_category_select_menu($contexts->having_cap('agpu/question:add'));
        $output = ob_get_clean();
    ...
    public function test_question_category_options(): void {
        ...
        $categorycontexts = helper::question_category_options($contexts->having_cap('agpu/question:add'));
        ...
        $newcategorycontexts = helper::question_category_options($contexts->having_cap('agpu/question:add'), true);
