...
class question_text_format implements \renderable, \templatable {
    ...
    /**
     * @var \agpu_url The return URL for redirecting back to the current question bank page.
     */
    ...
    public function __construct(view $qbank) {
        ...
        $this->returnurl = new \agpu_url($qbank->returnurl);
        $this->preference = question_get_display_preference($row->get_preference_key(), 0, PARAM_INT, new \agpu_url(''));
    }

    public function export_for_template(renderer_base $output): array {
        return [
            'formaction' => new \agpu_url('/question/bank/viewquestiontext/save.php'),
            'sesskey' => sesskey(),
