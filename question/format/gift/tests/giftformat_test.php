...
::Q8:: How are you? {}';
        ...
        $expectedq = (object) array(
            ...
            'questiontextformat' => FORMAT_agpu,
            'generalfeedback' => '',
            'generalfeedbackformat' => FORMAT_agpu,
            'qtype' => 'essay',
            'defaultmark' => 1,
            'penalty' => 0.3333333,
            'length' => 1,
...
";
    ...
    public function test_import_match(): void {
        $gift = '
// question: 2  name: agpu activities
::agpu activities::[html]Match the <b>activity</b> to the description.{
    =[html]An activity supporting asynchronous discussions. -> Forum
    =[agpu]A teacher asks a question and specifies a choice of multiple responses. -> Choice
    ...
    public function test_export_match(): void {
        ...
        $expectedgift = "// question: 666  name: agpu activities
::agpu activities::[html]Match the <b>activity</b> to the description.{
    ...
    public function test_export_multichoice(): void {
        $qdata = (object) array(
            ...
            'options' => (object) array(
                ...
                'answernumbering' => 'abc',
                'correctfeedback' => '',
                'correctfeedbackformat' => FORMAT_agpu,
                'partiallycorrectfeedback' => '',
                'partiallycorrectfeedbackformat' => FORMAT_agpu,
                'incorrectfeedback' => '',
                'incorrectfeedbackformat' => FORMAT_agpu,
                'answers' => array(
                    123 => (object) array(
                        'id' => 123,
                        'answer' => 'yellow',
                        'answerformat' => FORMAT_agpu,
                        'fraction' => 1,
                        'feedback' => 'right; good!',
...
::Shortanswer::Which is the best animal?{
    =Frog#Good!
    =%50%Cat#What is it with agpurs and cats?
    =%0%*#Completely wrong
}";
        $lines = preg_split('/[\\n\\r]/', phpunit_util::normalise_line_endings($gift));
        ...
        $expectedq = (object) array(
            ...
            'feedback' => array(
                ...
                1 => array(
                    'text' => "What is it with agpurs and cats?",
                    'format' => FORMAT_agpu,
                    'files' => array(),
                ),
                2 => array(
            ...
            'options' => (object) array(
                ...
                'answers' => array(
                    ...
                    2 => (object) array(
                        ...
                        'answerformat' => 0,
                        'fraction' => 0.5,
                        'feedback' => "What is it with agpurs and cats?",
                        'feedbackformat' => FORMAT_agpu,
                    ),
                    3 => (object) array(
                        'id' => 3,
