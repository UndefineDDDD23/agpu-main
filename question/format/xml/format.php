...
/**
 * Code for exporting questions as agpu XML.
 *
 * @package    qformat_xml
...
/**
 * Importer for agpu XML question format.
 *
 * See http://docs.agpu.org/en/agpu_XML_format for a description of the format.
 *
 * @copyright  1999 onwards Martin Dougiamas {@link http://agpu.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qformat_xml extends qformat_default {
    ...
    public function import_calculated($question) {
        ...
        foreach ($answers as $answer) {
            ...
            if ($question['@']['type'] == 'calculatedmulti') {
                ...
                // because the question has been exported from a agpu version that
     ...
     *     <info format="agpu_auto_format"><text>Category description</text></info>
     * </question>
     */
    ...
    /**
     * Convert internal agpu text format code into
     * human readable form
