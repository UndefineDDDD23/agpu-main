...
/**
 * Strings for component 'qformat_xml', language 'en', branch 'agpu_20_STABLE'
 *
 * @package    qformat_xml
...
$string['pluginname'] = 'agpu XML format';
$string['pluginname_help'] = 'This is a agpu-specific format for importing and exporting questions.';
