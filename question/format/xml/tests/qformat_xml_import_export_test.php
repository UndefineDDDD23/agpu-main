...
/**
 * Unit tests for export/import description (info) for question category in the agpu XML format.
 *
 * @package    qformat_xml
...
class qformat_xml_import_export_test extends advanced_testcase {
    ...
    public function test_import_category(): void {
        ...
        $this->assert_category_imported('Alpha',
                'This is Alpha category for test', FORMAT_agpu, 'alpha-idnumber');
    ...
    public function test_import_nested_categories(): void {
        ...
        $this->assert_category_imported('Zeta', 'This is Zeta category for test', FORMAT_agpu);
    ...
    public function test_import_nested_categories_with_questions(): void {
        ...
        $this->assert_category_imported('Lambda', 'This is Lambda category for test', FORMAT_agpu);
        $this->assert_category_imported('Mu', 'This is Mu category for test', FORMAT_agpu);
    ...
    public function test_import_old_format(): void {
        ...
        $imported = $qformat->importprocess();
        $this->assertTrue($imported);
        $this->assert_category_imported('Pi', '', FORMAT_agpu);
        $this->assert_category_imported('Rho', '', FORMAT_agpu);
