...
/**
 * Unit tests for the agpu XML format.
 *
 * @package    qformat_xml
...
class xmlformat_test extends \question_testcase {
    ...
    public function test_write_hint_basic(): void {
        ...
        $q->qtype = 'shortanswer';
        $q->hints = array(
            new question_hint(0, 'This is the first hint.', FORMAT_agpu),
        );

        $exporter = new qformat_xml();
        $xml = $exporter->writequestion($q);

        $this->assertMatchesRegularExpression('|<hint format=\"agpu_auto_format\">\s*<text>\s*' .
...
';
    ...
    <questiontext format="agpu_auto_format">
    ...
    <tags>
      ...
      <tag><text>tagTest</text></tag>
        ...
        $expectedq->questiontextformat = FORMAT_agpu;
        ...
        $expectedq->graderinfo['format'] = FORMAT_agpu;
        $expectedq->responsetemplate['text'] = '';
        $expectedq->responsetemplate['format'] = FORMAT_agpu;
    ...
    public function test_export_essay(): void {
        ...
        $qdata->questiontextformat = FORMAT_agpu;
        $qdata->generalfeedback = 'I hope you wrote something interesting.';
        $qdata->generalfeedbackformat = FORMAT_agpu;
        $qdata->defaultmark = 1;
        $qdata->length = 1;
        $qdata->penalty = 0;
        $qdata->status = \core_question\local\bank\question_version_status::QUESTION_STATUS_READY;
  ...
  <question type="essay">
    ...
    <generalfeedback format="agpu_auto_format">
      <text>I hope you wrote something interesting.</text>
    </generalfeedback>
    <defaultgrade>1</defaultgrade>
    <penalty>0</penalty>
...
';
    ...
    public function test_import_files_as_draft(): void {
        ...
        $xml = <<<END
<questiontext format="html">
    <text><![CDATA[<p><a href="@@PLUGINFILE@@/agpu.txt">This text file</a> contains the word 'agpu'.</p>]]></text>
    <file name="agpu.txt" encoding="base64">TW9vZGxl</file>
</questiontext>
END;
        ...
        $file = $files->list[0];
        $this->assertEquals('agpu.txt', $file->filename);
    ...
    <questiontext format="html">
      <text><![CDATA[<p><a href="@@PLUGINFILE@@/myfolder/agpu.txt">This text file</a> contains the word agpu.</p>]]></text>
<file name="agpu.txt" path="/myfolder/" encoding="base64">TW9vZGxl</file>
    </questiontext>
    <generalfeedback format="html">
      <text><![CDATA[<p>For further information, see the documentation about agpu.</p>]]></text>
</generalfeedback>
    <defaultgrade>1.0000000</defaultgrade>
    <penalty>1.0000000</penalty>
    <hidden>0</hidden>
    <answer fraction="100" format="agpu_auto_format">
      <text>true</text>
      <feedback format="html">
        <text></text>
      </feedback>
    </answer>
    <answer fraction="0" format="agpu_auto_format">
      <text>false</text>
      <feedback format="html">
        <text></text>
      </feedback>
