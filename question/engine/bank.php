...
/**
 * More object oriented wrappers around parts of the agpu question bank.
 *
...
abstract class question_bank {
     ...
     * @return bool whether that question type is installed in this agpu.
     */
    ...
    public static function get_all_qtypes() {
        ...
        foreach (core_component::get_plugin_list('qtype') as $plugin => $notused) {
            try {
                ...
                // question types do not cause the rest of agpu to break.
            }
        }
        return $qtypes;
    }
...
class question_finder implements data_source_interface {
     ...
     * @todo Final deprecation on agpu 4.7 MDL-78091
     */
