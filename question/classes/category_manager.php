...
class category_manager {
    ...
    public function add_category(
        ...
        if (!$this->idnumber_is_unique_in_context($idnumber, $contextid)) {
            throw new agpu_exception('idnumbertaken', 'error');
        }
