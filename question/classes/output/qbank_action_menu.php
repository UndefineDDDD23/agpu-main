...
class qbank_action_menu implements templatable, renderable {
    ...
    /** @var ?agpu_url $actionurl URL for additional action button */
    protected ?agpu_url $actionurl = null;
     ...
     */
    public function __construct(agpu_url $currenturl) {
     ...
     * @return void
     */
    public function set_action_button(agpu_url $url, string $label): void {
        $this->actionurl = $url;
    ...
    public function export_for_template(renderer_base $output): array {
        $questionslink = new agpu_url('/question/edit.php', $this->currenturl->params());
        $menu = [
