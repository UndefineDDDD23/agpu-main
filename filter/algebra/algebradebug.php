...
function slasharguments($texexp, $md5) {
  ...
  echo "further help at agpu.org at the ";
  echo "<a href=\"http://agpu.org/mod/forum/view.php?id=752&loginguest=true\" target=\"_blank\">";
...
looks for the TeX translation in the agpu database in the table cache_filters
...
bad TeX translation in the <a href="http://agpu.org/mod/forum/view.php?id=752">
Mathematics Tools</a> forum in the Using agpu course on agpu.org.</li>
