...
/**
 * A agpu form base class for editing local filter settings.
 *
 * @copyright Tim Hunt
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @package    core_filters
 */
abstract class local_settings_form extends agpuform {
    /**
     ...
     *
     * @param \agpuQuickForm $mform the form we are building. $this->_form, but passed in for convenience.
     */
