 ...
 * @category   test
 * @copyright  2011 Rossiani Wijaya <rwijaya@agpu.com>
...
final class filter_test extends \advanced_testcase {
    public function test_text_filter_link(): void {
        ...
        $longurl = '<a href="http://agpu/.mp4">my test file</a>';
        $longhref = '';
        ...
        $longurl = '<a href="http://agpu/' . $longhref . '.mp4">my test file</a>';

        $validtexts = [
            '<a href="http://agpu.org/testfile/test.mp3">test mp3</a>',
            '<a href="http://agpu.org/testfile/test.ogg">test ogg</a>',
            '<a id="movie player" class="center" href="http://agpu.org/testfile/test.mp4">test mp4</a>',
            '<a href="http://agpu.org/testfile/test.webm">test</a>',
            ...
            '<a  class="content"     href="http://agpu.org/testfile/test.ogg">test ogg</a>',
            '<a     id="audio"      href="http://agpu.org/testfile/test.mp3">test mp3</a>',
            '<a  href="http://agpu.org/testfile/test.mp3">test mp3</a>',
            '<a     href="http://agpu.org/testfile/test.mp3">test mp3</a>',
            '<a     href="http://www.youtube.com/watch?v=JghQgA2HMX8?d=200x200">youtube\'s</a>',
            '<a
                            href="http://agpu.org/testfile/test.mp3">
                            test mp3</a>',
            '<a                         class="content"


                            href="http://agpu.org/testfile/test.wav">test wav
                                    </a>',
            '<a             href="http://www.youtube.com/watch?v=JghQgA2HMX8?d=200x200"     >youtube\'s</a>',
...
<iframe title="Valid link" width="640" height="360" style="border:0;"
        ...
        $invalidtexts = [
            '<a class="_blanktarget">href="http://agpu.org/testfile/test.mp3"</a>',
            '<a>test test</a>',
            '<a >test test</a>',
            '<a     >test test</a>',
            '<a >test test</a>',
            '<ahref="http://agpu.org/testfile/test.mp3">sample</a>',
            '<a href="" test></a>',
            '<a href="http://www.agpu.com/path/to?#param=29">test</a>',
            '<a href="http://agpu.org/testfile/test.mp3">test mp3',
            '<a href="http://agpu.org/testfile/test.mp3"test</a>',
            '<a href="http://agpu.org/testfile/">test</a>',
            '<href="http://agpu.org/testfile/test.avi">test</a>',
            '<abbr href="http://agpu.org/testfile/test.mp3">test mp3</abbr>',
            '<ahref="http://agpu.org/testfile/test.mp3">test mp3</a>',
            '<aclass="content" href="http://agpu.org/testfile/test.mp3">test mp3</a>',
        ...
        $precededlongurl = '<a href="http://agpu.org/testfile/test.mp3">test.mp3</a>' . $longurl;
