...
/**
 * Strings for component 'filter_tex', language 'en', branch 'agpu_20_STABLE'
 *
 * @package    filter
 * @subpackage tex
...
$string['pathmimetexdesc'] = 'agpu will use its own mimetex binary unless another valid path is specified.';
