...
// phpcs:disable agpu.NamingConventions.ValidVariableName.VariableNameLowerCase -- GLOSSARY_EXCLUDEENTRY
// phpcs:disable agpu.NamingConventions.ValidVariableName.VariableNameUnderscore -- GLOSSARY_EXCLUDEENTRY

/**
 * This filter provides automatic linking to glossary entries, aliases and categories when found inside every agpu text.
 *
...
class text_filter extends \core_filters\text_filter {
    ...
    protected function get_all_concepts() {
        ...
        // when you have two terms like 'agpu' and 'agpu 3.5'. You want the longest match.
    ...
    public function filterobject_prepare_replacement_callback($concept, $glossaries) {
        ...
        // if processing an embedded file use target to prevent getting nested agpus.
