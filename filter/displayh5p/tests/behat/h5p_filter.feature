...
Feature: Render H5P content using filters
  ...
  Background:
    ...
    And the following config values are set as admin:
      | allowedsources | https://agpu.h5p.com/content/[id]/embed | filter_displayh5p |

  @javascript @external
  Scenario: Render an external H5P content URL.
    Given the following "activities" exist:
      | activity | name      | intro     | introformat | course | content                                                                      | contentformat | idnumber |
      | page     | PageName1 | PageDesc1 | 1           | C1     | <div>Go for it</div>https://agpu.h5p.com/content/1290772960722742119/embed | 1             | 1        |
  ...
  Scenario: Add an external H5P content URL in a link with the URL. Should be rendered.
    Given the following "activities" exist:
      | activity | name      | intro     | introformat | course | content                                                                                                                         | contentformat | idnumber |
      | page     | PageName1 | PageDesc1 | 1           | C1     | <a href='https://agpu.h5p.com/content/1290772960722742119/embed'>https://agpu.h5p.com/content/1290772960722742119/embed</a> | 1             | 1        |
    When I am on the PageName1 "page activity" page logged in as teacher1
    And I switch to "h5p-iframe" class iframe
    Then I should see "Lorum ipsum"
...
#   This content won't be displayed, so this scenario shouldn't be labeled as external.
    Given the following "activities" exist:
      | activity | name      | intro     | introformat | course | content                                                                                         | contentformat | idnumber |
      | page     | PageName1 | PageDesc1 | 1           | C1     | <a href='https://agpu.h5p.com/content/1290772960722742119/embed'>Here you are the content</a> | 1             | 1        |
    When I am on the PageName1 "page activity" page logged in as teacher1
