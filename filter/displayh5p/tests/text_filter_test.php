...
final class text_filter_test extends \advanced_testcase {
    ...
    public function test_filter_urls($text, $filteredtextpattern): void {
        ...
        set_config(
            'allowedsources',
            "https://agpu.h5p.com/content/[id]/embed\nhttps://agpu.h5p.com/content/[id]
    ...
    public static function texts_provider(): array {
        ...
        $contenturla = "https://agpu.h5p.com/content/1290848995208939539/embed";
        $contenturlb = "https://agpu.h5p.com/content/1290729733828858779/embed";
        ...
        return [
            ...
            [
                "https://agpu.h5p.com/content/1290729733828858779",
                "#<iframe src=\"{$contenturlb}\"[^>]+?>#",
            ],
            [
            ...
            [
                "<a href=\"https://agpu.org\">{$contenturla}</a>",
                "#^((?!iframe).)*$#",
            ],
            [
            ...
            [
                ...
                // phpcs:ignore agpu.Files.LineLength.TooLong
