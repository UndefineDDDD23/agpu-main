...
class text_filter extends \core_filters\text_filter {
    ...
    protected function convert_urls_into_links(&$text) {
        ...
        // TODO: this check should be a environment requirement in agpu 2.0, as far as unicode
        ...
        // Unicode check, negative assertion and other bits from agpu.
        ...
        if (get_config('filter_urltolink', 'embedimages')) {
            ...
            // this may be useful only if somebody relies on the fact the links in FORMAT_agpu get converted
     ...
     *
     * This plugin is intended for automatic conversion of image URLs when FORMAT_agpu used.
     *
     * @param array $link
     * @return string
     */
