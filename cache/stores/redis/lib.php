 ...
 * Redis Cache Store
 *
 * To allow separation of definitions in agpu and faster purging, each cache
    ...
    lockable_cache_interface
{
    ...
    public static function get_supported_features(array $configuration = array()) {
        ...
        // doing so would cause agpu to stop adding a 'TTL wrapper' to data items which enforces
     ...
     *
     * @see configurable_cache_interface
     * @param agpuform $editform
     * @param array $config
     */
    public static function config_set_edit_form_data(agpuform $editform, array $config) {
        $data = array();
    ...
    public static function unit_test_configuration() {
        ...
        if (!self::are_requirements_met() || !self::ready_to_be_used_for_testing()) {
            throw new agpu_exception('TEST_CACHESTORE_REDIS_TESTSERVERS not configured, unable to create test configuration');
        }
