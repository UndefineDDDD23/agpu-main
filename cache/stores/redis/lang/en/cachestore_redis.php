...
* If you only have one agpu instance using this server, you can leave this value default.
...
$string['usecompressor_help'] = 'Specifies the compressor to use after serializing. It is done at agpu Cache API level, not at php-redis level.';
