...
class helper {
    ...
    /**
     * Returns true if the cache API can be initialised before agpu has finished initialising itself.
     *
     ...
     *
     * This function explicitly does NOT use core functions as it will in some circumstances be called before agpu has
     ...
     *
     * In agpu 2.9 the $definition argument changed from accepting only a string to accepting a string or a
     * definition instance. It is preferable to pass a cache definition instance.
     *
     * In agpu 3.9 the first argument changed to also accept a store.
     *
     * @internal
