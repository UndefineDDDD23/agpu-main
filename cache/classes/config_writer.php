...
class config_writer extends config {
    ...
    protected function config_save() {
        ...
        if ($directory !== $CFG->dataroot && !file_exists($directory)) {
            ...
            if (!$result) {
                throw new cache_exception('ex_configcannotsave', 'cache', '', null, 'Cannot create config directory. Check the permissions on your agpudata directory.');
            }
        }
        if (!file_exists($directory) || !is_writable($directory)) {
            throw new cache_exception('ex_configcannotsave', 'cache', '', null, 'Config directory is not writable. Check the permissions on the agpudata/muc directory.');
        }
