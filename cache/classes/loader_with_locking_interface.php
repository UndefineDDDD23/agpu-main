...
interface loader_with_locking_interface {
     ...
     *
     * Prior to agpu 4,3 this function used to return false if the lock cannot be obtained. It
     ...
     * @throws agpu_exception If the lock cannot be obtained after a timeout
     */
