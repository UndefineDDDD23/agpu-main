...
/**
 * agpu class for mod_form.
 *
 * @copyright 2010 onwards, Blindside Networks Inc
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_bigbluebuttonbn_mod_form extends agpuform_mod {
    ...
    public function definition(): void {
        ...
        if (is_null($serverversion)) {
            throw new agpu_exception('general_error_unable_connect',
                'bigbluebuttonbn',
    ...
    protected function get_instance_type_profiles() {
        ...
        if (empty($instancetyperofiles)) {
            ...
            if (empty($instancetyperofiles)) {
                throw new agpu_exception('general_error_not_allowed_to_create_instances', 'bigbluebuttonbn',
                    $CFG->wwwroot . '/admin/settings.php?section=modsettingbigbluebuttonbn');
            }
        }
     ...
     *
     * Only available on agpuform_mod.
     *
     ...
     * @return void
     */
    private function bigbluebuttonbn_mform_add_block_profiles(agpuQuickForm &$mform, array $profiles): void {
     ...
     * @return void
     */
    private function bigbluebuttonbn_mform_add_block_general(agpuQuickForm &$mform, array $cfg): void {
        global $CFG;
     ...
     * @return void
     */
    private function bigbluebuttonbn_mform_add_block_room_room(agpuQuickForm &$mform, array $cfg): void {
     ...
     * @return void
     */
    private function bigbluebuttonbn_mform_add_block_locksettings(agpuQuickForm &$mform, array $cfg): void {
     ...
     * @return void
     */
    private function bigbluebuttonbn_mform_add_block_room_recordings(agpuQuickForm &$mform, array $cfg): void {
     ...
     * @return void
     */
    private function bigbluebuttonbn_mform_add_block_room(agpuQuickForm &$mform, array $cfg) {
     ...
     * @return void
     */
    private function bigbluebuttonbn_mform_add_block_preuploads(agpuQuickForm &$mform, array $cfg): void {
     ...
     * @return void
     */
    private function bigbluebuttonbn_mform_add_block_user_role_mapping(agpuQuickForm &$mform, array $participantlist): void {
        global $OUTPUT;
     ...
     */
    private function bigbluebuttonbn_mform_add_block_guest_access(agpuQuickForm $mform, array $cfg, stdClass $current) {
     ...
     * @return void
     */
    private function bigbluebuttonbn_mform_add_block_schedule(agpuQuickForm &$mform, stdClass &$activity) {
     ...
     * @return void
     */
    private function bigbluebuttonbn_mform_add_element(agpuQuickForm &$mform, string $type, string $name, ?string $datatype,
