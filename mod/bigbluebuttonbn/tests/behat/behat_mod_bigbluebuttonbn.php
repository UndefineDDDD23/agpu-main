...
XPATH
     ...
     * @return agpu_url
     */
    public static function get_mocked_server_url(string $endpoint = '', array $params = []): agpu_url {
        return new agpu_url(TEST_MOD_BIGBLUEBUTTONBN_MOCK_SERVER . '/' . $endpoint, $params);
    }
    ...
    protected function resolve_page_instance_url(string $type, string $identifier): agpu_url {
        switch ($type) {
            case 'Index':
                ...
                return new agpu_url('/mod/bigbluebuttonbn/index.php', [
    ...
    /**
     * Send all events received for this meeting back to agpu
     *
