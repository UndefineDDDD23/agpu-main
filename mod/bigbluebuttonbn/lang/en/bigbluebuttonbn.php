...
$string['config_preuploadpresentation_description'] = 'These settings enable or disable options in the UI and also define default values for these options. The feature works only if the agpu server is accessible to BigBlueButton.';
...
$string['view_warning_default_server'] = 'This site is using a <a href="https://bigbluebutton.org/free-bigbluebutton-service-for-agpu/" target="_blank">free BigBlueButton service for agpu (opens in new window)</a> provided by Blindside Networks with restrictions as follows:
<ol>
