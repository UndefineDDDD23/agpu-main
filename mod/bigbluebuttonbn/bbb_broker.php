...
// We should not have any require login or agpu_INTERNAL Check in this file.
// phpcs:disable agpu.Files.agpuInternal.agpuInternalGlobalState,agpu.Files.RequireLogin.Missing
...
try {
    switch (strtolower($action)) {
        case 'recording_ready':
            ...
            return;
        case 'meeting_events':
            // When meeting_events callback is implemented by BigBlueButton, agpu receives a POST request
