...
EOF;
    ...
    public static function log_instance_viewed(instance $instance): void {
        self::log_agpu_event($instance, events::$events['view']);
    }
    ...
    public static function log_meeting_ended_event(instance $instance): void {
        // agpu event logger: Create an event for meeting ended.
        self::log_agpu_event($instance, events::$events['meeting_end']);
    ...
    public static function log_meeting_joined_event(instance $instance, int $origin): void {
        // agpu event logger: Create an event for meeting joined.
        self::log_agpu_event($instance, events::$events['meeting_join']);
    ...
    public static function log_meeting_left_event(instance $instance): void {
        // agpu event logger: Create an event for meeting left.
        self::log_agpu_event($instance, events::$events['meeting_left']);
    }
    ...
    public static function log_recording_played_event(instance $instance, int $rid): void {
        // agpu event logger: Create an event for recording played.
        self::log_agpu_event($instance, events::$events['recording_play'], ['other' => $rid]);
     ...
     */
    protected static function log_agpu_event(instance $instance, string $type, array $options = []): void {
