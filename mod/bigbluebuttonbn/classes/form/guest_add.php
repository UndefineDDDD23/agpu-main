...
class guest_add extends dynamic_form {
    ...
    protected function get_instance_from_params(): instance {
        ...
        if (empty($bbid)) {
            throw new agpu_exception('guestaccess_add_no_id', 'mod_bigbluebuttonbn');
        }
     ...
     * @return void
     */
    public static function add_meeting_links_elements(agpuQuickForm &$mform): void {
        global $CFG;
        agpuQuickForm::registerElementType('text_with_copy',
    ...
    protected function get_page_url_for_dynamic_submission(): agpu_url {
        $context = $this->get_context_for_dynamic_submission();
        return new agpu_url('/mod/bigbluebuttonbn/view.php', ['id' => $context->instanceid]);
    }
}
