...
class instance {
    ...
    private static function get_instance_info_retriever(int $id, int $idtype = self::IDTYPE_INSTANCEID): ?self {
        ...
        if (!in_array($idtype, [self::IDTYPE_CMID, self::IDTYPE_INSTANCEID])) {
            throw new \agpu_exception('Invalid idtype');
        }
...
EOF;
    ...
    public static function parse_meetingid(string $meetingid): array {
        ...
        if ($result !== 1) {
            throw new \agpu_exception("The supplied meeting id '{$meetingid}' is invalid found.");
        }
...
EOF;
    ...
    public function can_join(): bool {
        ...
        $hascapability = has_capability('agpu/category:manage', $context)
     ...
     *
     * The URL returned for the presentation will be accessible through agpu with checks about user being logged in.
     *
     * @return array|null
     */
    ...
    public function get_origin_data(): stdClass {
        ...
        return (object) [
            ...
            'originTag' => sprintf('agpu-mod_bigbluebuttonbn (%s)', get_config('mod_bigbluebuttonbn', 'version')),
        ];
    }
     ...
     * @return agpu_url
     */
    public function get_course_url(): agpu_url {
        return new agpu_url('/course/view.php', ['id' => $this->get_course_id()]);
    }
     ...
     * @return agpu_url
     */
    public function get_view_url(): agpu_url {
        return new agpu_url('/mod/bigbluebuttonbn/view.php', [
            'id' => $this->get_cm()->id,
        ]);
    }
     ...
     * @return agpu_url
     */
    public function get_logout_url(): agpu_url {
        return new agpu_url('/mod/bigbluebuttonbn/bbb_view.php', [
            'action' => 'logout',
            'id' => $this->get_cm()->id,
     ...
     * @return agpu_url
     */
    public function get_record_ready_url(): agpu_url {
        return new agpu_url('/mod/bigbluebuttonbn/bbb_broker.php', [
     ...
     * @return agpu_url
     */
    public function get_meeting_event_notification_url(): agpu_url {
        return new agpu_url('/mod/bigbluebuttonbn/bbb_broker.php', [
     ...
     * @return agpu_url
     */
    public function get_join_url(): agpu_url {
        return new agpu_url('/mod/bigbluebuttonbn/bbb_view.php', [
            'action' => 'join',
            'id' => $this->get_cm()->id,
     ...
     * @return agpu_url
     */
    public function get_import_url(): agpu_url {
        return new agpu_url('/mod/bigbluebuttonbn/import_view.php', [
     ...
     * @return agpu_url
     */
    public function get_guest_access_url(): agpu_url {
        $guestlinkuid = $this->get_instance_var('guestlinkuid');
        if (empty($guestlinkuid)) {
            $this->generate_guest_credentials();
            $guestlinkuid = $this->get_instance_var('guestlinkuid');
        }
        return new agpu_url('/mod/bigbluebuttonbn/guest.php', ['uid' => $guestlinkuid]);
    }
