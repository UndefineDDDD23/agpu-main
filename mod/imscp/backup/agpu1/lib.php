...
/**
 * imscp conversion handler. This resource handler is called by agpu1_mod_resource_handler
 *
 * @copyright  2011 Andrew Davis <andrew@agpu.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class agpu1_mod_imscp_handler extends agpu1_resource_successor_handler {

    /** @var agpu1_file_manager the file manager instance */
    ...
    public function process_legacy_resource(array $data, ?array $raw = null) {
        ...
        $imscp['intro'] = agpu1_converter::migrate_referenced_files($imscp['intro'], $this->fileman);
