...
$accessallgroups = ($lessongroupmode == NOGROUPS) || has_capability('agpu/site:accessallgroups', $context);
...
$url = new agpu_url('/mod/lesson/overrides.php', array('cmid' => $cm->id, 'mode' => $mode));
...
navigation_node::override_active_url(new agpu_url('/mod/lesson/overrides.php', ['cmid' => $cmid]));
...
$userurl = new agpu_url('/user/view.php', array());
$groupurl = new agpu_url('/group/overview.php', array('id' => $cm->course));

$overridedeleteurl = new agpu_url('/mod/lesson/overridedelete.php');
$overrideediturl = new agpu_url('/mod/lesson/overrideedit.php');
