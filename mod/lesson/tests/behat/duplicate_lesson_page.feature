...
Feature: In a lesson activity, a teacher can duplicate a lesson page
  ...
  Background:
    ...
    And the following "user private files" exist:
      | user     | filepath                                  |
      | teacher1 | mod/lesson/tests/fixtures/agpu_logo.jpg |
  ...
  Scenario: Duplicate content page with an image.
    ...
    And I click on "agpu_logo.jpg" "link"
    ...
    Then "//*[contains(@data-id, 'id_contents_editor')]//img[contains(@src, 'agpu_logo.jpg')]" "xpath_element" should exist
  ...
  Scenario: Duplicate question page with image in answer.
    ...
    Then "//*[contains(@data-id, 'id_answer_editor_0')]//img[contains(@src, 'agpu_logo.jpg')]" "xpath_element" should exist
  ...
  Scenario: Duplicate question page with image in feedback.
    ...
    Then "//*[contains(@data-id, 'id_response_editor_0')]//img[contains(@src, 'agpu_logo.jpg')]" "xpath_element" should exist
