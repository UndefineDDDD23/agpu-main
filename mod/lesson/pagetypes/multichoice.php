    ...
    public function check_answer() {
        ...
        if ($this->properties->qoption) {
            ...
            if (!$answer = $DB->get_record("lesson_answers", array("id" => $result->answerid))) {
                throw new \agpu_exception("Continue: answer record not found");
            }
...
class lesson_display_answer_form_multichoice_singleanswer extends agpuform {
...
class lesson_display_answer_form_multichoice_multianswer extends agpuform {
