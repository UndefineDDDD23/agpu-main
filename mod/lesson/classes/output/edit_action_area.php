...
class edit_action_area implements templatable, renderable {
     ...
     */
    public function __construct(int $cmid, agpu_url $currenturl) {
        $this->cmid = $cmid;
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        $viewurl = new agpu_url('/mod/lesson/edit.php', ['id' => $this->cmid, 'mode' => 'collapsed']);
        $fullviewurl = new agpu_url('/mod/lesson/edit.php', ['id' => $this->cmid, 'mode' => 'full']);
        $menu = [
        ...
        return [
            'back' => [
                ...
                'link' => (new agpu_url('/mod/lesson/view.php', ['id' => $this->cmid]))->out(false)
            ],
