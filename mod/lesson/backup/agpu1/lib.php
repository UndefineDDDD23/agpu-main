 ...
 */
class agpu1_mod_lesson_handler extends agpu1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /agpu_BACKUP/COURSE/MODULES/MOD/LESSON does not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'lesson', '/agpu_BACKUP/COURSE/MODULES/MOD/LESSON',
                array(
                    'renamefields' => array(
            ...
            new convert_path(
                'lesson_page', '/agpu_BACKUP/COURSE/MODULES/MOD/LESSON/PAGES/PAGE',
                array(
                    'newfields' => array(
                        'contentsformat' => FORMAT_agpu,
            ...
            new convert_path(
                'lesson_pages', '/agpu_BACKUP/COURSE/MODULES/MOD/LESSON/PAGES'
            ),
            new convert_path(
                'lesson_answer', '/agpu_BACKUP/COURSE/MODULES/MOD/LESSON/PAGES/PAGE/ANSWERS/ANSWER',
                array(
                    'newfields' => array(
                        'answerformat' => 0,
                        'responseformat' => 0,
    ...
    /**
     * This is executed every time we have one /agpu_BACKUP/COURSE/MODULES/MOD/LESSON
     * data available
     */
    ...
    /**
     * This is executed every time we have one /agpu_BACKUP/COURSE/MODULES/MOD/LESSON/PAGES/PAGE
     * data available
     */
    ...
    /**
     * This is executed every time we have one /agpu_BACKUP/COURSE/MODULES/MOD/LESSON/PAGES/PAGE/ANSWERS/ANSWER
     * data available
     */
