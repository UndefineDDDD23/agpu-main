...
$url = new agpu_url('/mod/lesson/report.php', array('id'=>$id));
...
if ($action === 'delete') {
    ...
    redirect(new agpu_url($PAGE->url, array('action'=>'reportoverview')));
    ...
    **************************************************************************/
    ...
    if (has_capability('gradereport/grader:view', $course_context) && has_capability('agpu/grade:viewall', $course_context)) {
        $seeallgradeslink = new agpu_url('/grade/report/grader/index.php', array('id'=>$course->id));
    ...
    if (has_capability('mod/lesson:edit', $context)) {
        $reporturl = new agpu_url('/mod/lesson/report.php');
