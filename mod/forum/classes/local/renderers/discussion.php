...
class discussion {
    ...
    /** @var agpu_page $page The page this discussion is being rendered for */
    private $page;
    ...
    /** @var agpu_url $baseurl The base URL for the discussion */
    private $baseurl;
     ...
     * @param agpu_page $page The page this discussion is being rendered for
     ...
     * @param agpu_url $baseurl The base URL for the discussion
