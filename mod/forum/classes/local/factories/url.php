...
class url {
     ...
     * @return agpu_url
     */
    public function get_course_url_from_courseid(int $courseid): agpu_url {
        return new agpu_url('/course/view.php', [
            'id' => $courseid,
        ]);
    }
     ...
     * @return agpu_url
     */
    public function get_course_url_from_forum(forum_entity $forum): agpu_url {
     ...
     * @return agpu_url
     */
    public function get_discussion_create_url(forum_entity $forum): agpu_url {
        return new agpu_url('/mod/forum/post.php', [
            'forum' => $forum->get_id(),
        ]);
    }
    ...
    public function get_forum_view_url_from_course_module_id(int $coursemoduleid, ?int $pageno = null,
        ...
        $url = new agpu_url('/mod/forum/view.php', [
            'id' => $coursemoduleid,
        ]);
     ...
     * @return agpu_url
     */
    public function get_discussion_view_url_from_discussion_id(int $discussionid): agpu_url {
        return new agpu_url('/mod/forum/discuss.php', [
            'd' => $discussionid
        ]);
    }
     ...
     * @return agpu_url
     */
    public function get_discussion_view_url_from_discussion(discussion_entity $discussion): agpu_url {
    ...
    public function get_discussion_view_latest_post_url_from_discussion(discussion_entity $discussion, ?int $latestpost) {
        ...
        if (null === $latestpost) {
            ...
            return new agpu_url($viewurl, ['parent' => $latestpost]);
        }
    }
     ...
     * @return agpu_url
     */
    public function get_discussion_view_url_from_post(post_entity $post): agpu_url {
     ...
     * @return agpu_url
     */
    public function get_view_post_url_from_post_id(int $discussionid, int $postid): agpu_url {
     ...
     * @return agpu_url
     */
    public function get_view_post_url_from_post(post_entity $post): agpu_url {
     ...
     * @return agpu_url
     */
    public function get_view_isolated_post_url_from_post_id(int $discussionid, int $postid): agpu_url {
        $url = $this->get_discussion_view_url_from_discussion_id($discussionid);
     ...
     * @return agpu_url
     */
    public function get_view_isolated_post_url_from_post(post_entity $post): agpu_url {
     ...
     * @return agpu_url
     */
    public function get_edit_post_url_from_post(forum_entity $forum, post_entity $post): agpu_url {
        if ($forum->get_type() == 'single' && !$post->has_parent()) {
            return new agpu_url('/course/modedit.php', [
     ...
     * @return agpu_url
     */
    public function get_split_discussion_at_post_url_from_post(post_entity $post): agpu_url {
        return new agpu_url('/mod/forum/post.php', [
            'prune' => $post->get_id()
        ]);
    }
     ...
     * @return agpu_url
     */
    public function get_delete_post_url_from_post(post_entity $post): agpu_url {
        return new agpu_url('/mod/forum/post.php', [
            'delete' => $post->get_id()
        ]);
    }
     ...
     * @return agpu_url
     */
    public function get_reply_to_post_url_from_post(post_entity $post): agpu_url {
        return new agpu_url('/mod/forum/post.php#mformforum', [
            'reply' => $post->get_id()
        ]);
    }
     ...
     * @return agpu_url
     */
    public function get_export_post_url_from_post(post_entity $post): ?agpu_url {
        global $CFG;
        ...
        $url = $button->to_html(PORTFOLIO_ADD_agpu_URL);
        return $url ?: null;
    }
     ...
     * @return agpu_url
     */
    public function get_mark_post_as_read_url_from_post(post_entity $post, int $displaymode = FORUM_MODE_THREADED): agpu_url {
        $params = [
        ...
        $url = new agpu_url('/mod/forum/discuss.php', $params);
     ...
     * @return agpu_url
     */
    public function get_mark_post_as_unread_url_from_post(post_entity $post, int $displaymode = FORUM_MODE_THREADED): agpu_url {
        $params = [
            'd' => $post->get_discussion_id(),
            'postid' => $post->get_id(),
            'mark' => 'unread'
     ...
     */
    public function get_export_attachment_url_from_post_and_attachment(post_entity $post, stored_file $attachment): ?agpu_url {
        global $CFG;
     ...
     * @return agpu_url
     */
    public function get_author_profile_url(author_entity $author, int $courseid): agpu_url {
        return new agpu_url('/user/view.php', [
            'id' => $author->get_id(),
            'course' => $courseid
        ]);
    }
     ...
     * @return agpu_url
     */
    public function get_author_group_url(\stdClass $group): agpu_url {
        return new agpu_url('/user/index.php', [
                'id' => $group->courseid,
                'group' => $group->id
        ]);
    }
    ...
    public function get_mark_discussion_as_read_url_from_discussion(
        ...
        return new agpu_url('/mod/forum/markposts.php', [
     ...
     * @return agpu_url
     */
    public function get_mark_all_discussions_as_read_url(forum_entity $forum): agpu_url {
        return new agpu_url('/mod/forum/markposts.php', [
            'f' => $forum->get_id(),
            'mark' => 'read',
            'sesskey' => sesskey(),
     ...
     * @return agpu_url
     */
    public function get_discussion_subscribe_url(discussion_entity $discussion): agpu_url {
        return new agpu_url('/mod/forum/subscribe.php', [
            'sesskey' => sesskey(),
     ...
     */
    public function get_pin_discussion_url_from_discussion(discussion_entity $discussion): agpu_url {
        return new agpu_url('discuss.php', [
            'sesskey' => sesskey(),
            'd' => $discussion->get_id(),
