 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_forum_post_form extends agpuform {
    ...
    function definition() {
        ...
        if ($inpagereply) {
            ...
            $manageactivities = has_capability('agpu/course:manageactivities', $coursecontext);
     ...
     */
    private function add_group_elements_if_applicable(agpuQuickForm $mform): void {
        global $CFG;
