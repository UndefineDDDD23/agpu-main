...
class forum_actionbar implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output): array {
        global $USER;
        $actionurl = (new agpu_url('/mod/forum/search.php'))->out(false);
