...
class subscription_actionbar implements renderable, templatable {
     ...
     * @param agpu_url $currenturl Current URL.
     * @param \stdClass $forum The forum object.
     * @param int $edit This argument decides to show view/manage subscribers view.
     */
    public function __construct(int $id, agpu_url $currenturl, \stdClass $forum, int $edit) {
        $this->id = $id;
    ...
    private function create_view_manage_menu(): ?url_select {
        ...
        $viewlink = new agpu_url('/mod/forum/subscribers.php', ['id' => $this->id, 'edit' => 'off']);
        $managelink = new agpu_url('/mod/forum/subscribers.php', ['id' => $this->id, 'edit' => 'on']);
