...
class forum_gradeitem_test extends \advanced_testcase {
     ...
     * @param bool $viewsuspendeduserscapability Whether the 'agpu/course:viewsuspendedusers' capability is allowed or not.
    ...
    public function test_should_grade_only_active_users(bool $showonlyactiveenrolconfig, bool $showonlyactiveenrolpreference,
        ...
        // Set the 'agpu/course:viewsuspendedusers' user capability.
        assign_capability('agpu/course:viewsuspendedusers', $viewsuspendeduserscapability ?
