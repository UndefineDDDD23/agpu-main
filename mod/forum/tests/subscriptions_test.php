...
class subscriptions_test extends \advanced_testcase {
    ...
    public function test_unsubscribable_forums(): void {
        ...
        // Add the agpu/course:viewhiddenactivities capability to the student user.
        $roleids = $DB->get_records_menu('role', null, '', 'shortname, id');
        $context = \context_course::instance($course->id);
        assign_capability('agpu/course:viewhiddenactivities', CAP_ALLOW, $roleids['student'], $context);
