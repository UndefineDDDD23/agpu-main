...
class mail_test extends \advanced_testcase {
    ...
    protected function helper_spoof_message_inbound_setup() {
        ...
        $CFG->messageinbound_mailbox = 'agpuagpu123';
    ...
    public function test_subscription_disabled_user_subscribed_forum(): void {
        ...
        assign_capability('agpu/course:manageactivities', CAP_ALLOW, $roleids['student'], \context_course::instance($course->id));
    ...
    public function test_forum_message_inbound_multiple_posts(): void {
        ...
        foreach ($messages as $message) {
            $this->assertMatchesRegularExpression('/Reply-To: agpuagpu123\+[^@]*@example.com/', $message->header);
        }
    }
    ...
    public function forum_post_email_templates_provider() {
        ...
        $base = array(
            'user' => array('firstname' => 'Love', 'lastname' => 'agpu', 'mailformat' => 0, 'maildigest' => 0),
            'course' => array('shortname' => '101', 'fullname' => 'agpu 101'),
            'forums' => array(
                array(
                    'name' => 'agpu Forum',
                    'forumposts' => array(
                        array(
                            'name' => 'Hello agpu',
                            'message' => 'Welcome to agpu',
                            'messageformat' => FORMAT_agpu,
                            'attachments' => array(
                                array(
                ...
                array(
                    ...
                    'contents' => array(
                        ...
                        'Attachment example.txt:' . '\r*\n' .
                            'https://www.example.com/agpu/pluginfile.php/\d*/mod_forum/attachment/\d*/example.txt' . '\r*\n',
                        'Hello agpu', 'agpu Forum', 'Welcome.*agpu', 'Love agpu', '1\d1'
                    ),
                ),
            ),
        );
        ...
        $newcase = $base;
        $newcase['user']['lastname'] = 'agpu\'"';
        $newcase['course']['shortname'] = '101\'"';
        $newcase['forums'][0]['name'] = 'agpu Forum\'"';
        $newcase['forums'][0]['forumposts'][0]['name'] = 'Hello agpu\'"';
        $newcase['forums'][0]['forumposts'][0]['message'] = 'Welcome to agpu\'"';
        $newcase['expectations'][0]['contents'] = array(
            'Attachment example.txt:', '~{\$a', '~&amp;(quot|\#039);', 'Love agpu\'', '101\'', 'agpu Forum\'"',
            'Hello agpu\'"', 'Welcome to agpu\'"');
        ...
        $newcase['forums'][0]['forumposts'][0]['message'] = 'Welcome to agpu>';
        $newcase['expectations'][0]['contents'] = array(
            'Attachment example.txt:', '~{\$a', '~&amp;gt;', 'Love agpu>', '101>', 'agpu Forum>',
            'Hello agpu>', 'Welcome to agpu>');
        ...
        $newcase['expectations'][0]['contents'] = array(
            ...
            'Attachment example.txt:' . '\r*\n' .
            'https://www.example.com/agpu/pluginfile.php/\d*/mod_forum/attachment/\d*/example.txt' .  '\r*\n' ,
            'Text and image', 'agpu Forum',
            'Welcome to agpu, *' . '\r*\n' . '.*'
                .'https://www.example.com/agpu/pluginfile.php/\d+/mod_forum/post/\d+/'
        ...
        $newcase['expectations'][0]['contents'] = array(
            ...
            '~&amp;(amp|lt|gt|quot|\#039);',
            '<div class="attachments">( *\n *)?<a href',
            '<div class="subject">\n.*Hello agpu\'"&gt;&amp;', '>agpu Forum\'"&gt;&amp;',
            '>Welcome.*agpu\'"&gt;&amp;', '>Love agpu&\#039;&quot;&gt;&amp;', '>101\'"&gt;&amp');
        ...
        $newcase['forums'][0]['forumposts'][0]['message'] = '<p>Welcome to agpu, '
        ...
        $newcase['expectations'][0]['contents'] = array(
            ...
            '~&(amp|lt|gt|quot|\#039);(?!course|lang|version|iosappid|androidappid)',
            '<div class="attachments">( *\n *)?<a href',
            '<div class="subject">\n.*HTML text and image', '>agpu Forum',
            '<p>Welcome to agpu, '
            .'<img src="https://www.example.com/agpu/tokenpluginfile.php/[^/]*/\d+/mod_forum/post/\d+/'
