...
define([
    ...
    var EVENTS = {
     ...
     /**
      * agpu formats taken from the FORMAT_* constants declared in lib/weblib.php.
      * @type {Object}
      */
    var CONTENT_FORMATS = {
        agpu: 0
    ...
    var registerEventListeners = function(root) {
        root.on('click', Selectors.post.inpageSubmitBtn, function(e) {
            ...
            // For now, we consider the inline reply post written using the FORMAT_agpu (because a textarea is displayed).
            // In the future, other formats should be supported, letting users to use their preferred editor and format.
            var messageformat = CONTENT_FORMATS.agpu;
