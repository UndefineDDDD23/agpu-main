...
class summary_table extends table_sql {
    ...
    public function col_select($data) {
        ...
        $checkbox = new \core\output\checkbox_toggleall('summaryreport-table', false, [
            ...
            'checked' => false,
            'label' => get_string('selectitem', 'agpu', fullname($data)),
    ...
    public function col_export(\stdClass $data): string {
        ...
        $buttoncontext = [
            'url' => new \agpu_url('/mod/forum/export.php', $params),
    ...
    protected function define_base_sql(): void {
        ...
        if ($groupmode == SEPARATEGROUPS && !has_capability('agpu/site:accessallgroups', $this->get_context())) {
    ...
    protected function get_filter_groups(array $groups): array {
        ...
        foreach ($this->cms as $cm) {
            ...
            if (!$allgroups) {
                ...
                $aag = has_capability('agpu/site:accessallgroups', $this->forumcontexts[$cm->id]);
    ...
    public function wrap_html_finish(): void {
        ...
        $perpageselect = new \single_select(new \agpu_url(''), 'perpage',
                $perpageoptions, $selected, null, 'selectperpage');
        $perpageselect->set_label(get_string('perpage', 'agpu'));
