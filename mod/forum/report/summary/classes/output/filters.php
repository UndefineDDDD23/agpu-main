...
class filters implements renderable, templatable {
    ...
    /**
     * agpu URL used as the form action on the generate button.
     *
     * @var agpu_url $actionurl
     */
    protected $actionurl;
     ...
     * @param agpu_url $actionurl The form action URL.
     ...
     */
    public function __construct(stdClass $course, array $cms, agpu_url $actionurl, array $filterdata = []) {
        $this->cms = $cms;
