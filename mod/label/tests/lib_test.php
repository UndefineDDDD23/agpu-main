...
<source src="@@PLUGINFILE@@/agpu-hit-song.mp3">
@@PLUGINFILE@@/agpu-hit-song.mp3
</audio>&nbsp;</p>',
                'format' => FORMAT_HTML,
...
<p>&nbsp;<video controls="controls">
    ...
    https://www.youtube.com/watch?v=xxxyy
            ...
            'with plain text' => [
                'name' => '',
                'content' => 'Content with @@PLUGINFILE@@/agpu-hit-song.mp3 nothing',
                'format' => FORMAT_HTML,
                'expected' => 'Content with nothing'
            ],
            'with several spaces' => [
                'name' => '',
                'content' => "Content with @@PLUGINFILE@@/agpu-hit-song.mp3 \r &nbsp; several spaces",
                'format' => FORMAT_HTML,
            ...
            'markdown with pluginfile' => [
                'name' => '',
                'content' => "##Simple Title\n simple markdown format @@PLUGINFILE@@/agpu-hit-song.mp3",
                'format' => FORMAT_MARKDOWN,
                'expected' => 'Simple Title simple markdown format'
            ],
            'plain text' => [
                'name' => '',
                'content' => "Simple plain text @@PLUGINFILE@@/agpu-hit-song.mp3",
                'format' => FORMAT_PLAIN,
            ...
            'html format text' => [
                'name' => '',
                'content' => "<h1>Simple plain title</h1><p> with plain text</p> @@PLUGINFILE@@/agpu-hit-song.mp3",
                'format' => FORMAT_HTML,
