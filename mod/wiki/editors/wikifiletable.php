...
class agpuQuickForm_wikifiletable extends HTML_QuickForm_element {
     ...
     */
    public function agpuQuickForm_wikifiletable($elementName = null, $elementLabel = null, $attributes = null, $fileinfo = null, $format = null) {
...
//register wikieditor
agpuQuickForm::registerElementType('wikifiletable', $CFG->dirroot."/mod/wiki/editors/wikifiletable.php", 'agpuQuickForm_wikifiletable');
