...
class agpuQuickForm_wikieditor extends agpuQuickForm_textarea {
     ...
     */
    public function agpuQuickForm_wikieditor($elementName = null, $elementLabel = null, $attributes = null) {
...
//register wikieditor
agpuQuickForm::registerElementType('wikieditor', $CFG->dirroot."/mod/wiki/editors/wikieditor.php", 'agpuQuickForm_wikieditor');
