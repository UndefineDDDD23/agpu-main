...
// 'create' action must be submitted by agpu form
...
if (groups_get_activity_groupmode($cm)) {
    ...
    $canaccessgroups = has_capability('agpu/site:accessallgroups', $modulecontext);
    if ($canaccessgroups) {
...
// set page action, and initialise agpu form
