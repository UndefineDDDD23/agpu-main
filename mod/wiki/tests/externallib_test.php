 ...
 * @package    mod_wiki
 * @category   external
 * @copyright  2015 Dani Palou <dani@agpu.com>
...
class externallib_test extends externallib_advanced_testcase {
    ...
    public function test_view_wiki(): void {
        ...
        $agpuwiki = new \agpu_url('/mod/wiki/view.php', array('id' => $this->cm->id));
        $this->assertEquals($agpuwiki, $event->get_url());
    ...
    public function test_view_page(): void {
        ...
        $this->assertEquals($this->context, $event->get_context());
        $pageurl = new \agpu_url('/mod/wiki/view.php', array('pageid' => $this->firstpage->id));
    ...
    public function test_get_subwiki_files_collaborative_no_groups(): void {
        ...
        $expectedfile = array(
            ...
            'fileurl' => \agpu_url::make_webservice_pluginfile_url($file['contextid'], $file['component'],
        ...
        $expectedfile['fileurl'] = \agpu_url::make_webservice_pluginfile_url($file['contextid'], $file['component'],
                            $file['filearea'], $file['itemid'], $file['filepath'], $file['filename']);
