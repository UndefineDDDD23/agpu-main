...
class action_bar implements templatable, renderable {
     ...
     */
    public function __construct(int $pageid, agpu_url $pageurl, bool $displayprint = false) {
        $this->pageid = $pageid;
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        if ($this->displayprint) {
            $printlink = new agpu_url('/mod/wiki/prettyview.php', ['pageid' => $this->pageid]);
