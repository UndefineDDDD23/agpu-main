...
function data_export_xls($export, $dataname, $count) {
    ...
    $filearg = '-';
    $workbook = new agpuExcelWorkbook($filearg);
...
/**
 * @deprecated since agpu 4.3, exporting is now being done by \mod_data\local\exporter\csv_entries_exporter
 * @global object
 * @param array $export
...
/**
 * @deprecated since agpu 4.3, exporting is now being done by \mod_data\local\exporter\ods_entries_exporter
 * @global object
 * @param array $export
 * @param string $dataname
 * @param int $count
...
function data_export_ods($export, $dataname, $count) {
    ...
    $filename .= '.ods';
    $filearg = '-';
    $workbook = new agpuODSWorkbook($filearg);
    $workbook->send($filename);
    $worksheet = array();
    $worksheet[0] = $workbook->add_worksheet('');
    $rowno = 0;
...
/**
 * @deprecated since agpu 4.3, use \mod_data\local\exporter\utils::data_exportdata with a \mod_data\local\exporter\entries_exporter object
 * @global object
 * @param int $dataid
 * @param array $fields
...
/**
 * @deprecated since agpu 4.3, importing is now being done by \mod_data\local\importer\csv_importer::import_csv
