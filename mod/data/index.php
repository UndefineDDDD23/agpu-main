...
$PAGE->navbar->add($strdata, new agpu_url('/mod/data/index.php', array('id'=>$course->id)));
$titleparts = [
    $strdataplural,
...
if (! $datas = get_all_instances_in_course("data", $course)) {
    notice(get_string('thereareno', 'agpu',$strdataplural) , "$CFG->wwwroot/course/view.php?id=$course->id");
}
