...
class events_test extends \advanced_testcase {
    ...
    public function test_field_created(): void {
        ...
        $url = new \agpu_url('/mod/data/field.php', array('d' => $data->id));
    ...
    public function test_record_created(): void {
        ...
        $this->assertEquals(\context_module::instance($data->cmid), $event->get_context());
        $url = new \agpu_url('/mod/data/view.php', array('d' => $data->id, 'rid' => $recordid));
        $this->assertEquals($url, $event->get_url());
    }
    ...
    public function test_record_updated(): void {
        ...
        $this->assertEquals(\context_module::instance($data->cmid), $event->get_context());
        $url = new \agpu_url('/mod/data/view.php', array('d' => $data->id, 'rid' => $event->objectid));
        $this->assertEquals($url, $event->get_url());
    }
    ...
    public function test_record_deleted(): void {
        ...
        $this->assertEquals(\context_module::instance($data->cmid), $event->get_context());
        $url = new \agpu_url('/mod/data/view.php', array('d' => $data->id));
        $this->assertEquals($url, $event->get_url());
    }
    ...
    public function test_template_viewed(): void {
        ...
        $this->assertEquals(\context_module::instance($data->cmid), $event->get_context());
        $url = new \agpu_url('/mod/data/templates.php', array('d' => $data->id));
        $this->assertEquals($url, $event->get_url());
    }
    ...
    public function test_importing_events(
        ...
        foreach ($expected as $triggeredevent => $count) {
            for ($i = 0; $i < $count; $i++) {
                ...
                $url = new \agpu_url('/mod/data/field.php', ['d' => $activity->id]);
                $this->assertEquals($url, $event->get_url());
            }
        }
    }
