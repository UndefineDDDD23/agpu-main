...
class action_bar {
     ...
     */
    public function __construct(int $id, agpu_url $pageurl) {
        $this->id = $id;
    ...
    public function get_create_fields(bool $isprimarybutton = false): \action_menu {
        ...
        foreach ($menufield as $fieldtype => $fieldname) {
            ...
            $fieldselect->add(new \action_menu_link(
                new agpu_url('/mod/data/field.php', $fieldselectparams),
    ...
    public function get_view_action_bar(bool $hasentries, string $mode): string {
        ...
        $viewlistlink = new agpu_url('/mod/data/view.php', ['d' => $this->id]);
        $viewsinglelink = new agpu_url('/mod/data/view.php', ['d' => $this->id, 'mode' => 'single']);
    ...
    public function get_templates_action_bar(): string {
        ...
        $listtemplatelink = new agpu_url('/mod/data/templates.php', ['d' => $this->id,
            'mode' => 'listtemplate']);
        $singletemplatelink = new agpu_url('/mod/data/templates.php', ['d' => $this->id,
            'mode' => 'singletemplate']);
        $advancedsearchtemplatelink = new agpu_url('/mod/data/templates.php', ['d' => $this->id,
            'mode' => 'asearchtemplate']);
        $addtemplatelink = new agpu_url('/mod/data/templates.php', ['d' => $this->id, 'mode' => 'addtemplate']);
        $rsstemplatelink = new agpu_url('/mod/data/templates.php', ['d' => $this->id, 'mode' => 'rsstemplate']);
        $csstemplatelink = new agpu_url('/mod/data/templates.php', ['d' => $this->id, 'mode' => 'csstemplate']);
        $jstemplatelink = new agpu_url('/mod/data/templates.php', ['d' => $this->id, 'mode' => 'jstemplate']);
        ...
        $resetcurrrent = new agpu_url($this->currenturl);
        ...
        $resetallurl = new agpu_url($this->currenturl);
        $resetallurl->params([
    ...
    public function get_presets_preview_action_bar(manager $manager, string $fullname, string $current): string {
        ...
        foreach (['listtemplate', 'singletemplate'] as $templatename) {
            $link = new agpu_url('/mod/data/preset.php', [
                'd' => $this->id,
        ...
        $data = [
            ...
            'backurl' => new agpu_url('/mod/data/preset.php', ['id' => $cm->id]),
    ...
    protected function get_presets_actions_select(bool $hasimport = false): ?\action_menu {
        ...
        if ($hasimport) {
            ...
            $actionsselect->add(new \action_menu_link(
                new agpu_url('/mod/data/preset.php', $actionsselectparams),
                null,
