 ...
 *
 * @package    mod_data
 * @copyright  2022 Laurent David <laurent.david@agpu.com>
...
class import_presets extends dynamic_form {
    ...
    public function process_dynamic_submission(): array {
        ...
        $returnurl = new agpu_url('/mod/data/preset.php', [
    ...
    protected function check_access_for_dynamic_submission(): void {
        if (!has_capability('mod/data:managetemplates', $this->get_context_for_dynamic_submission())) {
            throw new agpu_exception('importpresetmissingcapability', 'data');
        }
    }
    ...
    protected function get_page_url_for_dynamic_submission(): agpu_url {
        $cmid = $this->optional_param('cmid', null, PARAM_INT);
        return new agpu_url('/mod/data/preset.php', ['id' => $cmid]);
    }
