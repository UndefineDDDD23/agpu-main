...
class manager {
     ...
     *
     * @param agpu_page|null $page the current page
     * @return mod_data_renderer the module renderer
     */
    public function get_renderer(?agpu_page $page = null): mod_data_renderer {
        global $PAGE;
        $page = $page ?? $PAGE;
     ...
     * - baseurl: a agpu_url object to the current page.
     *
