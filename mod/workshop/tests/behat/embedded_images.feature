...
Feature: Teachers can embed images into instructions and conclusion fields
  ...
  Scenario: Embedding the image into the instructions and conclusions fields
    ...
    And the following "user private files" exist:
      | user     | filepath                                   |
      | teacher1 | mod/workshop/tests/fixtures/agpulogo.png |
    ...
    And I click on "agpulogo.png" "link"
    ...
    Then "//*[contains(@class, 'instructions')]//img[contains(@src, 'pluginfile.php') and contains(@src, '/mod_workshop/instructauthors/agpulogo.png') and @alt='How to submit']" "xpath_element" should exist
    And I change phase in workshop "Workshop with embedded images" to "Assessment phase"
    Then "//*[contains(@class, 'instructions')]//img[contains(@src, 'pluginfile.php') and contains(@src, '/mod_workshop/instructreviewers/agpulogo.png') and @alt='How to assess']" "xpath_element" should exist
    And I change phase in workshop "Workshop with embedded images" to "Closed"
    Then "//*[contains(@class, 'conclusion')]//img[contains(@src, 'pluginfile.php') and contains(@src, '/mod_workshop/conclusion/agpulogo.png') and @alt='Well done']" "xpath_element" should exist
