 ...
 * It uses the standard core agpu formslib. For more info about them, please
 * visit: https://agpudev.io/docs/apis/subsystems/form
 *
 ...
 */
class mod_workshop_mod_form extends agpuform_mod {
    ...
    public function validation($data, $files) {
        ...
        // Refer to validation defined in agpuform_mod.php.
