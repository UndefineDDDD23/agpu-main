...
$previewlnk = new agpu_url('/mod/feedback/print.php', array('id' => $id));
if ($courseid) {
...
if (!$PAGE->has_secondary_navigation()) {
    if (!has_capability('mod/feedback:viewreports', $context) &&
        ...
        $analysisurl = new agpu_url('/mod/feedback/analysis.php', array('id' => $id));
    ...
    if (has_capability('mod/feedback:mapcourse', $context) && $feedback->course == SITEID) {
        ...
        $mapurl = new agpu_url('/mod/feedback/mapcourse.php', array('id' => $id));
