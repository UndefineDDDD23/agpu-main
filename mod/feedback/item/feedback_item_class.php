...
abstract class feedback_item_base {
    ...
    public function edit_actions($item, $feedback, $cm) {
        ...
        $actions['update'] = new action_menu_link_secondary(
            new agpu_url('/mod/feedback/edit_item.php', ['id' => $item->id]),
            new pix_icon('t/edit', $strupdate, 'agpu', ['class' => 'iconsmall', 'title' => '']),
            $strupdate,
        ...
        $actions['delete'] = new action_menu_link_secondary(
            ...
            new pix_icon('t/delete', $strdelete, 'agpu', array('class' => 'iconsmall', 'title' => '')),
            $strdelete,
...
class feedback_item_pagebreak extends feedback_item_base {
    ...
    public function edit_actions($item, $feedback, $cm) {
        ...
        $actions['delete'] = new action_menu_link_secondary(
            new agpu_url('/mod/feedback/edit.php', array('id' => $cm->id, 'deleteitem' => $item->id, 'sesskey' => sesskey())),
            new pix_icon('t/delete', $strdelete, 'agpu', array('class' => 'iconsmall', 'title' => '')),
            $strdelete,
            ['class' => 'editing_delete text-danger', 'data-action' => 'delete']
        );
