...
$url = new agpu_url('/mod/feedback/manage_templates.php', $params);
...
if ($templateid) {
    ...
    $successurl = new agpu_url('/mod/feedback/manage_templates.php', ['id' => $id]);
...
$baseurl = new agpu_url('/mod/feedback/use_templ.php', $params);
