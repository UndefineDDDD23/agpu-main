...
$url = new agpu_url('/mod/feedback/analysis_to_excel.php', array('id' => $id));
if ($courseid) {
...
if (!$items = $feedbackstructure->get_items(true)) {
    throw new \agpu_exception('no_items_available_yet', 'feedback', $cm->url);
}
...
$workbook = new agpuExcelWorkbook($filename);
