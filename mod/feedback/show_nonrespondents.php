...
$format = optional_param('format', FORMAT_agpu, PARAM_INT);
...
$url = new agpu_url('/mod/feedback/show_nonrespondents.php', array('id'=>$cm->id));
...
$canbulkmessaging = has_capability('agpu/course:bulkmessaging', $coursecontext);
...
$baseurl = new agpu_url('/mod/feedback/show_nonrespondents.php');
