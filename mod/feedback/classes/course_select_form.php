 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_feedback_course_select_form extends agpuform {
    /** @var agpu_url */
    protected $action;
     ...
     * Constructor
     *
     * @param string|agpu_url $action the action attribute for the form
    ...
    public function __construct($action, mod_feedback_structure $feedbackstructure, $editable = true) {
        $this->action = new agpu_url($action, ['courseid' => null]);
