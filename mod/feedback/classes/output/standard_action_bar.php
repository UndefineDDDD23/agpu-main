...
class standard_action_bar extends base_action_bar {
    ...
    public function get_items(): array {
        ...
        if (has_capability('mod/feedback:edititems', $this->context)) {
            $editurl = new agpu_url('/mod/feedback/edit.php', $this->urlparams);
        ...
        if (has_any_capability($capabilities, $this->context)) {
            $previewlnk = new agpu_url('/mod/feedback/print.php', array('id' => $this->cmid));
            if ($this->course->id) {
        ...
        if ($this->viewcompletion) {
            ...
            $completeurl = new agpu_url('/mod/feedback/complete.php',
