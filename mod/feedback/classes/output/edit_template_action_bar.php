...
class edit_template_action_bar extends base_action_bar {
    ...
    public function get_items(): array {
        ...
        $templateurl = new agpu_url('/mod/feedback/manage_templates.php', $this->urlparams + $additionalparams);
        ...
        if ($showdelete) {
            ...
            $deleteurl = new agpu_url('/mod/feedback/manage_templates.php', $params);
