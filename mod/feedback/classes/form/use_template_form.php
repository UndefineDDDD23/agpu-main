...
class use_template_form extends dynamic_form {
     ...
     *
     * @throws \agpu_exception User does not have capability to access the form
     */
    ...
    public function process_dynamic_submission(): array {
        ...
        $url = new agpu_url('/mod/feedback/edit.php', ['id' => $id]);
    ...
    protected function get_page_url_for_dynamic_submission(): agpu_url {
        ...
        return new agpu_url('/mod/feedback/use_templ.php', $params);
    }
}
