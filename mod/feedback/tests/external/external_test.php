...
final class external_test extends externallib_advanced_testcase {
    ...
    public function test_view_feedback(): void {
        ...
        $agpudata = new \agpu_url('/mod/feedback/view.php', array('id' => $this->cm->id));
    ...
    protected function complete_basic_feedback() {
        ...
        assign_capability('agpu/site:accessallgroups', CAP_PROHIBIT, $this->teacherrole->id, $this->context);
        accesslib_clear_all_caches_for_unit_testing();
