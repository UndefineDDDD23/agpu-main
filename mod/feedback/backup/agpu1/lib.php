 ...
 */
class agpu1_mod_feedback_handler extends agpu1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /agpu_BACKUP/COURSE/MODULES/MOD/FEEDBACK does not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'feedback', '/agpu_BACKUP/COURSE/MODULES/MOD/FEEDBACK',
                array(
                    'renamefields' => array(
                        'summary' => 'intro',
            ...
            new convert_path(
                'feedback_item', '/agpu_BACKUP/COURSE/MODULES/MOD/FEEDBACK/ITEMS/ITEM',
                array (
                    'newfields' => array(
                        'label' => '',
                        'options' => '',
    ...
    /**
     * This is executed every time we have one /agpu_BACKUP/COURSE/MODULES/MOD/FEEDBACK
     * data available
     */
    ...
    /**
     * This is executed every time we have one /agpu_BACKUP/COURSE/MODULES/MOD/FEEDBACK/ITEMS/ITEM
     * data available
     */
