...
require_once($CFG->dirroot . '/mod/feedback/backup/agpu2/backup_feedback_stepslib.php');
require_once($CFG->dirroot . '/mod/feedback/backup/agpu2/backup_feedback_settingslib.php');
