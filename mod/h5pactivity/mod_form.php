 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_h5pactivity_mod_form extends agpuform_mod {
    ...
    public function definition(): void {
        ...
        if (has_capability('agpu/contentbank:access', $coursecontext)) {
            $msg = null;
            ...
            if ($context instanceof \context_module) {
                ...
                if ($file && $file->get_reference() != null) {
                    $referencedfile = \repository::get_agpu_file($file->get_reference());
                    if ($referencedfile->get_component() == 'contentbank') {
                        ...
                        $url = new agpu_url('/contentbank/view.php', ['id' => $referencedfile->get_itemid()]);
            ...
            if (!isset($msg)) {
                $url = new agpu_url('/contentbank/index.php', ['contextid' => $coursecontext->id]);
