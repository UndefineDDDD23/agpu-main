 ...
 * @since      agpu 3.11
 * @copyright  2020 Ilya Tregubov <ilya@agpu.com>
...
class get_user_attempts extends external_api {
     ...
     *
     * @throws  agpu_exception if the user cannot see the report
    ...
    public static function execute(int $h5pactivityid, $sortorder = 'id ASC', ?int $page = 0,
        ...
        if (!$manager->can_view_all_attempts()) {
            throw new agpu_exception('nopermissiontoviewattempts', 'error', '', null,
