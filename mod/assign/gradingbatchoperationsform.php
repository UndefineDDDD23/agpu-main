 ...
 * @todo Final deprecation in agpu 6.0. See MDL-82869.
 */
...
class mod_assign_grading_batch_operations_form extends agpuform {
    /**
    ...
    public function definition() {
        ...
        if (!empty($CFG->messaging) &&
            has_all_capabilities(['agpu/site:sendmessage', 'agpu/course:bulkmessaging'], $instance['context'])
        ) {
