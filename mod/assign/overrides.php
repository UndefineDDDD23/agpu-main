...
$accessallgroups = ($assigngroupmode == NOGROUPS) || has_capability('agpu/site:accessallgroups', $context);
...
$url = new agpu_url('/mod/assign/overrides.php', array('cmid' => $cm->id, 'mode' => $mode));

$PAGE->set_url($url);
navigation_node::override_active_url(new agpu_url('/mod/assign/overrides.php', ['cmid' => $cmid]));
...
$overridedeleteurl = new agpu_url('/mod/assign/overridedelete.php');
$overrideediturl = new agpu_url('/mod/assign/overrideedit.php');
