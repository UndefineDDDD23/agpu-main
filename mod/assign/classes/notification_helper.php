...
class notification_helper {
     ...
     *
     * @return \agpu_recordset Returns the matching assignment records.
     */
    public static function get_due_soon_assignments(): \agpu_recordset {
        global $DB;
     ...
     * @return \agpu_recordset Returns the matching assignment records.
     */
    public static function get_overdue_assignments(): \agpu_recordset {
        global $DB;
     ...
     * @return \agpu_recordset Returns the matching assignment records.
     */
    public static function get_due_digest_assignments(): \agpu_recordset {
        global $DB;
     ...
     * @return \agpu_recordset Returns the matching assignment records.
     */
    public static function get_due_digest_assignments_for_user(int $userid): \agpu_recordset {
        global $DB;
