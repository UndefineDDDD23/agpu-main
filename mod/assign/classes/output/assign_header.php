...
class assign_header implements \renderable {
    ...
    public $postfix;
    /** @var \agpu_url|null $subpageurl link for the sub page */
    public $subpageurl;
     ...
     * @param \agpu_url|null $subpageurl      An optional sub page URL link for the subpage.
