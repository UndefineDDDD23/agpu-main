...
class override_actionmenu implements templatable, renderable {
    ...
    /** @var agpu_url The current url for this page. */
     ...
     *
     * @param agpu_url $currenturl The current url for this page.
     * @param \cm_info $cm course module information.
     */
    public function __construct(agpu_url $currenturl, \cm_info $cm) {
        $this->currenturl = $currenturl;
        $this->cm = $cm;
        $groupmode = groups_get_activity_groupmode($this->cm);
        $this->canaccessallgroups = ($groupmode === NOGROUPS) ||
                has_capability('agpu/site:accessallgroups', $this->cm->context);
    ...
    protected function get_select_menu(): url_select {
        $userlink = new agpu_url('/mod/assign/overrides.php', ['cmid' => $this->cm->id, 'mode' => 'user']);
        $grouplink = new agpu_url('/mod/assign/overrides.php', ['cmid' => $this->cm->id, 'mode' => 'group']);
        $menu = [
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        $url = new agpu_url('/mod/assign/overrideedit.php', $params);
