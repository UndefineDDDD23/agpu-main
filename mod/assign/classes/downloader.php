...
class downloader {
    ...
    private function get_student_prefix(stdClass $student): string {
        ...
        if ($manager->is_blind_marking()) {
            ...
            $fullname = fullname($student, has_capability('agpu/site:viewfullnames', $manager->get_context()));
        }
    ...
    private function load_submissionplugin_filelist(
        ...
        if ($this->downloadasfolders) {
            ...
            // This is the default behavior for version of agpu >= 3.1.
            ...
            // This was the default behavior for version of agpu < 3.1.
