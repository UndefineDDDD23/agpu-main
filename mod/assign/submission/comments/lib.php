...
/**
 * This file contains the agpu hooks for the submission comments plugin
 *
...
/**
 *
 * Callback method for data validation---- required method for AJAXagpu based comment API
 *
...
/**
 * Permission control method for submission plugin ---- required method for AJAXagpu based comment API
 *
 * @param stdClass $options
 * @return array
 */
