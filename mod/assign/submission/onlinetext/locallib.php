...
class assign_submission_onlinetext extends assign_submission_plugin {
     ...
     */
    public function get_form_elements($submission, agpuQuickForm $mform, stdClass $data) {
        $elements = array();
    ...
    public function get_files(stdClass $submission, stdClass $user) {
        ...
        if ($onlinetextsubmission && !html_is_blank($onlinetextsubmission->onlinetext)) {
            // Do not pass the text through format_text. The result may not be displayed in agpu and
    ...
    /**
     * Return true if this plugin can upgrade an old agpu 2.2 assignment of this type and version.
     *
