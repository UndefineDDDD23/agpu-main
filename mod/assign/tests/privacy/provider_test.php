...
class provider_test extends provider_testcase {
    ...
    public function test_get_users_in_context(): void {
        ...
        $data->grade = $grade;
        $data->assignfeedbackcomments_editor = ['text' => $teachercommenttext, 'format' => FORMAT_agpu];
    ...
    public function test_export_user_data_student(): void {
        ...
        $data->attemptnumber = 1;
        $data->grade = $grade2;
        $data->assignfeedbackcomments_editor = ['text' => $teachercommenttext2, 'format' => FORMAT_agpu];
    ...
    public function test_export_user_data_teacher(): void {
        ...
        $data->attemptnumber = 1;
        $data->grade = $grade3;
        $data->assignfeedbackcomments_editor = ['text' => $teachercommenttext3, 'format' => FORMAT_agpu];
