...
class externallib_test extends \mod_assign\externallib_advanced_testcase {
    ...
    public function test_get_grades(): void {
        ...
        $roleid = $this->assignUserCapability('agpu/course:viewparticipants', $context->id, 3);
    ...
    public function test_view_grading_table_correct(): void {
        ...
        $agpuurl = new \agpu_url('/mod/assign/view.php', array('id' => $cm->id));
        $this->assertEquals($agpuurl, $event->get_url());
    ...
    public function test_get_submission_status_in_submission_status_for_teacher(): void {
        ...
        $teacherrole = $DB->get_record('role', array('shortname' => 'teacher'));
        assign_capability('agpu/site:accessallgroups', CAP_ALLOW, $teacherrole->id, $context->id, true);
        accesslib_clear_all_caches_for_unit_testing();
