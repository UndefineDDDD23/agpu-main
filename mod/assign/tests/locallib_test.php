...
final class locallib_test extends \advanced_testcase {
    ...
    public function test_return_links(): void {
        ...
        $PAGE->set_url(new \agpu_url('/mod/assign/view.php', ['id' => $assign->get_course_module()->id]));
    ...
    public function test_gradingtable_filter_by_requiresgrading_no_grade(): void {
        ...
        $PAGE->set_url(new \agpu_url('/mod/assign/view.php', [
...
External link 1:<img src=\"https://agpu.org/logo/logo-240x60.gif\" alt=\"agpu\" />
External link 2:<img alt=\"agpu\" src=\"https://agpu.org/logo/logo-240x60.gif\" />
Internal link 1:<img src=\"$url/logo-240x60.gif\" alt=\"agpu\" />
Internal link 2:<img alt=\"agpu\" src=\"@@PLUGINFILE@@logo-240x60.gif\" />
...
";
    ...
    public function test_can_edit_submission_separategroups_with_editothersubmission(): void {
        ...
        assign_capability('mod/assign:editothersubmission', CAP_ALLOW, $roleid, $assign->get_context()->id);
        assign_capability('agpu/site:accessallgroups', CAP_ALLOW, $roleid, $assign->get_context()->id);
        role_assign($roleid, $teacher->id, $assign->get_context()->id);
