...
class lib_test extends \advanced_testcase {
    ...
    public function test_assign_user_complete(): void {
        ...
        $PAGE->set_url(new \agpu_url('/mod/assign/view.php', array('id' => $assign->get_course_module()->id)));
    ...
    public function test_assign_core_calendar_provide_event_action_duedate_as_student(): void {
        ...
        $this->assertInstanceOf('agpu_url', $actionevent->get_url());
    ...
    public function test_assign_core_calendar_provide_event_action_duedate_for_group_assignment(): void {
        ...
        $this->assertInstanceOf('agpu_url', $actionevent1->get_url());
        ...
        $this->assertInstanceOf('agpu_url', $actionevent2->get_url());
    ...
    public function test_student_role_cant_update_due_event(): void {
        ...
        assign_capability('agpu/course:manageactivities', CAP_PROHIBIT, $roleid, $context, true);
    ...
    public function test_teacher_role_can_update_due_event(): void {
        ...
        assign_capability('agpu/calendar:manageentries', CAP_ALLOW, $roleid, $context, true);
        assign_capability('agpu/course:manageactivities', CAP_ALLOW, $roleid, $context, true);
