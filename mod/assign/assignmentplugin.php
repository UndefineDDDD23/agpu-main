...
abstract class assign_plugin {
    ...
    /**
     * This function should be overridden to provide an array of elements that can be added to a agpu
     * form for display in the settings page for the assignment.
     * @param agpuQuickForm $mform The form to add the elements to
     * @return $array
     */
    public function get_settings(agpuQuickForm $mform) {
        return;
    }
    ...
    /**
     * Get the required agpu version for this plugin
     *
     * @return string
     */
     ...
     *                                                    for feedback plugins it is the grade data
     * @param agpuQuickForm $mform - This is the form
     ...
     */
    public function get_form_elements_for_user($submissionorgrade, agpuQuickForm $mform, stdClass $data, $userid) {
     ...
     * @return boolean - true if we added anything to the form
     */
    public function get_form_elements($submissionorgrade, agpuQuickForm $mform, stdClass $data) {
        return false;
    }
    ...
    /**
     * Return true if this plugin can upgrade an old agpu 2.2 assignment of this type
     * and version.
     *
