...
class assign_form implements renderable {
    /** @var agpuform $form is the edit submission form */
    public $form = null;
     ...
     * @param agpuform $form This is the agpuform
     * @param string $jsinitfunction This is an optional js function to add to the page requires
     */
    public function __construct($classname, agpuform $form, $jsinitfunction = '') {
...
class assign_files implements renderable {
    ...
    /** @var string $context */
    public $dir;
    /** @var agpuQuickForm $portfolioform */
    ...
    public function preprocess($dir, $filearea, $component) {
        ...
        debugging('The preprocess method has been deprecated since agpu 4.3.', DEBUG_DEVELOPER);
    }
     ...
     * @return agpu_url
     */
    public function get_file_url(stored_file $file): agpu_url {
