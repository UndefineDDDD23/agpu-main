...
class convert_submission extends adhoc_task {
    ...
    public function execute() {
        ...
        if ($result->status !== pdf::GSPATH_OK) {
            ...
            throw new agpu_exception('pathtogserror', 'assignfeedback_editpdf', '', $statusstring, $result->status);
        }
        ...
        foreach ($users as $userid) {
            ...
            //
            // mod/assign/feedback/editpdf/classes/task/convert_submissions.php@agpu_400_STABLE
            //
            ...
            switch ($combineddocument->get_status()) {
                ...
                case combined_document::STATUS_FAILED:
                    ...
                    throw new \agpu_exception('documentcombinationfailed');
            }
