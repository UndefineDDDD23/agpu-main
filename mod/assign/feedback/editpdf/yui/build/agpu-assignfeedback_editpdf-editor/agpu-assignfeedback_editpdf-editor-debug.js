YUI.add('agpu-assignfeedback_editpdf-editor', function (Y, NAME) {
...
Y.Base.modifyAttrs(DROPDOWN, {
     ...
     *
     * agpu override: We override this for commentsearch to force it always false.
     *
     * @attribute Modal
     * @type Boolean
     * @default false
...
Y.Base.modifyAttrs(COMMENTSEARCH, {
     ...
     * Whether the widget should be modal or not.
     *
     * agpu override: We override this for commentsearch to force it always true.
     *
     * @attribute Modal
     * @type Boolean
     * @default true
...
Y.extend(EDITOR, Y.Base, EDITOR.prototype, {
    NAME: 'agpu-assignfeedback_editpdf-editor',
    ATTRS: {
        userid: {
...
M.assignfeedback_editpdf.editor.init = M.assignfeedback_editpdf.editor.init || function(params) {
    ...
    "requires": [
        ...
        "agpu-core-notification-dialog",
        "agpu-core-notification-alert",
        "agpu-core-notification-warning",
