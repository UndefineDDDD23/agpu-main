...
$PAGE->set_url(new agpu_url('/mod/assign/feedback/editpdf/testgs.php'));
...
$PAGE->navbar->add(get_string('pluginname', 'assignfeedback_editpdf'), new agpu_url('/admin/settings.php?section=assignfeedback_editpdf'));
...
switch ($result->status) {
    case assignfeedback_editpdf\pdf::GSPATH_OK:
        ...
        $imgurl = new agpu_url($PAGE->url, array('sendimage' => 1));
...
$returl = new agpu_url('/admin/settings.php', array('section' => 'assignfeedback_editpdf'));
