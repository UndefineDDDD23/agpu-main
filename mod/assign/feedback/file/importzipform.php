 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignfeedback_file_import_zip_form extends agpuform implements renderable {
                ...
                if ($importer->is_file_modified($assignment, $users, $plugin, $filename, $unzippedfile)) {
                    ...
                    foreach ($users as $user) {
                        if ($assignment->is_blind_marking()) {
                            ...
                            $userdescs[] = fullname($user, has_capability('agpu/site:viewfullnames', $assignment->get_context()));
                        }
                    }
