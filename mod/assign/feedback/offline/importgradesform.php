 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignfeedback_offline_import_grades_form extends agpuform implements renderable {
    ...
    public function definition() {
        ...
        if (!$gradeimporter->init()) {
            $thisurl = new agpu_url('/mod/assign/view.php', array('action'=>'viewpluginpage',
                                                                     'pluginsubtype'=>'assignfeedback',
                                                                     'plugin'=>'offline',
                                                                     'pluginaction'=>'uploadgrades',
                                                                     'id'=>$assignment->get_course_module()->id));
            throw new \agpu_exception('invalidgradeimport', 'assignfeedback_offline', $thisurl);
            return;
        }
