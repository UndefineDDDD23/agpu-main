...
if (! $override = $DB->get_record('assign_overrides', array('id' => $overrideid))) {
    throw new \agpu_exception('invalidoverrideid', 'assign');
}
...
$url = new agpu_url('/mod/assign/overridedelete.php', array('id' => $override->id));
$confirmurl = new agpu_url($url, array('id' => $override->id, 'confirm' => 1));
$cancelurl = new agpu_url('/mod/assign/overrides.php', array('cmid' => $cm->id));
