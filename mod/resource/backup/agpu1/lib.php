 ...
 * @copyright  2011 Andrew Davis <andrew@agpu.com>
 ...
 */
class agpu1_mod_resource_handler extends agpu1_mod_handler {

    /** @var agpu1_file_manager instance */
     ...
     * defined.
     *
     * Note that the paths /agpu_BACKUP/COURSE/MODULES/MOD/RESOURCE do not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'resource', '/agpu_BACKUP/COURSE/MODULES/MOD/RESOURCE',
                array(
                    'renamefields' => array(
                        'summary' => 'intro',
                    ),
    ...
    public function process_resource(array $data, array $raw) {
        ...
        $resource['intro'] = agpu1_converter::migrate_referenced_files($resource['intro'], $this->fileman);
     ...
     * @throws agpu1_convert_exception for the unknown types
     * @return null|agpu1_mod_handler the instance of the handler, or null if the type does not have a successor
     */
    protected function get_successor($type, $reference) {
        ...
        switch ($type) {
            ...
            case 'file':
                ...
                break;
            default:
                throw new agpu1_convert_exception('unknown_resource_successor', $type);
        }
        ...
        if (!isset($this->successors[$name])) {
            ...
            $class = 'agpu1_mod_'.$name.'_handler';
