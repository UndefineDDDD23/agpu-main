...
/**
 * Strings for component 'url', language 'en', branch 'agpu_20_STABLE'
 *
 * @package    mod_url
...
Avoid using the word "link". This will help screen reader users as screen readers announce links (e.g. "agpu.org, link") so there\'s no need to include the word "link" in the name field.';
