...
/**
 * URL conversion handler. This resource handler is called by agpu1_mod_resource_handler
 */
class agpu1_mod_url_handler extends agpu1_resource_successor_handler {
    ...
    public function process_legacy_resource(array $data, ?array $raw = null) {
        ...
        $url['intro'] = agpu1_converter::migrate_referenced_files($url['intro'], $this->fileman);
