...
final class restore_39_test extends advanced_testcase {
    ...
    public function test_restore_random_question_39(): void {
        ...
        // The example agpu 3.9 backup file used in this test is an activity-level backup of a quiz.
        ...
        $backupfile = 'agpu_39_quiz_with_random_question_from_mod_context';
        ...
        // Restore the quiz activity in the backup from agpu 3.9 to a new course.
