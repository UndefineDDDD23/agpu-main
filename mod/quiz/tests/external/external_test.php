...
class external_test extends externallib_advanced_testcase {
    ...
    public function test_view_quiz(): void {
        ...
        $agpuquiz = new \agpu_url('/mod/quiz/view.php', ['id' => $this->cm->id]);
        $this->assertEquals($agpuquiz, $event->get_url());
    ...
    public function test_view_attempt_summary(): void {
        ...
        $this->assertEquals($context, $event->get_context());
        $agpuquiz = new \agpu_url('/mod/quiz/summary.php', ['attempt' => $attempt->id]);
        $this->assertEquals($agpuquiz, $event->get_url());
        $this->assertEventContextNotUsed($event);
        $this->assertNotEmpty($event->get_name());
    ...
    public function test_view_attempt_review(): void {
        ...
        $this->assertEquals($context, $event->get_context());
        $agpuquiz = new \agpu_url('/mod/quiz/review.php', ['attempt' => $attempt->id]);
        $this->assertEquals($agpuquiz, $event->get_url());
        $this->assertEventContextNotUsed($event);
        $this->assertNotEmpty($event->get_name());
    ...
    public function test_get_quiz_feedback_for_grade(): void {
        ...
        $this->assertEquals(FORMAT_agpu, $result['feedbacktextformat']);
    }
