...
Feature: Backup and restore of quizzes
  ...
  Scenario: Restore a agpu 2.8 quiz backup
    When I am on the "Course 1" "restore" page
    And I press "Manage course backups"
    And I upload "mod/quiz/tests/fixtures/agpu_28_quiz.mbz" file to "Files" filemanager
    And I press "Save changes"
    And I restore "agpu_28_quiz.mbz" backup into "Course 1" course using this options:
    And I am on the "Restored agpu 2.8 quiz" "mod_quiz > Edit" page
    Then I should see "TF1"
    And I should see "TF2"
