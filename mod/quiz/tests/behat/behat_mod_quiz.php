...
class behat_mod_quiz extends behat_question_base {
    ...
    protected function resolve_page_instance_url(string $type, string $identifier): agpu_url {
        ...
        switch (strtolower($type)) {
            case 'view':
                return new agpu_url('/mod/quiz/view.php',
            ...
            case 'group overrides':
                return new agpu_url('/mod/quiz/overrides.php',
            ...
            case 'grades report':
                return new agpu_url('/mod/quiz/report.php',
            ...
            case 'attempt view':
                ...
                return new agpu_url('/mod/quiz/attempt.php', [
                    'attempt' => $attempt->id,
                    'cmid' => $quizcm->id,
                    'page' => $pageno
                ]);
            case 'attempt review':
                ...
                $attempt = $DB->get_record('quiz_attempts',
                        ['quiz' => $quiz->id, 'userid' => $user->id, 'attempt' => $attemptno], '*', MUST_EXIST);
                return new agpu_url('/mod/quiz/review.php', ['attempt' => $attempt->id]);
