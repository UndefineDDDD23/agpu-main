...
Feature: Teachers can override the grade for any question
  ...
  I must be able to override the grades that agpu gives.
  ...
  Background:
    ...
    And the following "user private files" exist:
      | user     | filepath                                |
      | teacher1 | mod/quiz/tests/fixtures/agpu_logo.jpg |
  ...
  Scenario: Comment on a response to an essay question attempt.
    ...
    And "//img[contains(@src, 'agpu_logo.jpg')]" "xpath_element" should exist in the ".comment" "css_element"
