 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @deprecated since agpu 4.2. Code moved to mod_quiz\task\update_overdue_attempts.
 * @todo MDL-76612 Final deprecation in agpu 4.6
 */
class mod_quiz_overdue_attempt_updater {

    /**
     * @deprecated since agpu 4.2. Code moved to mod_quiz\task\update_overdue_attempts. that was.
     */
 ...
 * constructor for a agpu_exception.
 *
 * @copyright 2008 Tim Hunt
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since     agpu 2.0
 * @deprecated since agpu 4.2. Please just use agpu_exception.
 * @todo MDL-76612 Final deprecation in agpu 4.6
 */
class agpu_quiz_exception extends agpu_exception {
    /**
     * Constructor.
     *
    ...
    public function __construct($quizobj, $errorcode, $a = null, $link = '', $debuginfo = null) {
        debugging('Class agpu_quiz_exception is deprecated. ' .
                'Please use a standard agpu_exception instead.', DEBUG_DEVELOPER);
        if (!$link) {
 ...
 * @deprecated since agpu 4.2. Please use grade_calculator::recompute_quiz_sumgrades.
 * @todo MDL-76612 Final deprecation in agpu 4.6
 */
 ...
 *
 * @param stdClass $quiz a quiz.
 * @deprecated since agpu 4.2. Please use grade_calculator::recompute_all_attempt_sumgrades.
 * @todo MDL-76612 Final deprecation in agpu 4.6
 */
 ...
 *
 * @param stdClass $quiz the quiz settings.
 * @deprecated since agpu 4.2. Please use grade_calculator::recompute_all_final_grades.
 * @todo MDL-76612 Final deprecation in agpu 4.6
 */
 ...
 * @deprecated since agpu 4.2. Please use grade_calculator::update_quiz_maximum_grade.
 * @todo MDL-76612 Final deprecation in agpu 4.6
 */
 ...
 * @deprecated since agpu 4.2. No direct replacement.
 * @todo MDL-76612 Final deprecation in agpu 4.6
 */
 ...
 * @todo MDL-80944 Final deprecation in agpu 4.8
