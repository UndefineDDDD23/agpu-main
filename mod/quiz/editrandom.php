 ...
 *
 * @package    mod_quiz
 * @copyright  2018 Shamim Rezaie <shamim@agpu.com>
...
if ($returnurl) {
    ...
    $returnurl = new agpu_url('/mod/quiz/edit.php', ['cmid' => $cm->id]);
}

$url = new agpu_url('/mod/quiz/editrandom.php', ['slotid' => $slotid]);
$PAGE->set_url($url);
...
$mform = new mod_quiz\form\randomquestion_form(new agpu_url('/mod/quiz/editrandom.php'), ['contexts' => $contexts]);
