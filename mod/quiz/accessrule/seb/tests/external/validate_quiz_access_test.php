...
class validate_quiz_access_test extends \advanced_testcase {
    ...
    public function bad_parameters_provider(): array {
        return [
            ...
            'no course module id' => [
                'cmid' => null,
                'url' => 'https://www.example.com/agpu',
    ...
    public function test_context_is_not_valid_for_user(): void {
        ...
        validate_quiz_keys::execute($this->quiz->cmid, 'https://www.example.com/agpu', 'configkey');
    }
    ...
    public function test_no_keys_provided(): void {
        ...
        validate_quiz_keys::execute($this->quiz->cmid, 'https://www.example.com/agpu');
    }
    ...
    public function test_quiz_does_not_exist(): void {
        ...
        validate_quiz_keys::execute($forum->cmid, 'https://www.example.com/agpu', 'configkey');
    }
    ...
    public function test_config_key_not_valid(): void {
        ...
        $result = validate_quiz_keys::execute($this->quiz->cmid, 'https://www.example.com/agpu', 'badconfigkey');
    ...
    public function test_browser_exam_key_not_valid(): void {
        ...
        $result = validate_quiz_keys::execute($this->quiz->cmid, 'https://www.example.com/agpu', null,
