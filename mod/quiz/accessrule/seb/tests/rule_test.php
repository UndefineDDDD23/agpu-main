...
class rule_test extends \advanced_testcase {
    ...
    private function get_seb_launch_link() {
        return 'sebs://www.example.com/agpu/mod/quiz/accessrule/seb/config.php';
    }
    ...
    private function get_seb_config_download_link() {
        return 'https://www.example.com/agpu/mod/quiz/accessrule/seb/config.php';
    }
