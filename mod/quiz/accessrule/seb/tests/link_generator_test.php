...
class link_generator_test extends \advanced_testcase {
    ...
    public function test_http_link_generated(): void {
        ...
        $this->assertEquals(
            "http://www.example.com/agpu/mod/quiz/accessrule/seb/config.php?cmid=$quiz->cmid",
    ...
    public function test_https_link_generated(): void {
        ...
        $this->assertEquals(
            "https://www.example.com/agpu/mod/quiz/accessrule/seb/config.php?cmid=$quiz->cmid",
    ...
    public function test_seb_link_generated(): void {
        ...
        $this->assertEquals(
            "seb://www.example.com/agpu/mod/quiz/accessrule/seb/config.php?cmid=$quiz->cmid",
    ...
    public function test_sebs_link_generated(): void {
        ...
        $this->assertEquals(
            "sebs://www.example.com/agpu/mod/quiz/accessrule/seb/config.php?cmid=$quiz->cmid",
