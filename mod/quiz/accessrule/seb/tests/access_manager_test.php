...
class access_manager_test extends \advanced_testcase {
    ...
    public function test_access_keys_validate_with_config_key(): void {
        ...
        $FULLME = 'https://example.com/agpu/mod/quiz/attempt.php?attemptid=123&page=4';
    ...
    /**
     * Test that access is set correctly in agpu session.
     */
    ...
    /**
     * Test that access is set in agpu session for only course module associated with access manager.
     */
    ...
    /**
     * Test that access state can be retrieved from agpu session.
     */
    ...
    /**
     * Test that access can be cleared from agpu session.
     */
