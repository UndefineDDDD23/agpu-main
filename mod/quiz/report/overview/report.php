...
class quiz_overview_report extends attempts_report {
    ...
    protected function display_commit_regrade_if_required(
        ...
        $commitregradeurl = new agpu_url($options->get_url(), ['sesskey' => sesskey(), 'regradealldrydo' => 1]);
     ...
     * @param agpu_url $redirecturl
     */
    protected function process_regrade_actions($quiz, $cm, $currentgroup,
            \core\dml\sql_join $groupstudentsjoins, agpu_url $redirecturl) {
     ...
     * @param agpu_url $nexturl where to send the user after the regrade.
