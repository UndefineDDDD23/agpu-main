YUI.add('agpu-mod_quiz-util-page', function (Y, NAME) {
 ...
 * @submodule agpu-mod_quiz-util-page
 */

Y.namespace('agpu.mod_quiz.util.page');

/**
 * A collection of utility classes for use with pages.
 *
 * @class agpu.mod_quiz.util.page
 * @static
 */
Y.agpu.mod_quiz.util.page = {
    CSS: {
        PAGE: 'page'
    },
    CONSTANTS: {
        ...
        PAGEIDPREFIX: 'page-',
        PAGENUMBERPREFIX: M.util.get_string('page', 'agpu') + ' '
    },
    SELECTORS: {
        ACTIONMENU: 'div.agpu-actionmenu',
     ...
     */
    getPages: function() {
        return Y.all(Y.agpu.mod_quiz.util.slot.SELECTORS.PAGECONTENT + ' ' +
                     Y.agpu.mod_quiz.util.slot.SELECTORS.SECTIONUL + ' ' +
                    this.SELECTORS.PAGE);
    },
    ...
    remove: function(page, keeppagebreak) {
        ...
        var previousslot = page.previous(Y.agpu.mod_quiz.util.slot.SELECTORS.SLOT);
        if (!keeppagebreak && previousslot) {
            Y.agpu.mod_quiz.util.slot.removePageBreak(previousslot);
        }
        page.remove();
    },
