...
class update_overdue_attempts extends \core\task\scheduled_task {
     ...
     * @return agpu_recordset of quiz_attempts that need to be processed because time has
     *     passed, sorted by courseid then quizid.
     */
    public function get_list_of_overdue_attempts(int $processto): agpu_recordset {
        global $DB;
