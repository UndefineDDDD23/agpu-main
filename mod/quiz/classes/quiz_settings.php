...
class quiz_settings {
    ...
    public function get_questions(?array $questionids = null, bool $requirequestionfullyloaded = true) {
        ...
        foreach ($questionids as $id) {
            if (!array_key_exists($id, $this->questions)) {
                throw new agpu_exception('cannotstartmissingquestion', 'quiz', $this->view_url());
            }
     ...
     *
     * @return agpu_url the URL of this quiz's view page.
     */
    public function view_url() {
        return new agpu_url('/mod/quiz/view.php', ['id' => $this->cm->id]);
    }

    /**
     * Get the URL of this quiz's edit questions page.
     *
     * @return agpu_url the URL of this quiz's edit page.
     */
    public function edit_url() {
        return new agpu_url('/mod/quiz/edit.php', ['cmid' => $this->cm->id]);
    }
     ...
     * @return agpu_url the URL of that attempt.
     */
    public function attempt_url($attemptid, $page = 0) {
        ...
        return new agpu_url('/mod/quiz/attempt.php', $params);
    }
    ...
    public function start_attempt_url($page = 0) {
        ...
        return new agpu_url('/mod/quiz/startattempt.php', $params);
    }
    ...
    public function review_url($attemptid) {
        return new agpu_url('/mod/quiz/review.php', ['attempt' => $attemptid, 'cmid' => $this->get_cmid()]);
    }
    ...
    public function summary_url($attemptid) {
        return new agpu_url('/mod/quiz/summary.php', ['attempt' => $attemptid, 'cmid' => $this->get_cmid()]);
    }
    ...
    protected function ensure_question_loaded($id) {
        if (isset($this->questions[$id]->_partiallyloaded)) {
            throw new agpu_exception('questionnotloaded', 'quiz', $this->view_url(), $id);
        }
    }
