...
class edit_renderer extends \plugin_renderer_base {
     ...
     * @param \agpu_url $pageurl the canonical URL of this page.
     * @param array $pagevars the variables from {@link question_edit_setup()}.
     * @return string HTML to output.
     */
    public function edit_page(\mod_quiz\quiz_settings $quizobj, structure $structure,
        \core_question\local\bank\question_edit_contexts $contexts, \agpu_url $pageurl, array $pagevars) {
        $output = '';
     ...
     * @return string HTML to output.
     */
    public function maximum_grade_input($structure, \agpu_url $pageurl) {
        $output = '';
     ...
     * @return string HTML to output.
     */
    protected function repaginate_button(structure $structure, \agpu_url $pageurl) {
    ...
    protected function selectmultiple_controls(structure $structure) {
        ...
        $output .= html_writer::tag('div',
                        ...
                        " " .
                        html_writer::tag('button', get_string('cancel', 'agpu'),
        ...
        $selectalltext = get_string('selectall', 'agpu');
        $deselectalltext = get_string('deselectall', 'agpu');
     ...
     * @return string HTML to output.
     */
    protected function repaginate_form(structure $structure, \agpu_url $pageurl) {
        $perpage = [];
    ...
    protected function start_section($structure, $section) {
        ...
        if (!$structure->can_be_edited()) {
            ...
            $editsectionheadingicon = html_writer::link(new \agpu_url('#'),
                $this->pix_icon('t/editstring', get_string('sectionheadingedit', 'quiz', $sectionheadingtext),
                        'agpu', ['class' => 'editicon visibleifjs']),
    ...
    public function section_remove_icon($section) {
        ...
        $url = new \agpu_url('/mod/quiz/edit.php',
     ...
     * @return string HTML to output.
     */
    public function add_menu_actions(structure $structure, $page, \agpu_url $pageurl,
    ...
    public function edit_menu_actions(structure $structure, $page,
            \agpu_url $pageurl, array $pagevars) {
        ...
        $returnurl = new \agpu_url($pageurl, ['addonpage' => $page]);
        ...
        $actions['addaquestion'] = new \action_menu_link_secondary(
            new \agpu_url('/question/bank/editquestion/addquestion.php', $params),
            new \pix_icon('t/add', $str->addaquestion, 'agpu', ['class' => 'iconsmall', 'title' => '']),
            $str->addaquestion, ['class' => 'cm-edit-action addquestion', 'data-action' => 'addquestion']
        );

        // Call question bank.
        $icon = new \pix_icon('t/add', $str->questionbank, 'agpu', ['class' => 'iconsmall', 'title' => '']);
        if ($page) {
        ...
        if ($structure->can_add_random_questions()) {
            $returnurl = new \agpu_url('/mod/quiz/edit.php', ['cmid' => $structure->get_cmid(), 'data-addonpage' => $page]);
            $params = ['returnurl' => $returnurl, 'cmid' => $structure->get_cmid(), 'appendqnumstring' => 'addarandomquestion'];
            $url = new \agpu_url('/mod/quiz/edit.php', $params);
            $icon = new \pix_icon('t/add', $str->addarandomquestion, 'agpu', ['class' => 'iconsmall', 'title' => '']);
        ...
        $actions['addasection'] = new \action_menu_link_secondary(
            new \agpu_url($pageurl, $params),
            new \pix_icon('t/add', $str->addasection, 'agpu', ['class' => 'iconsmall', 'title' => '']),
     ...
     * @return string HTML to output.
     */
    protected function add_question_form(structure $structure, $page, \agpu_url $pageurl, array $pagevars) {
        ...
        return html_writer::tag('form', html_writer::div($output),
                ['class' => 'addnewquestion', 'method' => 'post',
                        'action' => new \agpu_url('/question/bank/editquestion/addquestion.php')]);
    }
     ...
     * @return string HTML to output.
     */
    public function question(structure $structure, int $slot, \agpu_url $pageurl) {
     ...
     * @return string HTML to output.
     */
    public function get_question_name_for_slot(structure $structure, int $slot, \agpu_url $pageurl): string {
     ...
     * @return string HTML to output.
     */
    public function get_action_icon(structure $structure, int $slot, \agpu_url $pageurl): string {
        // Action icons.
        $qtype = $structure->get_question_type_for_slot($slot);
    ...
    public function question_move_icon(structure $structure, $slot) {
        return html_writer::link(new \agpu_url('#'),
            $this->pix_icon('i/dragdrop', get_string('move'), 'agpu', ['class' => 'iconsmall', 'title' => '']),
     ...
     * @param structure $structure object containing the structure of the quiz.
     * @param int $slot the first slot on the page we are outputting.
     * @param \agpu_url $pageurl the canonical URL of the edit page.
     * @return string HTML to output.
     */
    public function question_remove_icon(structure $structure, $slot, $pageurl) {
        $url = new \agpu_url($pageurl, ['sesskey' => sesskey(), 'remove' => $slot]);
    ...
    public function page_split_join_button($structure, $slot) {
        ...
        $url = new \agpu_url('repaginate.php', ['quizid' => $structure->get_quizid(),
    ...
    public function question_name(structure $structure, $slot, $pageurl) {
        ...
        $editurl = new \agpu_url('/question/bank/editquestion/question.php', [
        ...
        $editicon = $this->pix_icon('t/edit', '', 'agpu', ['title' => '']);
    ...
    public function random_question(structure $structure, $slotnumber, $pageurl) {
        ...
        $editurl = new \agpu_url('/mod/quiz/editrandom.php',
        ...
        $editicon = $this->pix_icon('t/edit', $configuretitle, 'agpu', ['title' => '']);
        $qbankurlparams = [
        ...
        $qbankurl = new \agpu_url('/question/edit.php', $qbankurlparams);
    ...
    public function marked_out_of_field(structure $structure, $slot) {
        if (!$structure->is_real_question($slot)) {
            ...
            $output .= html_writer::span(
                    $this->pix_icon('spacer', '', 'agpu', ['class' => 'editicon visibleifjs', 'title' => '']),
                    'editing_maxmark');
        ...
        $output .= html_writer::span(
            html_writer::link(
                new \agpu_url('#'),
                $this->pix_icon('t/editstring', '', 'agpu', ['class' => 'editicon visibleifjs', 'title' => '']),
                [
    ...
    protected function initialise_editing_javascript(structure $structure,
            \core_question\local\bank\question_edit_contexts $contexts, array $pagevars, \agpu_url $pageurl) {
        ...
        $this->page->requires->yui_module('agpu-mod_quiz-toolboxes',
        ...
        $this->page->requires->yui_module('agpu-mod_quiz-dragdrop', 'M.mod_quiz.init_section_dragdrop',
                [[
                        'courseid' => $structure,
                        'quizid' => $structure->get_quizid(),
                        'ajaxurl' => $config->sectionurl,
        ...
        $this->page->requires->yui_module('agpu-mod_quiz-dragdrop', 'M.mod_quiz.init_resource_dragdrop',
                [[
                        'courseid' => $structure,
                        'quizid' => $structure->get_quizid(),
                        'ajaxurl' => $config->resourceurl,
