...
class overrides_actions implements renderable, templatable {
    ...
    public function create_add_button(\renderer_base $output): \single_button {
        $addoverrideurl = new agpu_url('/mod/quiz/overrideedit.php',
    ...
    public function export_for_template(renderer_base $output): array {
        ...
        $useroverridesurl = new agpu_url('/mod/quiz/overrides.php', ['cmid' => $this->cmid, 'mode' => 'user']);
        $groupoverridesurl = new agpu_url('/mod/quiz/overrides.php', ['cmid' => $this->cmid, 'mode' => 'group']);
