...
class view_page {
    ...
    public $canedit;
    /** @var agpu_url $editurl the URL for editing this quiz. */
    public $editurl;
    ...
    public $buttontext;
    /** @var agpu_url $startattempturl URL to start an attempt. */
    ...
    /** @var agpu_url $startattempturl URL for any Back to the course button. */
