...
class override_manager {
    ...
    /**
     * Validates the data, usually from a agpuform or a webservice call.
     * If it contains an 'id' property, additional validation is performed against the existing record.
     *
     * @param array $formdata data from agpuform or webservice call.
     ...
     * @param \stdClass $formdata formdata, usually from agpuform or webservice call.
     * @return array array where the keys are error elements, and the values are lists of errors for each element.
     */
     ...
     *
     * @param array $formdata data usually from agpuform or webservice call.
