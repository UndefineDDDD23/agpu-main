 ...
 */
abstract class attempts_report_options_form extends \agpuform {
     ...
     *
     * @param agpuQuickForm $mform the form we are building.
     */
    protected function standard_attempt_fields(agpuQuickForm $mform) {
     ...
     * @param agpuQuickForm $mform the form we are building.
     */
    protected function other_attempt_fields(agpuQuickForm $mform) {
    }
     ...
     * @param agpuQuickForm $mform the form we are building.
     */
    protected function standard_preference_fields(agpuQuickForm $mform) {
     ...
     * @param agpuQuickForm $mform the form we are building.
     */
    protected function other_preference_fields(agpuQuickForm $mform) {
    }
