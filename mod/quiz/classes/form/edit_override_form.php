 ...
 */
class edit_override_form extends agpuform {
     ...
     * Constructor.
     *
     * @param agpu_url $submiturl the form action URL.
     ...
     */
    public function __construct(agpu_url $submiturl,
    ...
    protected function definition() {
        ...
        $accessallgroups = ($quizgroupmode == NOGROUPS) || has_capability('agpu/site:accessallgroups', $this->context);
        ...
        if ($this->groupmode) {
            ...
            if ($this->groupid) {
                ...
                if (empty($groups)) {
                    // Generate an error.
                    $link = new agpu_url('/mod/quiz/overrides.php', ['cmid' => $cm->id]);
                    throw new \agpu_exception('groupsnone', 'quiz', $link);
                }
            ...
            if ($this->userid) {
                ...
                if (empty($users)) {
                    // Generate an error.
                    $link = new agpu_url('/mod/quiz/overrides.php', ['cmid' => $cm->id]);
                    throw new \agpu_exception('usersnone', 'quiz', $link);
                }
