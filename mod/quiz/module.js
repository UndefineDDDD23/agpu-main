...
M.mod_quiz.init_comment_popup = function(Y) {
    ...
    closebutton.set('value', M.util.get_string('cancel', 'agpu'));
...
M.mod_quiz.timer = {
        ...
        require(['core_user/repository'], function(UserRepository) {
            UserRepository.getUserPreference('quiz_timerhidden')
                ...
                .catch((error) => {
                    ...
                    Y.log(error, 'error', 'agpu-mod_quiz');
                });
        });
    },
    ...
    setVisibility: function(visible, updatePref = true) {
        ...
        if (visible) {
            button.setContent(M.util.get_string('hide', 'agpu'));
            timer.show();
        } else {
            button.setContent(M.util.get_string('show', 'agpu'));
            timer.hide();
        }
