...
$baseurl = new agpu_url('/mod/quiz/reviewquestion.php',
        ['attempt' => $attemptid, 'slot' => $slot]);
$currenturl = new agpu_url($baseurl);
if (!is_null($seq)) {
...
$summary->add_item('user', $userpicture,
    new action_link(new agpu_url('/user/view.php', ['id' => $student->id, 'course' => $attemptobj->get_courseid()]),
