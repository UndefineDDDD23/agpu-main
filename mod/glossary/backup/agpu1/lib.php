 ...
 */
class agpu1_mod_glossary_handler extends agpu1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /agpu_BACKUP/COURSE/MODULES/MOD/GLOSSARY does not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'glossary', '/agpu_BACKUP/COURSE/MODULES/MOD/GLOSSARY',
                array(
                    'newfields' => array(
                        'introformat'       => FORMAT_agpu,
                        'completionentries' => 0,
                    ),
                )
            ),
            new convert_path('glossary_categories', '/agpu_BACKUP/COURSE/MODULES/MOD/GLOSSARY/CATEGORIES'),
            new convert_path(
                'glossary_category', '/agpu_BACKUP/COURSE/MODULES/MOD/GLOSSARY/CATEGORIES/CATEGORY',
                array(
                    'dropfields' => array(
                        'glossaryid'
                    )
    ...
    /**
     * This is executed every time we have one /agpu_BACKUP/COURSE/MODULES/MOD/GLOSSARY
     * data available
     */
    public function process_glossary($data) {
        ...
        $data['intro'] = agpu1_converter::migrate_referenced_files($data['intro'], $this->fileman);
    ...
    /**
     * This is executed every time we have one /agpu_BACKUP/COURSE/MODULES/MOD/GLOSSARY/CATEGORIES/CATEGORY
     * data available
     */
