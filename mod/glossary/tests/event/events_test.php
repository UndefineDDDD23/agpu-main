...
class events_test extends \advanced_testcase {
    ...
    public function test_comment_created(): void {
        ...
        $url = new \agpu_url('/mod/glossary/view.php', array('id' => $glossary->cmid));
    ...
    public function test_course_module_viewed(): void {
        ...
        $this->assertEquals(new \agpu_url('/mod/glossary/view.php', array('id' => $glossary->cmid, 'mode' => $mode)), $event->get_url());
        $this->assertEventContextNotUsed($event);
    }
