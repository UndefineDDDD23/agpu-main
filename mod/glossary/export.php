...
$url = new agpu_url('/mod/glossary/export.php', array('id'=>$id));
if ($cat !== 0) {
    $url->param('cat', $cat);
}
if ($mode !== '') {
...
echo $OUTPUT->header();
$backlink = html_writer::link(new agpu_url('view.php', ['id' => $cm->id]),
...
$exporturl = agpu_url::make_pluginfile_url($context->id, 'mod_glossary', 'export', 0, "/$cat/", 'export.xml', true);
