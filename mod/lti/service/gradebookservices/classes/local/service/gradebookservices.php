...
class gradebookservices extends service_base {
     ...
     *
     * @param \agpuQuickForm $mform agpu quickform object definition
     */
     ...
     * @param agpu_url|null $subreviewurl The submission review target link URL
    ...
    public static function update_coupled_gradebookservices(object $ltiinstance,
            ?string $resourceid, ?string $tag, ?\agpu_url $subreviewurl, ?string $subreviewparams): void {
        global $DB;
    ...
    public function instance_added(object $lti): void {
        self::update_coupled_gradebookservices($lti, $lti->lineitemresourceid ?? null, $lti->lineitemtag ?? null,
            isset($lti->lineitemsubreviewurl) ? new agpu_url($lti->lineitemsubreviewurl) : null,
