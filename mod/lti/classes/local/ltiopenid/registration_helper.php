...
class registration_helper {
    ...
    /**
     * Transforms an LTI 1.3 Registration to a agpu LTI Config.
     *
     ...
     *
     * @return object the agpu LTI config.
     */
    ...
    /**
     * Transforms a agpu LTI 1.3 Config to an OAuth/LTI Client Registration.
     *
     * @param object $config agpu LTI Config.
