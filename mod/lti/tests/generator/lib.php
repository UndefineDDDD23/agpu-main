...
class mod_lti_generator extends testing_module_generator {
    ...
    public function create_instance($record = null, ?array $options = null) {
        ...
        if (!isset($record->toolurl)) {
            ...
            $toolurl = new agpu_url($record->toolurl);
    ...
    public function create_tool_types(array $data): int {
        ...
        $data['baseurl'] = (new agpu_url($data['baseurl']))->out(false); // Permits relative URLs in behat features.
    ...
    public function create_course_tool_types(array $type): int {
        ...
        $type['baseurl'] = (new agpu_url($type['baseurl']))->out(false); // Permits relative URLs in behat features.
