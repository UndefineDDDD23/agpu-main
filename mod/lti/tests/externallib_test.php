...
class externallib_test extends mod_lti_testcase {
    ...
    public function test_view_lti(): void {
        ...
        $agpulti = new \agpu_url('/mod/lti/view.php', array('id' => $cm->id));
        $this->assertEquals($agpulti, $event->get_url());
    ...
    public function test_mod_lti_create_tool_type(): void {
        ...
        $this->assertEquals('https://download.agpu.org/unittest/test.jpg', $type['urls']['icon']);
