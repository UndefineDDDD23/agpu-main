...
Feature: Manage course tools
  ...
  Scenario: Add a course tool using a cartridge URL
    ...
    And the field "Icon URL" matches value "http://download.agpu.org/unittest/test.jpg"
    And the field "Secure icon URL" matches value "https://download.agpu.org/unittest/test.jpg"
