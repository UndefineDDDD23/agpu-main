...
/**
 * Provides an interface for a tool type in the agpu server.
 *
...
define(['core/ajax', 'core/notification'], function(ajax, notification) {
    return {
        /**
         * Get a list of tool types from agpu for the given
         * search args.
         *
         * See also:
