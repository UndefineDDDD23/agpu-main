...
/**
 * Provides an interface for external tools in the agpu server.
 *
...
/**
 * Get a list of LTI tool types and tool proxies from agpu for the given
 * search args.
 *
 * See also:
...
/**
 * Get a count of LTI tool types and tool proxies from agpu for the given
 * search args.
 *
 * See also:
