 ...
 */
 define(['jquery', 'core/ajax', 'core/notification', 'core/templates', 'core/modal',
    ...
    /**
     * Delete the tool type from the agpu server. Triggers a success
     ...
     * in the agpu server. A success or failure announcement is triggered depending
     * on the result.
     *
     ...
     * type requires access to in agpu (if any).
     *
