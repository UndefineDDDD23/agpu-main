...
$redirect = new agpu_url('/mod/lti/toolproxies.php', array('tab' => $tab));
...
$redirect = new agpu_url('/mod/lti/toolproxies.php');
if ($duplicate) {
...
$url = new agpu_url('/mod/lti/register.php', array('id' => $id));
$PAGE->set_url($url);
...
$registration = new agpu_url('/mod/lti/registration.php',
