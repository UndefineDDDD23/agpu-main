...
namespace agpu\mod\lti; // Using a namespace as the basicLTI module imports classes with the same names.
...
class TrivialOAuthDataStore extends OAuthDataStore {
     ...
     * @param string $consumerkey     Consumer key
     *
     * @return agpu\mod\lti\OAuthConsumer  OAuthConsumer object
     */
     ...
     *
     * @param agpu\mod\lti\OAuthConsumer $consumer     Consumer
     * @param string $tokentype    Type of token
     * @param string $token        Token ID
     *
     * @return agpu\mod\lti\OAuthToken OAuthToken object
     */
