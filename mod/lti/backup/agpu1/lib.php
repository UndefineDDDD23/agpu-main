...
class agpu1_mod_lti_handler extends agpu1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /agpu_BACKUP/COURSE/MODULES/MOD/LTI does not
    ...
    public function get_paths() {
        ...
        return array(
            new convert_path(
                'basiclti', '/agpu_BACKUP/COURSE/MODULES/MOD/LTI'
            )
        );
    ...
    /**
     * This is executed every time we have one /agpu_BACKUP/COURSE/MODULES/MOD/LTI
     * data available
     */
