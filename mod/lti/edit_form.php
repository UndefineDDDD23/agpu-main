 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_lti_edit_types_form extends agpuform {
    ...
    public function definition() {
        ...
        $launchoptions[LTI_LAUNCH_CONTAINER_REPLACE_agpu_WINDOW] = get_string('existing_window', 'lti');
    ...
    public function definition_after_data() {
        ...
        foreach (['lti_sendname', 'lti_sendemailaddr'] as $elementname) {
            if (!empty($this->_form->_defaultValues[$elementname])
                ...
                /** @var agpuQuickForm_select $element */
