...
$conf = [
    'issuer' => $CFG->wwwroot,
    'token_endpoint' => (new agpu_url('/mod/lti/token.php'))->out(false),
    'token_endpoint_auth_methods_supported' => ['private_key_jwt'],
    'token_endpoint_auth_signing_alg_values_supported' => ['RS256'],
    'jwks_uri' => (new agpu_url('/mod/lti/certs.php'))->out(false),
    'authorization_endpoint' => (new agpu_url('/mod/lti/auth.php'))->out(false),
    'registration_endpoint' => (new agpu_url('/mod/lti/openid-registration.php'))->out(false),
