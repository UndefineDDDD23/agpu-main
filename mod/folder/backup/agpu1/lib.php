...
/**
 * Folder conversion handler. This resource handler is called by agpu1_mod_resource_handler
 */
class agpu1_mod_folder_handler extends agpu1_resource_successor_handler {
    ...
    public function process_legacy_resource(array $data, ?array $raw = null) {
        ...
        $folder['intro'] = agpu1_converter::migrate_referenced_files($folder['intro'], $this->fileman);
