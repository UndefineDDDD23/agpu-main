    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        if ($next) {
            $nextdata = [
                ...
                'url' => (new agpu_url('/mod/book/view.php', ['id' => $this->cmid, 'chapterid' => $next->id]))->out(false)
            ];
            $data['next'] = $nextdata;
        }
        if ($previous) {
            $previousdata = [
                ...
                'url' => (new agpu_url('/mod/book/view.php', ['id' => $this->cmid, 'chapterid' => $previous->id]))->out(false)
            ];
