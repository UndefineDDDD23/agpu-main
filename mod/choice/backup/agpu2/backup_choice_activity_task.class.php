...
require_once($CFG->dirroot . '/mod/choice/backup/agpu2/backup_choice_stepslib.php');
require_once($CFG->dirroot . '/mod/choice/backup/agpu2/backup_choice_settingslib.php');
