 ...
 */
class agpu1_mod_choice_handler extends agpu1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /agpu_BACKUP/COURSE/MODULES/MOD/CHOICE does not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'choice', '/agpu_BACKUP/COURSE/MODULES/MOD/CHOICE',
                array(
                    'renamefields' => array(
                        'text' => 'intro',
                        'format' => 'introformat',
            ...
            new convert_path('choice_options', '/agpu_BACKUP/COURSE/MODULES/MOD/CHOICE/OPTIONS'),
            new convert_path('choice_option', '/agpu_BACKUP/COURSE/MODULES/MOD/CHOICE/OPTIONS/OPTION'),
        );
    }

    /**
     * This is executed every time we have one /agpu_BACKUP/COURSE/MODULES/MOD/CHOICE
     * data available
     */
    ...
    /**
     * This is executed every time we have one /agpu_BACKUP/COURSE/MODULES/MOD/CHOICE/OPTIONS/OPTION
     * data available
     */
