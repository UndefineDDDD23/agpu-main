...
class externallib_test extends externallib_advanced_testcase {
    ...
    public function test_view_scorm(): void {
        ...
        $agpuurl = new \agpu_url('/mod/scorm/view.php', array('id' => $this->cm->id));
    ...
    public function test_mod_scorm_get_scorms_by_courses(): void {
        ...
        $packageurl1 = \agpu_url::make_webservice_pluginfile_url(
                            $scormcontext1->id, 'mod_scorm', 'package', 0, '/', $scorm1->reference)->out(false);
        $packageurl2 = \agpu_url::make_webservice_pluginfile_url(
    ...
    public function test_launch_sco(): void {
        ...
        $this->assertEquals($this->context, $event->get_context());
        $agpuurl = new \agpu_url('/mod/scorm/player.php', array('cm' => $this->cm->id, 'scoid' => $sco->id));
        $this->assertEquals($agpuurl, $event->get_url());
        $this->assertEventContextNotUsed($event);
        $this->assertNotEmpty($event->get_name());
