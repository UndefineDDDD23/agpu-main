...
$url = new agpu_url('/mod/chat/gui_sockets/index.php', array('id' => $id));
if ($groupid !== 0) {
...
if (!$chatsid = chat_login_user($chat->id, 'sockets', $groupid, $course)) {
    throw new \agpu_exception('cantlogin');
}
...
<html>
 ...
 <noframes>
  Sorry, this version of agpu Chat needs a browser that handles frames.
 </noframes>
</html>
