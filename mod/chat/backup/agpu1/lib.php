 ...
 */
class agpu1_mod_chat_handler extends agpu1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /agpu_BACKUP/COURSE/MODULES/MOD/CHAT does not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'chat', '/agpu_BACKUP/COURSE/MODULES/MOD/CHAT',
                array(
                    'newfields' => array(
                        'introformat' => 0
                    )
    ...
    /**
     * This is executed every time we have one /agpu_BACKUP/COURSE/MODULES/MOD/CHAT
     * data available
     */
    ...
    /**
     * This is executed every time we have one /agpu_BACKUP/COURSE/MODULES/MOD/CHAT/MESSAGES/MESSAGE
     * data available
     */
