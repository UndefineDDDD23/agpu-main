...
/**
 * Strings for component 'chat', language 'en', branch 'agpu_20_STABLE'
 *
 * @package   mod_chat
...
* Smilies - Any smiley faces (emoticons) that you can type elsewhere in agpu can also be typed here, for example :-)
