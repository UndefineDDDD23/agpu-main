...
class lib_test extends \advanced_testcase {
    ...
    public function test_chat_core_calendar_provide_event_action_chattime_event_different_timezones(): void {
        ...
        $this->assertInstanceOf('agpu_url', $actionevent12->get_url());
        ...
        $this->assertInstanceOf('agpu_url', $actionevent21->get_url());
        ...
        $this->assertInstanceOf('agpu_url', $actionevent22->get_url());
