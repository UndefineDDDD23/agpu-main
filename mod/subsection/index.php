...
if (empty($subsections)) {
    notice(get_string('thereareno', 'agpu', $modulenameplural), "$CFG->wwwroot/course/view.php?id=$course->id");
}
...
foreach ($subsections as $subsection) {
    if (!$subsection->visible) {
        $link = html_writer::link(
            new agpu_url('/mod/subsection/view.php', ['id' => $subsection->coursemodule]),
