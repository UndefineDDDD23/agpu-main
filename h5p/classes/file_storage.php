 ...
 *
 * @package    core_h5p
 * @copyright  2019 Victor Deniz <victor@agpu.com>, base on code by Joubel AS
...
use stored_file;
use agpu\H5PCore;
use agpu\H5peditorFile;
use agpu\H5PFileStorage;
...
class file_storage implements H5PFileStorage {
    ...
    /**
     * Stores a H5P library in the agpu filesystem.
     *
    ...
    public function saveContent($source, $content) {
        ...
        // Copy content directory into agpu filesystem.
    ...
    public function hasWriteAccess() {
        // agpu has access to the files table which is where all of the folders are stored.
        return true;
    }
    ...
    /**
     * Converts a relative system file path into agpu File API elements.
     *
     ...
     *
     * @throws \agpu_exception If the CSS setting is empty but there is a file to serve
    ...
    public static function get_custom_styles(): ?array {
        ...
        if (self::get_custom_styles_file($record)) {
            ...
            $cssurl = \agpu_url::make_pluginfile_url(
                $record['contextid'],
                $record['component'],
                $record['filearea'],
                null,
