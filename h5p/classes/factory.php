 ...
 *
 * @package    core_h5p
 * @copyright  2019 Mihail Geshoski <mihail@agpu.com>
...
use agpu\H5PContentValidator as content_validator;
use agpu\H5peditor;
use agpu\H5PStorage as storage;
use agpu\H5PValidator as validator;
...
class factory {
    ...
    /** @var \core_h5p\core The agpu H5PCore implementation */
    protected $core;

    /** @var \core_h5p\framework The agpu H5PFramework implementation */
    protected $framework;

    /** @var \core_h5p\file_storage The agpu H5PStorage implementation */
    protected $storage;

    /** @var validator The agpu H5PValidator implementation */
    protected $validator;

    /** @var content_validator The agpu H5PContentValidator implementation */
    protected $content_validator;

    /** @var editor_framework The agpu H5peditorStorage implementation */
    protected $editorframework;

    /** @var H5peditor */
    protected $editor;

    /** @var editor_ajax The agpu H5PEditorAjaxInterface implementation */
    ...
    public function get_core(): core {
        if (null === $this->core) {
            ...
            $url = \agpu_url::make_pluginfile_url($context->id, 'core_h5p', '', null,
                '', '')->out();
     ...
     *
     * @return agpu\H5PContentValidator
     */
