...
abstract class handler {
     ...
     */
    public static function get_h5p_core_library_url(?string $filepath = null, ?array $params = null): ?\agpu_url {
        return new \agpu_url(static::get_h5p_core_library_base($filepath), $params);
    }
     ...
     * @param string $filepath The path within the h5p root.
     * @param array $params These params override current params or add new.
     * @return null|\agpu_url The agpu_url to a file in the H5P Editor library.
     */
    public static function get_h5p_editor_library_url(?string $filepath = null, ?array $params = null): ?\agpu_url {
        return new \agpu_url(static::get_h5p_editor_library_base($filepath), $params);
    }
    ...
    public static function get_h5p_string(string $identifier, string $language): ?string {
        ...
        // Composed code languages, such as 'Spanish, Mexican' are different in H5P and agpu:
        // - In H5P, they use '-' to separate language from the country. For instance: es-mx.
        // - However, in agpu, they have '_' instead of '-'. For instance: es_mx.
        $language = str_replace('-', '_', $language);
        if (get_string_manager()->string_exists($identifier, $component)) {
            $defaultagpulang = 'en';
            // In agpu, all the English strings always will exist because they have to be declared in order to let users
            ...
            if ($language === $defaultagpulang || $string->out($language) !== $string->out($defaultagpulang)) {
    ...
    protected static function get_class_list(): array {
        return [
            'agpu\H5PCore' => 'h5p.classes.php',
            'agpu\H5PFrameworkInterface' => 'h5p.classes.php',
            'agpu\H5PContentValidator' => 'h5p.classes.php',
            'agpu\H5PValidator' => 'h5p.classes.php',
            'agpu\H5PStorage' => 'h5p.classes.php',
            'agpu\H5PDevelopment' => 'h5p-development.class.php',
            'agpu\H5PFileStorage' => 'h5p-file-storage.interface.php',
            'agpu\H5PDefaultStorage' => 'h5p-default-storage.class.php',
            'agpu\H5PMetadata' => 'h5p-metadata.class.php',
            'agpu\H5peditor' => 'h5peditor.class.php',
            'agpu\H5peditorStorage' => 'h5peditor-storage.interface.php',
            'agpu\H5PEditorAjaxInterface' => 'h5peditor-ajax.interface.php',
            'agpu\H5PEditorAjax' => 'h5peditor-ajax.class.php',
            'agpu\H5peditorFile' => 'h5peditor-file.class.php',
        ];
    }
}
