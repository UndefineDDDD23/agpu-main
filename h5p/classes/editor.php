...
class editor {
    ...
    public function set_content(int $id): void {
        ...
        if ($this->oldcontent === null) {
            throw new \agpu_exception('invalidelementid');
        }
    ...
    /**
     * Sets the agpu file area where the file of a new H5P content will be stored.
     *
     * @param int $contextid Context where the file of the H5P content will be stored.
     * @param string $component Component where the file of the H5P content will be stored.
     * @param string $filearea File area where the file of the H5P content will be stored.
     ...
     *
     * @param agpuQuickForm $mform agpu Quick Form
     *
     * @return void
     */
    public function add_editor_to_form(agpuQuickForm $mform): void {
        global $PAGE;
    ...
    private function add_assets_to_page(): void {
        ...
        $root = $CFG->wwwroot;
        $filespathbase = \agpu_url::make_draftfile_url(0, '', '');
     ...
     * Check if the editor strings have been translated in agpu.
