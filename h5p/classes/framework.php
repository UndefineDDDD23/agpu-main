...
/**
 * agpu's implementation of the H5P framework interface.
 *
 * @package    core_h5p
...
class framework implements H5PFrameworkInterface {
     ...
     *               - name: The name of the platform, for instance "agpu"
    ...
    public function getLibraryFileUrl($libraryfoldername, $filename) {
        ...
        return \agpu_url::make_pluginfile_url($context->id, 'core_h5p', 'libraries',
    ...
    public function isInDevMode() {
        return false; // Not supported (Files in agpu not editable).
    }
     ...
     * {@see \agpu\H5PEditorAjax::isContentTypeCacheUpdated}, the setting content_type_cache_updated_at
    ...
    public function getOption($name, $default = false) {
        if ($name == core::DISPLAY_OPTION_DOWNLOAD || $name == core::DISPLAY_OPTION_EMBED) {
            ...
            return \agpu\H5PDisplayOptionBehaviour::CONTROLLED_BY_AUTHOR_DEFAULT_OFF;
        }
