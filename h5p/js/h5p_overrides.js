...
H5P.getLibraryPath = function (library) {
    if (H5PIntegration.agpuLibraryPaths) {
        if (H5PIntegration.agpuLibraryPaths[library]) {
            return H5PIntegration.agpuLibraryPaths[library];
        }
    }
...
H5P.getagpuComponent = function () {
    if (H5PIntegration.agpuComponent) {
        return H5PIntegration.agpuComponent;
    }
    return undefined;
};
