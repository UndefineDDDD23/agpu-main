...
document.onreadystatechange = async() => {
    ...
    H5P.externalDispatcher.on('xAPI', function(event) {
        ...
        var agpucomponent = H5P.getagpuComponent();
        if (agpucomponent == undefined) {
            return;
        }
        ...
        if (isCompleted && !isChild) {
            ...
            H5PEmbedCommunicator.post(agpucomponent, statements);
    ...
    H5P.externalDispatcher.on('xAPIState', function(event) {
        ...
        if (state === null) {
            ...
            H5PEmbedCommunicator.deleteState(agpucomponent, contentId, H5P.getxAPIActor(), stateId);
            ...
            H5PEmbedCommunicator.postState(agpucomponent, contentId, H5P.getxAPIActor(), stateId, JSON.stringify(statedata));
        }
    });
