...
/**
 * Testing the agpu local class for managing the H5P Editor.
 *
 * @package    core_h5p
 * @category   test
...
class editor_test extends advanced_testcase {
    ...
    protected function get_test_form() {
        ...
        return new class extends \agpuform {
            /**
             * Form definition.
             */
    ...
    public function test_add_editor_to_form(): void {
        ...
        $expectedjs[] = (new \agpu_url('/h5p/js/h5p_overrides.js' . $cachebuster))->out();
