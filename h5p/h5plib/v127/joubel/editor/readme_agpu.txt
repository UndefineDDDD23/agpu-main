 ...
 * Review strings in joubel/editor/language/en.js and compare them with
   ...
   because they are related to the H5P Hub which is not currently supported by agpu.
 * Add namespace to this library to avoid collision. It means:
     - Add the "namespace agpu;" line at the top of all the h5peditor*.php files in the root folder.
