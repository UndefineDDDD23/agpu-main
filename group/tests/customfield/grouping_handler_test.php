...
class grouping_handler_test extends advanced_testcase {
    ...
    public function test_can_configure(): void {
        ...
        assign_capability('agpu/group:configurecustomfields', CAP_ALLOW, $roleid, context_system::instance()->id, true);
    ...
    public function test_can_edit(): void {
        ...
        $grouping = self::getDataGenerator()->create_grouping(['courseid' => $course->id]);
        $roleid = self::getDataGenerator()->create_role();
        assign_capability('agpu/course:managegroups', CAP_ALLOW, $roleid, $contextid, true);
    ...
    public function test_can_view(): void {
        ...
        assign_capability('agpu/course:managegroups', CAP_ALLOW, $manageroleid, $contextid, true);

        $viewroleid = self::getDataGenerator()->create_role();
        assign_capability('agpu/course:view', CAP_ALLOW, $viewroleid, $contextid, true);

        $viewandmanageroleid = self::getDataGenerator()->create_role();
        assign_capability('agpu/course:managegroups', CAP_ALLOW, $viewandmanageroleid, $contextid, true);
        assign_capability('agpu/course:view', CAP_ALLOW, $viewandmanageroleid, $contextid, true);
