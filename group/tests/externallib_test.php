...
class externallib_test extends externallib_advanced_testcase {
    ...
    public function test_create_groups(): void {
        ...
        $group1['descriptionformat'] = FORMAT_agpu;
        ...
        $roleid = $this->assignUserCapability('agpu/course:managegroups', $context->id);
        $this->assignUserCapability('agpu/course:view', $context->id, $roleid);
        ...
        foreach ($groups as $group) {
            ...
            switch ($dbgroup->name) {
                ...
                case $group2['name']:
                    ...
                    break;
                default:
                    throw new \agpu_exception('unknowgroupname');
                    break;
            }
        ...
        $this->unassignUserCapability('agpu/course:managegroups', $context->id, $roleid);
    ...
    public function test_update_groups(): void {
        ...
        $group1data['descriptionformat'] = FORMAT_agpu;
        ...
        foreach ([$group1, $group2] as $group) {
            ...
            switch ($dbgroup->name) {
                ...
                case $group2data['name']:
                    ...
                    break;
                default:
                    throw new \agpu_exception('unknowngroupname');
                    break;
            }
            $this->assertEquals($dbgroup->description, $groupdescription);
            $this->assertEquals($dbgroup->visibility, $groupvisibility);
    ...
    public function test_create_update_groupings(): void {
        ...
        $grouping1data['descriptionformat'] = FORMAT_agpu;
        ...
        $grouping2data['descriptionformat'] = FORMAT_agpu;
    ...
    public function test_get_groupings(): void {
        ...
        $groupingdata['descriptionformat'] = FORMAT_agpu;
        ...
        $group2data['name'] = 'Group Test 2';
        $group2data['description'] = 'Group Test 2 description';
        $group2data['descriptionformat'] = FORMAT_agpu;
