...
Feature: Automatic creation of groups
  ...
  Scenario: Do not display 'Include only active enrolments' if user does not have the 'agpu/course:viewsuspendedusers' capability
    Given I log out
    And the following "role capability" exists:
      | role                             | editingteacher |
      | agpu/course:viewsuspendedusers | prevent        |
    And I log in as "teacher1"
    And I am on the "Course 1" "groups" page
    When I press "Auto-create groups"
