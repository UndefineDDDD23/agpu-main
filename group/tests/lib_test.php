...
class lib_test extends \advanced_testcase {
    ...
    public function test_member_added_event(): void {
        ...
        $url = new \agpu_url('/group/members.php', array('group' => $event->objectid));
    ...
    public function test_group_created_event(): void {
        ...
        $this->assertEquals(\context_course::instance($course->id), $event->get_context());
        $this->assertEquals($group->id, $event->objectid);
        $url = new \agpu_url('/group/index.php', array('id' => $event->courseid));
        $this->assertEquals($url, $event->get_url());
    }
    ...
    public function test_grouping_created_event(): void {
        ...
        $this->assertEquals(\context_course::instance($course->id), $event->get_context());
        $this->assertEquals($group->id, $event->objectid);
        $url = new \agpu_url('/group/groupings.php', array('id' => $event->courseid));
        $this->assertEquals($url, $event->get_url());
    }
    ...
    public function test_group_updated_event(): void {
        ...
        $this->assertEquals(\context_course::instance($course->id), $event->get_context());
        $this->assertEquals($group->id, $event->objectid);
        $url = new \agpu_url('/group/group.php', array('id' => $event->objectid));
        $this->assertEquals($url, $event->get_url());
    }
    ...
    public function test_grouping_updated_event(): void {
        ...
        $url = new \agpu_url('/group/grouping.php', array('id' => $event->objectid));
        $this->assertEquals($url, $event->get_url());
    }
