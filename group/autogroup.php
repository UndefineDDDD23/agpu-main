...
if ($editform->is_cancelled()) {
    ...
    switch ($data->allocateby) {
        ...
        default:
            throw new \agpu_exception('unknoworder');
    }
    $source = array();
    if ($data->cohortid) {
    ...
    $onlyactive = !empty($data->includeonlyactiveenrol) || !has_capability('agpu/course:viewsuspendedusers', $context);
...
$PAGE->navbar->add($strgroups, new agpu_url('/group/index.php', array('id'=>$courseid)));
