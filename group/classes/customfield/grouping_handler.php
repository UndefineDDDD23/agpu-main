...
class grouping_handler extends handler {
    ...
    public function can_configure(): bool {
        return has_capability('agpu/group:configurecustomfields', $this->get_configuration_context());
    }
    ...
    public function can_edit(field_controller $field, int $instanceid = 0): bool {
        return has_capability('agpu/course:managegroups', $this->get_instance_context($instanceid));
    }
    ...
    public function can_view(field_controller $field, int $instanceid): bool {
        return has_any_capability(['agpu/course:managegroups', 'agpu/course:view'], $this->get_instance_context($instanceid));
    }
    ...
    public function get_configuration_url(): agpu_url {
        return new agpu_url('/group/grouping_customfield.php');
    }
