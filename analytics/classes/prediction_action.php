...
class prediction_action extends action {
     ...
     * @param \agpu_url $actionurl The final URL where the user should be forwarded.
     ...
     * @return void
     */
    public function __construct($actionname, \core_analytics\prediction $prediction, \agpu_url $actionurl, \pix_icon $icon,
     ...
     * @return \agpu_url
     */
    public static function transform_to_forward_url(\agpu_url $actionurl, string $actionname, int $predictionid): \agpu_url {
        ...
        return new \agpu_url('/report/insights/action.php', $params);
    }
}
