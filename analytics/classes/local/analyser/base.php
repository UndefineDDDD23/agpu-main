...
abstract class base {
    ...
    /**
     * Returns the sample's origin in agpu database.
     *
     * @return string
     */
     ...
     *
     * agpu/analytics:listinsights will be required at this level to access the sample predictions.
     *
     * @param int $sampleid
     * @return \context
     */
     ...
     * - The function caller expects the returned 'user' table to be aliased as 'u' (defacto standard in agpu).
