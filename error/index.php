 ...
 * to agpu to be rendered using the site theme.
 *
...
if ($ME === '/.well-known/change-password') {
    redirect(new agpu_url('/login/change_password.php'));
}
...
$canmessage = has_capability('agpu/site:senderrormessage', $context);
