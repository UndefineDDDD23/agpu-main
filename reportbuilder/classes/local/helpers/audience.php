...
class audience {
    ...
    public static function user_reports_list_access_sql(
        ...
        if (has_any_capability(['agpu/reportbuilder:editall', 'agpu/reportbuilder:viewall'], $context, $userid)) {
            return ['1=1', []];
        }
        ...
        if (has_capability('agpu/reportbuilder:edit', $context, $userid)) {
            $paramuserid = database::generate_param_name();
    ...
    /**
     * @deprecated since agpu 4.1 - please do not use this function any more, {@see custom_report_audience_cards_exporter}
     */
