 ...
 * @copyright  2020 Sara Arjona <sara@agpu.com> based on Marina Glancy code.
...
class user extends base {
    ...
    protected function get_all_columns(): array {
        ...
        $viewfullnames = has_capability('agpu/site:viewfullnames', context_system::instance());
            ...
            $column = (new column(
                ...
                ->add_callback(static function(?string $value, stdClass $row) use ($fullnamefield, $viewfullnames): string {
                    ...
                    if ($fullnamefield === 'fullnamewithlink') {
                        return html_writer::link(new agpu_url('/user/profile.php', ['id' => $row->id]),
    ...
    protected function get_user_fields(): array {
        return [
            ...
            'auth' => new lang_string('authentication', 'agpu'),
