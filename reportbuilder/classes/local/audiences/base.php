...
abstract class base {
     ...
     * @return string
     *
     * @deprecated since agpu 4.2 - please do not use this function any more, {@see get_component_displayname}
     */
     ...
     */
    abstract public function get_config_form(agpuQuickForm $mform): void;
