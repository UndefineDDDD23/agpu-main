...
class report extends dynamic_form {
    ...
    public function process_dynamic_submission() {
        ...
        return (new agpu_url('/reportbuilder/edit.php', ['id' => $reportpersistent->get('id')]))->out(false);
    }
     ...
     * @return agpu_url
     */
    public function get_page_url_for_dynamic_submission(): agpu_url {
        return new agpu_url('/reportbuilder/index.php');
    }
