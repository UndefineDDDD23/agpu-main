...
class schedule extends dynamic_form {
    ...
    protected function definition() {
        ...
        if (has_capability('agpu/reportbuilder:scheduleviewas', $context)) {
    ...
    protected function get_page_url_for_dynamic_submission(): agpu_url {
        return new agpu_url('/reportbuilder/edit.php', ['id' => $this->optional_param('reportid', 0, PARAM_INT)], 'schedules');
    }
}
