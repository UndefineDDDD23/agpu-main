...
class manual extends base {
    ...
    public function get_config_form(agpuQuickForm $mform): void {
        ...
        $options = [
            ...
            'valuehtmlcallback' => function($userid) {
                ...
                return fullname($user, has_capability('agpu/site:viewfullnames', context_system::instance()));
            }
        ];
    ...
    public function user_can_add(): bool {
        return has_capability('agpu/user:viewalldetails', context_system::instance());
    }
