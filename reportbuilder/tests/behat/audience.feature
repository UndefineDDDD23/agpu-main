...
Feature: Configure access to reports based on intended audience
  ...
  Scenario: Configure report audience as user who cannot use specific audience
    ...
    And the following "permission overrides" exist:
      ...
      | agpu/reportbuilder:editall | Allow      | manager | System       |           |
      | agpu/cohort:view           | Prohibit   | manager | System       |           |
  ...
  Scenario: View report as a user with edit capability
    ...
    And the following "permission overrides" exist:
      | capability                    | permission  | role            | contextlevel | reference |
      | agpu/reportbuilder:editall  | Prohibit    | viewreportsrole | System       |           |
      | agpu/reportbuilder:edit     | Allow       | viewreportsrole | System       |           |
      | agpu/reportbuilder:view     | Prohibit    | viewreportsrole | System       |           |
    When I log in as "user1"
    And I follow "Reports" in the user menu
    And I should see "Nothing to display"
  ...
  Scenario: View report as a user with editall capability
    ...
    And the following "permission overrides" exist:
      | capability                    | permission  | role            | contextlevel | reference |
      | agpu/reportbuilder:editall  | Allow       | viewreportsrole | System       |           |
      | agpu/reportbuilder:edit     | Prohibit    | viewreportsrole | System       |           |
      | agpu/reportbuilder:view     | Prohibit    | viewreportsrole | System       |           |
    When I log in as "user1"
    And I follow "Reports" in the user menu
    Then I should see "My report" in the "reportbuilder-table" "table"
