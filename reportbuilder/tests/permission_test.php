...
class permission_test extends advanced_testcase {
    ...
    public function test_require_can_view_reports_list(): void {
        ...
        unassign_capability('agpu/reportbuilder:view', $userrole, context_system::instance());
    ...
    public function test_require_can_edit_report_own(): void {
        ...
        $userrole = $DB->get_field('role', 'id', ['shortname' => 'user']);
        assign_capability('agpu/reportbuilder:edit', CAP_ALLOW, $userrole, context_system::instance());
    ...
    public function test_require_can_edit_report_all(): void {
        ...
        $userrole = $DB->get_field('role', 'id', ['shortname' => 'user']);
        assign_capability('agpu/reportbuilder:editall', CAP_ALLOW, $userrole, context_system::instance());
    ...
    public function test_require_can_create_report(): void {
        ...
        assign_capability('agpu/reportbuilder:edit', CAP_ALLOW, $roleid, context_system::instance());
        ...
        assign_capability('agpu/reportbuilder:editall', CAP_ALLOW, $roleid2, context_system::instance());
