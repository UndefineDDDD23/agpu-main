...
admin_externalpage_setup('customreports', null, ['id' => $reportid], new agpu_url('/reportbuilder/edit.php'));
navigation_node::override_active_url(new agpu_url('/reportbuilder/index.php'));
