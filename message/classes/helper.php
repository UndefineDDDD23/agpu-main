...
class helper {
    ...
    public static function get_member_info(int $referenceuserid, array $userids, bool $includecontactrequests = false,
        ...
        foreach ($otherusers as $member) {
            ...
            $profileurl = new \agpu_url('/user/profile.php', ['id' => $member->id]);
        ...
        // from the agpu database table (which can happen in earlier versions of agpu).
    ...
    public static function render_messaging_widget(
        ...
        if ($isdrawer) {
            ...
            $messageurl = new \agpu_url('/message/index.php');
        } else {
