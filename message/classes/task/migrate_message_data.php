...
class migrate_message_data extends \core\task\adhoc_task {
    ...
    public function execute() {
        ...
        if (!$hasbeenmigrated) {
            ...
            if ($updatepreference) {
                ...
                throw new \agpu_exception('Task failed.');
            }
        }
    }
    ...
    private function migrate_notification($notification, $isread) {
        ...
        $tabledata->fullmessageformat = $notification->fullmessageformat ?? FORMAT_agpu;
    ...
    private function migrate_message($conversationid, $message) {
        ...
        $tabledata->fullmessageformat = $message->fullmessageformat ?? FORMAT_agpu;
