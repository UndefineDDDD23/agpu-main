...
final class api_test extends \advanced_testcase {
    ...
    /**
     * Tests searching users as a user having the 'agpu/user:viewdetails' capability.
     */
    public function test_message_search_users_with_cap(): void {
        ...
        assign_capability('agpu/user:viewdetails', CAP_ALLOW, $authenticatedrole->id, \context_system::instance());
    ...
    public function test_get_favourite_conversations(): void {
        ...
        testhelper::send_fake_message($user1, $user4, 'Hey mate, you see the new messaging UI in agpu?', 0, $time + 9);
    ...
    public function test_get_conversations_group_linked(): void {
        ...
        $this->assertEquals(2, $conversations[0]->membercount);
        $this->assertEquals($course1->shortname, $conversations[0]->subname);
        $this->assertEquals('https://www.example.com/agpu/theme/image.php/boost/core/1/g/g1', $conversations[0]->imageurl);
    ...
    */
    ...
    public function test_count_unread_conversations(): void {
        ...
        testhelper::send_fake_message($user1, $user4, 'Hey mate, you see the new messaging UI in agpu?');
    ...
    public function test_can_send_message_with_messageanyuser_cap(): void {
        ...
        $coursecontext = \context_course::instance($course1->id);
        $teacherrole = $DB->get_record('role', ['shortname' => 'editingteacher']);
        assign_capability('agpu/site:messageanyuser', CAP_PROHIBIT, $teacherrole->id, $coursecontext->id);
     ...
     * has the capability 'agpu/site:messageanyuser'.
     */
    public function test_can_send_message_even_if_blocked_with_message_any_user_cap(): void {
        ...
        assign_capability('agpu/site:messageanyuser', CAP_ALLOW, $authenticateduserrole->id, \context_system::instance(), true);
    ...
    /**
     * Tests the user will be able to send a message even if they are blocked as the user
     * has the capability 'agpu/site:readallmessages'.
     */
    public function test_can_send_message_even_if_blocked_with_read_all_message_cap(): void {
        ...
        $authenticateduserrole = $DB->get_record('role', ['shortname' => 'user']);
        assign_capability('agpu/site:readallmessages', CAP_ALLOW, $authenticateduserrole->id, \context_system::instance(), true);
     ...
     * have the capability 'agpu/site:messageanyuser' at the course context.
     */
    ...
    public function test_can_send_message_to_conversation_sendmessage_cap(): void {
        ...
        // Remove the capability to send a message.
        $roleids = $DB->get_records_menu('role', null, '', 'shortname, id');
        unassign_capability('agpu/site:sendmessage', $roleids['user'], \context_system::instance());
    ...
    public function test_can_send_message_to_conversation_messageanyuser_cap(): void {
        ...
        assign_capability('agpu/site:messageanyuser', CAP_ALLOW, $authenticateduser->id, $systemcontext->id);
    ...
    public function test_send_message_to_conversation_individual_conversation(): void {
        ...
        $message1 = api::send_message_to_conversation($user1->id, $ic1->id, 'this is a message', FORMAT_agpu);
    ...
    public function test_send_message_to_conversation_group_conversation(): void {
        ...
        $sink = $this->redirectEvents();
        $messagessink = $this->redirectMessages();
        $message1 = api::send_message_to_conversation($user1->id, $gc2->id, 'message to the group', FORMAT_agpu);
        $events = $sink->get_events();
        $messages = $messagessink->get_messages();
        // Verify the message returned.
        $this->assertInstanceOf(\stdClass::class, $message1);
    ...
    public function test_send_message_to_conversation_non_existent_conversation(): void {
        ...
        $this->expectException(\agpu_exception::class);
        api::send_message_to_conversation($user1->id, 0, 'test', FORMAT_agpu);
    }
    ...
    public function test_send_message_to_conversation_non_member(): void {
        ...
        $this->expectException(\agpu_exception::class);
        api::send_message_to_conversation($user3->id, $ic1->id, 'test', FORMAT_agpu);
    }
    ...
    public function test_send_message_to_conversation_blocked_user(): void {
        ...
        $this->expectException(\agpu_exception::class);
        api::send_message_to_conversation($user2->id, $ic1->id, 'test', FORMAT_agpu);
    }
    ...
    public function test_can_delete_message_for_all_users_teacher(): void {
        ...
        assign_capability('agpu/site:deleteanymessage', CAP_ALLOW, $editingteacher->id, \context_system::instance());
