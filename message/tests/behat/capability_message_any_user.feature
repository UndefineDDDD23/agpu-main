...
Feature: Capability test for 'agpu/site:messageanyuser'
  In order to test that the 'agpu/site:messageanyuser' works as expected
  As a user with or without the capability 'agpu/site:messageanyuser'
