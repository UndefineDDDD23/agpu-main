...
class provider_test extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_user_preferences(): void {
        ...
        set_user_preference('message_provider_agpu_instantmessage_enabled', 'airnotifier', $USER->id);
        ...
        set_user_preference('message_provider_agpu_instantmessage_enabled', 'inbound', $user->id);
        ...
        $this->assertArrayHasKey('message_provider_agpu_instantmessage_enabled', $prefs);
        ...
        foreach ($prefs as $key => $pref) {
            if ($key == 'message_provider_agpu_instantmessage_enabled') {
