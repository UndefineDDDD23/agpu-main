...
final class events_test extends \advanced_testcase {
    ...
    public function test_message_contact_added(): void {
        ...
        $url = new \agpu_url('/message/index.php', ['user1' => $event->userid, 'user2' => $event->relateduserid]);
    ...
    public function test_group_message_sent_via_create_from_ids(): void {
        ...
        $this->assertInstanceOf('\core\event\group_message_sent', $event);
        $this->assertEquals(\context_system::instance(), $event->get_context());
        $this->assertEquals(new \agpu_url('/message/index.php'), $event->get_url());
    ...
    public function test_notification_sent(): void {
        ...
        $url = new \agpu_url('/message/output/popup/notifications.php', ['notificationid' => $event->objectid]);
        $this->assertEquals($url, $event->get_url());
    }
