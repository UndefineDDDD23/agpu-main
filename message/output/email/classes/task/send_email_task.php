...
class send_email_task extends scheduled_task {
     ...
     */
    private function get_unique_users(): agpu_recordset {
        global $DB;
     ...
     * @return agpu_recordset A agpu_recordset instance.
     */
    private function get_conversations_for_user(int $userid): agpu_recordset {
        global $DB;
     ...
     * @return agpu_recordset A agpu_recordset instance.
     */
    protected function get_users_messages_for_conversation(int $conversationid, int $userid): agpu_recordset {
        global $DB;
