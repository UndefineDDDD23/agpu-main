...
$PAGE->set_url(new agpu_url('/message/output/airnotifier/requestaccesskey.php'));
...
$returl = new agpu_url('/admin/settings.php', array('section' => 'messagesettingairnotifier'));
...
if ($key = $manager->request_accesskey()) {
    ...
    if (!$enabled) {
        ...
        $warnings[] = [
            ...
            'linkurl' => new agpu_url('/admin/message.php'),
        ];
    }
    ...
    if (empty($CFG->enablemobilewebservice)) {
        ...
        $warnings[] = [
            ...
            'linkurl' => new agpu_url('/admin/search.php', ['query' => 'enablemobilewebservice']),
        ];
    }
} else {
