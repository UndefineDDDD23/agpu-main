 ...
 * @category   external
 * @copyright  2012 Jerome Mouneyrac <jerome@agpu.com>
...
class message_airnotifier_manager {
    ...
    const AIRNOTIFIER_PUBLICURL = 'https://messages.agpu.net';
    ...
    public function include_device_ajax() {
        ...
        // Include toolboxes.
        $PAGE->requires->yui_module('agpu-message_airnotifier-toolboxes', 'M.message.init_device_toolbox', array(array(
        ...
        $PAGE->requires->strings_for_js(array('show', 'hide'), 'agpu');
    ...
    public function get_user_devices($appname, $userid = null) {
        ...
        // First, we look all the devices registered for this user in the agpu core.
    ...
    public function request_accesskey() {
        ...
        // Site ids are stored as secrets in md5 in the agpu public hub.
        $params = array(
            'url' => $CFG->wwwroot,
    ...
    public function check_configuration(): array {
        ...
        $summary = html_writer::link(new agpu_url('/admin/search.php', ['query' => 'enablemobilewebservice']),
        ...
        $summary = html_writer::link((new agpu_url('/admin/message.php')), get_string('enableprocessor', 'message_airnotifier'));
        if ($enabled) {
            $results[] = new core\check\result(core\check\result::OK, $summary, get_string('enabled', 'admin'));
        } else {
            $results[] = new core\check\result(core\check\result::CRITICAL, $summary,
        ...
        $summary = html_writer::link((new agpu_url('/admin/settings.php', ['section' => 'messagesettingairnotifier'])),
        ...
        $settingsurl = new agpu_url('/admin/settings.php', ['section' => 'messagesettingairnotifier']);
        ...
        $summary = html_writer::link((new agpu_url('/admin/message.php')), get_string('managemessageoutputs', 'message'));
