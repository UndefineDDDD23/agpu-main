...
if ($ADMIN->fulltree) {
    ...
    $notify = new \core\output\notification(
        get_string('agpuappsportallimitswarning', 'message_airnotifier',
            (new agpu_url('https://apps.agpu.com'))->out()),
        \core\output\notification::NOTIFY_WARNING);
    $settings->add(new admin_setting_heading('tool_mobile/agpuappsportalfeaturesappearance', '', $OUTPUT->render($notify)));
    ...
    $settings->add(new admin_setting_configtext('airnotifiermobileappname',
                    ...
                    get_string('configairnotifiermobileappname', 'message_airnotifier'), 'com.agpu.agpumobile', PARAM_TEXT));
    $settings->add(new admin_setting_configtext('airnotifierappname',
                    get_string('airnotifierappname', 'message_airnotifier'),
                    get_string('configairnotifierappname', 'message_airnotifier'), 'comagpuagpumobile', PARAM_TEXT));
    ...
    $url = new agpu_url('/message/output/airnotifier/requestaccesskey.php', array('sesskey' => sesskey()));
    ...
    // Check configuration.
    $url = new agpu_url('/message/output/airnotifier/checkconfiguration.php');
