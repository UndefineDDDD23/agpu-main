...
$pageurl = new agpu_url('/message/output/airnotifier/checkconfiguration.php');
...
$returl = new agpu_url('/admin/category.php', ['category' => 'messaging']);
$PAGE->navbar->add(get_string('messagingcategory', 'admin'), $returl);
$returl = new agpu_url('/admin/settings.php', ['section' => 'messagesettingairnotifier']);
...
if (data_submitted()) {
    ...
    if (optional_param('confirm', 0, PARAM_INT)) {
        ...
        $confirmurl = new agpu_url($pageurl->out(false), ['confirm' => 1]);
