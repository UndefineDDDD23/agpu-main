...
function(
    ...
    var NOTIFICATION_PREFERENCES_KEY = 'message_provider_agpu_instantmessage';
    ...
    var registerEventListeners = function(body, loggedInUserId) {
        ...
        settingsContainer.on(CustomEvents.events.activate, SELECTORS.NOTIFICATIONS_PREFERENCE, function(e) {
            ...
            var preferences = [
                {
                    type: 'message_provider_agpu_instantmessage_enabled',
                    value: newValue
                }
            ];
     ...
     *
     * agpu may have many (or no) message processors enabled to notify the user when they
