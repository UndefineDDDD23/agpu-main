...
$url = new agpu_url('/rating/index.php', array('contextid' => $contextid,
                                                 'component' => $component,
...
$params = array('contextid' => $contextid,
                ...
                'itemid' => $itemid,
                'scaleid' => $scaleid);
if (!has_capability('agpu/rating:view', $context) ||
        !component_callback($component, 'rating_can_see_item_ratings', array($params), true)) {
    throw new \agpu_exception('noviewrate', 'rating');
}

$canviewallratings = has_capability('agpu/rating:viewall', $context);
...
if (!$ratings) {
    ...
    $table->head = array(
        '',
        html_writer::link(new agpu_url($sorturl, array('sort' => 'firstname')), $strname),
        html_writer::link(new agpu_url($sorturl, array('sort' => 'rating')), $strrating),
        html_writer::link(new agpu_url($sorturl, array('sort' => 'time')), $strtime)
    );
