...
class lib_test extends \advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        $instance = $generator->create_instance([
            ...
            'controlledlinkfoldername' => 'agpufiles',
...
JSON;
    ...
    public function test_logout(): void {
        ...
        $mock->expects($this->exactly(2))->method('get_login_url')->will($this->returnValue(new \agpu_url('url')));
    ...
    public function test_send_file_errors(): void {
        ...
        $mock->expects($this->once())->method('is_dir')->with('agpufiles')->willReturn(false);
        ...
        $mock->expects($this->once())->method('mkcol')->with(
            $webdavprefix . 'agpufiles')->willReturn(400);
        $this->expectException(\repository_nextcloud\request_exception::class);
...
XML;
        ...
        // Checks that setting for foldername are used.
        $mock->expects($this->once())->method('is_dir')->with('agpufiles')->willReturn(true);
        ...
        $this->set_private_property($mock, 'ocsclient');
        $this->repo->expects($this->once())->method('move_file_to_folder')->with('/merged (3).txt', 'agpufiles',
