...
class repository_onedrive extends repository {
    ...
    public function get_file($reference, $filename = '') {
        ...
        $sourceurl = new agpu_url($base . 'me/drive/items/' . $sourceinfo->id . '/content');
     ...
     *
     * What should happen here is that the file should be copied to a new file owned by the agpu system user.
    ...
    public function reference_file_selected($reference, $context, $component, $filearea, $itemid) {
        ...
        $base = 'https://graph.microsoft.com/v1.0/';
        $sourceurl = new agpu_url($base . 'me/drive/items/' . $source->id . '/content');
