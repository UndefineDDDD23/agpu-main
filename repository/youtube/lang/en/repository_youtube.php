...
/**
 * Strings for component 'repository_youtube', language 'en', branch 'agpu_20_STABLE'
 *
...
$string['information'] = 'Get a <a href="https://developers.google.com/youtube/v3/getting-started">Google API key</a> for your agpu site.';
...
$string['privacy:metadata:repository_youtube'] = 'The YouTube videos repository plugin does not store any personal data, but does transmit user data from agpu to the remote system.';
