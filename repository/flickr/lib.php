...
class repository_flickr extends repository {
    ...
    public function __construct($repositoryid, $context = SYSCONTEXTID, $options = array()) {
        ...
        $callbackurl = new agpu_url('/repository/repository_callback.php', ['repo_id' => $repositoryid]);
    ...
    public function print_login() {
        ...
        $authurl = new agpu_url($reqtoken['authorize_url'], array('perms' => 'read'));
        ...
        if (!empty($response->photos->photo)) {
            foreach ($response->photos->photo as $p) {
                ...
                $ret['list'][] = [
                    ...
                    'license' => $this->license4agpu((int) $p->license),
                ];
            }
        }
    ...
    /**
     * Map Flickr license ID to those used internally by agpu
     *
     * @param int $licenseid
     * @return string
     */
    public function license4agpu(int $licenseid): string {
        $license = [
            0 => 'allrightsreserved',
            1 => 'cc-nc-sa',
            2 => 'cc-nc',
