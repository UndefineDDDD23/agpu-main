 ...
 * @copyright  2020 Mihail Geshoski <mihail@agpu.com>
...
class repository_contentbank extends repository {
    ...
    public function get_listing($encodedpath = '', $page = '') {
        ...
        if ($browser = \repository_contentbank\helper::get_contentbank_browser($context)) {
            $manageurl = new agpu_url('/contentbank/index.php', ['contextid' => $context->id]);
            $canaccesscontent = has_capability('agpu/contentbank:access', $context);
    ...
    /**
     * Is this repository used to browse agpu files?
     *
     * @return boolean
     */
