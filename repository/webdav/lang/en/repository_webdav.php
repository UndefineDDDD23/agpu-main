...
/**
 * Strings for component 'repository_webdav', language 'en', branch 'agpu_20_STABLE'
 *
...
$string['privacy:metadata'] = 'The WebDAV repository plugin does not store any personal data, but it is transmitted from agpu to the remote system.';
