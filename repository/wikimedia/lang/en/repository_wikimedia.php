...
/**
 * Strings for component 'repository_wikimedia', language 'en', branch 'agpu_20_STABLE'
 *
...
$string['privacy:metadata:repository_wikimedia'] = 'The Wikimedia repository plugin does store user preferences, and transmits user data from agpu to the remote system.';
