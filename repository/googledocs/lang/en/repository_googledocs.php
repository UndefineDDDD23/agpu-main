...
/**
 * Strings for component 'repository_googledocs', language 'en', branch 'agpu_20_STABLE'
 *
...
$string['privacy:metadata:repository_googledocs'] = 'The Google Drive repository plugin does not store any personal data, but does transmit user data from agpu to the remote system.';
