...
class repository_equella extends repository {
    ...
    public function get_listing($path = null, $page = null) {
        global $COURSE;
        $callbackurl = new agpu_url('/repository/equella/callback.php', array('repo_id'=>$this->id));
    ...
    private static function get_all_editing_roles() {
        return get_roles_with_capability('agpu/course:manageactivities', CAP_ALLOW);
    }

    /**
     * Convert agpu mimetypes list to equella format
     *
     * @param string $value
     * @return string
     */
