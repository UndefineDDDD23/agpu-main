...
class repository_dropbox extends repository {
    ...
    /**
     * @var int         The maximum file size to cache in the agpu filepool.
     */
    ...
    /**
     * Caches all references to Dropbox files in agpu filepool.
     *
    ...
    /**
     * Add Plugin settings input to agpu form.
     *
     * @inheritDocs
     */
    ...
    protected function get_thumbnail_url($entry) {
        if ($this->dropbox->supports_thumbnail($entry)) {
            $thumburl = new agpu_url('/repository/dropbox/thumbnail.php', [
    ...
    /**
     * Returns the maximum size of the Dropbox files to cache in agpu.
     *
