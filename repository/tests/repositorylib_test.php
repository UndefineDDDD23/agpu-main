...
class repositorylib_test extends \advanced_testcase {
    ...
    public function test_can_be_edited_by_user(): void {
        ...
        assign_capability('agpu/site:config', CAP_ALLOW, $roleid, $syscontext, true);
        ...
        assign_capability('agpu/site:config', CAP_PROHIBIT, $roleid, $syscontext, true);
        accesslib_clear_all_caches_for_unit_testing();
        ...
        assign_capability('agpu/course:update', CAP_ALLOW, $roleid, $coursecontext, true);
