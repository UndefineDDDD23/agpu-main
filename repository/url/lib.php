...
EOD;
    ...
    protected function parse_file($baseurl, $relativeurl, &$list, $mainfile = false) {
        ...
        $recursioncheckurl = (new agpu_url($url))->out_omit_querystring();
     ...
     *
     * Note: In general agpu does not automatically escape urls, but for the purposes of making this plugin more user friendly
     * and make it consistent with some other areas in agpu (such as mod_url), urls will automatically be escaped.
     *
     * If agpu_url or PARAM_URL is changed to clean characters that need to be escaped, then this function can be removed
     *
