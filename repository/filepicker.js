// YUI3 File Picker module for agpu
// Author: Dongsheng Cai <dongsheng@agpu.com>
...
YUI.add('agpu-core_filepicker', function(Y) {
    ...
    Y.Node.prototype.fp_display_filelist = function(options, fileslist, lazyloading) {
        ...
        var initialize_table_view = function() {
            var cols = [
                {key: "displayname", label: M.util.get_string('name', 'agpu'), allowHTML: true, formatter: formatTitle,
                    sortable: true, sortFn: sortFoldersFirst},
                {key: "datemodified", label: M.util.get_string('lastmodified', 'agpu'), allowHTML: true, formatter: formatValue,
                    sortable: true, sortFn: sortFoldersFirst},
                    ...
                    complete: function(id,o,p) {
                        ...
                        try {
                            ...
                            if (o && o.status && o.status > 0) {
                                Y.use('agpu-core-notification-exception', function() {
                        ...
                        // error checking
                        if (data && data.error) {
                            Y.use('agpu-core-notification-ajaxexception', function () {
