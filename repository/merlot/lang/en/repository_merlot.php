...
/**
 * Strings for component 'repository_merlot', language 'en', branch 'agpu_20_STABLE'
 *
...
$string['privacy:metadata:repository_merlot'] = 'The Merlot.org repository plugin does not store any personal data, but does transmit user data from agpu to the remote system.';
