...
if (!empty($generateurl)) {
    ...
    $link = new agpu_url('/calendar/export.php', $params);
    redirect($link->out());
    die;
}
$paramcategory = false;
...
$ical->add_property('prodid', '-//agpu Pty Ltd//NONSGML agpu Version ' . $CFG->version . '//EN');
foreach($events as $event) {
    ...
    $me = new calendar_event($event); // To use agpu calendar event services.
    ...
    if ($event->timeduration > 0) {
        ...
        // agpu doesn't support all day events yet. See MDL-56227.
