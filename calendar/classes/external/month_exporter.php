...
class month_exporter extends exporter {
    ...
    /**
     * @var agpu_url $url The URL for the events page.
     */
    protected $url;
    ...
    public function __construct(\calendar_information $calendar, \core_calendar\type_base $type, $related) {
        ...
        $this->url = new agpu_url('/calendar/view.php', [
                'view' => 'month',
                'time' => $calendar->time,
            ]);
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        $nextperiodlink = new agpu_url($this->url);
        $nextperiodlink->param('time', $nextperiod[0]);

        $previousperiodlink = new agpu_url($this->url);
