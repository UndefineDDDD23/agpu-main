 ...
 * to the problems agpu core wants to solve.
 *
            ...
            self::$eventfactory = new event_factory(
                ...
                function ($dbrow) {
                    ...
                    if (!$cm->get_course()->visible &&
                            !has_capability('agpu/course:viewhiddencourses', $coursecontext, $requestinguserid)) {
                        return true;
                    }

                    if (!has_capability('agpu/course:view', $coursecontext, $requestinguserid) &&
