...
class externallib_test extends externallib_advanced_testcase {
    ...
    public function test_delete_calendar_events(): void {
        ...
        // Remove all caps.
        $this->unassignUserCapability('agpu/calendar:manageentries', $sitecontext->id, $role->id);
        $this->unassignUserCapability('agpu/calendar:manageentries', $coursecontext->id, $role->id);
        $this->unassignUserCapability('agpu/calendar:managegroupentries', $coursecontext->id, $role->id);
        $this->unassignUserCapability('agpu/calendar:manageownentries', $usercontext->id, $role->id);

        // Assign proper caps and attempt delete.
         $this->assignUserCapability('agpu/calendar:manageentries', $sitecontext->id, $role->id);
         $events = array(
                array('eventid' => $siteevent->id, 'repeat' => 0),
                );
        core_calendar_external::delete_calendar_events($events);
        ...
        $this->assertEquals($count, $deletedcount);
         ...
         $this->assignUserCapability('agpu/calendar:manageownentries', $usercontext->id, $role->id);
         $events = array(
                array('eventid' => $userevent->id, 'repeat' => 0),
                );
        core_calendar_external::delete_calendar_events($events);
        ...
        $this->assertEquals($count, $deletedcount);
         ...
         $this->assignUserCapability('agpu/calendar:managegroupentries', $coursecontext->id, $role->id);
         $events = array(
                array('eventid' => $groupevent->id, 'repeat' => 0),
                );
        core_calendar_external::delete_calendar_events($events);
    ...
    public function test_core_create_calendar_events(): void {
        ...
        $this->getDataGenerator()->enrol_user($user->id, $course->id, $role->id);
        groups_add_member($group, $user);
        $this->assignUserCapability('agpu/calendar:manageentries', $coursecontext->id, $role->id);
        $this->assignUserCapability('agpu/calendar:managegroupentries', $coursecontext->id, $role->id);
        $eventsret = core_calendar_external::create_calendar_events($events);
        $eventsret = external_api::clean_returnvalue(core_calendar_external::create_calendar_events_returns(), $eventsret);
        // Check to see if things were created properly.
    ...
    public function test_update_event_start_day(): void {
        ...
        assign_capability('agpu/calendar:manageownentries', CAP_ALLOW, $roleid, $context, true);
    ...
    public function test_update_event_start_day_no_permission(): void {
        ...
        assign_capability('agpu/calendar:manageownentries', CAP_PROHIBIT, $roleid, $context, true);
        $this->expectException(\agpu_exception::class);
        $result = core_calendar_external::update_event_start_day($event->id, $newstartdate->getTimestamp());
        $result = external_api::clean_returnvalue(
            core_calendar_external::update_event_start_day_returns(),
    ...
    public function test_update_event_start_day_module_event(): void {
        ...
        assign_capability('agpu/calendar:manageentries', CAP_ALLOW, $roleid, $context, true);
        $this->expectException(\agpu_exception::class);
        $result = core_calendar_external::update_event_start_day($event->id, $newstartdate->getTimestamp());
        $result = external_api::clean_returnvalue(
            core_calendar_external::update_event_start_day_returns(),
    ...
    /**
     * A user with the agpu/calendar:manageownentries capability at the
    ...
    /**
     * A user without the agpu/calendar:manageownentries capability at the
    ...
    /**
     * A user with the agpu/calendar:manageentries capability at the
    ...
    /**
     * A user without the agpu/calendar:manageentries capability at the
    ...
    public function test_submit_create_update_form_create_site_event_no_permission(): void {
        ...
        assign_capability('agpu/calendar:manageentries', CAP_PROHIBIT, $roleid, $context, true);
    ...
    /**
     * A user that has the agpu/calendar:manageentries in a course that they
    ...
    /**
     * A user without the agpu/calendar:manageentries capability in a course
     ...
     * a course in which they are enrolled and have the agpu/calendar:manageentries capability.
     */
    ...
    /**
     * A user should be able to create an event for a group that they are a member of in
     * a course in which they are enrolled and have the agpu/calendar:managegroupentries capability.
     */
    public function test_submit_create_update_form_create_group_event_group_member_manage_group_entries(): void {
        ...
        assign_capability('agpu/calendar:manageentries', CAP_PROHIBIT, $roleid, $context, true);
        assign_capability('agpu/calendar:managegroupentries', CAP_ALLOW, $roleid, $context, true);
     ...
     * they are enrolled and have the agpu/site:accessallgroups capability.
     */
    public function test_submit_create_update_form_create_group_event_access_all_groups(): void {
        ...
        assign_capability('agpu/calendar:manageentries', CAP_ALLOW, $roleid, $context, true);
        assign_capability('agpu/site:accessallgroups', CAP_ALLOW, $roleid, $context, true);
     ...
     * agpu/site:accessallgroups capability.
     */
    public function test_submit_create_update_form_create_group_event_non_member_no_permission(): void {
        ...
        assign_capability('agpu/calendar:manageentries', CAP_ALLOW, $roleid, $context, true);
        assign_capability('agpu/site:accessallgroups', CAP_PROHIBIT, $roleid, $context, true);
