 ...
 * @copyright  2017 Mark Nelson <markn@agpu.com>
...
class lib_test extends \advanced_testcase {
    ...
    public function test_calendar_get_allowed_event_types_course(): void {
        ...
        assign_capability('agpu/calendar:manageentries', CAP_ALLOW, $roleid, $context1, true);
        assign_capability('agpu/calendar:manageentries', CAP_PROHIBIT, $roleid, $context2, true);
        ...
        assign_capability('agpu/calendar:manageentries', CAP_PROHIBIT, $roleid, $context1, true);
    ...
    public function test_calendar_get_allowed_event_types_group_access_all_groups(): void {
        ...
        $this->setUser($user);
        assign_capability('agpu/calendar:manageentries', CAP_ALLOW, $roleid, $context1, true);
        assign_capability('agpu/calendar:manageentries', CAP_ALLOW, $roleid, $context2, true);
        assign_capability('agpu/site:accessallgroups', CAP_ALLOW, $roleid, $context1, true);
        assign_capability('agpu/site:accessallgroups', CAP_ALLOW, $roleid, $context2, true);
