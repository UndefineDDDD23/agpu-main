...
$url = new agpu_url('/calendar/view.php');
...
if ($iscoursecalendar && !empty($courseid)) {
    navigation_node::override_active_url(new agpu_url('/course/view.php', array('id' => $course->id)));
    $PAGE->set_secondary_navigation(false);
} else if (!empty($categoryid)) {
    core_course_category::get($categoryid); // Check that category exists and can be accessed.
    $PAGE->set_category_by_id($categoryid);
    navigation_node::override_active_url(new agpu_url('/course/index.php', array('categoryid' => $categoryid)));
    $PAGE->navbar->add(
