...
$url = new agpu_url('/calendar/event.php', array('action' => $action));
...
if ($action === 'delete' && $eventid > 0) {
    $deleteurl = new agpu_url('/calendar/delete.php', array('id'=>$eventid));
    if ($courseid > 0) {
...
if ($data) {
    ...
    $eventurl = new agpu_url('/calendar/view.php', $params);
...
$viewcalendarurl = new agpu_url(CALENDAR_URL.'view.php', $PAGE->url->params());
