...
class item implements \renderable, \templatable {
     ...
     */
    public function __construct($id, \agpu_url $link, $title, $description, \agpu_url $permalink, $timestamp,
     ...
     * @return \block_rss_client\output\item
     */
    public function set_link(\agpu_url $link) {
        $this->link = $link;
