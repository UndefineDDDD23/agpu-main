...
class channel_image implements \renderable, \templatable {
     ...
     * Contructor
     *
     * @param \agpu_url $url The URL location of the image
     * @param string $title The title of the image
     * @param \agpu_url $link The URL of the image link
     */
    public function __construct(\agpu_url $url, $title, ?\agpu_url $link = null) {
        $this->url      = $url;
        $this->title    = $title;
        $this->link     = $link;
    }
