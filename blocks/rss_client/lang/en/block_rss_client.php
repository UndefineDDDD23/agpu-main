...
/**
 * Strings for component 'block_rss_client', language 'en', branch 'agpu_20_STABLE'
 *
...
$string['enableautodiscovery_help'] = 'If enabled, feeds on web pages are found automatically. For example, if https://docs.agpu.org is entered, then https://docs.agpu.org/en/index.php?title=Special:RecentChanges&feed=rss would be found.';
