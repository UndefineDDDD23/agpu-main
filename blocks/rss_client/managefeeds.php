...
$baseurl = new agpu_url('/blocks/rss_client/managefeeds.php', $urlparams);
...
$managefeeds = new agpu_url('/blocks/rss_client/managefeeds.php', $urlparams);
...
$table->define_headers(array(get_string('feed', 'block_rss_client'), get_string('actions', 'agpu')));
...
foreach($feeds as $feed) {
    ...
    $editurl = new agpu_url('/blocks/rss_client/editfeed.php?rssid=' . $feed->id . $extraparams);
    $editaction = $OUTPUT->action_icon($editurl, new pix_icon('t/edit', get_string('edit')));

    $deleteurl = new agpu_url('/blocks/rss_client/managefeeds.php?deleterssid=' . $feed->id . '&sesskey=' . sesskey() . $extraparams);
