YUI.add('agpu-availability_grade-form', function (Y, NAME) {

/**
 * JavaScript for form editing grade conditions.
 *
 * @module agpu-availability_grade-form
 */
...
M.availability_grade.form.getNode = function(json) {
    ...
    var html = '<label class="mb-3"><span class="pe-3">' + M.util.get_string('title', 'availability_grade') + '</span> ' +
            ...
            '<select name="id" class="custom-select"><option value="0">' + M.util.get_string('choosedots', 'agpu') + '</option>';
...
}, '@VERSION@', {"requires": ["base", "node", "event", "agpu-core_availability-form"]});
