YUI.add('agpu-availability_grouping-form', function (Y, NAME) {

/**
 * JavaScript for form editing grouping conditions.
 *
 * @module agpu-availability_grouping-form
 */
...
M.availability_grouping.form.getNode = function(json) {
    ...
    var html = '<label><span class="pe-3">' + M.util.get_string('title', 'availability_grouping') + '</span> ' +
            ...
            '<option value="choose">' + M.util.get_string('choosedots', 'agpu') + '</option>';
