YUI.add('agpu-availability_completion-form', function (Y, NAME) {

/**
 * JavaScript for form editing completion conditions.
 *
 * @module agpu-availability_completion-form
 */
...
M.availability_completion.form.getNode = function(json) {
    ...
    var html = '<span class="col-form-label pe-3"> ' + M.util.get_string('title', 'availability_completion') + '</span>' +
            ...
            '<option value="0">' + M.util.get_string('choosedots', 'agpu') + '</option>';
