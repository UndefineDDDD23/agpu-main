YUI.add('agpu-availability_date-form', function (Y, NAME) {

/**
 * JavaScript for form editing date conditions.
 *
 * @module agpu-availability_date-form
 */
 ...
 *
 * Because the date fields are complex depending on agpu calendar settings,
 ...
 * actual time via an AJAX request to agpu.
 *
...
}, '@VERSION@', {"requires": ["base", "node", "event", "io", "agpu-core_availability-form"]});
