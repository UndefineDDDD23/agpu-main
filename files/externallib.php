...
class core_files_external extends external_api {
     ...
     * @return array
     * @since agpu 2.9 Returns additional fields (timecreated, filesize, author, license)
     * @since agpu 2.2
     */
     ...
     * @since agpu 2.9 Returns additional fields for files (timecreated, filesize, author, license)
     * @since agpu 2.2
     */
    ...
    public static function upload(
        ...
        if (($fileinfo['component'] == 'user' and $fileinfo['filearea'] == 'private')) {
            throw new agpu_exception('privatefilesupload');
        }
        ...
        if ($file = $browser->get_file_info($context, $component, $filearea, $itemid, $filepath, $filename)) {
            throw new agpu_exception('fileexist');
        }
