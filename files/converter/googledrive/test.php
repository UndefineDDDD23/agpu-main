...
$PAGE->set_url(new agpu_url('/files/converter/googledrive/test.php'));
...
$PAGE->navbar->add(get_string('pluginname', 'fileconverter_googledrive'),
        new agpu_url('/admin/settings.php', array('section' => 'fileconvertergoogledrive')));
...
if ($result) {
    ...
    $pdflink = new agpu_url($PAGE->url, array('sendpdf' => 1, 'sesskey' => sesskey()));
...
$returl = new agpu_url('/admin/settings.php', array('section' => 'fileconvertergoogledrive'));
