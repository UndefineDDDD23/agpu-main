...
$PAGE->set_url(new agpu_url('/files/converter/unoconv/testunoconv.php'));
...
$PAGE->navbar->add(get_string('pluginname', 'fileconverter_unoconv'),
        new agpu_url('/admin/settings.php', array('section' => 'fileconverterunoconv')));
...
$returl = new agpu_url('/admin/settings.php', array('section' => 'fileconverterunoconv'));
