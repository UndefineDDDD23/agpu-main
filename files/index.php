...
/**
 * agpu file tree viewer based on YUI2 Treeview
 *
 * @package    core
 * @subpackage file
...
navigation_node::override_active_url(new agpu_url('/files/index.php', array('contextid'=>$contextid)));
...
require_capability('agpu/course:managefiles', $context);
