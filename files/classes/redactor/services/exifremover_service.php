...
class exifremover_service extends service implements file_redactor_service_interface {
    ...
    */
     ...
     * @throws agpu_exception If the ExifTool process fails or the destination file is not created.
     */
     ...
     * @return string The destination path of the recreated content
     * @throws agpu_exception If the image data is not successfully recreated.
     */
