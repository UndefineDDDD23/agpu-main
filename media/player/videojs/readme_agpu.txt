...
Instructions to import VideoJS player into agpu:
...
4. copy 'video-js.css' into 'styles.css'
   ...
   Maintain the css after  "/* Modifications of player made by agpu: */" to the end of the styles file.
   Check status of:
...
Instructions to import YouTube Playback Technology into agpu:
...
Instructions to import Ogv.js Playback Technology into agpu:
