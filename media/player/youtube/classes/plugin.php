...
class media_youtube_plugin extends core_media_player_external {
    ...
    protected function embed_external(agpu_url $url, $name, $width, $height, $options) {
        ...
        if ($this->isplaylist) {
            ...
            if (!$nocookie) {
                $embedurl = new agpu_url("https://$site/embed/videoseries", $params);
            } else {
                $embedurl = new agpu_url('https://www.youtube-nocookie.com/embed/videoseries', $params );
            }
            ...
            // Handle no cookie option.
            if (!$nocookie) {
                $embedurl = new agpu_url('https://www.youtube.com/embed/' . $videoid, $params );
            } else {
                $embedurl = new agpu_url('https://www.youtube-nocookie.com/embed/' . $videoid, $params );
            }
     ...
     * @param agpu_url $url URL of video to be embedded.
