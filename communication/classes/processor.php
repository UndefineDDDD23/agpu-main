...
class processor {
    ...
    protected function __construct(
        ...
        if (!class_exists($providerclass)) {
            throw new \agpu_exception('communicationproviderclassnotfound', 'core_communication', '', $providerclass);
        }
        ...
        if (!is_a($providerclass, communication_provider::class, true)) {
            ...
            throw new \agpu_exception('communicationproviderclassinvalid', 'core_communication', '', $providerclass);
        }
     ...
     * @param \agpuQuickForm $mform The agpu form
     */
    public static function set_provider_specific_form_definition(string $provider, \agpuQuickForm $mform): void {
