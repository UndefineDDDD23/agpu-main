...
class api {
     ...
     *
     * @param \agpuQuickForm $mform The form element
     ...
     */
    public function form_definition_for_provider(\agpuQuickForm $mform, string $provider = processor::PROVIDER_NONE): void {
    ...
    /**
     * Add the task to sync the provider data with local agpu data.
     */
