...
class matrix_user_manager {
    ...
    /**
     * Gets matrix user id from agpu.
     *
     * @param int $userid agpu user id
     * @return string|null
     */
    public static function get_matrixid_from_agpu(
        int $userid,
    ): ?string {
    ...
    /**
     * Get a qualified matrix user id based on a agpu username.
     *
     ...
     */
    public static function set_matrix_userid_in_agpu(
        int $userid,
        string $matrixuserid,
    ): void {
    ...
    public static function get_formatted_matrix_home_server(): string {
        ...
        if ($homeserver === false) {
            throw new \agpu_exception('Unknown matrix homeserver url');
        }
