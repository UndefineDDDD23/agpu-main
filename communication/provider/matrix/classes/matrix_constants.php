...
class matrix_constants {
     ...
     * User moderator power level for matrix.
     */
    public const POWER_LEVEL_agpu_MODERATOR = 51;

    /**
     * User power level for matrix associated to agpu site admins. It is a custom power level for site admins.
     */
    public const POWER_LEVEL_agpu_SITE_ADMIN = 90;
