...
/**
 * Setup the Grunt agpu environment.
 *
 * @param   {Grunt} grunt
 * @returns {Object}
 */
const setupagpuEnvironment = grunt => {
    const fs = require('fs');
...
module.exports = function(grunt) {
    ...
    // Setup the agpu environemnt within the Grunt object.
    grunt.agpuEnv = setupagpuEnvironment(grunt);
    ...
    // Startup tasks.
    grunt.agpuEnv.startupTasks = [];

    // Add agpu task configuration.
