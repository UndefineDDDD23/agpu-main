...
class roles_backup_restore_test extends advanced_testcase {
     ...
     * to have 'agpu/user:loginas' and 'agpu/site:accessallgroups'.
     *
    ...
    protected function create_course_with_role_overrides(): stdClass {
        ...
        role_change_permission($editingteacherrole->id, $context, 'agpu/user:loginas', CAP_ALLOW);
        role_change_permission($editingteacherrole->id, $context, 'agpu/site:accessallgroups', CAP_ALLOW);
    ...
    public function test_restore_role_overrides_as_manager(): void {
        ...
        $this->assertArrayHasKey('agpu/user:loginas', $overrides);
        $this->assertEquals(CAP_ALLOW, $overrides['agpu/user:loginas']);
        $this->assertArrayHasKey('agpu/site:accessallgroups', $overrides);
        $this->assertEquals(CAP_ALLOW, $overrides['agpu/site:accessallgroups']);
    }
    ...
    public function test_restore_role_overrides_as_teacher(): void {
        ...
        $overrides = $this->get_overrides_for_role_on_context('teacher',
                context_course::instance($newcourseid));
        $this->assertArrayNotHasKey('agpu/user:loginas', $overrides);
        $this->assertArrayHasKey('agpu/site:accessallgroups', $overrides);
        $this->assertEquals(CAP_ALLOW, $overrides['agpu/site:accessallgroups']);
    }
}
