...
class backup_controller extends base_controller {
    ...
    /**
     * Format of backup (agpu, imscc).
     *
     * Should be one of the backup::FORMAT_ constants.
     * for example backup::FORMAT_agpu
     *
     * @var string
     */
    protected $format;
    ...
    /** @var null Destination chain object (fs_agpu, fs_os, db, email...). */
     ...
     * @param string $format The backup format to use; Most likely backup::FORMAT_agpu
