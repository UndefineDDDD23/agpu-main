...
require_once($CFG->dirroot . '/backup/util/helper/restore_agpuxml_parser_processor.class.php');
...
require_once($CFG->dirroot . '/backup/agpu2/restore_plan_builder.class.php');
...
require_once($CFG->dirroot . '/backup/util/ui/base_agpuform.class.php');
...
require_once($CFG->dirroot . '/backup/util/ui/restore_agpuform.class.php');
require_once($CFG->dirroot . '/backup/util/ui/restore_ui_components.php');

// And some agpu stuff too
