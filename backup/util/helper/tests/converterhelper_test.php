...
class converterhelper_test extends \basic_testcase {
    ...
    public function test_choose_conversion_path(): void {
        ...
        $descriptions = array();
        $path = testable_convert_helper::choose_conversion_path(backup::FORMAT_agpu1, $descriptions);
        ...
        $path = testable_convert_helper::choose_conversion_path(backup::FORMAT_agpu, $descriptions);
        $this->assertEquals($path, array());

        // two alternatives
        $descriptions = array(
            // standard agpu 1.9 -> 2.x converter
            'agpu1' => array(
                'from'  => backup::FORMAT_agpu1,
                'to'    => backup::FORMAT_agpu,
                'cost'  => 10,
            ),
            // alternative agpu 1.9 -> 2.x converter
            'alternative' => array(
                'from'  => backup::FORMAT_agpu1,
                'to'    => backup::FORMAT_agpu,
                'cost'  => 8,
        ...
        $descriptions = array(
            ...
            // custom converter from custom 'CFv1' format -> agpu 2.0 format
            'cc2' => array(
                'from'  => 'CFv1',
                'to'    => backup::FORMAT_agpu,
                'cost'  => 5,
            ...
            // custom converter from CFv2 -> agpu 2.0 format
            'cc4' => array(
                'from'  => 'CFv2',
                'to'    => backup::FORMAT_agpu,
                'cost'  => 2,
