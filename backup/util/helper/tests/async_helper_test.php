...
class async_helper_test extends \advanced_testcase {
    ...
    public function test_send_message(): void {
        ...
        set_config('backup_async_message_subject', 'agpu {operation} completed sucessfully', 'backup');
        ...
        set_user_preference('message_provider_agpu_asyncbackupnotification', 'email', $user2);
        ...
        $this->assertSame('agpu Backup completed sucessfully', $email->subject);
