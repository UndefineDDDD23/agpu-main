...
abstract class backup_helper {
     ...
     * into agpu file storage. For stored files it returns the complete file_info object
     *
     ...
     *
     * @throws agpu_exception in case of any problems
     */
    public static function store_backup_file($backupid, $filepath, ?\core\progress\base $progress = null) {
        ...
        if (empty($filename)) {
            $filename = backup_plan_dbops::get_default_backup_filename('agpu2', $backuptype, $id, $hasusers, $isannon);
        }
