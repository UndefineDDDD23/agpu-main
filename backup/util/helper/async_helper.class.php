...
class async_helper  {
     ...
     *
     * @return agpu_url $url The link to the resource.
     */
    private function get_resource_link() {
        ...
        if ($this->type == 'backup') {
            ...
            $url = new agpu_url('/backup/restorefile.php', array('contextid' => $context->id));
        } else {
     ...
     *
     * @param \context $context The agpu context for the restores.
