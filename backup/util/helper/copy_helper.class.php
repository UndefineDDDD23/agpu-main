...
final class copy_helper {
    ...
    public static function process_formdata(\stdClass $formdata): \stdClass {
        ...
        if ($missingfields) {
            throw new \agpu_exception('copyfieldnotfound', 'backup', '', null, implode(", ", $missingfields));
        }
    ...
    public static function create_copy(\stdClass $copydata): array {
        ...
        $bc = new \backup_controller(\backup::TYPE_1COURSE, $copydata->courseid, \backup::FORMAT_agpu,
