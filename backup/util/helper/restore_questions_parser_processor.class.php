...
class restore_questions_parser_processor extends grouped_parser_processor {
    ...
    /** @var string XML path in the questions.xml to question elements within question_category (agpu 4.0+). */
    ...
    /** @var string XML path in the questions.xml to question elements within question_category (before agpu 4.0). */
