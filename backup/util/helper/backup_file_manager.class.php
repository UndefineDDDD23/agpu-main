 ...
 *
 * This class implements various functions related with agpu storage
...
class backup_file_manager {
    ...
    /**
     * Copy one file from agpu storage to backup storage
     */
    public static function copy_file_agpu2backup($backupid, $filerecorid) {
        global $DB;
