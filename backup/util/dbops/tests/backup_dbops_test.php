...
class backup_dbops_test extends \advanced_testcase {
    ...
    function test_backup_controller_dbops(): void {
        ...
        $bc = new mock_backup_controller4dbops(backup::TYPE_1ACTIVITY, $this->moduleid, backup::FORMAT_agpu,
    ...
    function test_backup_controller_dbops_includes_files(): void {
        ...
        $bc = new mock_backup_controller4dbops(backup::TYPE_1COURSE, $this->courseid, backup::FORMAT_agpu,
