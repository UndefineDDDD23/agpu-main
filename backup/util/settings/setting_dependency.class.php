...
abstract class setting_dependency {
    ...
    /**
     * Returns an array of properties suitable to be used to define a agpuforms
     * disabled command
     * @return array
     */
    abstract public function get_agpuform_properties();
    /**
...
class setting_dependency_disabledif_equals extends setting_dependency {
     ...
     * @return array
     */
    public function get_agpuform_properties() {
        return array(
