...
abstract class base_ui_stage {
     ...
     */
    abstract public function process(?base_agpuform $form = null);

    /**
     * Creates an instance of the correct agpuform properly populated and all
     * dependencies instantiated
     *
     * @abstract
     * @return backup_agpuform
     */
