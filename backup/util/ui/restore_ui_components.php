...
abstract class restore_search_base implements renderable {
     ...
     * @return agpu_url The URL for this page
     */
    final public function get_url() {
        ...
        return ($this->url !== null) ? new agpu_url($this->url, $params) : new agpu_url($PAGE->url, $params);
    }
     ...
     * @param agpu_url $url
     */
    final public function set_url(agpu_url $url) {
        $this->url = $url;
    }
...
class restore_course_search extends restore_search_base {
    ...
    protected function setup_restrictions() {
        $this->require_capability('agpu/restore:restorecourse');
    }
...
class restore_category_search extends restore_search_base  {
    ...
    public function __construct(array $config = array()) {
        parent::__construct($config);
        $this->require_capability('agpu/course:create');
    }
    /**
