...
/**
 * This file contains the generic agpuform bridge for the backup user interface
...
/**
 * Backup agpuform bridge
 *
 * Ahhh the mighty agpuform bridge! Strong enough to take the weight of 682 full
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class backup_agpuform extends base_agpuform {
    /**
     * Creates the form
     *
...
/**
 * Initial backup user interface stage agpuform.
 *
 * Nothing to override we only need it defined so that agpuform doesn't get confused
 * between stages.
 *
 * @package   core_backup
 * @copyright 2010 Sam Hemelryk
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_initial_form extends backup_agpuform {}

/**
 * Schema backup user interface stage agpuform.
 *
 * Nothing to override we only need it defined so that agpuform doesn't get confused
 * between stages.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_schema_form extends backup_agpuform {}

/**
 * Confirmation backup user interface stage agpuform.
 *
 * Nothing to override we only need it defined so that agpuform doesn't get confused
 * between stages.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_confirmation_form extends backup_agpuform {
