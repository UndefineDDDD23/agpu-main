@core @core_backup
Feature: Restore agpu 2 course backups
  In order to continue using my stored course contents
  As a teacher and an admin
  I need to restore them inside other agpu courses or in new courses
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | url      | C1     | url1     | Test URL name      | Test URL description | 3       | http://www.agpu.org |
      | forum    | C5     | 0005     | Test forum name    |                      | 1       |                       |
      | url      | C5     | url5     | Test URL name      | Test URL description | 3       | http://www.agpu.org |
