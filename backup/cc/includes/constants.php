...
// agpu RESOURCES TYPE ********************************************************************************************** //
define('agpu_TYPE_FORUM', 'forum');
define('agpu_TYPE_QUIZ', 'quiz');
define('agpu_TYPE_QUESTION_BANK', 'question_bank');
define('agpu_TYPE_RESOURCE', 'resource');
define('agpu_TYPE_LABEL', 'label');
define('agpu_TYPE_BASICLTI', 'basiclti');
define('agpu_TYPE_LTI', 'lti');
...
//agpu QUESTIONS TYPES ********************************************************************************************** //
define('agpu_QUIZ_MULTIPLE_CHOICE', 'multichoice');
define('agpu_QUIZ_TRUE_FALSE', 'truefalse');
define('agpu_QUIZ_MULTIANSWER', 'multianswer');
define('agpu_QUIZ_MULTIPLE_RESPONSE', 'multichoice');
define('agpu_QUIZ_MACHT', 'match');
define('agpu_QUIZ_ESSAY', 'essay');
define('agpu_QUIZ_SHORTANSWER', 'shortanswer');
