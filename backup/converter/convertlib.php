 ...
 *
 * All agpu backup converters are supposed to extend this base class.
 *
...
abstract class base_converter implements loggable {
     ...
     *
     * agpu 2.x format is being detected by the core itself. The converters are
     * therefore supposed to detect the source format. Eventually, if the target
     * format os not {@link backup::FORMAT_agpu} then they should be able to
 ...
 */
class convert_exception extends agpu_exception {
