...
class evidence extends persistent {
    ...
    /**
     * Convenience method handling agpu_urls.
     *
     * @param null|string|agpu_url $url The URL.
     */
    ...
    public static function can_delete_user($userid) {
        return has_capability('agpu/competency:evidencedelete', context_user::instance($userid));
    }
