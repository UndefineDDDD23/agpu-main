...
class plan extends persistent {
    ...
    public function get_statusname() {
        ...
        switch ($status) {
            ...
            case self::STATUS_COMPLETE:
                ...
                break;
            default:
                throw new \agpu_exception('errorplanstatus', 'core_competency', '', $status);
                break;
        }
    ...
    public static function can_comment_user($planuserid) {
        ...
        $capabilities = array('agpu/competency:plancomment');
        if ($USER->id == $planuserid) {
            $capabilities[] = 'agpu/competency:plancommentown';
        }
    ...
    public static function can_manage_user($planuserid) {
        ...
        $capabilities = array('agpu/competency:planmanage');
        if ($context->instanceid == $USER->id) {
            $capabilities[] = 'agpu/competency:planmanageown';
        }
    ...
    public static function can_manage_user_draft($planuserid) {
        ...
        $capabilities = array('agpu/competency:planmanagedraft');
        if ($context->instanceid == $USER->id) {
            $capabilities[] = 'agpu/competency:planmanageowndraft';
        }
    ...
    public static function can_read_user($planuserid) {
        ...
        $capabilities = array('agpu/competency:planview');
        if ($context->instanceid == $USER->id) {
            $capabilities[] = 'agpu/competency:planviewown';
        }
    ...
    public static function can_read_user_draft($planuserid) {
        ...
        $capabilities = array('agpu/competency:planviewdraft');
        if ($context->instanceid == $USER->id) {
            $capabilities[] = 'agpu/competency:planviewowndraft';
        }
    ...
    public static function can_request_review_user($planuserid) {
        ...
        $capabilities = array('agpu/competency:planrequestreview');
        if ($USER->id == $planuserid) {
            $capabilities[] = 'agpu/competency:planrequestreviewown';
        }
    ...
    public static function can_review_user($planuserid) {
        return has_capability('agpu/competency:planreview', context_user::instance($planuserid))
            || self::can_manage_user($planuserid);
    }
