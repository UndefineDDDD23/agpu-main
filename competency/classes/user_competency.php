...
class user_competency extends persistent {
    ...
    public static function get_status_name($status) {
        ...
        switch ($status) {
            ...
            case self::STATUS_IN_REVIEW:
                ...
                break;
            default:
                throw new \agpu_exception('errorusercomptencystatus', 'core_competency', '', $status);
                break;
        }
    ...
    public static function can_comment_user($userid) {
        ...
        $capabilities = array('agpu/competency:usercompetencycomment');
        if ($USER->id == $userid) {
            $capabilities[] = 'agpu/competency:usercompetencycommentown';
        }
    ...
    public static function can_grade_user($userid) {
        $ratecap = 'agpu/competency:competencygrade';
    ...
    public static function can_read_user_in_course($userid, $courseid) {
        $capability = 'agpu/competency:usercompetencyview';
    ...
    public static function can_request_review_user($userid) {
        ...
        $capabilities = array('agpu/competency:usercompetencyrequestreview');
        if ($USER->id == $userid) {
            $capabilities[] = 'agpu/competency:usercompetencyrequestreviewown';
        }
