...
class competency_framework extends persistent {
    ...
    public static function can_manage_context($context) {
        return has_capability('agpu/competency:competencymanage', $context);
    }
    ...
    public static function can_read_context($context) {
        return has_capability('agpu/competency:competencyview', $context) || self::can_manage_context($context);
    }
