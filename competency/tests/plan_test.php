...
class plan_test extends \advanced_testcase {
    ...
    public function test_can_manage_user(): void {
        ...
        assign_capability('agpu/competency:planmanage', CAP_ALLOW, $manage, $syscontext->id);
        assign_capability('agpu/competency:planmanageown', CAP_ALLOW, $manageown, $u2context->id);
    ...
    public function test_can_manage_user_draft(): void {
        ...
        assign_capability('agpu/competency:planmanage', CAP_ALLOW, $manage, $syscontext->id);
        assign_capability('agpu/competency:planmanageown', CAP_ALLOW, $manageown, $syscontext->id);
        assign_capability('agpu/competency:planmanagedraft', CAP_ALLOW, $managedraft, $syscontext->id);
        assign_capability('agpu/competency:planmanageowndraft', CAP_ALLOW, $manageowndraft, $syscontext->id);
    ...
    public function test_can_read_user(): void {
        ...
        assign_capability('agpu/competency:planview', CAP_ALLOW, $read, $syscontext->id);
        assign_capability('agpu/competency:planviewown', CAP_ALLOW, $readown, $u2context->id);
    ...
    public function test_can_read_user_draft(): void {
        ...
        assign_capability('agpu/competency:planview', CAP_ALLOW, $read, $syscontext->id);
        assign_capability('agpu/competency:planviewown', CAP_ALLOW, $readown, $syscontext->id);
        assign_capability('agpu/competency:planviewdraft', CAP_ALLOW, $readdraft, $syscontext->id);
        assign_capability('agpu/competency:planviewowndraft', CAP_ALLOW, $readowndraft, $syscontext->id);
        assign_capability('agpu/competency:planviewown', CAP_PROHIBIT, $readowndraft, $syscontext->id);
