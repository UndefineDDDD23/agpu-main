...
class external_test extends externallib_advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        unassign_capability('agpu/competency:competencygrade', $authrole->id);
        unassign_capability('agpu/competency:competencymanage', $authrole->id);
        unassign_capability('agpu/competency:competencyview', $authrole->id);
        unassign_capability('agpu/competency:planmanage', $authrole->id);
        unassign_capability('agpu/competency:planmanagedraft', $authrole->id);
        unassign_capability('agpu/competency:planmanageown', $authrole->id);
        unassign_capability('agpu/competency:planview', $authrole->id);
        unassign_capability('agpu/competency:planviewdraft', $authrole->id);
        unassign_capability('agpu/competency:planviewown', $authrole->id);
        unassign_capability('agpu/competency:planviewowndraft', $authrole->id);
        unassign_capability('agpu/competency:templatemanage', $authrole->id);
        unassign_capability('agpu/competency:templateview', $authrole->id);
        unassign_capability('agpu/cohort:manage', $authrole->id);
        unassign_capability('agpu/competency:coursecompetencyconfigure', $authrole->id);
        ...
        assign_capability('agpu/competency:competencymanage', CAP_ALLOW, $this->creatorrole, $syscontext->id);
        assign_capability('agpu/competency:coursecompetencyconfigure', CAP_ALLOW, $this->creatorrole, $syscontext->id);
        assign_capability('agpu/competency:competencyview', CAP_ALLOW, $this->userrole, $syscontext->id);
        assign_capability('agpu/competency:planmanage', CAP_ALLOW, $this->creatorrole, $syscontext->id);
        assign_capability('agpu/competency:planmanagedraft', CAP_ALLOW, $this->creatorrole, $syscontext->id);
        assign_capability('agpu/competency:planmanageown', CAP_ALLOW, $this->creatorrole, $syscontext->id);
        assign_capability('agpu/competency:planview', CAP_ALLOW, $this->creatorrole, $syscontext->id);
        assign_capability('agpu/competency:planviewdraft', CAP_ALLOW, $this->creatorrole, $syscontext->id);
        assign_capability('agpu/competency:templatemanage', CAP_ALLOW, $this->creatorrole, $syscontext->id);
        assign_capability('agpu/competency:competencygrade', CAP_ALLOW, $this->creatorrole, $syscontext->id);
        assign_capability('agpu/cohort:manage', CAP_ALLOW, $this->creatorrole, $syscontext->id);
        assign_capability('agpu/competency:templateview', CAP_ALLOW, $this->userrole, $syscontext->id);
        assign_capability('agpu/competency:planviewown', CAP_ALLOW, $this->userrole, $syscontext->id);
        assign_capability('agpu/competency:planviewowndraft', CAP_ALLOW, $this->userrole, $syscontext->id);
    ...
    public function test_create_and_update_plans(): void {
        ...
        assign_capability('agpu/competency:planmanageowndraft', CAP_ALLOW, $this->userrole, $syscontext->id);
        accesslib_clear_all_caches_for_unit_testing();
        ...
        assign_capability('agpu/competency:planmanageown', CAP_ALLOW, $this->userrole, $syscontext->id);
        accesslib_clear_all_caches_for_unit_testing();
        ...
        unassign_capability('agpu/competency:planmanageown', $this->userrole, $syscontext->id);
        unassign_capability('agpu/competency:planmanageowndraft', $this->userrole, $syscontext->id);
        accesslib_clear_all_caches_for_unit_testing();
    ...
    public function test_read_plans(): void {
        ...
        assign_capability('agpu/competency:plancommentown', CAP_PROHIBIT, $this->userrole, $syscontext->id, true);
        assign_capability('agpu/competency:planviewown', CAP_PROHIBIT, $this->userrole, $syscontext->id, true);
        assign_capability('agpu/competency:planviewowndraft', CAP_ALLOW, $this->userrole, $syscontext->id, true);
        accesslib_clear_all_caches_for_unit_testing();
        ...
        assign_capability('agpu/competency:plancommentown', CAP_ALLOW, $this->userrole, $syscontext->id, true);
        assign_capability('agpu/competency:planviewown', CAP_ALLOW, $this->userrole, $syscontext->id, true);
        assign_capability('agpu/competency:planmanageowndraft', CAP_PROHIBIT, $this->userrole, $syscontext->id, true);
        accesslib_clear_all_caches_for_unit_testing();
        ...
        assign_capability('agpu/competency:planviewown', CAP_PROHIBIT, $this->userrole, $syscontext->id, true);
        assign_capability('agpu/competency:planmanageown', CAP_PROHIBIT, $this->userrole, $syscontext->id, true);
        assign_capability('agpu/competency:planmanageowndraft', CAP_ALLOW, $this->userrole, $syscontext->id, true);
        accesslib_clear_all_caches_for_unit_testing();
        ...
        assign_capability('agpu/competency:planviewown', CAP_PROHIBIT, $this->userrole, $syscontext->id, true);
        assign_capability('agpu/competency:planmanageowndraft', CAP_PROHIBIT, $this->userrole, $syscontext->id, true);
        assign_capability('agpu/competency:planmanageown', CAP_ALLOW, $this->userrole, $syscontext->id, true);
        accesslib_clear_all_caches_for_unit_testing();
    ...
    public function test_delete_plans(): void {
        ...
        unassign_capability('agpu/competency:planmanage', $this->creatorrole, $syscontext->id);
        accesslib_clear_all_caches_for_unit_testing();
    ...
    public function test_add_competency_to_template(): void {
        ...
        // Unassign capability.
        unassign_capability('agpu/competency:templatemanage', $this->creatorrole, $syscontext->id);
        accesslib_clear_all_caches_for_unit_testing();
    ...
    public function test_read_template(): void {
        ...
        assign_capability('agpu/competency:templateview', CAP_PROHIBIT, $this->userrole, $syscontextid, true);
        accesslib_clear_all_caches_for_unit_testing();
        $this->setUser($this->user);
        $this->assertFalse(has_capability('agpu/competency:templateview', \context_system::instance()));
        try {
        ...
        assign_capability('agpu/competency:templateview', CAP_PREVENT, $this->userrole, $syscontextid, true);
        assign_capability('agpu/competency:templateview', CAP_ALLOW, $this->userrole, $catcontextid, true);
        accesslib_clear_all_caches_for_unit_testing();
        $this->assertFalse(has_capability('agpu/competency:templateview', \context_system::instance()));
        $this->assertTrue(has_capability('agpu/competency:templateview', \context_coursecat::instance($this->category->id)));
        try {
            external::read_template($systemplate->id);
            $this->fail('Invalid permissions');
        } catch (\required_capability_exception $e) {
        ...
        assign_capability('agpu/competency:templateview', CAP_ALLOW, $this->userrole, $syscontextid, true);
        accesslib_clear_all_caches_for_unit_testing();
        $this->assertTrue(has_capability('agpu/competency:templateview', \context_system::instance()));
    ...
    public function test_add_competency_to_plan(): void {
        ...
        assign_capability('agpu/competency:planmanage', CAP_ALLOW, $managerole, $syscontext->id);
        assign_capability('agpu/competency:planview', CAP_ALLOW, $managerole, $syscontext->id);
    ...
    public function test_update_course_competency_settings(): void {
        ...
        assign_capability('agpu/competency:coursecompetencyconfigure', CAP_ALLOW, $roleid, $context->id, true);
        assign_capability('agpu/competency:coursecompetencyview', CAP_ALLOW, $roleid, $context->id, true);
        assign_capability('agpu/competency:coursecompetencyview', CAP_ALLOW, $noobroleid, $context->id, true);
