...
class provider_test extends provider_testcase {
    ...
    protected function allow_anyone_to_comment_anywhere() {
        ...
        assign_capability('agpu/competency:plancomment', CAP_ALLOW, $roleid, SYSCONTEXTID, true);
        assign_capability('agpu/competency:planmanage', CAP_ALLOW, $roleid, SYSCONTEXTID, true);
        assign_capability('agpu/competency:planmanagedraft', CAP_ALLOW, $roleid, SYSCONTEXTID, true);
        assign_capability('agpu/competency:usercompetencycomment', CAP_ALLOW, $roleid, SYSCONTEXTID, true);
        assign_capability('agpu/competency:usercompetencyview', CAP_ALLOW, $roleid, SYSCONTEXTID, true);
