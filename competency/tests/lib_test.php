...
class lib_test extends \advanced_testcase {
    ...
    public function test_comment_add_user_competency(): void {
        ...
        assign_capability('agpu/competency:planview', CAP_ALLOW, $reviewerroleid, \context_system::instance()->id, true);
        assign_capability('agpu/competency:usercompetencycomment', CAP_ALLOW, $reviewerroleid,
        ...
        $this->assertEquals(FORMAT_agpu, $message->fullmessageformat);
    ...
    public function test_comment_add_plan(): void {
        ...
        $reviewerroleid = $dg->create_role();
        assign_capability('agpu/competency:planviewowndraft', CAP_ALLOW, $userroleid, \context_system::instance()->id, true);
        assign_capability('agpu/competency:planviewown', CAP_ALLOW, $userroleid, \context_system::instance()->id, true);
        assign_capability('agpu/competency:planviewdraft', CAP_ALLOW, $reviewerroleid, \context_system::instance()->id, true);
        assign_capability('agpu/competency:planmanage', CAP_ALLOW, $reviewerroleid, \context_system::instance()->id, true);
        assign_capability('agpu/competency:plancomment', CAP_ALLOW, $reviewerroleid, \context_system::instance()->id, true);
