...
class externallib_test extends externallib_advanced_testcase {
    ...
    public function test_get_activities_completion_status(): void {
        ...
        assign_capability('agpu/site:accessallgroups', CAP_PROHIBIT, $teacherrole->id, $context);
    ...
    public function test_override_status_user_without_capability(): void {
        ...
        $this->setUser($teacher);
        assign_capability('agpu/course:overridecompletion', CAP_PREVENT, $teacherrole->id, $coursecontext);
