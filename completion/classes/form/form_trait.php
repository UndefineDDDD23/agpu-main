...
trait form_trait {
     ...
     */
    protected function get_form(): \agpuQuickForm {
     ...
     *
     * @param string|null $modname The module name (for example, 'assign'). If null and form is agpuform_mod, the parameters are
     ...
     * @throws \coding_exception If the form is not agpuform_mod and $modname is null.
     */
    protected function add_completion_elements(
        ...
        $mform = $this->get_form();
        if ($modname === null) {
            if ($this instanceof \agpuform_mod) {
                ...
                throw new \coding_exception('You must specify the modname parameter if you are not using a agpuform_mod.');
            }
        }
