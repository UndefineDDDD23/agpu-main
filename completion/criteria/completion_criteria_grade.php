...
class completion_criteria_grade extends completion_criteria {
     ...
     *
     * @param agpu_form $mform agpu forms object
    ...
    public function config_form_display(&$mform, $data = null) {
        ...
        // Grades are stored in agpu with 5 decimal points, make sure we do not accidentally round them
    ...
    public function get_icon($alt, ?array $attributes = null) {
        return new pix_icon('i/grades', $alt, 'agpu', $attributes);
    }
}
