...
$hasmaintenanceaccess = has_capability('agpu/site:maintenanceaccess', context_system::instance());
    ...
    if (optional_param('setdefaulthome', false, PARAM_BOOL)) {
        ...
        if ($frontpagenode) {
            $frontpagenode->add(
                ...
                new agpu_url('/', array('setdefaulthome' => true)),
...
if ($hassiteconfig) {
    $editurl = new agpu_url('/course/view.php', ['id' => SITEID, 'sesskey' => sesskey()]);
...
if ($editing && has_capability('agpu/course:create', context_system::instance())) {
